(function(){var P$=Clazz.newPackage("javax.sound.sampled"),I$=[['javax.sound.sampled.AudioFormat','java.lang.StringBuffer']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
}, ['javax.sound.sampled.Line','javax.sound.sampled.Line.Info']);
...
C$.$init$.apply(this);
if (formats == null ) {
this.formats = Clazz.array((I$[1]||$incl$(1)), [0]);
} else {
...
var formats = Clazz.array((I$[1]||$incl$(1)), -1, [format]);
this.formats = formats;
...
var returnedArray = Clazz.array((I$[1]||$incl$(1)), [this.formats.length]);
