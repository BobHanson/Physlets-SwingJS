...
var C$=Clazz.newInterface(P$, "LongConsumer");
...
(function(){var C$=Clazz.newClass(P$, "LongConsumer$lambda1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.LongConsumer', 1);
