...
this.fontSearch = Clazz.new_((I$[7]||$incl$(7)).c$$S$I$I,[null, 0, 0]);
this.fontTable = Clazz.new_((I$[8]||$incl$(8)));
this.attributesPool = (I$[9]||$incl$(9)).synchronizedMap$java_util_Map(Clazz.new_((I$[10]||$incl$(10))));
this.search = Clazz.new_((I$[11]||$incl$(11)));
}, 1);
...
var style = Clazz.new_((I$[12]||$incl$(12)).c$$S$javax_swing_text_Style, [this, null, nm, parent]);
if (nm != null ) {
...
return (I$[1]||$incl$(1)).getForeground$javax_swing_text_AttributeSet(attr);
});

Clazz.newMeth(C$, 'getBackground$javax_swing_text_AttributeSet', function (attr) {
return (I$[1]||$incl$(1)).getBackground$javax_swing_text_AttributeSet(attr);
});
...
return Clazz.new_((I$[15]||$incl$(15)).c$$javax_swing_text_AttributeSet, [this, null, a]);
});

Clazz.newMeth(C$, 'createLargeAttributeSet$javax_swing_text_AttributeSet', function (a) {
return Clazz.new_((I$[11]||$incl$(11)).c$$javax_swing_text_AttributeSet,[a]);
});
...
if (Clazz.instanceOf(a, "javax.swing.text.MutableAttributeSet") && a !== (I$[11]||$incl$(11)).EMPTY  ) {
return a;
...
return Clazz.new_((I$[2]||$incl$(2)).c$$OA, [this, null, this.attributes]);
});
...
Clazz.newMeth(C$, '$init$', function () {
this.keys = Clazz.new_((I$[3]||$incl$(3)));
this.data = Clazz.new_((I$[3]||$incl$(3)));
}, 1);
...
p$.initialize$OA.apply(this, [(a).attributes]);
} else {
...
p$.removeSearchAttribute$O$O.apply(this, [name, value]);
}
});
...
if (this.isDefined$O((I$[1]||$incl$(1)).NameAttribute)) {
return this.getAttribute$O((I$[1]||$incl$(1)).NameAttribute).toString();
}return null;
});

Clazz.newMeth(C$, 'setName$S', function (name) {
if (name != null ) {
this.addAttribute$O$O((I$[1]||$incl$(1)).NameAttribute, name);
}});
...
if (parent != null ) {
this.addAttribute$O$O((I$[1]||$incl$(1)).ResolveAttribute, parent);
} else {
this.removeAttribute$O((I$[1]||$incl$(1)).ResolveAttribute);
}});
})()
})();
