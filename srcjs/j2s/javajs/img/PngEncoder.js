(function(){var P$=Clazz.newPackage("javajs.img"),I$=[['java.util.zip.Deflater','java.io.ByteArrayOutputStream','java.util.zip.DeflaterOutputStream']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
p$.writeHeader.apply(this, []);
p$.writeText$S.apply(this, [C$.getApplicationText$S$S$I$I(this.appPrefix, this.type, 0, 0)]);
p$.writeText$S.apply(this, ["Software\0" + this.comment]);
p$.writeText$S.apply(this, ["Creation Time\0" + this.date]);
if (!this.encodeAlpha && this.transparentColor != null  ) p$.writeTransparentColor$I.apply(this, [this.transparentColor.intValue()]);
return p$.writeImageData.apply(this, []);
});
...
var nRows;
var scanPos;
var deflater = Clazz.new_((I$[1]||$incl$(1)).c$$I,[this.compressionLevel]);
var outBytes = Clazz.new_((I$[2]||$incl$(2)).c$$I,[1024]);
var compBytes = Clazz.new_((I$[3]||$incl$(3)).c$$java_io_ByteArrayOutputStream$java_util_zip_Deflater,[outBytes, deflater]);
var pt = 0;
try {
while (rowsLeft > 0){
