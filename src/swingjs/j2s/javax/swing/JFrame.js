(function(){var P$=Clazz.newPackage("javax.swing"),I$=[['javax.swing.JComponent','javax.swing.UIManager','javax.swing.JRootPane','javax.swing.SwingUtilities','javax.swing.RepaintManager','java.lang.Boolean']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
var rp = Clazz.new_((I$[3]||$incl$(3)).c$$S$Z,["_Frame" + (++C$.frameCount), false]);
rp.setOpaque$Z(true);
return rp;
});
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["defaultCloseOperation must be one of: DO_NOTHING_ON_CLOSE, HIDE_ON_CLOSE, DISPOSE_ON_CLOSE, or EXIT_ON_CLOSE"]);
