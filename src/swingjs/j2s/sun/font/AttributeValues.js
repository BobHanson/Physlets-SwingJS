(function(){var P$=Clazz.newPackage("sun.font"),I$=[['sun.font.EAttribute','java.awt.geom.AffineTransform','java.lang.InternalError','java.util.HashMap','java.lang.StringBuilder','java.awt.font.TextAttribute','Boolean',['java.awt.geom.Point2D','.Double']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
var C$=Clazz.newClass(P$, "AttributeValues", null, null, 'Cloneable');
C$.DEFAULT = null;
C$.MASK_ALL = 0;
var p$=C$.prototype;
...
C$.MASK_ALL = C$.getMask$sun_font_EAttributeA(Clazz.getClass((I$[1]||$incl$(1))).getEnumConstants());
}
...
if (a.att == null ) {
throw Clazz.new_((I$[3]||$incl$(3)).c$$S,["can't set derived attribute: " + a]);
}if (src == null  || src === C$.DEFAULT  ) {
this.setDefault$sun_font_EAttribute(a);
} else {
if ((src.defined & a.mask) != 0) {
p$.i_set$sun_font_EAttribute$sun_font_AttributeValues.apply(this, [a, src]);
p$.update$sun_font_EAttribute.apply(this, [a]);
}}});
...
try {
p$.i_set$sun_font_EAttribute$O.apply(this, [a, o]);
p$.update$sun_font_EAttribute.apply(this, [a]);
return;
} catch (e) {
...
if (a.att == null ) {
throw Clazz.new_((I$[3]||$incl$(3)).c$$S,["can't get derived attribute: " + a]);
}if ((this.nondefault & a.mask) != 0) {
return p$.i_get$sun_font_EAttribute.apply(this, [a]);
}return null;
});
...
var ea = (I$[1]||$incl$(1)).forAttribute$java_text_AttributedCharacterIterator_Attribute(e.getKey());
...
for (var ea, $ea = 0, $$ea = (I$[1]||$incl$(1)).atts; $ea<$$ea.length&&((ea=$$ea[$ea]),1);$ea++) {
if (m == 0) {
break;
}if ((m & ea.mask) != 0) {
m = m&(~ea.mask);
...
try {
var ea = (I$[1]||$incl$(1)).forAttribute$java_text_AttributedCharacterIterator_Attribute(key);
if (ea != null ) {
result.set$sun_font_EAttribute$O(ea, val);
}} catch (ex) {
if (Clazz.exceptionOf(ex, "java.lang.ClassCastException")){
} else {
throw ex;
}
}
...
case (I$[1]||$incl$(1)).ESTRIKETHROUGH:
return (I$[7]||$incl$(7)).$valueOf(this.strikethrough);
case (I$[1]||$incl$(1)).ERUN_DIRECTION:
{
switch (this.runDirection) {
case 0:
return (I$[6]||$incl$(6)).RUN_DIRECTION_LTR;
case 1:
return (I$[6]||$incl$(6)).RUN_DIRECTION_RTL;
default:
return null;
}
}case (I$[1]||$incl$(1)).EBIDI_EMBEDDING:
...
case (I$[1]||$incl$(1)).ESWAP_COLORS:
return (I$[7]||$incl$(7)).$valueOf(this.swapColors);
case (I$[1]||$incl$(1)).EKERNING:
...
case (I$[1]||$incl$(1)).EFONT:
return true;
case (I$[1]||$incl$(1)).ECHAR_REPLACEMENT:
return true;
case (I$[1]||$incl$(1)).EFOREGROUND:
return true;
case (I$[1]||$incl$(1)).EBACKGROUND:
return true;
case (I$[1]||$incl$(1)).EUNDERLINE:
...
case (I$[1]||$incl$(1)).ESWAP_COLORS:
return true;
case (I$[1]||$incl$(1)).ENUMERIC_SHAPING:
return true;
case (I$[1]||$incl$(1)).EKERNING:
...
default:
throw Clazz.new_((I$[3]||$incl$(3)).c$$S,["unknown attribute: " + a]);
}
});
...
}var obj = map.get$O((I$[6]||$incl$(6)).JUSTIFICATION);
...
return C$.extractRotation$java_awt_geom_Point2D_Double$java_awt_geom_AffineTransform$Z(Clazz.new_((I$[8]||$incl$(8)).c$$D$D,[1, 0]), tx, andTranslation);
}, 1);

Clazz.newMeth(C$, 'extractYRotation$java_awt_geom_AffineTransform$Z', function (tx, andTranslation) {
return C$.extractRotation$java_awt_geom_Point2D_Double$java_awt_geom_AffineTransform$Z(Clazz.new_((I$[8]||$incl$(8)).c$$D$D,[0, 1]), tx, andTranslation);
}, 1);
...
var rtx = (I$[2]||$incl$(2)).getRotateInstance$D$D(pt.x, pt.y);
try {
