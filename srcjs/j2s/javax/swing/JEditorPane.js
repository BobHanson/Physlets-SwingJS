(function(){var P$=Clazz.newPackage("javax.swing"),I$=[['javax.swing.UIManager',['javax.swing.JEditorPane','.PageStream'],'javax.swing.SwingUtilities','javax.swing.JEditorPane$PageLoader$2','javax.swing.JEditorPane$PageLoader$3','javax.swing.JEditorPane$PageLoader$1','java.lang.Error',['javax.swing.JEditorPane','.PlainEditorKit','.PlainParagraph','.LogicalView'],'javax.swing.text.WrappedPlainView',['javax.swing.JEditorPane','.PlainEditorKit','.PlainParagraph'],'javax.swing.text.BoxView','java.util.HashMap','javax.swing.event.HyperlinkListener','java.awt.Rectangle',['javax.swing.JEditorPane','.PageLoader'],'javax.swing.JEditorPane$1','java.io.InputStreamReader','java.lang.Boolean','java.io.BufferedInputStream','Boolean','javax.swing.JEditorPane$2','java.util.Hashtable','java.net.URL',['javax.swing.JEditorPane','.PlainEditorKit'],['javax.swing.JEditorPane','.HeaderParser'],'swingjs.api.Interface','java.awt.Dimension','java.io.StringReader']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.defaultEditorKitMap = Clazz.new_((I$[12]||$incl$(12)).c$$I,[0]);
}
...
Clazz.newMeth(C$, 'c$$S$S$S', function (type, text, uid) {
...
this.listenerList.add$Class$TT(Clazz.getClass((I$[13]||$incl$(13)),['hyperlinkUpdate$javax_swing_event_HyperlinkEvent']), listener);
});

Clazz.newMeth(C$, 'removeHyperlinkListener$javax_swing_event_HyperlinkListener', function (listener) {
this.listenerList.remove$Class$TT(Clazz.getClass((I$[13]||$incl$(13)),['hyperlinkUpdate$javax_swing_event_HyperlinkEvent']), listener);
});

Clazz.newMeth(C$, 'getHyperlinkListeners', function () {
return this.listenerList.getListeners$Class(Clazz.getClass((I$[13]||$incl$(13)),['hyperlinkUpdate$javax_swing_event_HyperlinkEvent']));
});
...
this.scrollRectToVisible$java_awt_Rectangle(Clazz.new_((I$[14]||$incl$(14)).c$$I$I$I$I,[0, 0, 1, 1]));
}var reloaded = false;
...
), Clazz.new_((I$[16]||$incl$(16)).$init$, [this, {reference: reference}])));
...
var r = (charset != null ) ? Clazz.new_((I$[17]||$incl$(17)).c$$java_io_InputStream$S,[$in, charset]) : Clazz.new_((I$[17]||$incl$(17)).c$$java_io_InputStream,[$in]);
...
doc.putProperty$O$O("IgnoreCharsetDirective", (I$[20]||$incl$(20)).$valueOf(true));
this.read$java_io_InputStream$javax_swing_text_Document($in, doc);
}
} else {
throw e$$;
...
), Clazz.new_((I$[21]||$incl$(21)).$init$, [this, {conn: conn}])));
} catch (e$$) {
...
if (!this.isEditable()) {
(I$[1]||$incl$(1)).getLookAndFeel().provideErrorFeedback$java_awt_Component(this);
return;
...
return (I$[3]||$incl$(3)).appContextGet$O(C$.kitTypeRegistryKey);
}, 1);
...
if ((I$[3]||$incl$(3)).appContextGet$O(C$.kitTypeRegistryKey) == null ) {
{
...
return;
}var r = Clazz.new_((I$[28]||$incl$(28)).c$$S,[t]);
var kit = this.getEditorKit();
...
Clazz.newMeth(C$, 'run', function () {
this.b$['javax.swing.JEditorPane.PageLoader'].doc = this.this$0.initializeModel$javax_swing_text_EditorKit$java_net_URL(this.this$0.kit, this.b$['javax.swing.JEditorPane.PageLoader'].page);
this.this$0.setDocument$javax_swing_text_Document(this.b$['javax.swing.JEditorPane.PageLoader'].doc);
});
})()
...
}this.this$0.read$java_io_InputStream$javax_swing_text_Document(this.$in, this.doc);
...
Clazz.newMeth(C$, 'run', function () {
var u = this.this$0.getDocument().getProperty$O("stream");
var ref = u.getRef();
this.this$0.scrollToReference$S(ref);
});
})()
...
this.this$0.firePropertyChange$S$O$O("page", this.b$['javax.swing.JEditorPane.PageLoader'].old, this.b$['javax.swing.JEditorPane.PageLoader'].page);
}});
})()
...
return Clazz.new_((I$[9]||$incl$(9)).c$$javax_swing_text_Element,[elem]);
});
...
return Clazz.new_((I$[10]||$incl$(10)).c$$javax_swing_text_Element,[elem]);
} else if (kind.equals$O("paragraph")) {
return Clazz.new_((I$[11]||$incl$(11)).c$$javax_swing_text_Element$I,[elem, 1]);
}}return null;
});
;
...
if (this.getViewCount() != 1) throw Clazz.new_((I$[7]||$incl$(7)).c$$S,["One child view is assumed."]);
