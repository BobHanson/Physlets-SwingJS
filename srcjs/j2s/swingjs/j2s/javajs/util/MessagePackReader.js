(function(){var P$=Clazz.newPackage("javajs.util"),I$=[['javajs.util.BinaryDocument','javajs.util.BC','java.lang.Boolean','java.util.Hashtable','javajs.util.SB']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
var C$=Clazz.newClass(P$, "MessagePackReader");
var p$=C$.prototype;
...
return ((b & 240) == 128 ? p$.getMap$I.apply(this, [b & 15]) : p$.getArray$I.apply(this, [b & 15]));
case 192:
switch (b) {
case 192:
return null;
case 194:
return (I$[3]||$incl$(3)).FALSE;
case 195:
return (I$[3]||$incl$(3)).TRUE;
case 199:
return p$.getObject$I.apply(this, [this.doc.readUInt8()]);
case 200:
return p$.getObject$I.apply(this, [this.doc.readUnsignedShort()]);
case 201:
return p$.getObject$I.apply(this, [this.doc.readInt()]);
case 212:
return p$.getObject$I.apply(this, [1]);
case 213:
return p$.getObject$I.apply(this, [2]);
case 214:
return p$.getObject$I.apply(this, [4]);
case 215:
return p$.getObject$I.apply(this, [8]);
case 216:
return p$.getObject$I.apply(this, [16]);
case 220:
return p$.getArray$I.apply(this, [this.doc.readUnsignedShort()]);
case 221:
return p$.getArray$I.apply(this, [this.doc.readInt()]);
case 222:
return p$.getMap$I.apply(this, [this.doc.readUnsignedShort()]);
case 223:
return p$.getMap$I.apply(this, [this.doc.readInt()]);
case 196:
...
return Clazz.array(java.lang.Object, -1, [Integer.$valueOf(this.doc.readUInt8()), this.doc.readBytes$I(n)]);
});
...
var type = (I$[2]||$incl$(2)).bytesToInt$BA$I$Z(b, 0, true);
var n = (I$[2]||$incl$(2)).bytesToInt$BA$I$Z(b, 4, true);
var param = (I$[2]||$incl$(2)).bytesToInt$BA$I$Z(b, 8, true);
switch (type) {
case 1:
...
var id = Clazz.array(java.lang.String, [((b.length - 12)/4|0)]);
