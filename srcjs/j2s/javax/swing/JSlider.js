(function(){var P$=Clazz.newPackage("javax.swing"),I$=[['java.util.Hashtable',['javax.swing.JSlider','.JSliderLabelUIResource'],'javax.swing.DefaultBoundedRangeModel',['javax.swing.JSlider','.ModelListener'],'javax.swing.event.ChangeListener','javax.swing.event.ChangeEvent',['javax.swing.JSlider','.JSliderSmartHashtable']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Slider label start point out of range."]);
}if (increment <= 0) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Label incremement must be > 0"]);
}var table = Clazz.new_((I$[7]||$incl$(7)).c$$I$I, [this, null, increment, start]);
...
if (font != null  && !(Clazz.instanceOf(font, "javax.swing.plaf.UIResource")) ) {
return font;
...
return fg;
}if (!(Clazz.instanceOf(this.this$0.getForeground(), "javax.swing.plaf.UIResource"))) {
