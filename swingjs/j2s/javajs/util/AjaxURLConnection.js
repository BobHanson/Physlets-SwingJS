(function(){var P$=Clazz.newPackage("javajs.util"),p$1={},I$=[[0,'java.util.Hashtable',['javajs.util.AjaxURLConnection','.AjaxHttpsURLConnection'],'java.io.ByteArrayOutputStream','javajs.util.Rdr']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
...
return this.streamOut=Clazz.new_($I$(3));
});
