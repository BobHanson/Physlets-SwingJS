(function(){var P$=Clazz.newPackage("sun.awt.geom"),I$=[['sun.awt.geom.AreaOp$1','sun.awt.geom.CurveLink','sun.awt.geom.ChainEnd','java.util.Vector','sun.awt.geom.Curve','sun.awt.geom.Edge','java.util.Arrays','java.lang.InternalError']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.EmptyLinkList = Clazz.array((I$[2]||$incl$(2)), [2]);
C$.EmptyChainList = Clazz.array((I$[3]||$incl$(3)), [2]);
}
...
var curvelist = edges.toArray$TTA(Clazz.array((I$[5]||$incl$(5)), [numcurves]));
...
if (c.getOrder() > 0) {
edges.add$TE(Clazz.new_((I$[6]||$incl$(6)).c$$sun_awt_geom_Curve$I,[c, curvetag]));
}}
}, 1);
...
if (numedges < 2) {
return edges;
}var edgelist = edges.toArray$TTA(Clazz.array((I$[6]||$incl$(6)), [numedges]));
(I$[7]||$incl$(7)).sort$TTA$java_util_Comparator(edgelist, C$.YXTopComparator);
if (false) {
...
var subcurves = Clazz.new_((I$[4]||$incl$(4)));
var chains = Clazz.new_((I$[4]||$incl$(4)));
...
throw Clazz.new_((I$[8]||$incl$(8)).c$$S,["backstepping to " + new Double(yrange[1]).toString() + " from " + new Double(yrange[0]).toString() ]);
}if (ordering >= 0) {
if (ordering == 0) {
...
Clazz.newInstance(this, arguments[0],false,C$);
}, ['sun.awt.geom.AreaOp','sun.awt.geom.AreaOp.CAGOp']);
