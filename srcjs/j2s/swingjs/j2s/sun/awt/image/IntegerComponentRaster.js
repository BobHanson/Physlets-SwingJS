...
this.setIntCompRaster$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Rectangle$java_awt_Point$java_awt_image_Raster(sampleModel, sampleModel.createDataBuffer(), Clazz.new_((I$[1]||$incl$(1)).c$$I$I$I$I,[origin.x, origin.y, sampleModel.getWidth(), sampleModel.getHeight()]), origin, null);
}, 1);
...
Clazz.super_(C$, this,1);
this.setIntCompRaster$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Rectangle$java_awt_Point$java_awt_image_Raster(sampleModel, dataBuffer, Clazz.new_((I$[1]||$incl$(1)).c$$I$I$I$I,[origin.x, origin.y, sampleModel.getWidth(), sampleModel.getHeight()]), origin, null);
}, 1);
...
throw Clazz.new_(Clazz.load('java.lang.ArrayIndexOutOfBoundsException').c$$S,["Coordinate out of bounds!"]);
}p$.setDataElementsRaster4$I$I$I$I$java_awt_image_Raster.apply(this, [dstOffX, dstOffY, width, height, inRaster]);
});
