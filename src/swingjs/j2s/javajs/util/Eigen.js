(function(){var P$=Clazz.newPackage("javajs.util"),I$=[['javajs.util.V3']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
if (eigenVectors[i] == null ) eigenVectors[i]=Clazz.new_((I$[1]||$incl$(1)));
