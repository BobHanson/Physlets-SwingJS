(function(){var P$=Clazz.newPackage("javax.swing"),I$=[['java.util.concurrent.atomic.AtomicLong','java.util.concurrent.TimeUnit','java.lang.StringBuffer','java.util.concurrent.DelayQueue','javax.swing.SwingUtilities','sun.awt.AppContext','java.lang.Thread',['javax.swing.TimerQueue','.DelayedTimer'],'java.lang.StringBuilder']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.sharedInstanceKey = Clazz.new_((I$[3]||$incl$(3)).c$$S,["TimerQueue.sharedInstanceKey"]);
C$.expiredTimersKey = Clazz.new_((I$[3]||$incl$(3)).c$$S,["TimerQueue.expiredTimersKey"]);
...
if (this.running) {
throw Clazz.new_(Clazz.load('java.lang.RuntimeException').c$$S,["Can\'t start a TimerQueue that is already running"]);
} else {
var threadGroup = (I$[6]||$incl$(6)).getAppContext().getThreadGroup();
var timerThread = Clazz.new_((I$[7]||$incl$(7)).c$$ThreadGroup$Runnable$S,[threadGroup, this, "TimerQueue"]);
...
p$.addTimer$javax_swing_TimerQueue_DelayedTimer.apply(this, [Clazz.new_((I$[8]||$incl$(8)).c$$javax_swing_Timer$J,[timer, (I$[2]||$incl$(2)).MILLISECONDS.toNanos$J(delayMillis) + C$.now()])]);
}} finally {
}
});
...
if (Clazz.exceptionOf(ignore, "java.lang.SecurityException")){
} else {
throw ignore;
}
} finally {
...
if (Clazz.exceptionOf(ignore, "java.lang.InterruptedException")){
} else {
throw ignore;
}
}
...
C$.$clinit$ = function() {Clazz.load(C$, 1);
C$.sequencer = Clazz.new_((I$[1]||$incl$(1)).c$$J,[0]);
}
...
return unit.convert$J$java_util_concurrent_TimeUnit(this.time - P$.TimerQueue.now(), (I$[2]||$incl$(2)).NANOSECONDS);
});
...
Clazz.newMeth(C$, ['compareTo$java_util_concurrent_Delayed','compareTo$TT'], function (other) {
if (other === this ) {
return 0;
...
return 1;
}}var d = (this.getDelay$java_util_concurrent_TimeUnit((I$[2]||$incl$(2)).NANOSECONDS) - other.getDelay$java_util_concurrent_TimeUnit((I$[2]||$incl$(2)).NANOSECONDS));
