(function(){var P$=Clazz.newPackage("javax.swing"),I$=[['javax.swing.SizeSequence','javax.swing.DefaultListSelectionModel','sun.swing.SwingUtilities2','java.text.NumberFormat','java.text.DateFormat','javax.swing.border.EmptyBorder','javax.swing.UIManager','javax.swing.JTextField','javax.swing.border.LineBorder','java.awt.Color','javax.swing.JCheckBox','javax.swing.DropMode','javax.swing.table.DefaultTableModel','javax.swing.table.AbstractTableModel','javax.swing.JScrollPane','java.awt.Dimension','javax.swing.table.TableColumn','javax.swing.table.TableRowSorter',['javax.swing.JTable','.SortManager'],'java.lang.Boolean','java.awt.Rectangle','javax.swing.JTable$2','javax.swing.JTable$3','javax.swing.JTable$4','javax.swing.JTable$5','java.awt.event.MouseEvent','javax.swing.SwingUtilities','javax.swing.event.TableModelEvent',['javax.swing.event.RowSorterEvent','.Type'],['javax.swing.JTable','.ModelChange'],'java.awt.Point','sun.swing.SwingLazyValue','javax.swing.UIDefaults','java.lang.Number','java.util.Date','javax.swing.Icon','javax.swing.ImageIcon','javax.swing.table.DefaultTableColumnModel','javax.swing.table.JTableHeader']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
this.editorRemover = null;
this.dropMode = (I$[12]||$incl$(12)).USE_SELECTION;
}, 1);
...
C$.c$$javax_swing_table_TableModel.apply(this, [Clazz.new_((I$[13]||$incl$(13)).c$$I$I,[numRows, numColumns])]);
}, 1);

Clazz.newMeth(C$, 'c$$java_util_Vector$java_util_Vector', function (rowData, columnNames) {
C$.c$$javax_swing_table_TableModel.apply(this, [Clazz.new_((I$[13]||$incl$(13)).c$$java_util_Vector$java_util_Vector,[rowData, columnNames])]);
}, 1);
...
), Clazz.new_((I$[14]||$incl$(14)), [this, {columnNames: columnNames, rowData: rowData}],P$.JTable$1))]);
}, 1);
...
var scrollPaneBorder = (I$[7]||$incl$(7)).getBorder$O("Table.scrollPaneBorder");
...
return Clazz.new_((I$[15]||$incl$(15)).c$$java_awt_Component,[aTable]);
}, 1);
...
return Clazz.new_((I$[16]||$incl$(16)).c$$I$I,[this.getColumnModel().getColumnMargin(), this.rowMargin]);
});
...
var newColumn = Clazz.new_((I$[17]||$incl$(17)).c$$I,[i]);
...
if (dropMode != null ) {
switch (dropMode) {
case (I$[12]||$incl$(12)).USE_SELECTION:
case (I$[12]||$incl$(12)).ON:
case (I$[12]||$incl$(12)).INSERT:
case (I$[12]||$incl$(12)).INSERT_ROWS:
case (I$[12]||$incl$(12)).INSERT_COLS:
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Row index out of range"]);
}return row;
});

Clazz.newMeth(C$, 'boundColumn$I', function (col) {
if (col < 0 || col >= this.getColumnCount() ) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Column index out of range"]);
}return col;
});
...
if ((I$[20]||$incl$(20)).TRUE === this.getClientProperty$O("Table.isFileList") ) {
...
), Clazz.new_((I$[22]||$incl$(22)).$init$, [this, {cm: cm, inverse: inverse}]));
...
), Clazz.new_((I$[23]||$incl$(23)).$init$, [this, {end: end, start: start, cm: cm}]));
var totalWidth = 0;
...
), Clazz.new_((I$[25]||$incl$(25)).$init$, [this, {r: r}]));
...
(I$[27]||$incl$(27)).updateRendererOrEditorUI$O(aColumn.getCellRenderer());
(I$[27]||$incl$(27)).updateRendererOrEditorUI$O(aColumn.getCellEditor());
(I$[27]||$incl$(27)).updateRendererOrEditorUI$O(aColumn.getHeaderRenderer());
}
var defaultRenderers = this.defaultRenderersByColumnClass.elements();
while (defaultRenderers.hasMoreElements()){
(I$[27]||$incl$(27)).updateRendererOrEditorUI$O(defaultRenderers.nextElement());
}
var defaultEditors = this.defaultEditorsByColumnClass.elements();
while (defaultEditors.hasMoreElements()){
(I$[27]||$incl$(27)).updateRendererOrEditorUI$O(defaultEditors.nextElement());
}
...
if (dataModel == null ) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Cannot set a null TableModel"]);
...
this.setRowSorter$javax_swing_RowSorter(Clazz.new_((I$[18]||$incl$(18)).c$$TM,[dataModel]));
}}});
...
if (e.getType() === (I$[29]||$incl$(29)).SORT_ORDER_CHANGED ) {
...
(I$[3]||$incl$(3)).setLeadAnchorWithoutSelection$javax_swing_ListSelectionModel$I$I(this.selectionModel, lead, lead);
this.selectionModel.setValueIsAdjusting$Z(false);
});
...
var drawRect = Clazz.new_((I$[21]||$incl$(21)).c$$I$I$I$I,[0, start * rh, this.getColumnModel().getTotalColumnWidth(), (this.getRowCount() - start) * rh]);
this.revalidate();
...
var drawRect = Clazz.new_((I$[21]||$incl$(21)).c$$I$I$I$I,[0, start * rh, this.getColumnModel().getTotalColumnWidth(), (previousRowCount - start) * rh]);
this.revalidate();
this.repaint$java_awt_Rectangle(drawRect);
});
...
if (!retValue && condition == 1  && this.isFocusOwner()  && !(I$[20]||$incl$(20)).FALSE.equals(this.getClientProperty$O("JTable.autoStartsEdit")) ) {
...
h.put$TK$TV(c, Clazz.new_((I$[32]||$incl$(32)).c$$S,[s]));
});
...
p$.setLazyRenderer$Class$S.apply(this, [Clazz.getClass((I$[35]||$incl$(35))), "javax.swing.JTable$DateRenderer"]);
p$.setLazyRenderer$Class$S.apply(this, [Clazz.getClass((I$[36]||$incl$(36)),['getIconHeight','getIconWidth','paintIcon$java_awt_Component$java_awt_Graphics$I$I']), "javax.swing.JTable$IconRenderer"]);
p$.setLazyRenderer$Class$S.apply(this, [Clazz.getClass((I$[37]||$incl$(37))), "javax.swing.JTable$IconRenderer"]);
p$.setLazyRenderer$Class$S.apply(this, [Clazz.getClass((I$[20]||$incl$(20))), "javax.swing.JTable$BooleanRenderer"]);
});
...
this.setPreferredScrollableViewportSize$java_awt_Dimension(Clazz.new_((I$[16]||$incl$(16)).c$$I$I,[450, 400]));
this.setAutoscrolls$Z(true);
});

Clazz.newMeth(C$, 'createDefaultDataModel', function () {
return Clazz.new_((I$[13]||$incl$(13)));
});

Clazz.newMeth(C$, 'createDefaultColumnModel', function () {
return Clazz.new_((I$[38]||$incl$(38)));
});
...
return Clazz.new_((I$[39]||$incl$(39)).c$$javax_swing_table_TableColumnModel,[this.columnModel]);
});
...
if (this.modelRowSizes != null ) {
this.this$0.rowModel.setSizes$I$I(this.this$0.getRowCount(), this.this$0.getRowHeight());
for (var viewIndex = this.this$0.getRowCount() - 1; viewIndex >= 0; viewIndex--) {
var modelIndex = this.this$0.convertRowIndexToModel$I(viewIndex);
...
Clazz.newInstance(this, arguments[0],false,C$);
}, ['javax.swing.JTable','javax.swing.JTable.NumberRenderer']);
...
C$.$clinit$ = function() {Clazz.load(C$, 1);
C$.noFocusBorder = Clazz.new_((I$[6]||$incl$(6)).c$$I$I$I$I,[1, 1, 1, 1]);
}
...
if (hasFocus) {
this.setBorder$javax_swing_border_Border((I$[7]||$incl$(7)).getBorder$O("Table.focusCellHighlightBorder"));
} else {
...
Clazz.newMeth(C$, '$init$', function () {
this.argTypes = Clazz.array(java.lang.Class, -1, [Clazz.getClass(java.lang.String)]);
}, 1);

Clazz.newMeth(C$, 'c$', function () {
C$.superclazz.c$$javax_swing_JTextField.apply(this, [Clazz.new_((I$[8]||$incl$(8)))]);
C$.$init$.apply(this);
...
if (Clazz.exceptionOf(e, "java.lang.Exception")){
(this.getComponent()).setBorder$javax_swing_border_Border(Clazz.new_((I$[9]||$incl$(9)).c$$java_awt_Color,[(I$[10]||$incl$(10)).red]));
return false;
} else {
throw e;
}
...
Clazz.newInstance(this, arguments[0],false,C$);
}, ['javax.swing.JTable','javax.swing.JTable.GenericEditor']);
...
Clazz.newMeth(C$, 'c$', function () {
C$.superclazz.c$$javax_swing_JCheckBox.apply(this, [Clazz.new_((I$[11]||$incl$(11)))]);
C$.$init$.apply(this);
