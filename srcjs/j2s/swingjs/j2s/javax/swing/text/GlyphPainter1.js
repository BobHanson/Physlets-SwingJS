(function(){var P$=Clazz.newPackage("javax.swing.text"),I$=[['javax.swing.text.Utilities','javax.swing.text.SegmentCache','java.awt.Rectangle',['javax.swing.text.Position','.Bias'],'java.awt.Toolkit']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
var C$=Clazz.newClass(P$, "GlyphPainter1", null, ['javax.swing.text.GlyphView','javax.swing.text.GlyphView.GlyphPainter']);
var p$=C$.prototype;
...
var width = (I$[1]||$incl$(1)).getTabbedTextWidth$javax_swing_text_View$javax_swing_text_Segment$java_awt_FontMetrics$I$javax_swing_text_TabExpander$I$IA(v, text, this.metrics, (x|0), e, p0, justificationData);
...
(I$[2]||$incl$(2)).releaseSharedSegment$javax_swing_text_Segment(text);
return Clazz.new_((I$[3]||$incl$(3)).c$$I$I$I$I,[alloc.x + width, alloc.y, 0, this.metrics.getHeight()]);
...
var text = v.getText$I$I(p0, p1);
var justificationData = p$.getJustificationData$javax_swing_text_GlyphView.apply(this, [v]);
var offs = (I$[1]||$incl$(1)).getTabbedTextOffset$javax_swing_text_View$javax_swing_text_Segment$java_awt_FontMetrics$I$I$javax_swing_text_TabExpander$I$IA(v, text, this.metrics, alloc.x, (x|0), expander, p0, justificationData);
(I$[2]||$incl$(2)).releaseSharedSegment$javax_swing_text_Segment(text);
...
var justificationData = p$.getJustificationData$javax_swing_text_GlyphView.apply(this, [v]);
var index = (I$[1]||$incl$(1)).getTabbedTextOffset$javax_swing_text_View$javax_swing_text_Segment$java_awt_FontMetrics$I$I$javax_swing_text_TabExpander$I$Z$IA(v, s, this.metrics, (x|0), ((x + len)|0), expander, p0, false, justificationData);
