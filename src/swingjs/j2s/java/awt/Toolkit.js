(function(){var P$=Clazz.newPackage("java.awt"),I$=[['java.util.HashMap','sun.awt.NullComponentPeer','java.awt.Insets','swingjs.JSToolkit','java.awt.GraphicsEnvironment','java.awt.Cursor',['java.awt.Toolkit','.SelectiveAWTEventListener'],['java.awt.Toolkit','.ToolkitEventMulticaster'],'java.awt.AWTEventMulticaster','java.awt.event.AWTEventListener','java.awt.event.AWTEventListenerProxy','java.util.ArrayList','java.beans.PropertyChangeSupport']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
return Clazz.new_((I$[6]||$incl$(6)).c$$I,[0]);
});
...
{
var la = (I$[9]||$incl$(9)).getListeners$java_util_EventListener$Class(this.eventListener, Clazz.getClass((I$[10]||$incl$(10)),['eventDispatched$java_awt_AWTEvent']));
var ret = Clazz.array((I$[10]||$incl$(10)), [la.length]);
...
{
var la = (I$[9]||$incl$(9)).getListeners$java_util_EventListener$Class(this.eventListener, Clazz.getClass((I$[10]||$incl$(10)),['eventDispatched$java_awt_AWTEvent']));
var list = Clazz.new_((I$[12]||$incl$(12)).c$$I,[la.length]);
for (var i = 0; i < la.length; i++) {
var sael = la[i];
if ((sael.getEventMask() & eventMask) == eventMask) {
list.add$TE(Clazz.new_((I$[11]||$incl$(11)).c$$J$java_awt_event_AWTEventListener,[sael.getEventMask(), sael.getListener()]));
}}
return list.toArray$TTA(Clazz.array((I$[10]||$incl$(10)), [0]));
}});
...
return Clazz.new_((I$[13]||$incl$(13)).c$$O,[toolkit]);
}, 1);
;
