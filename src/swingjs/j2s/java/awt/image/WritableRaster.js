(function(){var P$=Clazz.newPackage("java.awt.image"),I$=[['java.awt.Rectangle','java.awt.Point']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
Clazz.super_(C$, this,1);
this.setRaster$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Rectangle$java_awt_Point$java_awt_image_Raster(sampleModel, sampleModel.createDataBuffer(), Clazz.new_((I$[1]||$incl$(1)).c$$I$I$I$I,[origin.x, origin.y, sampleModel.getWidth(), sampleModel.getHeight()]), origin, null);
}, 1);
...
Clazz.super_(C$, this,1);
this.setRaster$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Rectangle$java_awt_Point$java_awt_image_Raster(sampleModel, dataBuffer, Clazz.new_((I$[1]||$incl$(1)).c$$I$I$I$I,[origin.x, origin.y, sampleModel.getWidth(), sampleModel.getHeight()]), origin, null);
}, 1);
