...
this.秘childTainted=false;
return this.component.toArray$TTA(this.秘childArray != null  && this.秘childArray.length > n  ? this.秘childArray : (this.秘childArray=Clazz.array($I$(1), [n * 2])));
});
...
Clazz.newMeth(C$, '秘getInsetsC$', function () {
var i=(this.peer == null  ? null : (this.peer).getInsets$());
return (i == null  ? C$.NULL_INSETS : i);
});
...
;Clazz.setTVer('3.2.4.07');//Created 2019-06-16 22:44:40 Java2ScriptVisitor version 3.2.4.07 net.sf.j2s.core.jar version 3.2.4.07
