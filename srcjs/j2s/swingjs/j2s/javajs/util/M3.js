...
var C$=Clazz.newClass(P$, "M3", null, 'javajs.util.M34', 'java.io.Serializable');
var p$=C$.prototype;
...
return (I$[1]||$incl$(1)).floatToIntBits$F(this.m00) ^ (I$[1]||$incl$(1)).floatToIntBits$F(this.m01) ^ (I$[1]||$incl$(1)).floatToIntBits$F(this.m02) ^ (I$[1]||$incl$(1)).floatToIntBits$F(this.m10) ^ (I$[1]||$incl$(1)).floatToIntBits$F(this.m11) ^ (I$[1]||$incl$(1)).floatToIntBits$F(this.m12) ^ (I$[1]||$incl$(1)).floatToIntBits$F(this.m20) ^ (I$[1]||$incl$(1)).floatToIntBits$F(this.m21) ^ (I$[1]||$incl$(1)).floatToIntBits$F(this.m22) ;
});
