(function(){var P$=Clazz.newPackage("swingjs.jzlib"),I$=[['swingjs.jzlib.InfTree','swingjs.jzlib.InfCodes']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
this.inftree = Clazz.new_((I$[1]||$incl$(1)));
}, 1);

Clazz.newMeth(C$, 'c$$swingjs_jzlib_ZStream$I', function (z, w) {
C$.$init$.apply(this);
this.z = z;
this.codes = Clazz.new_((I$[2]||$incl$(2)).c$$swingjs_jzlib_ZStream$swingjs_jzlib_InfBlocks,[this.z, this]);
...
break;
case 1:
(I$[1]||$incl$(1)).inflate_trees_fixed$IA$IA$IAA$IAA$swingjs_jzlib_ZStream(this.bl, this.bd, this.tl, this.td, this.z);
...
q = q+(t);
m = m-(t);
if ((this.left = this.left-(t)) != 0) break;
...
if (n != 0 && r == -5 ) r = 0;
this.z.avail_out = this.z.avail_out-(n);
this.z.total_out = this.z.total_out+(n);
if (this.check && n > 0 ) {
