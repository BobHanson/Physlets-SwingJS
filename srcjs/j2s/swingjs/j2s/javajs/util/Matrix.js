(function(){var P$=Clazz.newPackage("javajs.util"),I$=[[['javajs.util.Matrix','.LUDecomp']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
return Clazz.new_((I$[1]||$incl$(1)).c$$I$I, [this, null, this.m, this.n]).solve$javajs_util_Matrix$I(C$.identity$I$I(this.m, this.m), this.n);
});
...
C$.$init$.apply(this);
this.LU = this.this$0.getArrayCopy();
