(function(){var P$=Clazz.newPackage("javax.swing.tree"),I$=[['java.lang.StringBuffer']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
if (child == null ) throw Clazz.new_(Clazz.load('java.lang.NullPointerException').c$$S,["Null child not allowed"]);
...
var tempSpot = Clazz.new_((I$[1]||$incl$(1)).c$$S,["["]);
