(function(){var P$=Clazz.newPackage("javax.swing.text"),I$=[[['javax.swing.text.Position','.Bias'],'javax.swing.text.SegmentCache','javax.swing.text.Utilities','javax.swing.text.StateInvariantError','javax.swing.text.Segment','javax.swing.text.View',['javax.swing.text.WrappedPlainView','.WrappedLine']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
try {
if (line.isLeaf()) {
p$.drawText$javax_swing_text_Element$I$I$java_awt_Graphics$I$I.apply(this, [line, p0, p1, g, x, y]);
} else {
...
x = p$.drawText$javax_swing_text_Element$I$I$java_awt_Graphics$I$I.apply(this, [elem, start, end, g, x, y]);
}
}} catch (e) {
if (Clazz.exceptionOf(e, "javax.swing.text.BadLocationException")){
throw Clazz.new_((I$[4]||$incl$(4)).c$$S,["Can't render: " + p0 + "," + p1 ]);
} else {
throw e;
}
}
...
this.lineBuffer = Clazz.new_((I$[5]||$incl$(5)));
}return this.lineBuffer;
});

Clazz.newMeth(C$, 'calculateBreakPosition$I$I', function (p0, p1) {
var p;
var segment = (I$[2]||$incl$(2)).getSharedSegment();
this.loadText$javax_swing_text_Segment$I$I(segment, p0, p1);
var currentWidth = this.getWidth();
if (currentWidth == 2147483647) {
currentWidth = (p$.getDefaultSpan$I.apply(this, [0])|0);
}if (this.wordWrap) {
p = p0 + (I$[3]||$incl$(3)).getBreakLocation$javax_swing_text_Segment$java_awt_FontMetrics$I$I$javax_swing_text_TabExpander$I(segment, this.metrics, this.tabBase, this.tabBase + currentWidth, this, p0);
} else {
p = p0 + (I$[3]||$incl$(3)).getTabbedTextOffset$javax_swing_text_Segment$java_awt_FontMetrics$I$I$javax_swing_text_TabExpander$I$Z(segment, this.metrics, this.tabBase, this.tabBase + currentWidth, this, p0, false);
...
if (n > 0) {
var added = Clazz.array((I$[6]||$incl$(6)), [n]);
for (var i = 0; i < n; i++) {
added[i] = Clazz.new_((I$[7]||$incl$(7)).c$$javax_swing_text_Element, [this, null, e.getElement$I(i)]);
}
...
var added = Clazz.array((I$[6]||$incl$(6)), [addedElems.length]);
for (var i = 0; i < addedElems.length; i++) {
added[i] = Clazz.new_((I$[7]||$incl$(7)).c$$javax_swing_text_Element, [this, null, addedElems[i]]);
}
...
throw Clazz.new_((I$[4]||$incl$(4)).c$$S,["Can\'t get line text"]);
} else {
throw bl;
}
}
...
switch (axis) {
case 0:
var width = this.this$0.getWidth();
if (width == 2147483647 ) {
width = this.this$0.getDefaultSpan$I.apply(this.this$0, [axis]);
}return width;
case 1:
...
return this.this$0.getDefaultSpan$I.apply(this.this$0, [axis]);
}default:
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Invalid axis: " + axis]);
}
});
...
}this.this$0.drawLine$I$I$java_awt_Graphics$I$I(p0, p1, g, x, y);
p0 = p1;
y = y+(this.this$0.metrics.getHeight());
}
});
...
}var testP = (b === (I$[1]||$incl$(1)).Forward ) ? pos : Math.max(p0, pos - 1);
var line = 0;
var lineEnds = this.getLineEnds();
if (lineEnds != null ) {
line = p$.findLine$I.apply(this, [testP - p0]);
if (line > 0) {
p0 = p0+(lineEnds[line - 1]);
}alloc.y = alloc.y+(alloc.height * line);
}if (pos > p0) {
var segment = (I$[2]||$incl$(2)).getSharedSegment();
this.this$0.loadText$javax_swing_text_Segment$I$I(segment, p0, pos);
alloc.x = alloc.x+((I$[3]||$incl$(3)).getTabbedTextWidth$javax_swing_text_Segment$java_awt_FontMetrics$I$javax_swing_text_TabExpander$I(segment, this.this$0.metrics, alloc.x, this.this$0, p0));
(I$[2]||$incl$(2)).releaseSharedSegment$javax_swing_text_Segment(segment);
}return alloc;
});

Clazz.newMeth(C$, 'viewToModel$F$F$java_awt_Shape$javax_swing_text_Position_BiasA', function (fx, fy, a, bias) {
bias[0] = (I$[1]||$incl$(1)).Forward;
var alloc = a;
var x = (fx|0);
var y = (fy|0);
if (y < alloc.y) {
...
var segment = (I$[2]||$incl$(2)).getSharedSegment();
this.this$0.loadText$javax_swing_text_Segment$I$I(segment, p0, p1);
var n = (I$[3]||$incl$(3)).getTabbedTextOffset$javax_swing_text_Segment$java_awt_FontMetrics$I$I$javax_swing_text_TabExpander$I(segment, this.this$0.metrics, alloc.x, x, this.this$0, p0);
(I$[2]||$incl$(2)).releaseSharedSegment$javax_swing_text_Segment(segment);
return Math.min(p0 + n, p1 - 1);
}}}});

Clazz.newMeth(C$, 'insertUpdate$javax_swing_event_DocumentEvent$java_awt_Shape$javax_swing_text_ViewFactory', function (e, a, f) {
p$.update$javax_swing_event_DocumentEvent$java_awt_Shape.apply(this, [e, a]);
});
...
this.this$0.preferenceChanged$javax_swing_text_View$Z$Z(this, false, true);
this.getContainer().repaint();
} else if (a != null ) {
