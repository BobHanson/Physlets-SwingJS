(function(){var P$=Clazz.newPackage("java.util.zip"),I$=[[0,'java.util.Date','InternalError']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
...
var d=Clazz.new_($I$(1).c$$I$I$I$I$I$I,[((((dtime >> 25) & 127) + 80)|0), ((((dtime >> 21) & 15) - 1)|0), (((dtime >> 16) & 31)|0), (((dtime >> 11) & 31)|0), (((dtime >> 5) & 63)|0), (((dtime << 1) & 62)|0)]);
return d.getTime$();
}, 1);

Clazz.newMeth(C$, 'javaToDosTime$J', function (time) {
var d=Clazz.new_($I$(1).c$$J,[time]);
