...
C$.ASYNC_RETURN = Clazz.new_((I$[1]||$incl$(1)));
}
...
this.chooserPanels = Clazz.array((I$[2]||$incl$(2)), [0]);
}, 1);
...
return null;
}var pane = Clazz.new_(C$.c$$java_awt_Color,[initialColor != null  ? initialColor : (I$[3]||$incl$(3)).white]);
var ok = Clazz.new_((I$[4]||$incl$(4)).c$$javax_swing_JColorChooser,[pane]);
...
C$.c$$java_awt_Color.apply(this, [(I$[3]||$incl$(3)).white]);
}, 1);

Clazz.newMeth(C$, 'c$$java_awt_Color', function (initialColor) {
C$.c$$javax_swing_colorchooser_ColorSelectionModel.apply(this, [Clazz.new_((I$[7]||$incl$(7)).c$$java_awt_Color,[initialColor])]);
}, 1);
...
this.setColor$java_awt_Color(Clazz.new_((I$[3]||$incl$(3)).c$$I$I$I,[r, g, b]));
});
...
if (containedAt == -1) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["chooser panel not in this chooser"]);
}var newArray = Clazz.array((I$[2]||$incl$(2)), [this.chooserPanels.length - 1]);
...
var chooserPanelsString = Clazz.new_((I$[8]||$incl$(8)).c$$S,[""]);
for (var i = 0; i < this.chooserPanels.length; i++) {
