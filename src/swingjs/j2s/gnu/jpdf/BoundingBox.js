(function(){var P$=Clazz.newPackage("gnu.jpdf"),I$=[['java.awt.Point','java.awt.Dimension','java.lang.StringBuffer','java.util.Vector','java.util.StringTokenizer','java.awt.Font','java.awt.Frame']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
if (!p$.checkHAlign$I.apply(this, [hAlign])) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["BoundingBox.getStringBounds, " + "hAlign invalid : " + hAlign ]);
}if (!p$.checkVAlign$I.apply(this, [vAlign])) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["BoundingBox.getStringBounds, " + "vAlign invalid : " + hAlign ]);
}if (fm == null ) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["BoundingBox.getStringBounds, FontMetrics null"]);
}if (string == null ) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["BoundingBox.getStringBounds, String null"]);
...
if (Clazz.exceptionOf(stle, "gnu.jpdf.StringTooLongException")){
var buf = Clazz.new_((I$[3]||$incl$(3))).append$S(string);
if (buf.length$() == 0) {
System.out.println$S("BoundingBox.drawChoppedString, buf len 0 ??");
throw Clazz.new_(Clazz.load('java.lang.RuntimeException'));
...
var returnVector = Clazz.new_((I$[4]||$incl$(4)));
var st = Clazz.new_((I$[5]||$incl$(5)).c$$S$S$Z,[string, " \u0009\u000a\u000d\u000c", true]);
var tempBuffer = Clazz.new_((I$[3]||$incl$(3)));
var finalBuffer = Clazz.new_((I$[3]||$incl$(3)));
while (st.hasMoreTokens()){
var tempString = st.nextToken();
tempBuffer.append$S(tempString);
if ((fm.stringWidth$S(tempBuffer.toString()) < lw) && (tempBuffer.toString().charAt(tempBuffer.toString().length$() - 1) != "\u000a") && (tempBuffer.toString().charAt(tempBuffer.toString().length$() - 1) != "\u000d")  ) {
...
if (child == null ) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["BoundingBox.subtract, BoundingBox child is null"]);
}if (!child.hasParent()) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["BoundingBox.subtract, BoundingBox child has no parent"]);
}if (!(child.getParent() === this )) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["BoundingBox.subtract, this is not BoundingBox child\'s parent"]);
...
var upperLeft = Clazz.new_((I$[1]||$incl$(1)).c$$I$I,[5, 5]);
var bounds = Clazz.new_((I$[2]||$incl$(2)).c$$I$I,[100, 100]);
var parent = Clazz.new_(C$.c$$java_awt_Point$java_awt_Dimension,[upperLeft, bounds]);
var string = "Hello World!";
var font = Clazz.new_((I$[6]||$incl$(6)).c$$S$I$I,["SansSerif", 0, 12]);
