(function(){var P$=Clazz.newPackage("java.text"),I$=[['java.util.HashMap','java.util.Hashtable','java.lang.StringBuffer','java.text.DontCareFieldPosition','java.text.ParsePosition','java.util.Locale','sun.util.resources.LocaleData','java.text.DecimalFormatSymbols','java.text.DecimalFormat']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
return this.format$D$StringBuffer$java_text_FieldPosition(number, Clazz.new_((I$[3]||$incl$(3))), (I$[4]||$incl$(4)).INSTANCE).toString();
});

Clazz.newMeth(C$, 'format$J', function (number) {
return this.format$J$StringBuffer$java_text_FieldPosition(number, Clazz.new_((I$[3]||$incl$(3))), (I$[4]||$incl$(4)).INSTANCE).toString();
});

Clazz.newMeth(C$, 'parse$S', function (source) {
var parsePosition = Clazz.new_((I$[5]||$incl$(5)).c$$I,[0]);
...
return C$.getInstance$java_util_Locale$I((I$[6]||$incl$(6)).getDefault(), 0);
}, 1);
...
return C$.getInstance$java_util_Locale$I((I$[6]||$incl$(6)).getDefault(), 4);
}, 1);
...
return C$.getInstance$java_util_Locale$I((I$[6]||$incl$(6)).getDefault(), 1);
}, 1);
...
return C$.getInstance$java_util_Locale$I((I$[6]||$incl$(6)).getDefault(), 2);
}, 1);
...
return C$.getInstance$java_util_Locale$I((I$[6]||$incl$(6)).getDefault(), 3);
}, 1);
...
var format = Clazz.new_((I$[9]||$incl$(9)).c$$S$java_text_DecimalFormatSymbols,[numberPatterns[entry], symbols]);
if (choice == 4) {
...
C$.$clinit$ = function() {Clazz.load(C$, 1);
C$.$instanceMap = Clazz.new_((I$[1]||$incl$(1)).c$$I,[11]);
