...
this.秘canvas=canvas;
var pix=this.秘pix;
this.秘g=Clazz.new_($I$(11).c$$O,[canvas]);
...
;Clazz.setTVer('3.2.4.07');//Created 2019-06-16 22:44:08 Java2ScriptVisitor version 3.2.4.07 net.sf.j2s.core.jar version 3.2.4.07
