(function(){var P$=Clazz.newPackage("javax.swing"),I$=[['java.lang.Boolean',['javax.swing.ScrollPaneLayout','.UIResource'],'java.awt.Point','java.awt.Rectangle','javax.swing.SwingUtilities',['javax.swing.JScrollPane','.ScrollBar'],'javax.swing.JViewport']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
throw Clazz.new_(Clazz.load('java.lang.ClassCastException').c$$S,[s]);
}});
...
return Clazz.new_((I$[6]||$incl$(6)).c$$I, [this, null, 0]);
});
...
return Clazz.new_((I$[6]||$incl$(6)).c$$I, [this, null, 1]);
});
...
C$.$init$.apply(this);
this.putClientProperty$O$O("JScrollBar.fastWheelScrolling", (I$[1]||$incl$(1)).TRUE);
}, 1);
...
var vp = this.this$0.getViewport();
