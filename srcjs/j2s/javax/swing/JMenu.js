...
return this.add$javax_swing_JMenuItem(Clazz.new_((I$[7]||$incl$(7)).c$$S,[s]));
});
...
), Clazz.new_((I$[7]||$incl$(7)), [this, null],P$.JMenu$1));
...
this.$popupMenu.insert$java_awt_Component$I(Clazz.new_((I$[7]||$incl$(7)).c$$S,[s]), pos);
});
...
var mi = Clazz.new_((I$[7]||$incl$(7)).c$$javax_swing_Action,[a]);
mi.setHorizontalTextPosition$I(11);
mi.setVerticalTextPosition$I(0);
this.$popupMenu.insert$java_awt_Component$I(mi, pos);
return mi;
...
this.$popupMenu.insert$java_awt_Component$I(Clazz.new_((I$[8]||$incl$(8))), index);
});
...
throw Clazz.new_((I$[9]||$incl$(9)).c$$S,["boolean isTearOff() {} not yet implemented"]);
});
...
this.listenerList.add$Class$TT(Clazz.getClass((I$[11]||$incl$(11)),['menuCanceled$javax_swing_event_MenuEvent','menuDeselected$javax_swing_event_MenuEvent','menuSelected$javax_swing_event_MenuEvent']), l);
});

Clazz.newMeth(C$, 'removeMenuListener$javax_swing_event_MenuListener', function (l) {
this.listenerList.remove$Class$TT(Clazz.getClass((I$[11]||$incl$(11)),['menuCanceled$javax_swing_event_MenuEvent','menuDeselected$javax_swing_event_MenuEvent','menuSelected$javax_swing_event_MenuEvent']), l);
});

Clazz.newMeth(C$, 'getMenuListeners', function () {
return this.listenerList.getListeners$Class(Clazz.getClass((I$[11]||$incl$(11)),['menuCanceled$javax_swing_event_MenuEvent','menuDeselected$javax_swing_event_MenuEvent','menuSelected$javax_swing_event_MenuEvent']));
});
...
return Clazz.new_((I$[13]||$incl$(13)), [this, null]);
});

Clazz.newMeth(C$, 'createWinListener$javax_swing_JPopupMenu', function (p) {
return Clazz.new_((I$[14]||$incl$(14)).c$$javax_swing_JPopupMenu, [this, null, p]);
});
...
throw Clazz.new_((I$[9]||$incl$(9)).c$$S,["setAccelerator() is not defined for JMenu.  Use setMnemonic() instead."]);
});
...
var elements = Clazz.new_((I$[17]||$incl$(17)));
