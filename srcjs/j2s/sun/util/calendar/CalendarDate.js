(function(){var P$=Clazz.newPackage("sun.util.calendar"),I$=[['java.util.TimeZone','java.lang.InternalError','java.lang.StringBuilder','sun.util.calendar.CalendarUtils']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.c$$java_util_TimeZone.apply(this, [(I$[1]||$incl$(1)).getDefault()]);
}, 1);
...
(I$[4]||$incl$(4)).sprintf0d$StringBuilder$I$I(sb, this.year, 4).append$C("-");
(I$[4]||$incl$(4)).sprintf0d$StringBuilder$I$I(sb, this.month, 2).append$C("-");
(I$[4]||$incl$(4)).sprintf0d$StringBuilder$I$I(sb, this.dayOfMonth, 2).append$C("T");
(I$[4]||$incl$(4)).sprintf0d$StringBuilder$I$I(sb, this.hours, 2).append$C(":");
(I$[4]||$incl$(4)).sprintf0d$StringBuilder$I$I(sb, this.minutes, 2).append$C(":");
(I$[4]||$incl$(4)).sprintf0d$StringBuilder$I$I(sb, this.seconds, 2).append$C(".");
(I$[4]||$incl$(4)).sprintf0d$StringBuilder$I$I(sb, this.millis, 3);
