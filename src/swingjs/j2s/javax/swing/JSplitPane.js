(function(){var P$=Clazz.newPackage("javax.swing"),I$=[['javax.swing.JButton','javax.swing.UIManager','java.lang.Boolean']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.c$$I$Z$java_awt_Component$java_awt_Component.apply(this, [1, false, Clazz.new_((I$[1]||$incl$(1)).c$$S,[(I$[2]||$incl$(2)).getString$O("SplitPane.leftButtonText")]), Clazz.new_((I$[1]||$incl$(1)).c$$S,[(I$[2]||$incl$(2)).getString$O("SplitPane.rightButtonText")])]);
}, 1);
...
var intLocation = (proportionalLocation|0);
var isInt = (intLocation == Math.round(proportionalLocation));
