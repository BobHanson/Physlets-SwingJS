(function(){var P$=Clazz.newPackage("swingjs"),I$=[['sun.awt.image.SunWritableRaster']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
var bt = table;
if (p$.lookupByteRaster$java_awt_image_Raster$java_awt_image_WritableRaster$BAA.apply(this, [src, dst, bt.getTable()]) > 0) {
retRaster = dst;
}}break;
case 65:
var bOp = op;
...
if (p$.transformRaster$java_awt_image_Raster$java_awt_image_WritableRaster$DA$I.apply(this, [src, dst, matrix, bOp.getInterpolationType()]) > 0) {
retRaster = dst;
}break;
case 67:
var cOp = op;
if (p$.convolveRaster$java_awt_image_Raster$java_awt_image_WritableRaster$java_awt_image_Kernel$I.apply(this, [src, dst, cOp.getKernel(), cOp.getEdgeCondition()]) > 0) {
retRaster = dst;
}break;
default:
break;
...
if (retRaster != null ) {
(I$[1]||$incl$(1)).markDirty$java_awt_image_WritableRaster(retRaster);
}return retRaster;
});
...
var bt = table;
if (p$.lookupByteBI$java_awt_image_BufferedImage$java_awt_image_BufferedImage$BAA.apply(this, [src, dst, bt.getTable()]) > 0) {
retBI = dst;
}}break;
case 67:
var cOp = op;
if (p$.convolveBI$java_awt_image_BufferedImage$java_awt_image_BufferedImage$java_awt_image_Kernel$I.apply(this, [src, dst, cOp.getKernel(), cOp.getEdgeCondition()]) > 0) {
retBI = dst;
}break;
}
return retBI;
