(function(){var P$=Clazz.newPackage("swingjs.jzlib"),I$=[[['swingjs.jzlib.Deflate','.Config'],'swingjs.jzlib.Tree','swingjs.jzlib.StaticTree','swingjs.jzlib.CRC32','swingjs.jzlib.GZIPHeader']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.config_table = null;
{
C$.config_table = Clazz.array((I$[1]||$incl$(1)), [10]);
C$.config_table[0] = Clazz.new_((I$[1]||$incl$(1)).c$$I$I$I$I$I,[0, 0, 0, 0, 0]);
C$.config_table[1] = Clazz.new_((I$[1]||$incl$(1)).c$$I$I$I$I$I,[4, 4, 8, 4, 1]);
C$.config_table[2] = Clazz.new_((I$[1]||$incl$(1)).c$$I$I$I$I$I,[4, 5, 16, 8, 1]);
C$.config_table[3] = Clazz.new_((I$[1]||$incl$(1)).c$$I$I$I$I$I,[4, 6, 32, 32, 1]);
C$.config_table[4] = Clazz.new_((I$[1]||$incl$(1)).c$$I$I$I$I$I,[4, 4, 16, 16, 2]);
C$.config_table[5] = Clazz.new_((I$[1]||$incl$(1)).c$$I$I$I$I$I,[8, 16, 32, 32, 2]);
C$.config_table[6] = Clazz.new_((I$[1]||$incl$(1)).c$$I$I$I$I$I,[8, 16, 128, 128, 2]);
C$.config_table[7] = Clazz.new_((I$[1]||$incl$(1)).c$$I$I$I$I$I,[8, 32, 128, 256, 2]);
C$.config_table[8] = Clazz.new_((I$[1]||$incl$(1)).c$$I$I$I$I$I,[32, 128, 258, 1024, 2]);
C$.config_table[9] = Clazz.new_((I$[1]||$incl$(1)).c$$I$I$I$I$I,[32, 258, 258, 4096, 2]);
}
;
C$.z_errmsg = Clazz.array(java.lang.String, -1, ["need dictionary", "stream end", "", "file error", "stream error", "data error", "insufficient memory", "buffer error", "incompatible version", ""]);
}
...
this.wrap = 1;
this.l_desc = Clazz.new_((I$[2]||$incl$(2)));
this.d_desc = Clazz.new_((I$[2]||$incl$(2)));
this.bl_desc = Clazz.new_((I$[2]||$incl$(2)));
...
return p$.deflateInit5$I$I$I$I$I.apply(this, [level, 8, bits, 8, 0]);
});

Clazz.newMeth(C$, 'deflateInit3$I$I$I', function (level, bits, memlevel) {
return p$.deflateInit5$I$I$I$I$I.apply(this, [level, 8, bits, memlevel, 0]);
});
...
this.l_desc.stat_desc = (I$[3]||$incl$(3)).static_l_desc;
this.d_desc.dyn_tree = this.dyn_dtree;
this.d_desc.stat_desc = (I$[3]||$incl$(3)).static_d_desc;
this.bl_desc.dyn_tree = this.bl_tree;
this.bl_desc.stat_desc = (I$[3]||$incl$(3)).static_bl_desc;
...
this.bl_tree[curlen * 2] = (this.bl_tree[curlen * 2]+(count)|0);
} else if (curlen != 0) {
...
if (this.bl_tree[(I$[2]||$incl$(2)).bl_order[max_blindex] * 2 + 1] != 0) break;
}
this.opt_len = this.opt_len+(3 * (max_blindex + 1) + 5 + 5 + 4);
return max_blindex;
});
...
this.send_bits$I$I(this.bl_tree[(I$[2]||$incl$(2)).bl_order[rank] * 2 + 1], 3);
}
...
this.matches++;
dist--;
this.dyn_ltree[((I$[2]||$incl$(2))._length_code[lc] + 256 + 1 ) * 2]++;
this.dyn_dtree[(I$[2]||$incl$(2)).d_code$I(dist) * 2]++;
...
out_length = out_length+(this.dyn_dtree[dcode * 2] * (5 + (I$[2]||$incl$(2)).extra_dbits[dcode]));
}
...
code = (I$[2]||$incl$(2))._length_code[lc];
this.send_code$I$HA(code + 256 + 1 , ltree);
extra = (I$[2]||$incl$(2)).extra_lbits[code];
if (extra != 0) {
lc = lc-((I$[2]||$incl$(2)).base_length[code]);
this.send_bits$I$I(lc, extra);
}dist--;
code = (I$[2]||$incl$(2)).d_code$I(dist);
this.send_code$I$HA(code, dtree);
extra = (I$[2]||$incl$(2)).extra_dbits[code];
if (extra != 0) {
dist = dist-((I$[2]||$incl$(2)).base_dist[code]);
...
var bin_freq = 0;
while (n < 7){
bin_freq = bin_freq+(this.dyn_ltree[n * 2]);
n++;
}
while (n < 128){
ascii_freq = ascii_freq+(this.dyn_ltree[n * 2]);
n++;
}
while (n < 256){
bin_freq = bin_freq+(this.dyn_ltree[n * 2]);
...
this.compress_block$HA$HA((I$[3]||$incl$(3)).static_ltree, (I$[3]||$incl$(3)).static_dtree);
} else {
...
this.strm.checksum = Clazz.new_((I$[4]||$incl$(4)));
...
if (this.strstart != 0) header = header|(32);
...
this.gheader = Clazz.new_((I$[5]||$incl$(5)));
}return this.gheader;
});
