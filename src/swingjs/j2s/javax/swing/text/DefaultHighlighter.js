(function(){var P$=Clazz.newPackage("javax.swing.text"),I$=[[['javax.swing.text.Position','.Bias'],'java.util.Vector','javax.swing.SwingUtilities',['javax.swing.text.Highlighter','.Highlight'],['javax.swing.text.DefaultHighlighter','.DefaultHighlightPainter'],['javax.swing.text.DefaultHighlighter','.SafeDamager'],['javax.swing.text.DefaultHighlighter','.LayeredHighlightInfo'],['javax.swing.text.DefaultHighlighter','.HighlightInfo']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.noHighlights = Clazz.array((I$[4]||$incl$(4)), [0]);
C$.DefaultPainter = Clazz.new_((I$[5]||$incl$(5)).c$$java_awt_Color,[null]);
}
...
this.highlights = Clazz.new_((I$[2]||$incl$(2)));
this.safeDamager = Clazz.new_((I$[6]||$incl$(6)), [this, null]);
}, 1);
...
var i = (this.getDrawsLayeredHighlights() && (Clazz.instanceOf(p, "javax.swing.text.LayeredHighlighter.LayerPainter")) ) ? Clazz.new_((I$[7]||$incl$(7)), [this, null]) : Clazz.new_((I$[8]||$incl$(8)), [this, null]);
i.painter=p;
...
}var h = Clazz.array((I$[4]||$incl$(4)), [size]);
...
try {
var shape = view.modelToView$I$javax_swing_text_Position_Bias$I$javax_swing_text_Position_Bias$java_awt_Shape(offs0, (I$[1]||$incl$(1)).Forward, offs1, (I$[1]||$incl$(1)).Backward, bounds);
...
Clazz.newInstance(this, arguments[0],true,C$);
}, ['javax.swing.text.DefaultHighlighter','javax.swing.text.DefaultHighlighter.HighlightInfo']);
...
Clazz.newMeth(C$, '$init$', function () {
this.p0 = Clazz.new_((I$[2]||$incl$(2)).c$$I,[10]);
this.p1 = Clazz.new_((I$[2]||$incl$(2)).c$$I,[10]);
this.lastDoc = null;
}, 1);
...
this.p1.add$TE(pos1);
if (addToQueue) {
(I$[3]||$incl$(3)).invokeLater$Runnable(this);
}});
