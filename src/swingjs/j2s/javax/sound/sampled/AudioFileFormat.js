(function(){var P$=Clazz.newPackage("javax.sound.sampled"),I$=[['java.util.HashMap','java.util.Collections','java.lang.StringBuffer']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
