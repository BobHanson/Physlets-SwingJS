(function(){var P$=Clazz.newPackage("java.awt.geom"),I$=[['java.lang.InternalError',['java.awt.geom.Point2D','.Double'],['java.awt.geom.Point2D','.Float'],'javajs.util.AU',['java.awt.geom.Path2D','.Double']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
throw Clazz.new_((I$[1]||$incl$(1)).c$$S,["missing case in transform state switch"]);
});
...
if (pSrc == null ) {
return null;
}return Clazz.new_((I$[5]||$incl$(5)).c$$java_awt_Shape$java_awt_geom_AffineTransform,[pSrc, this]);
});
