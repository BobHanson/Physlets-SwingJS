(function(){var P$=Clazz.newPackage("javax.swing"),I$=[['java.lang.StringBuilder','java.awt.Toolkit']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
var C$=Clazz.newClass(P$, "ImageIcon", null, null, 'javax.swing.Icon');
C$.mediaTrackerID = 0;
C$.TRACKER_KEY = null;

C$.$clinit$ = function() {Clazz.load(C$, 1);
C$.TRACKER_KEY = Clazz.new_((I$[1]||$incl$(1)).c$$S,["TRACKER_KEY"]);
}
