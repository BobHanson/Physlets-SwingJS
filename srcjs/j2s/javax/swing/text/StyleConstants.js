(function(){var P$=Clazz.newPackage("javax.swing.text"),I$=[[['javax.swing.text.StyleConstants','.CharacterConstants'],['javax.swing.text.StyleConstants','.FontConstants'],['javax.swing.text.StyleConstants','.ColorConstants'],['javax.swing.text.StyleConstants','.ParagraphConstants'],'Boolean','java.awt.Color']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.BidiLevel = Clazz.new_((I$[1]||$incl$(1)).c$$S,["bidiLevel"]);
C$.FontFamily = Clazz.new_((I$[2]||$incl$(2)).c$$S,["family"]);
C$.Family = C$.FontFamily;
C$.FontSize = Clazz.new_((I$[2]||$incl$(2)).c$$S,["size"]);
C$.Size = C$.FontSize;
C$.Bold = Clazz.new_((I$[2]||$incl$(2)).c$$S,["bold"]);
C$.Italic = Clazz.new_((I$[2]||$incl$(2)).c$$S,["italic"]);
C$.Underline = Clazz.new_((I$[1]||$incl$(1)).c$$S,["underline"]);
C$.StrikeThrough = Clazz.new_((I$[1]||$incl$(1)).c$$S,["strikethrough"]);
C$.Superscript = Clazz.new_((I$[1]||$incl$(1)).c$$S,["superscript"]);
C$.Subscript = Clazz.new_((I$[1]||$incl$(1)).c$$S,["subscript"]);
C$.Foreground = Clazz.new_((I$[3]||$incl$(3)).c$$S,["foreground"]);
C$.Background = Clazz.new_((I$[3]||$incl$(3)).c$$S,["background"]);
C$.ComponentAttribute = Clazz.new_((I$[1]||$incl$(1)).c$$S,["component"]);
C$.IconAttribute = Clazz.new_((I$[1]||$incl$(1)).c$$S,["icon"]);
C$.ComposedTextAttribute = Clazz.new_(C$.c$$S,["composed text"]);
C$.FirstLineIndent = Clazz.new_((I$[4]||$incl$(4)).c$$S,["FirstLineIndent"]);
C$.LeftIndent = Clazz.new_((I$[4]||$incl$(4)).c$$S,["LeftIndent"]);
C$.RightIndent = Clazz.new_((I$[4]||$incl$(4)).c$$S,["RightIndent"]);
C$.LineSpacing = Clazz.new_((I$[4]||$incl$(4)).c$$S,["LineSpacing"]);
C$.SpaceAbove = Clazz.new_((I$[4]||$incl$(4)).c$$S,["SpaceAbove"]);
C$.SpaceBelow = Clazz.new_((I$[4]||$incl$(4)).c$$S,["SpaceBelow"]);
C$.Alignment = Clazz.new_((I$[4]||$incl$(4)).c$$S,["Alignment"]);
C$.TabSet = Clazz.new_((I$[4]||$incl$(4)).c$$S,["TabSet"]);
C$.Orientation = Clazz.new_((I$[4]||$incl$(4)).c$$S,["Orientation"]);
...
a.addAttribute$O$O(C$.Bold, (I$[5]||$incl$(5)).$valueOf(b));
}, 1);
...
a.addAttribute$O$O(C$.Italic, (I$[5]||$incl$(5)).$valueOf(b));
}, 1);
