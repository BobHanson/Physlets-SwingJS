(function(){var P$=java.util,I$=[['java.util.Hashtable','java.util.TimeZone','java.util.Locale','java.util.GregorianCalendar','java.util.Date','java.text.DateFormatSymbols','java.util.HashMap','java.lang.InternalError','java.lang.StringBuilder','sun.util.resources.LocaleData']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.FIELD_NAME = Clazz.array(java.lang.String, -1, ["ERA", "YEAR", "MONTH", "WEEK_OF_YEAR", "WEEK_OF_MONTH", "DAY_OF_MONTH", "DAY_OF_YEAR", "DAY_OF_WEEK", "DAY_OF_WEEK_IN_MONTH", "AM_PM", "HOUR", "HOUR_OF_DAY", "MINUTE", "SECOND", "MILLISECOND", "ZONE_OFFSET", "DST_OFFSET"]);
}
...
return C$.createCalendar$java_util_TimeZone$java_util_Locale(zone, (I$[3]||$incl$(3)).getDefault());
}, 1);
...
return Clazz.new_((I$[4]||$incl$(4)).c$$java_util_TimeZone$java_util_Locale,[zone, aLocale]);
}, 1);

Clazz.newMeth(C$, 'getTime', function () {
return Clazz.new_((I$[5]||$incl$(5)),[this.getTimeInMillis()]);
});
...
return null;
}var symbols = (I$[6]||$incl$(6)).getInstance$java_util_Locale(locale);
var strings = p$.getFieldStrings$I$I$java_text_DateFormatSymbols.apply(this, [field, style, symbols]);
if (strings != null ) {
...
var shortNames = p$.getDisplayNamesImpl$I$I$java_util_Locale.apply(this, [field, 1, locale]);
if (field == 0 || field == 9 ) {
return shortNames;
}var longNames = p$.getDisplayNamesImpl$I$I$java_util_Locale.apply(this, [field, 2, locale]);
if (shortNames == null ) {
return longNames;
}if (longNames != null ) {
shortNames.putAll$java_util_Map(longNames);
}return shortNames;
}return p$.getDisplayNamesImpl$I$I$java_util_Locale.apply(this, [field, style, locale]);
});
...
var strings = p$.getFieldStrings$I$I$java_text_DateFormatSymbols.apply(this, [field, style, symbols]);
if (strings != null ) {
var names = Clazz.new_((I$[7]||$incl$(7)));
...
try {
var that = obj;
return p$.compareTo$J.apply(this, [C$.getMillisOf$java_util_Calendar(that)]) == 0 && this.lenient == that.lenient   && this.firstDayOfWeek == that.firstDayOfWeek  && this.minimalDaysInFirstWeek == that.minimalDaysInFirstWeek  && this.zone.equals$O(that.zone) ;
} catch (e) {
...
Clazz.newMeth(C$, ['compareTo$java_util_Calendar','compareTo$TT'], function (anotherCalendar) {
return p$.compareTo$J.apply(this, [C$.getMillisOf$java_util_Calendar(anotherCalendar)]);
});
...
var buffer = Clazz.new_((I$[9]||$incl$(9)).c$$I,[800]);
