(function(){var P$=java.lang,I$=[['java.lang.CharacterDataLatin1']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
var C$=Clazz.newClass(java.lang, "CharacterDataLatin1", null, 'CharacterData');
C$.sharpsMap = null;
C$.instance = null;
var p$=C$.prototype;
C$.A = null;
...
var props = CharacterDataLatin1.A[offset.$c()];
return props;
});
