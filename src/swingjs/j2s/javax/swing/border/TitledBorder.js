(function(){var P$=Clazz.newPackage("javax.swing.border"),I$=[['java.awt.Point','java.awt.Rectangle','java.awt.Insets','javax.swing.UIManager','java.awt.Dimension',['java.awt.Component','.BaselineResizeBehavior'],'java.awt.Font']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
this.textLoc = Clazz.new_((I$[1]||$incl$(1)));
}, 1);
...
}var grooveRect = Clazz.new_((I$[2]||$incl$(2)).c$$I$I$I$I,[x + 2, y + 2, width - 4, height - 4]);
var font = g.getFont();
...
insets = Clazz.new_((I$[3]||$incl$(3)).c$$I$I$I$I,[0, 0, 0, 0]);
...
break;
case 5:
grooveRect.height = grooveRect.height-((fontHeight/2|0));
...
var clipRect = Clazz.new_((I$[2]||$incl$(2)));
...
return this.getBorderInsets$java_awt_Component$java_awt_Insets(c, Clazz.new_((I$[3]||$incl$(3)).c$$I$I$I$I,[0, 0, 0, 0]));
});
...
var b = this.border;
if (b == null ) b = (I$[4]||$incl$(4)).getBorder$O("TitledBorder.border");
return b;
});

Clazz.newMeth(C$, 'getTitlePosition', function () {
if (this.titlePosition == 0) {
var value = (I$[4]||$incl$(4)).get$O("TitledBorder.position");
...
if (f == null ) f = (I$[4]||$incl$(4)).getFont$O("TitledBorder.font");
return f;
});

Clazz.newMeth(C$, 'getTitleColor', function () {
var c = this.titleColor;
if (c == null ) c = (I$[4]||$incl$(4)).getColor$O("TitledBorder.titleColor");
return c;
});
...
break;
default:
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,[titlePosition + " is not a valid title position."]);
}
});
...
break;
default:
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,[titleJustification + " is not a valid title justification."]);
}
});
...
var minSize = Clazz.new_((I$[5]||$incl$(5)).c$$I$I,[insets.right + insets.left, insets.top + insets.bottom]);
var font = this.getFont$java_awt_Component(c);
...
if (c == null ) {
throw Clazz.new_(Clazz.load('java.lang.NullPointerException').c$$S,["Must supply non-null component"]);
}if (height < 0) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Height must be >= 0"]);
...
borderInsets = Clazz.new_((I$[3]||$incl$(3)).c$$I$I$I$I,[0, 0, 0, 0]);
}var fm = c.getFontMetrics$java_awt_Font(font);
var fontHeight = fm.getHeight();
var descent = fm.getDescent();
var ascent = fm.getAscent();
...
case 0:
case 3:
return (I$[6]||$incl$(6)).CONSTANT_ASCENT;
case 4:
case 5:
case 6:
return (I$[6]||$incl$(6)).CONSTANT_DESCENT;
}
return (I$[6]||$incl$(6)).OTHER;
});
...
return font;
}return Clazz.new_((I$[7]||$incl$(7)).c$$S$I$I,["Dialog", 0, 12]);
});
