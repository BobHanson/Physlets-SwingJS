(function(){var P$=Clazz.newPackage("swingjs.plaf"),I$=[['java.io.File',['swingjs.plaf.JSFileChooserUI','.ApproveSelectionAction'],['swingjs.plaf.JSFileChooserUI','.CancelSelectionAction'],'javax.swing.JPanel','java.awt.BorderLayout','javax.swing.SwingUtilities','sun.swing.DefaultLookup','javax.swing.plaf.ActionMapUIResource','javax.swing.LookAndFeel','java.lang.Boolean']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
this.cancelButtonText = null;
this.openDialogTitleText = null;
this.approveSelectionAction = Clazz.new_((I$[2]||$incl$(2)), [this, null]);
this.cancelSelectionAction = Clazz.new_((I$[3]||$incl$(3)), [this, null]);
this.filechooser = null;
this.propertyChangeListener = null;
this.accessoryPanel = null;
this.readOnly = true;
...
(I$[6]||$incl$(6)).replaceUIInputMap$javax_swing_JComponent$I$javax_swing_InputMap(fc, 1, inputMap);
var actionMap = this.getActionMap();
(I$[6]||$incl$(6)).replaceUIActionMap$javax_swing_JComponent$javax_swing_ActionMap(fc, actionMap);
});

Clazz.newMeth(C$, 'getInputMap$I', function (condition) {
if (condition == 1) {
return (I$[7]||$incl$(7)).get$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S(this.getFileChooser(), this, "FileChooser.ancestorInputMap");
}return null;
});
...
}(I$[6]||$incl$(6)).replaceUIInputMap$javax_swing_JComponent$I$javax_swing_InputMap(fc, 1, null);
(I$[6]||$incl$(6)).replaceUIActionMap$javax_swing_JComponent$javax_swing_ActionMap(fc, null);
});

Clazz.newMeth(C$, 'installDefaults$javax_swing_JFileChooser', function (fc) {
this.installStrings$javax_swing_JFileChooser(fc);
(I$[9]||$incl$(9)).installProperty$javax_swing_JComponent$S$O(fc, "opaque", (I$[10]||$incl$(10)).FALSE);
});
