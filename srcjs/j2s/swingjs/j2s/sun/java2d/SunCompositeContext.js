(function(){var P$=Clazz.newPackage("sun.java2d"),I$=[['sun.java2d.loops.CompositeType','java.awt.image.BufferedImage']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
