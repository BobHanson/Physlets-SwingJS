(function(){var P$=Clazz.newPackage("gnu.jpdf"),I$=[['java.util.Vector','gnu.jpdf.PDFStream','java.awt.print.PageFormat','gnu.jpdf.PDFGraphics','java.awt.Dimension','java.awt.Rectangle','gnu.jpdf.PDFAnnot','gnu.jpdf.PDFOutline','gnu.jpdf.PDFObject',['gnu.jpdf.PDFPage','.procset']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.DEF_FORMAT = Clazz.new_((I$[3]||$incl$(3)));
}
...
this.xobjects = Clazz.new_((I$[1]||$incl$(1)));
}, 1);
...
return Clazz.new_((I$[5]||$incl$(5)).c$$I$I,[(this.pageFormat.getWidth()|0), (this.pageFormat.getHeight()|0)]);
});

Clazz.newMeth(C$, 'getImageableArea', function () {
return Clazz.new_((I$[6]||$incl$(6)).c$$I$I$I$I,[(this.pageFormat.getImageableX()|0), (this.pageFormat.getImageableY()|0), ((this.pageFormat.getImageableX() + this.pageFormat.getImageableWidth())|0), ((this.pageFormat.getImageableY() + this.pageFormat.getImageableHeight())|0)]);
});
...
var ob = Clazz.new_((I$[7]||$incl$(7)).c$$I$I$I$I$S,[xy1[0], xy1[1], xy2[0], xy2[1], note]);
...
var xy1 = this.cxy$I$I(x, y + h);
var xy2 = this.cxy$I$I(x + w, y);
var ob = Clazz.new_((I$[7]||$incl$(7)).c$$I$I$I$I$gnu_jpdf_PDFObject,[xy1[0], xy1[1], xy2[0], xy2[1], dest]);
this.pdfDocument.add$gnu_jpdf_PDFObject(ob);
this.annotations.addElement$TE(ob);
return ob;
});
...
var ob = Clazz.new_((I$[7]||$incl$(7)).c$$I$I$I$I$gnu_jpdf_PDFObject$I$I$I$I,[xy1[0], xy1[1], xy2[0], xy2[1], dest, xy3[0], xy3[1], xy4[0], xy4[1]]);
this.pdfDocument.add$gnu_jpdf_PDFObject(ob);
this.annotations.addElement$TE(ob);
return ob;
});
...
var outline = Clazz.new_((I$[8]||$incl$(8)).c$$S$gnu_jpdf_PDFPage,[title, this]);
...
var xy1 = this.cxy$I$I(x, y + h);
var xy2 = this.cxy$I$I(x + w, y);
var outline = Clazz.new_((I$[8]||$incl$(8)).c$$S$gnu_jpdf_PDFPage$I$I$I$I,[title, this, xy1[0], xy1[1], xy2[0], xy2[1]]);
this.pdfDocument.add$gnu_jpdf_PDFObject(outline);
this.pdfDocument.getOutline().add$gnu_jpdf_PDFOutline(outline);
return outline;
});
...
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "/Parent ");
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, this.pdfPageList.toString());
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "\u000a");
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "/MediaBox [");
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, Integer.toString(0));
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, " ");
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, Integer.toString(0));
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, " ");
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, Integer.toString((this.pageFormat.getWidth()|0)));
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, " ");
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, Integer.toString((this.pageFormat.getHeight()|0)));
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "]\u000a");
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "/Resources << ");
if (this.fonts.size() > 0) {
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "\u000a/Font << ");
for (var font, $font = this.fonts.iterator(); $font.hasNext()&&((font=$font.next()),1);) {
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, font.getName());
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, " ");
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, font.toString());
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, " ");
}
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, ">> ");
...
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, str);
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, " ");
}
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, ">> ");
...
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "/XObject << ");
...
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "/Thumb ");
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, this.thumbnail.toString());
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "\u000a");
}if (this.contents.size() > 0) {
if (this.contents.size() == 1) {
var ob = this.contents.elementAt$I(0);
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "/Contents ");
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, ob.toString());
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "\u000a");
} else {
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "/Contents [");
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, (I$[9]||$incl$(9)).toArray$java_util_Vector(this.contents));
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "\u000a");
}}if (this.annotations.size() > 0) {
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "/Annots ");
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, (I$[9]||$incl$(9)).toArray$java_util_Vector(this.annotations));
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "\u000a");
...
Clazz.newMeth(C$, 'write$java_io_OutputStream', function (os) {
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, Integer.toString(this.objser));
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, " 0 obj\u000a");
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "[");
for (var str, $str = this.set.iterator(); $str.hasNext()&&((str=$str.next()),1);) (I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, str);

(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "]\u000a");
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "endobj\u000a");
});
})()
})();
