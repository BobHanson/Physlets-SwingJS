...
C$.sharedRaisedBevel = Clazz.new_((I$[1]||$incl$(1)).c$$I,[0]);
C$.sharedLoweredBevel = Clazz.new_((I$[1]||$incl$(1)).c$$I,[1]);
C$.sharedEtchedBorder = Clazz.new_((I$[2]||$incl$(2)));
C$.emptyBorder = Clazz.new_((I$[3]||$incl$(3)).c$$I$I$I$I,[0, 0, 0, 0]);
C$.html5Border = Clazz.new_((I$[3]||$incl$(3)).c$$I$I$I$I,[0, 0, 0, 0]);
}
...
return Clazz.new_((I$[4]||$incl$(4)).c$$java_awt_Color$I,[color, 1]);
}, 1);

Clazz.newMeth(C$, 'createLineBorder$java_awt_Color$I', function (color, thickness) {
return Clazz.new_((I$[4]||$incl$(4)).c$$java_awt_Color$I,[color, thickness]);
}, 1);
...
return Clazz.new_((I$[1]||$incl$(1)).c$$I$java_awt_Color$java_awt_Color,[type, highlight, shadow]);
}, 1);
...
return Clazz.new_((I$[1]||$incl$(1)).c$$I$java_awt_Color$java_awt_Color$java_awt_Color$java_awt_Color,[type, highlightOuter, highlightInner, shadowOuter, shadowInner]);
}, 1);
...
return Clazz.new_((I$[2]||$incl$(2)).c$$java_awt_Color$java_awt_Color,[highlight, shadow]);
}, 1);
...
return C$.sharedEtchedBorder;
default:
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["type must be one of EtchedBorder.RAISED or EtchedBorder.LOWERED"]);
}
}, 1);

Clazz.newMeth(C$, 'createEtchedBorder$I$java_awt_Color$java_awt_Color', function (type, highlight, shadow) {
return Clazz.new_((I$[2]||$incl$(2)).c$$I$java_awt_Color$java_awt_Color,[type, highlight, shadow]);
}, 1);

Clazz.newMeth(C$, 'createTitledBorder$S', function (title) {
return Clazz.new_((I$[5]||$incl$(5)).c$$S,[title]);
}, 1);

Clazz.newMeth(C$, 'createTitledBorder$javax_swing_border_Border', function (border) {
return Clazz.new_((I$[5]||$incl$(5)).c$$javax_swing_border_Border,[border]);
}, 1);

Clazz.newMeth(C$, 'createTitledBorder$javax_swing_border_Border$S', function (border, title) {
return Clazz.new_((I$[5]||$incl$(5)).c$$javax_swing_border_Border$S,[border, title]);
}, 1);
...
return Clazz.new_((I$[5]||$incl$(5)).c$$javax_swing_border_Border$S$I$I,[border, title, titleJustification, titlePosition]);
}, 1);
...
return Clazz.new_((I$[5]||$incl$(5)).c$$javax_swing_border_Border$S$I$I$java_awt_Font,[border, title, titleJustification, titlePosition, titleFont]);
}, 1);
...
return Clazz.new_((I$[5]||$incl$(5)).c$$javax_swing_border_Border$S$I$I$java_awt_Font$java_awt_Color,[border, title, titleJustification, titlePosition, titleFont, titleColor]);
}, 1);
...
return Clazz.new_((I$[3]||$incl$(3)).c$$I$I$I$I,[top, left, bottom, right]);
}, 1);
...
return Clazz.new_((I$[6]||$incl$(6)).c$$javax_swing_border_Border$javax_swing_border_Border,[outsideBorder, insideBorder]);
}, 1);

Clazz.newMeth(C$, 'createMatteBorder$I$I$I$I$java_awt_Color', function (top, left, bottom, right, color) {
return Clazz.new_((I$[7]||$incl$(7)).c$$I$I$I$I$java_awt_Color,[top, left, bottom, right, color]);
}, 1);
