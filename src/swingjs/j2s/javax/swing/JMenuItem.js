(function(){var P$=Clazz.newPackage("javax.swing"),I$=[['javax.swing.DefaultButtonModel',['javax.swing.JMenuItem','.MenuItemFocusListener'],'java.lang.Boolean','javax.swing.UIManager','javax.swing.event.MenuDragMouseEvent','javax.swing.event.MenuKeyEvent','javax.swing.event.MenuDragMouseListener','javax.swing.event.MenuKeyListener','javax.swing.MenuElement']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
Clazz.newMeth(C$, 'c$$S$javax_swing_Icon$S', function (text, icon, uid) {
Clazz.super_(C$, this,1);
p$.init0$S$javax_swing_Icon$I$S.apply(this, [text, icon, 0, uid]);
}, 1);

Clazz.newMeth(C$, 'c$$S$javax_swing_Icon$I$S', function (text, icon, mnemonic, uid) {
Clazz.super_(C$, this,1);
p$.init0$S$javax_swing_Icon$I$S.apply(this, [text, icon, mnemonic, uid]);
}, 1);

Clazz.newMeth(C$, 'init0$S$javax_swing_Icon$I$S', function (text, icon, mnemonic, uid) {
...
this.addFocusListener$java_awt_event_FocusListener(Clazz.new_((I$[2]||$incl$(2))));
...
this.processMenuDragMouseEvent$javax_swing_event_MenuDragMouseEvent(Clazz.new_((I$[5]||$incl$(5)).c$$java_awt_Component$I$J$I$I$I$I$I$I$Z$javax_swing_MenuElementA$javax_swing_MenuSelectionManager,[e.getComponent(), e.getID(), e.getWhen(), e.getModifiers(), e.getX(), e.getY(), e.getXOnScreen(), e.getYOnScreen(), e.getClickCount(), e.isPopupTrigger(), path, manager]));
});
...
var mke = Clazz.new_((I$[6]||$incl$(6)).c$$java_awt_Component$I$J$I$I$C$javax_swing_MenuElementA$javax_swing_MenuSelectionManager,[e.getComponent(), e.getID(), e.getWhen(), e.getModifiers(), e.getKeyCode(), e.getKeyChar(), path, manager]);
...
return Clazz.array((I$[9]||$incl$(9)), [0]);
});
...
this.listenerList.add$Class$TT(Clazz.getClass((I$[7]||$incl$(7)),['menuDragMouseDragged$javax_swing_event_MenuDragMouseEvent','menuDragMouseEntered$javax_swing_event_MenuDragMouseEvent','menuDragMouseExited$javax_swing_event_MenuDragMouseEvent','menuDragMouseReleased$javax_swing_event_MenuDragMouseEvent']), l);
});

Clazz.newMeth(C$, 'removeMenuDragMouseListener$javax_swing_event_MenuDragMouseListener', function (l) {
this.listenerList.remove$Class$TT(Clazz.getClass((I$[7]||$incl$(7)),['menuDragMouseDragged$javax_swing_event_MenuDragMouseEvent','menuDragMouseEntered$javax_swing_event_MenuDragMouseEvent','menuDragMouseExited$javax_swing_event_MenuDragMouseEvent','menuDragMouseReleased$javax_swing_event_MenuDragMouseEvent']), l);
});

Clazz.newMeth(C$, 'getMenuDragMouseListeners', function () {
return this.listenerList.getListeners$Class(Clazz.getClass((I$[7]||$incl$(7)),['menuDragMouseDragged$javax_swing_event_MenuDragMouseEvent','menuDragMouseEntered$javax_swing_event_MenuDragMouseEvent','menuDragMouseExited$javax_swing_event_MenuDragMouseEvent','menuDragMouseReleased$javax_swing_event_MenuDragMouseEvent']));
});

Clazz.newMeth(C$, 'addMenuKeyListener$javax_swing_event_MenuKeyListener', function (l) {
this.listenerList.add$Class$TT(Clazz.getClass((I$[8]||$incl$(8)),['menuKeyPressed$javax_swing_event_MenuKeyEvent','menuKeyReleased$javax_swing_event_MenuKeyEvent','menuKeyTyped$javax_swing_event_MenuKeyEvent']), l);
});

Clazz.newMeth(C$, 'removeMenuKeyListener$javax_swing_event_MenuKeyListener', function (l) {
this.listenerList.remove$Class$TT(Clazz.getClass((I$[8]||$incl$(8)),['menuKeyPressed$javax_swing_event_MenuKeyEvent','menuKeyReleased$javax_swing_event_MenuKeyEvent','menuKeyTyped$javax_swing_event_MenuKeyEvent']), l);
});

Clazz.newMeth(C$, 'getMenuKeyListeners', function () {
return this.listenerList.getListeners$Class(Clazz.getClass((I$[8]||$incl$(8)),['menuKeyPressed$javax_swing_event_MenuKeyEvent','menuKeyReleased$javax_swing_event_MenuKeyEvent','menuKeyTyped$javax_swing_event_MenuKeyEvent']));
});
