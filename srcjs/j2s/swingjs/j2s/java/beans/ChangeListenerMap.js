(function(){var P$=Clazz.newPackage("java.beans"),I$=[['java.util.HashMap','java.util.ArrayList','java.util.Collections']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
}var list = Clazz.new_((I$[2]||$incl$(2)));
