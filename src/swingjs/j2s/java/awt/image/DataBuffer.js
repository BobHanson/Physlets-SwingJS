(function(){var P$=Clazz.newPackage("java.awt.image"),I$=[[['sun.java2d.StateTrackable','.State'],'sun.java2d.StateTrackableDelegate']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
if (type < 0 || type > 3 ) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Unknown data type " + type]);
}return C$.dataTypeSize[type];
}, 1);

Clazz.newMeth(C$, 'c$$I$I', function (dataType, size) {
C$.c$$sun_java2d_StateTrackable_State$I$I.apply(this, [(I$[1]||$incl$(1)).UNTRACKABLE, dataType, size]);
}, 1);

Clazz.newMeth(C$, 'c$$sun_java2d_StateTrackable_State$I$I', function (initialState, dataType, size) {
C$.$init$.apply(this);
this.theTrackable = (I$[2]||$incl$(2)).createInstance$sun_java2d_StateTrackable_State(initialState);
...
C$.c$$sun_java2d_StateTrackable_State$I$I$I.apply(this, [(I$[1]||$incl$(1)).UNTRACKABLE, dataType, size, numBanks]);
}, 1);
...
C$.c$$sun_java2d_StateTrackable_State$I$I$I$I.apply(this, [(I$[1]||$incl$(1)).UNTRACKABLE, dataType, size, numBanks, offset]);
}, 1);
...
C$.c$$sun_java2d_StateTrackable_State$I$I$I$IA.apply(this, [(I$[1]||$incl$(1)).UNTRACKABLE, dataType, size, numBanks, offsets]);
}, 1);

Clazz.newMeth(C$, 'c$$sun_java2d_StateTrackable_State$I$I$I$IA', function (initialState, dataType, size, numBanks, offsets) {
C$.$init$.apply(this);
if (numBanks != offsets.length) {
throw Clazz.new_(Clazz.load('java.lang.ArrayIndexOutOfBoundsException').c$$S,["Number of banks does not match number of bank offsets"]);
}this.theTrackable = (I$[2]||$incl$(2)).createInstance$sun_java2d_StateTrackable_State(initialState);
this.dataType = dataType;
this.banks = numBanks;
this.size = size;
