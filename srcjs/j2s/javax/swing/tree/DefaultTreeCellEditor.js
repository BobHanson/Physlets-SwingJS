(function(){var P$=Clazz.newPackage("javax.swing.tree"),I$=[['java.awt.Dimension','javax.swing.UIManager','javax.swing.SwingUtilities',['javax.swing.tree.DefaultTreeCellEditor','.EditorContainer'],'javax.swing.DefaultCellEditor',['javax.swing.tree.DefaultTreeCellEditor','.DefaultTextField']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
p$.cleanupAfterEditing.apply(this, []);
return true;
}return false;
});
...
if ((Clazz.instanceOf(event, "java.awt.event.MouseEvent")) && (I$[3]||$incl$(3)).isLeftMouseButton$java_awt_event_MouseEvent(event) ) {
var me = event;
...
var aBorder = (I$[2]||$incl$(2)).getBorder$O("Tree.editorBorder");
var editor = ((
...
), Clazz.new_((I$[5]||$incl$(5)).c$$javax_swing_JTextField, [this, null, Clazz.new_((I$[6]||$incl$(6)).c$$javax_swing_border_Border, [this, null, aBorder])],P$.DefaultTreeCellEditor$1));
...
var yLoc = p$.calculateIconY$javax_swing_Icon.apply(this, [this.this$0.editingIcon]);
...
}}var background = this.this$0.getBorderSelectionColor();
if (background != null ) {
