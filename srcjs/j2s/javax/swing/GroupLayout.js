...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Pref must be >= 0"]);
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Invalid size"]);
}}, 1);

Clazz.newMeth(C$, 'checkLessThan$I$I', function (min, max) {
if (min >= 0 && max >= 0  && min > max ) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Following is not met: min<=pref<=max"]);
}}, 1);

Clazz.newMeth(C$, 'c$$java_awt_Container', function (host) {
C$.$init$.apply(this);
if (host == null ) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Container must be non-null"]);
}this.honorsVisibility = true;
this.host = host;
this.setHorizontalGroup$javax_swing_GroupLayout_Group(this.createParallelGroup$javax_swing_GroupLayout_Alignment$Z((I$[11]||$incl$(11)).LEADING, true));
this.setVerticalGroup$javax_swing_GroupLayout_Group(this.createParallelGroup$javax_swing_GroupLayout_Alignment$Z((I$[11]||$incl$(11)).LEADING, true));
this.componentInfos = Clazz.new_((I$[14]||$incl$(14)));
this.tmpParallelSet = Clazz.new_((I$[15]||$incl$(15)));
}, 1);
...
if (component == null ) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Component must be non-null"]);
...
if (group == null ) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Group must be non-null"]);
...
group.addSpring$javax_swing_GroupLayout_Spring(Clazz.new_((I$[8]||$incl$(8)), [this, null]));
...
return Clazz.new_((I$[16]||$incl$(16)), [this, null]);
});

Clazz.newMeth(C$, 'createParallelGroup', function () {
return this.createParallelGroup$javax_swing_GroupLayout_Alignment((I$[11]||$incl$(11)).LEADING);
});
...
if (alignment === (I$[11]||$incl$(11)).BASELINE ) {
return Clazz.new_((I$[17]||$incl$(17)).c$$Z, [this, null, resizable]);
}return Clazz.new_((I$[18]||$incl$(18)).c$$javax_swing_GroupLayout_Alignment$Z, [this, null, alignment, resizable]);
});

Clazz.newMeth(C$, 'createBaselineGroup$Z$Z', function (resizable, anchorBaselineToTop) {
return Clazz.new_((I$[17]||$incl$(17)).c$$Z$Z, [this, null, resizable, anchorBaselineToTop]);
});
...
if (components == null ) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Components must be non-null"]);
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Axis must be one of SwingConstants.HORIZONTAL or SwingConstants.VERTICAL"]);
...
if (info == null ) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Component must already exist"]);
...
if (layoutStyle == null ) {
layoutStyle = (I$[19]||$incl$(19)).getInstance();
}return layoutStyle;
});
...
throw Clazz.new_(Clazz.load('java.lang.IllegalStateException').c$$S,[info.component + " is not attached to a horizontal group"]);
}if (info.verticalSpring == null ) {
throw Clazz.new_(Clazz.load('java.lang.IllegalStateException').c$$S,[info.component + " is not attached to a vertical group"]);
}}
});
...
return Clazz.new_((I$[20]||$incl$(20)).c$$I$I,[width + insets.left + insets.right , height + insets.top + insets.bottom ]);
});

Clazz.newMeth(C$, 'checkParent$java_awt_Container', function (parent) {
if (parent !== this.host ) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["GroupLayout can only be used with one Container at a time"]);
}});

Clazz.newMeth(C$, 'getComponentInfo$java_awt_Component', function (component) {
var info = this.componentInfos.get$O(component);
if (info == null ) {
info = Clazz.new_((I$[21]||$incl$(21)).c$$java_awt_Component, [this, null, component]);
...
this.horizontalGroup.insertAutopadding$I$java_util_List$java_util_List$java_util_List$java_util_List$Z(0, Clazz.new_((I$[2]||$incl$(2)).c$$I,[1]), Clazz.new_((I$[2]||$incl$(2)).c$$I,[1]), Clazz.new_((I$[2]||$incl$(2)).c$$I,[1]), Clazz.new_((I$[2]||$incl$(2)).c$$I,[1]), insert);
this.verticalGroup.insertAutopadding$I$java_util_List$java_util_List$java_util_List$java_util_List$Z(1, Clazz.new_((I$[2]||$incl$(2)).c$$I,[1]), Clazz.new_((I$[2]||$incl$(2)).c$$I,[1]), Clazz.new_((I$[2]||$incl$(2)).c$$I,[1]), Clazz.new_((I$[2]||$incl$(2)).c$$I,[1]), insert);
});
...
p$.registerComponents$javax_swing_GroupLayout_Group$I.apply(this, [this.horizontalGroup, 0]);
p$.registerComponents$javax_swing_GroupLayout_Group$I.apply(this, [this.verticalGroup, 1]);
}var buffer = Clazz.new_((I$[22]||$incl$(22)));
...
Clazz.newInstance(this, arguments[0],true,C$);
}, ['javax.swing.GroupLayout','javax.swing.GroupLayout.Spring']);
...
this.springs = Clazz.new_((I$[2]||$incl$(2)));
}, 1);
...
return this.addSpring$javax_swing_GroupLayout_Spring(Clazz.new_((I$[3]||$incl$(3)).c$$java_awt_Component$I$I$I, [this, null, component, min, pref, max]));
});
...
return this.addSpring$javax_swing_GroupLayout_Spring(Clazz.new_((I$[4]||$incl$(4)).c$$I$I$I, [this, null, min, pref, max]));
});
...
Clazz.newInstance(this, arguments[0],true,C$);
}, ['javax.swing.GroupLayout','javax.swing.GroupLayout.Group']);
var p$=C$.prototype;
...
return this.addSpring$javax_swing_GroupLayout_Spring(Clazz.new_((I$[5]||$incl$(5)).c$$javax_swing_JComponent$javax_swing_JComponent$javax_swing_LayoutStyle_ComponentPlacement$I$I, [this, null, comp1, comp2, type, pref, max]));
});
...
if (type !== (I$[6]||$incl$(6)).RELATED  && type !== (I$[6]||$incl$(6)).UNRELATED  ) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Type must be one of LayoutStyle.ComponentPlacement.RELATED or LayoutStyle.ComponentPlacement.UNRELATED"]);
}p$.checkPreferredGapValues$I$I.apply(this, [pref, max]);
this.this$0.hasPreferredPaddingSprings = true;
return this.addSpring$javax_swing_GroupLayout_Spring(Clazz.new_((I$[7]||$incl$(7)).c$$javax_swing_LayoutStyle_ComponentPlacement$I$I, [this, null, type, pref, max]));
});
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Pref and max must be either DEFAULT_VALUE or >= 0 and pref <= max"]);
}this.this$0.hasPreferredPaddingSprings = true;
return this.addSpring$javax_swing_GroupLayout_Spring(Clazz.new_((I$[8]||$incl$(8)).c$$I$I, [this, null, pref, max]));
});
...
var sorted = Clazz.new_((I$[2]||$incl$(2)).c$$I,[size]);
...
sorted.add$TE(Clazz.new_((I$[9]||$incl$(9)).c$$I$I,[counter, sDelta]));
}}
(I$[10]||$incl$(10)).sort$java_util_List(sorted);
return sorted;
});
...
var newLeadingPadding = Clazz.new_((I$[2]||$incl$(2)).c$$java_util_Collection,[leadingPadding]);
var newTrailingPadding = Clazz.new_((I$[2]||$incl$(2)).c$$I,[1]);
var newLeading = Clazz.new_((I$[2]||$incl$(2)).c$$java_util_Collection,[leading]);
...
var padding = Clazz.new_((I$[7]||$incl$(7)), [this, null]);
...
if (newTrailing == null ) {
newTrailing = Clazz.new_((I$[2]||$incl$(2)).c$$I,[1]);
} else {
newTrailing.clear();
...
return (I$[1]||$incl$(1)).CONSTANT_DESCENT;
} else if (!leadingResizable && trailingResizable ) {
return (I$[1]||$incl$(1)).CONSTANT_ASCENT;
}} else {
var brb = this.baselineSpring.getBaselineResizeBehavior();
if (brb === (I$[1]||$incl$(1)).CONSTANT_ASCENT ) {
for (var spring, $spring = this.springs.iterator(); $spring.hasNext()&&((spring=$spring.next()),1);) {
if (spring === this.baselineSpring ) {
return (I$[1]||$incl$(1)).CONSTANT_ASCENT;
}if (spring.isResizable$I(1)) {
...
} else if (brb === (I$[1]||$incl$(1)).CONSTANT_DESCENT ) {
for (var i = this.springs.size() - 1; i >= 0; i--) {
var spring = this.springs.get$I(i);
if (spring === this.baselineSpring ) {
return (I$[1]||$incl$(1)).CONSTANT_DESCENT;
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Pref and max must be either DEFAULT_SIZE, PREFERRED_SIZE, or >= 0 and pref <= max"]);
}});
})()
;
...
Clazz.newMeth(C$, ['compareTo$javax_swing_GroupLayout_SpringDelta','compareTo$TT'], function (o) {
...
p$.checkChildAlignment$javax_swing_GroupLayout_Alignment.apply(this, [alignment]);
var spring = Clazz.new_((I$[3]||$incl$(3)).c$$java_awt_Component$I$I$I, [this, null, component, min, pref, max]);
...
if (alignment == null ) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Alignment must be non-null"]);
}if (!allowsBaseline && alignment === (I$[11]||$incl$(11)).BASELINE  ) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Alignment must be one of:LEADING, TRAILING or CENTER"]);
}});
...
Clazz.newInstance(this, arguments[0],true,C$);
}, ['javax.swing.GroupLayout','javax.swing.GroupLayout.ParallelGroup']);
var p$=C$.prototype;
...
C$.superclazz.c$$javax_swing_GroupLayout_Alignment$Z.apply(this, [(I$[11]||$incl$(11)).LEADING, resizable]);
C$.$init$.apply(this);
...
for (var spring, $spring = this.springs.iterator(); $spring.hasNext()&&((spring=$spring.next()),1);) {
if (spring.getAlignment() == null  || spring.getAlignment() === (I$[11]||$incl$(11)).BASELINE  ) {
...
resizeBehavior = (I$[1]||$incl$(1)).CONSTANT_ASCENT;
...
if (resizeBehavior === (I$[1]||$incl$(1)).CONSTANT_DESCENT ) {
this.baselineAnchoredToTop = false;
} else {
...
var alignment = spring.getAlignment();
if (alignment == null  || alignment === (I$[11]||$incl$(11)).BASELINE  ) {
var baseline = spring.getBaseline();
if (baseline >= 0) {
var springMax = spring.getMaximumSize$I(1);
var springPref = spring.getPreferredSize$I(1);
...
if (axis == 0) {
throw Clazz.new_(Clazz.load('java.lang.IllegalStateException').c$$S,["Baseline must be used along vertical axis"]);
}});
...
this.$max = max;
this.$pref = pref;
this.this$0.getComponentInfo$java_awt_Component.apply(this.this$0, [component]);
}, 1);
...
return this.this$0.getComponentInfo$java_awt_Component.apply(this.this$0, [this.getComponent()]).isVisible();
});
...
if (!this.isVisible()) {
return 0;
}var ci = this.this$0.getComponentInfo$java_awt_Component.apply(this.this$0, [this.component]);
...
Clazz.newMeth(C$, 'getBaseline', function () {
if (this.baseline == -1) {
var horizontalSpring = this.this$0.getComponentInfo$java_awt_Component.apply(this.this$0, [this.component]).horizontalSpring;
...
return this.this$0.getComponentInfo$java_awt_Component.apply(this.this$0, [this.component]).isLinked$I(axis);
});
...
this.installed = true;
if (axis == 0) {
this.this$0.getComponentInfo$java_awt_Component.apply(this.this$0, [this.component]).horizontalSpring = this;
} else {
this.this$0.getComponentInfo$java_awt_Component.apply(this.this$0, [this.component]).verticalSpring = this;
}}});
...
position = 5;
}return this.this$0.getLayoutStyle0.apply(this.this$0, []).getPreferredGap$javax_swing_JComponent$javax_swing_JComponent$javax_swing_LayoutStyle_ComponentPlacement$I$java_awt_Container(this.source, this.target, this.type, position, this.this$0.host);
});
...
this.sources = Clazz.new_((I$[2]||$incl$(2)).c$$java_util_Collection,[sources]);
});
...
var p = this.this$0.getLayoutStyle0.apply(this.this$0, []);
var position;
if (axis == 0) {
if (this.this$0.isLeftToRight.apply(this.this$0, [])) {
position = 3;
} else {
position = 7;
}} else {
...
padding = p.getPreferredGap$javax_swing_JComponent$javax_swing_JComponent$javax_swing_LayoutStyle_ComponentPlacement$I$java_awt_Container(source.getComponent(), target.getComponent(), this.type, position, this.this$0.host);
} else {
padding = 10;
}if (padding > delta) {
...
if (this.source != null ) {
if (this.this$0.areParallelSiblings$java_awt_Component$java_awt_Component$I.apply(this.this$0, [this.source.getComponent(), spring.getComponent(), oAxis])) {
...
if (this.this$0.areParallelSiblings$java_awt_Component$java_awt_Component$I.apply(this.this$0, [source.getComponent(), component, oAxis])) {
...
if (this.matches == null ) {
this.matches = Clazz.new_((I$[2]||$incl$(2)).c$$I,[1]);
}this.matches.add$TE(Clazz.new_((I$[12]||$incl$(12)).c$$javax_swing_GroupLayout_ComponentSpring$javax_swing_GroupLayout_ComponentSpring,[source, target]));
});
...
Clazz.newInstance(this, arguments[0],true,C$);
}, ['javax.swing.GroupLayout','javax.swing.GroupLayout.AutoPreferredGapSpring']);
var p$=C$.prototype;
...
this.targets = Clazz.new_((I$[2]||$incl$(2)).c$$I,[1]);
...
padding = p.getContainerGap$javax_swing_JComponent$I$java_awt_Container(targetSpring.getComponent(), position, this.this$0.host);
...
padding = p.getContainerGap$javax_swing_JComponent$I$java_awt_Container(sourceSpring.getComponent(), position, this.this$0.host);
...
C$.$init$.apply(this);
this.linked = Clazz.new_((I$[2]||$incl$(2)));
this.size = -2147483648;
this.axis = axis;
}, 1);
...
Clazz.new_((I$[13]||$incl$(13)).c$$I,[0]).add$javax_swing_GroupLayout_ComponentInfo(this);
}return this.horizontalMaster;
} else {
if (this.verticalMaster == null  && create ) {
Clazz.new_((I$[13]||$incl$(13)).c$$I,[1]).add$javax_swing_GroupLayout_ComponentInfo(this);
