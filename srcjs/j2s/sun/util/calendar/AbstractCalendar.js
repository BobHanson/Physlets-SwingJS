(function(){var P$=Clazz.newPackage("sun.util.calendar"),I$=[['sun.util.calendar.Era','sun.util.calendar.CalendarUtils']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["unknown era name: " + eraName]);
});
...
}return fixedDate - (I$[2]||$incl$(2)).mod$J$J(fd, 7);
}, 1);
