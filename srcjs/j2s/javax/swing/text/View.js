(function(){var P$=Clazz.newPackage("javax.swing.text"),I$=[[['javax.swing.text.Position','.Bias'],'javax.swing.text.Utilities','java.awt.Rectangle',['javax.swing.event.DocumentEvent','.EventType']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
var C$=Clazz.newClass(P$, "View", null, null, 'javax.swing.SwingConstants');
C$.sharedBiasReturn = null;

C$.$clinit$ = function() {Clazz.load(C$, 1);
C$.sharedBiasReturn = Clazz.array((I$[1]||$incl$(1)), [1]);
}
...
return this.modelToView$I$java_awt_Shape$javax_swing_text_Position_Bias(pos, a, (I$[1]||$incl$(1)).Forward);
});
