(function(){var P$=Clazz.newPackage("java.awt.image"),I$=[['java.awt.image.DataBufferByte','java.awt.image.DataBufferUShort','java.awt.image.DataBufferShort','java.awt.image.DataBufferInt','java.awt.image.DataBuffer','java.util.Arrays']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Scanline stride must be >= 0"]);
}if (this.$numBands < 1) {
...
return (I$[5]||$incl$(5)).getDataTypeSize$I(this.dataType);
});
...
return this.width == that.width && this.height == that.height  && this.$numBands == that.$numBands  && this.dataType == that.dataType  && (I$[6]||$incl$(6)).equals$IA$IA(this.bandOffsets, that.bandOffsets)  && (I$[6]||$incl$(6)).equals$IA$IA(this.bankIndices, that.bankIndices)  && this.$numBands == that.$numBands  && this.numBanks == that.numBanks  && this.scanlineStride == that.scanlineStride  && this.pixelStride == that.pixelStride ;
});
