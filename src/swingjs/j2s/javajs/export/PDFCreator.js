(function(){var P$=Clazz.newPackage("javajs.export"),I$=[['java.util.Hashtable','javajs.util.Lst','javajs.export.PDFObject','javajs.util.SB']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
var o = Clazz.new_((I$[3]||$incl$(3)).c$$I,[++this.count]);
...
var info = Clazz.new_((I$[1]||$incl$(1)));
...
var trailer = Clazz.new_((I$[3]||$incl$(3)).c$$I,[-2]);
