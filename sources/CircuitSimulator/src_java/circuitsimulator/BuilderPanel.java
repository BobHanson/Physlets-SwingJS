...
{   
	...
	//{{DECLARE_CONTROLS
	java.awt.Button setGridButton = new java.awt.Button();
	...
	java.awt.Button listButton = new java.awt.Button();
	java.awt.Button calculateButton = new java.awt.Button();
	java.awt.TextField numberInput = new java.awt.TextField();
	java.awt.TextField dtInput = new java.awt.TextField();
	java.awt.Label label9 = new java.awt.Label();
	java.awt.Label label10 = new java.awt.Label();
	java.awt.Button arrows = new java.awt.Button();
	java.awt.Button loadButton = new java.awt.Button();
	java.awt.TextField inputfile = new java.awt.TextField();
	java.awt.Button forwarding = new java.awt.Button();
	java.awt.Button resetting = new java.awt.Button();
	...
	class SymAction implements java.awt.event.ActionListener
	{
 	...
 	class SymMouse extends java.awt.event.MouseAdapter 
 	{
		...
		public void mouseReleased(java.awt.event.MouseEvent event) {
		    ...
		    String name = ""+((CircuitElement)object).name();
