(function(){var P$=Clazz.newPackage("gnu.jpdf"),I$=[['java.util.Vector','gnu.jpdf.PDFStream','gnu.jpdf.PDFStringHelper']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
if (this.parent != null ) {
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "/Title ");
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, (I$[3]||$incl$(3)).makePDFString$S(this.title));
...
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, " /Fit]\u000a/Parent ");
} else {
...
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "]\u000a/Parent ");
}(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, this.parent.toString());
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "\u000a");
}if (this.parent == null ) {
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "/Count ");
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, Integer.toString(this.outlines.size()));
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "\u000a");
} else {
var c = this.descendants();
if (c > 0) {
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "/Count ");
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, Integer.toString(-c));
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "\u000a");
}}if (this.outlines.size() > 0) {
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "/First ");
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, this.outlines.elementAt$I(0).toString());
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "\u000a");
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "/Last ");
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, this.outlines.elementAt$I(this.outlines.size() - 1).toString());
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "\u000a");
}if (this.parent != null ) {
var index = this.parent.getIndex$gnu_jpdf_PDFOutline(this);
if (index > 0) {
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "/Prev ");
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, this.parent.getNode$I(index - 1).toString());
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "\u000a");
}if (index < this.parent.getLast()) {
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "/Next ");
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, this.parent.getNode$I(index + 1).toString());
(I$[2]||$incl$(2)).write$java_io_OutputStream$S(os, "\u000a");
