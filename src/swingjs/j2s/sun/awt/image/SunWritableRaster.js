(function(){var P$=Clazz.newPackage("sun.awt.image"),I$=[['sun.awt.image.SunWritableRaster$1','sun.java2d.StateTrackableDelegate',['sun.java2d.StateTrackable','.State']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.getStealer().setTrackable$java_awt_image_DataBuffer$sun_java2d_StateTrackableDelegate(db, (I$[2]||$incl$(2)).createInstance$sun_java2d_StateTrackable_State((I$[3]||$incl$(3)).STABLE));
}, 1);
