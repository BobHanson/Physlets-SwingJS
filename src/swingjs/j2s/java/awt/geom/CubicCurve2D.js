...
return Math.max((I$[5]||$incl$(5)).ptSegDistSq$D$D$D$D$D$D(x1, y1, x2, y2, ctrlx1, ctrly1), (I$[5]||$incl$(5)).ptSegDistSq$D$D$D$D$D$D(x1, y1, x2, y2, ctrlx2, ctrly2));
}, 1);
...
var d = eqn[3];
if (d == 0.0 ) {
return (I$[6]||$incl$(6)).solveQuadratic$DA$DA(eqn, res);
}var a = eqn[2] / d;
var b = eqn[1] / d;
var c = eqn[0] / d;
var roots = 0;
...
var x2 = this.getX2();
var y2 = this.getY2();
var crossings = ((I$[7]||$incl$(7)).pointCrossingsForLine$D$D$D$D$D$D(x, y, x1, y1, x2, y2) + (I$[7]||$incl$(7)).pointCrossingsForCubic$D$D$D$D$D$D$D$D$D$D$I(x, y, x1, y1, this.getCtrlX1(), this.getCtrlY1(), this.getCtrlX2(), this.getCtrlY2(), x2, y2, 0));
...
return false;
}var rect = Clazz.new_((I$[4]||$incl$(4)).c$$D$D$D$D,[x, y, w, h]);
...
return ((I$[9]||$incl$(9)).getInstance$S$Z("java.awt.geom.CubicInterator", false)).set$java_awt_geom_CubicCurve2D$java_awt_geom_AffineTransform(this, at);
});

Clazz.newMeth(C$, 'getPathIterator$java_awt_geom_AffineTransform$D', function (at, flatness) {
return Clazz.new_((I$[10]||$incl$(10)).c$$java_awt_geom_PathIterator$D,[this.getPathIterator$java_awt_geom_AffineTransform(at), flatness]);
});
...
return Clazz.new_((I$[1]||$incl$(1)).c$$F$F,[this.ctrlx1, this.ctrly1]);
});
...
return Clazz.new_((I$[1]||$incl$(1)).c$$F$F,[this.ctrlx2, this.ctrly2]);
});
...
Clazz.newMeth(C$, 'getCtrlP1', function () {
return Clazz.new_((I$[3]||$incl$(3)).c$$D$D,[this.ctrlx1, this.ctrly1]);
});
...
Clazz.newMeth(C$, 'getCtrlP2', function () {
return Clazz.new_((I$[3]||$incl$(3)).c$$D$D,[this.ctrlx2, this.ctrly2]);
});
