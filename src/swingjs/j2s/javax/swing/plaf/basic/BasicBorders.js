(function(){var P$=Clazz.newPackage("javax.swing.plaf.basic"),I$=[['java.awt.Insets','javax.swing.plaf.basic.BasicGraphicsUtils','javax.swing.UIManager',['javax.swing.plaf.BorderUIResource','.CompoundBorderUIResource'],['javax.swing.plaf.basic.BasicBorders','.ButtonBorder'],['javax.swing.plaf.basic.BasicBorders','.MarginBorder'],['javax.swing.plaf.basic.BasicBorders','.RadioButtonBorder'],['javax.swing.plaf.basic.BasicBorders','.ToggleButtonBorder'],['javax.swing.plaf.basic.BasicBorders','.MenuBarBorder'],['javax.swing.plaf.basic.BasicBorders','.SplitPaneBorder'],['javax.swing.plaf.basic.BasicBorders','.FieldBorder'],['javax.swing.plaf.BorderUIResource','.LineBorderUIResource'],'java.awt.Color','javax.swing.border.BevelBorder','javax.swing.BorderFactory']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
var buttonBorder = Clazz.new_((I$[4]||$incl$(4)).c$$javax_swing_border_Border$javax_swing_border_Border,[Clazz.new_((I$[5]||$incl$(5)).c$$java_awt_Color$java_awt_Color$java_awt_Color$java_awt_Color,[table.getColor$O("Button.shadow"), table.getColor$O("Button.darkShadow"), table.getColor$O("Button.light"), table.getColor$O("Button.highlight")]), Clazz.new_((I$[6]||$incl$(6)))]);
return buttonBorder;
}, 1);

Clazz.newMeth(C$, 'getRadioButtonBorder', function () {
var table = (I$[3]||$incl$(3)).getLookAndFeelDefaults();
var radioButtonBorder = Clazz.new_((I$[4]||$incl$(4)).c$$javax_swing_border_Border$javax_swing_border_Border,[Clazz.new_((I$[7]||$incl$(7)).c$$java_awt_Color$java_awt_Color$java_awt_Color$java_awt_Color,[table.getColor$O("RadioButton.shadow"), table.getColor$O("RadioButton.darkShadow"), table.getColor$O("RadioButton.light"), table.getColor$O("RadioButton.highlight")]), Clazz.new_((I$[6]||$incl$(6)))]);
return radioButtonBorder;
}, 1);

Clazz.newMeth(C$, 'getToggleButtonBorder', function () {
var table = (I$[3]||$incl$(3)).getLookAndFeelDefaults();
var toggleButtonBorder = Clazz.new_((I$[4]||$incl$(4)).c$$javax_swing_border_Border$javax_swing_border_Border,[Clazz.new_((I$[8]||$incl$(8)).c$$java_awt_Color$java_awt_Color$java_awt_Color$java_awt_Color,[table.getColor$O("ToggleButton.shadow"), table.getColor$O("ToggleButton.darkShadow"), table.getColor$O("ToggleButton.light"), table.getColor$O("ToggleButton.highlight")]), Clazz.new_((I$[6]||$incl$(6)))]);
return toggleButtonBorder;
}, 1);

Clazz.newMeth(C$, 'getMenuBarBorder', function () {
var table = (I$[3]||$incl$(3)).getLookAndFeelDefaults();
var menuBarBorder = Clazz.new_((I$[9]||$incl$(9)).c$$java_awt_Color$java_awt_Color,[table.getColor$O("MenuBar.shadow"), table.getColor$O("MenuBar.highlight")]);
return menuBarBorder;
}, 1);

Clazz.newMeth(C$, 'getSplitPaneBorder', function () {
var table = (I$[3]||$incl$(3)).getLookAndFeelDefaults();
var splitPaneBorder = Clazz.new_((I$[10]||$incl$(10)).c$$java_awt_Color$java_awt_Color,[table.getColor$O("SplitPane.highlight"), table.getColor$O("SplitPane.darkShadow")]);
return splitPaneBorder;
}, 1);

Clazz.newMeth(C$, 'getTextFieldBorder', function () {
var table = (I$[3]||$incl$(3)).getLookAndFeelDefaults();
var textFieldBorder = Clazz.new_((I$[11]||$incl$(11)).c$$java_awt_Color$java_awt_Color$java_awt_Color$java_awt_Color,[table.getColor$O("TextField.shadow"), table.getColor$O("TextField.darkShadow"), table.getColor$O("TextField.light"), table.getColor$O("TextField.highlight")]);
return textFieldBorder;
}, 1);

Clazz.newMeth(C$, 'getProgressBarBorder', function () {
var progressBarBorder = Clazz.new_((I$[12]||$incl$(12)).c$$java_awt_Color$I,[(I$[13]||$incl$(13)).green, 2]);
return progressBarBorder;
}, 1);

Clazz.newMeth(C$, 'getInternalFrameBorder', function () {
var table = (I$[3]||$incl$(3)).getLookAndFeelDefaults();
var internalFrameBorder = Clazz.new_((I$[4]||$incl$(4)).c$$javax_swing_border_Border$javax_swing_border_Border,[Clazz.new_((I$[14]||$incl$(14)).c$$I$java_awt_Color$java_awt_Color$java_awt_Color$java_awt_Color,[0, table.getColor$O("InternalFrame.borderLight"), table.getColor$O("InternalFrame.borderHighlight"), table.getColor$O("InternalFrame.borderDarkShadow"), table.getColor$O("InternalFrame.borderShadow")]), (I$[15]||$incl$(15)).createLineBorder$java_awt_Color$I(table.getColor$O("InternalFrame.borderColor"), 1)]);
return internalFrameBorder;
}, 1);
;
(function(){var C$=Clazz.newClass(P$.BasicBorders, "RolloverButtonBorder", function(){
Clazz.newInstance(this, arguments[0],false,C$);
}, ['javax.swing.plaf.basic.BasicBorders','javax.swing.plaf.basic.BasicBorders.ButtonBorder']);
...
return this.getBorderInsets$java_awt_Component$java_awt_Insets(c, Clazz.new_((I$[1]||$incl$(1)).c$$I$I$I$I,[0, 0, 0, 0]));
});
...
Clazz.newMeth(C$, 'paintBorder$java_awt_Component$java_awt_Graphics$I$I$I$I', function (c, g, x, y, width, height) {
(I$[2]||$incl$(2)).drawBezel$java_awt_Graphics$I$I$I$I$Z$Z$java_awt_Color$java_awt_Color$java_awt_Color$java_awt_Color(g, x, y, width, height, false, false, this.shadow, this.darkShadow, this.highlight, this.lightHighlight);
});
...
(I$[2]||$incl$(2)).drawLoweredBezel$java_awt_Graphics$I$I$I$I$java_awt_Color$java_awt_Color$java_awt_Color$java_awt_Color(g, x, y, width, height, this.shadow, this.darkShadow, this.highlight, this.lightHighlight);
} else {
(I$[2]||$incl$(2)).drawBezel$java_awt_Graphics$I$I$I$I$Z$Z$java_awt_Color$java_awt_Color$java_awt_Color$java_awt_Color(g, x, y, width, height, false, b.isFocusPainted() && b.hasFocus() , this.shadow, this.darkShadow, this.highlight, this.lightHighlight);
}} else {
(I$[2]||$incl$(2)).drawBezel$java_awt_Graphics$I$I$I$I$Z$Z$java_awt_Color$java_awt_Color$java_awt_Color$java_awt_Color(g, x, y, width, height, false, false, this.shadow, this.darkShadow, this.highlight, this.lightHighlight);
}});
...
Clazz.newMeth(C$, 'paintBorder$java_awt_Component$java_awt_Graphics$I$I$I$I', function (c, g, x, y, width, height) {
(I$[2]||$incl$(2)).drawEtchedRect$java_awt_Graphics$I$I$I$I$java_awt_Color$java_awt_Color$java_awt_Color$java_awt_Color(g, x, y, width, height, this.shadow, this.darkShadow, this.highlight, this.lightHighlight);
});
...
Clazz.newMeth(C$, 'getBorderInsets$java_awt_Component', function (c) {
return Clazz.new_((I$[1]||$incl$(1)).c$$I$I$I$I,[1, 1, 1, 1]);
});
