(function(){var P$=Clazz.newPackage("javax.imageio"),I$=[['java.util.Hashtable','javajs.util.OC','javax.imageio.IIOImage','swingjs.JSUtil','swingjs.JSToolkit','javajs.util.PT','swingjs.api.Interface']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
this.params = Clazz.new_((I$[1]||$incl$(1)));
}, 1);
...
return false;
}if (out == null  && o != null  ) (I$[4]||$incl$(4)).saveFile$S$O$S$S(fileName, o, this.params.get$O("mimeType"), null);
} catch (e) {
if (Clazz.exceptionOf(e, "java.lang.Exception")){
return false;
} else {
...
if (image == null  && !params.containsKey$O("rgbbuf") ) throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["image == null!"]);
var bytes = null;
var errMsg = null;
...
var outputChannel = Clazz.new_((I$[2]||$incl$(2)));
