(function(){var P$=Clazz.newPackage("javax.swing"),I$=[['javax.swing.JOptionPane','javax.swing.JDialog','javax.swing.SwingUtilities','java.awt.BorderLayout','java.awt.event.WindowAdapter','javax.swing.ProgressMonitor$ProgressOptionPane$2','javax.swing.UIManager','javax.swing.JProgressBar','javax.swing.JLabel',['javax.swing.ProgressMonitor','.ProgressOptionPane']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
this.cancelOption[0] = (I$[7]||$incl$(7)).getString$O("OptionPane.cancelButtonText");
...
this.myBar = Clazz.new_((I$[8]||$incl$(8)));
this.myBar.setMinimum$I(this.min);
this.myBar.setMaximum$I(this.max);
this.myBar.setValue$I(nv);
if (this.note != null ) this.noteLabel = Clazz.new_((I$[9]||$incl$(9)).c$$S,[this.note]);
this.pane = Clazz.new_((I$[10]||$incl$(10)).c$$O, [this, null, Clazz.array(java.lang.Object, -1, [this.message, this.noteLabel, this.myBar])]);
this.dialog = this.pane.createDialog$java_awt_Component$S(this.parentComponent, (I$[7]||$incl$(7)).getString$O("ProgressMonitor.progressText"));
this.dialog.show();
}}}}});
...
var dialog;
var window = (I$[1]||$incl$(1)).getWindowForComponent$java_awt_Component(parentComponent);
if (Clazz.instanceOf(window, "java.awt.Frame")) {
dialog = Clazz.new_((I$[2]||$incl$(2)).c$$java_awt_Frame$S$Z,[window, title, false]);
} else {
dialog = Clazz.new_((I$[2]||$incl$(2)).c$$java_awt_Dialog$S$Z,[window, title, false]);
...
this.b$['javax.swing.ProgressMonitor.ProgressOptionPane'].setValue$O(this.this$0.cancelOption[0]);
});
...
), Clazz.new_((I$[5]||$incl$(5)), [this, null],P$.ProgressMonitor$ProgressOptionPane$1)));
...
), Clazz.new_((I$[6]||$incl$(6)).$init$, [this, {dialog: dialog}])));
return dialog;
});
