...
l=(l/(60)|0);
this.hours=(l == 0) ? null : $I$(6).valueOf$J(l % 24);
l=(l/(24)|0);
this.days=(l == 0) ? null : $I$(6).valueOf$J(l);
}, 1);
...
return (C$.getCalendarTimeInMillis$java_util_Calendar(cal)|0);
});
...
var diff=C$.getCalendarTimeInMillis$java_util_Calendar(c) - C$.getCalendarTimeInMillis$java_util_Calendar(startTimeInstant);
var days=(((diff/(86400000)|0))|0);
