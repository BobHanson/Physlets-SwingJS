(function(){var P$=Clazz.newPackage("javax.xml.bind.helpers"),I$=[[0,'java.util.ResourceBundle','java.text.MessageFormat']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
