...
public class Trail extends ComponentModifier
{
...
//------------------------------------------------------------------------------
    ...
    public void added() 
    {
        npoints = getProperties().trailLength.getValue(); 
...
//------------------------------------------------------------------------------
    ...
    {
        int tlen = getProperties().trailLength.getValue();
...
//------------------------------------------------------------------------------
    ...
    public void paintFg( SceneGraphics g ) 
    {
        ...
        {
            if ( color == null )
                g.setColor( getProperties().trailFg.getValue() );
            else
                g.setColor( color );

//REMIND: should we optimize this (in case of VERY long trails)?
...
//------------------------------------------------------------------------------
    ...
    {
        DataElement tdata = data.newElement( "trail" );
