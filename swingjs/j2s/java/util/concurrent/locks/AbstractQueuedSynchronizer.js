(function(){var P$=Clazz.newPackage("java.util.concurrent.locks"),p$1={},p$2={},I$=[[0,['java.util.concurrent.locks.AbstractQueuedSynchronizer','.Node'],'Thread','java.util.concurrent.locks.LockSupport','java.util.ArrayList']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
var C$=Clazz.newClass(P$, "AbstractQueuedSynchronizer", function(){
...
var t=this.tail;
if (t == null ) {
if (p$2.compareAndSetHead$java_util_concurrent_locks_AbstractQueuedSynchronizer_Node.apply(this, [Clazz.new_($I$(1))])) this.tail=this.head;
} else {
node.prev=t;
...
var node=Clazz.new_($I$(1).c$$Thread$java_util_concurrent_locks_AbstractQueuedSynchronizer_Node,[$I$(2).currentThread$(), mode]);
var pred=this.tail;
if (pred != null ) {
node.prev=pred;
...
if (C$.shouldParkAfterFailedAcquire$java_util_concurrent_locks_AbstractQueuedSynchronizer_Node$java_util_concurrent_locks_AbstractQueuedSynchronizer_Node(p, node) && nanosTimeout > 1000 ) $I$(3).parkNanos$O$J(this, nanosTimeout);
...
;
(function(){var C$=Clazz.newClass(P$.AbstractQueuedSynchronizer, "Node", function(){
...
;
(function(){var C$=Clazz.newClass(P$.AbstractQueuedSynchronizer, "ConditionObject", function(){
...
} while (!this.this$0.transferForSignal$java_util_concurrent_locks_AbstractQueuedSynchronizer_Node.apply(this.this$0, [first]) && (first=this.firstWaiter) != null  );
}, p$1);
...
first.nextWaiter=null;
this.this$0.transferForSignal$java_util_concurrent_locks_AbstractQueuedSynchronizer_Node.apply(this.this$0, [first]);
first=next;
} while (first != null );
}, p$1);
...
var savedState=this.this$0.fullyRelease$java_util_concurrent_locks_AbstractQueuedSynchronizer_Node.apply(this.this$0, [node]);
var interrupted=false;
while (!this.this$0.isOnSyncQueue$java_util_concurrent_locks_AbstractQueuedSynchronizer_Node.apply(this.this$0, [node])){
$I$(3).park$O(this);
if ($I$(2).interrupted$()) interrupted=true;
}
if (this.this$0.acquireQueued$java_util_concurrent_locks_AbstractQueuedSynchronizer_Node$I.apply(this.this$0, [node, savedState]) || interrupted ) P$.AbstractQueuedSynchronizer.selfInterrupt$();
});

Clazz.newMeth(C$, 'checkInterruptWhileWaiting$java_util_concurrent_locks_AbstractQueuedSynchronizer_Node', function (node) {
return $I$(2).interrupted$() ? (this.this$0.transferAfterCancelledWait$java_util_concurrent_locks_AbstractQueuedSynchronizer_Node.apply(this.this$0, [node]) ? -1 : 1) : 0;
}, p$1);
...
if (interruptMode == -1) throw Clazz.new_(Clazz.load('InterruptedException'));
 else if (interruptMode == 1) P$.AbstractQueuedSynchronizer.selfInterrupt$();
}, p$1);
...
if (this.this$0.acquireQueued$java_util_concurrent_locks_AbstractQueuedSynchronizer_Node$I.apply(this.this$0, [node, savedState]) && interruptMode != -1 ) interruptMode=1;
...
while (!this.this$0.isOnSyncQueue$java_util_concurrent_locks_AbstractQueuedSynchronizer_Node.apply(this.this$0, [node])){
if (nanosTimeout <= 0) {
this.this$0.transferAfterCancelledWait$java_util_concurrent_locks_AbstractQueuedSynchronizer_Node.apply(this.this$0, [node]);
break;
...
timedout=this.this$0.transferAfterCancelledWait$java_util_concurrent_locks_AbstractQueuedSynchronizer_Node.apply(this.this$0, [node]);
break;
...
;Clazz.setTVer('3.2.4.07');//Created 2019-06-16 21:47:09 Java2ScriptVisitor version 3.2.4.07 net.sf.j2s.core.jar version 3.2.4.07
