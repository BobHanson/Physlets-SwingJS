(function(){var P$=Clazz.newPackage("javax.imageio"),I$=[['java.awt.Point']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
this.sourceBands = null;
this.destinationType = null;
this.destinationOffset = Clazz.new_((I$[1]||$incl$(1)).c$$I$I,[0, 0]);
this.defaultController = null;
this.controller = null;
}, 1);
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["sourceRegion.y < 0!"]);
}if (sourceRegion.width <= 0) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["sourceRegion.width <= 0!"]);
}if (sourceRegion.height <= 0) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["sourceRegion.height <= 0!"]);
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["sourceXSubsampling <= 0!"]);
}if (sourceYSubsampling <= 0) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["sourceYSubsampling <= 0!"]);
}if (subsamplingXOffset < 0 || subsamplingXOffset >= sourceXSubsampling ) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["subsamplingXOffset out of range!"]);
}if (subsamplingYOffset < 0 || subsamplingYOffset >= sourceYSubsampling ) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["subsamplingYOffset out of range!"]);
}if (this.sourceRegion != null ) {
...
if (band < 0) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Band value < 0!"]);
