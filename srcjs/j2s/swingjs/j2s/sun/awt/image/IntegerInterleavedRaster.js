...
p$.setIntInterRaster$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Rectangle$java_awt_Point$sun_awt_image_IntegerInterleavedRaster.apply(this, [sampleModel, sampleModel.createDataBuffer(), Clazz.new_((I$[1]||$incl$(1)).c$$I$I$I$I,[origin.x, origin.y, sampleModel.getWidth(), sampleModel.getHeight()]), origin, null]);
}, 1);
...
p$.setIntInterRaster$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Rectangle$java_awt_Point$sun_awt_image_IntegerInterleavedRaster.apply(this, [sampleModel, dataBuffer, Clazz.new_((I$[1]||$incl$(1)).c$$I$I$I$I,[origin.x, origin.y, sampleModel.getWidth(), sampleModel.getHeight()]), origin, null]);
});
...
Clazz.super_(C$, this,1);
p$.setIntInterRaster$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Rectangle$java_awt_Point$sun_awt_image_IntegerInterleavedRaster.apply(this, [sampleModel, dataBuffer, aRegion, origin, parent]);
}, 1);
