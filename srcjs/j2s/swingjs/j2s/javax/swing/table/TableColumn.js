(function(){var P$=Clazz.newPackage("javax.swing.table"),I$=[['Boolean','javax.swing.event.SwingPropertyChangeSupport','java.beans.PropertyChangeListener','javax.swing.UIManager','javax.swing.table.DefaultTableCellRenderer']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
if (oldValue != newValue ) {
p$.firePropertyChange$S$O$O.apply(this, [propertyName, (I$[1]||$incl$(1)).$valueOf(oldValue), (I$[1]||$incl$(1)).$valueOf(newValue)]);
}});
...
this.setBorder$javax_swing_border_Border((I$[4]||$incl$(4)).getBorder$O("TableHeader.cellBorder"));
return this;
});
})()
), Clazz.new_((I$[5]||$incl$(5)), [this, null],P$.TableColumn$1));
