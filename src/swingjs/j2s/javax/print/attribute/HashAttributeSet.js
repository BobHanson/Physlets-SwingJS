(function(){var P$=Clazz.newPackage("javax.print.attribute"),I$=[['java.util.HashMap','javax.print.attribute.Attribute','javax.print.attribute.AttributeSetUtilities']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.c$$Class.apply(this, [Clazz.getClass((I$[2]||$incl$(2)),['getCategory','getName'])]);
}, 1);

Clazz.newMeth(C$, 'c$$javax_print_attribute_Attribute', function (attribute) {
C$.c$$javax_print_attribute_Attribute$Class.apply(this, [attribute, Clazz.getClass((I$[2]||$incl$(2)),['getCategory','getName'])]);
}, 1);

Clazz.newMeth(C$, 'c$$javax_print_attribute_AttributeA', function (attributes) {
C$.c$$javax_print_attribute_AttributeA$Class.apply(this, [attributes, Clazz.getClass((I$[2]||$incl$(2)),['getCategory','getName'])]);
}, 1);

Clazz.newMeth(C$, 'c$$javax_print_attribute_AttributeSet', function (attributes) {
C$.c$$javax_print_attribute_AttributeSet$Class.apply(this, [attributes, Clazz.getClass((I$[2]||$incl$(2)),['getCategory','getName'])]);
}, 1);
...
return this.attrMap.get$O((I$[3]||$incl$(3)).verifyAttributeCategory$O$Class(category, Clazz.getClass((I$[2]||$incl$(2)),['getCategory','getName'])));
});

Clazz.newMeth(C$, 'add$javax_print_attribute_Attribute', function (attribute) {
var oldAttribute = this.attrMap.put$TK$TV(attribute.getCategory(), (I$[3]||$incl$(3)).verifyAttributeValue$O$Class(attribute, this.myInterface));
return (!attribute.equals$O(oldAttribute));
});

Clazz.newMeth(C$, 'remove$Class', function (category) {
return category != null  && (I$[3]||$incl$(3)).verifyAttributeCategory$O$Class(category, Clazz.getClass((I$[2]||$incl$(2)),['getCategory','getName'])) != null   && this.attrMap.remove$O(category) != null  ;
});
...
return category != null  && (I$[3]||$incl$(3)).verifyAttributeCategory$O$Class(category, Clazz.getClass((I$[2]||$incl$(2)),['getCategory','getName'])) != null   && this.attrMap.get$O(category) != null  ;
});
...
var attrs = Clazz.array((I$[2]||$incl$(2)), [this.size()]);
