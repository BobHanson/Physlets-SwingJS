(function(){var P$=Clazz.newPackage("javax.swing.tree"),I$=[['javax.swing.event.EventListenerList','javax.swing.tree.TreeNode','javax.swing.event.TreeModelListener','javax.swing.event.TreeModelEvent']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
this.listenerList.add$Class$TT(Clazz.getClass((I$[3]||$incl$(3)),['treeNodesChanged$javax_swing_event_TreeModelEvent','treeNodesInserted$javax_swing_event_TreeModelEvent','treeNodesRemoved$javax_swing_event_TreeModelEvent','treeStructureChanged$javax_swing_event_TreeModelEvent']), l);
});

Clazz.newMeth(C$, 'removeTreeModelListener$javax_swing_event_TreeModelListener', function (l) {
this.listenerList.remove$Class$TT(Clazz.getClass((I$[3]||$incl$(3)),['treeNodesChanged$javax_swing_event_TreeModelEvent','treeNodesInserted$javax_swing_event_TreeModelEvent','treeNodesRemoved$javax_swing_event_TreeModelEvent','treeStructureChanged$javax_swing_event_TreeModelEvent']), l);
});

Clazz.newMeth(C$, 'getTreeModelListeners', function () {
return this.listenerList.getListeners$Class(Clazz.getClass((I$[3]||$incl$(3)),['treeNodesChanged$javax_swing_event_TreeModelEvent','treeNodesInserted$javax_swing_event_TreeModelEvent','treeNodesRemoved$javax_swing_event_TreeModelEvent','treeStructureChanged$javax_swing_event_TreeModelEvent']));
});
