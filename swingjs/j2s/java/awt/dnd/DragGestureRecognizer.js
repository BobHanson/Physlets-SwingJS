(function(){var P$=Clazz.newPackage("java.awt.dnd"),I$=[[0,'java.util.ArrayList','java.awt.dnd.DragGestureEvent']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
...
this.events=Clazz.new_($I$(1).c$$I,[1]);
}, 1);
...
this.dragGestureListener.dragGestureRecognized$(Clazz.new_($I$(2).c$$java_awt_dnd_DragGestureRecognizer$I$java_awt_Point$java_util_List,[this, dragAction, p, this.events]));
}} finally {
this.events.clear$();
}
});
...
;Clazz.setTVer('3.2.4.07');//Created 2019-06-16 22:44:32 Java2ScriptVisitor version 3.2.4.07 net.sf.j2s.core.jar version 3.2.4.07
