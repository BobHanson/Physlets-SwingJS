...
var C$=Clazz.newClass(P$, "Checkbox", null, 'swingjs.a2s.Checkbox');
...
C$.superclazz.c$$S$Z$java_awt_CheckboxGroup.apply(this, [label, state, group]);
C$.$init$.apply(this);
}, 1);
...
;Clazz.setTVer('3.2.4.07');//Created 2019-06-16 22:44:39 Java2ScriptVisitor version 3.2.4.07 net.sf.j2s.core.jar version 3.2.4.07
