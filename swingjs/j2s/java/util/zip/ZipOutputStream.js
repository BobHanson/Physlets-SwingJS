...
p$1.writeEND$J$J.apply(this, [off, this.written - off]);
this.finished=true;
});
...
if (size == 4294967295) p$1.writeLong$J.apply(this, [e.size]);
if (csize == 4294967295) p$1.writeLong$J.apply(this, [e.csize]);
if (offset == 4294967295) p$1.writeLong$J.apply(this, [entry.offset]);
}if (e.extra != null ) {
p$1.writeBytes$BA$I$I.apply(this, [e.extra, 0, e.extra.length]);
