(function(){var P$=Clazz.newPackage("java.nio"),I$=[[0,'java.nio.HeapDoubleBuffer','StringBuffer']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
var C$=Clazz.newClass(P$, "DoubleBuffer", null, 'java.nio.Buffer', 'Comparable');
...
try {
return Clazz.new_($I$(1).c$$DA$I$I,[array, offset, length]);
} catch (x) {
...
Clazz.newMeth(C$, ['compareTo$java_nio_DoubleBuffer','compareTo$','compareTo$TT'], function (that) {
