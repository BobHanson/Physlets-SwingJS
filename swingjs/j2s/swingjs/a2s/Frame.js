(function(){var P$=Clazz.newPackage("swingjs.a2s"),I$=[[0,'swingjs.a2s.A2SListener','swingjs.a2s.Util','java.awt.event.WindowAdapter']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
...
(function(){var C$=Clazz.newClass(P$, "Frame$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load('java.awt.event.WindowAdapter'), null, 1);
...
), Clazz.new_($I$(3), [this, null],P$.Frame$1)));
}, 1);
