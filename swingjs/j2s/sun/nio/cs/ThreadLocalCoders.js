(function(){var P$=Clazz.newPackage("sun.nio.cs"),p$1={},I$=[[0,'java.nio.charset.Charset',['sun.nio.cs.ThreadLocalCoders','.Cache']]],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
var C$=Clazz.newClass(P$, "ThreadLocalCoders", function(){
...
(function(){var C$=Clazz.newClass(P$, "ThreadLocalCoders$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load(['sun.nio.cs.ThreadLocalCoders','.Cache']), null, 1);
...
), Clazz.new_($I$(2).c$$I, [this, null, 3],P$.ThreadLocalCoders$1));
C$.encoderCache=((P$.ThreadLocalCoders$2||
(function(){var C$=Clazz.newClass(P$, "ThreadLocalCoders$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load(['sun.nio.cs.ThreadLocalCoders','.Cache']), null, 1);
...
), Clazz.new_($I$(2).c$$I, [this, null, 3],P$.ThreadLocalCoders$2));
}
...
;
(function(){var C$=Clazz.newClass(P$.ThreadLocalCoders, "Cache", function(){
