(function(){var P$=Clazz.newPackage("javax.swing.text"),I$=[['javax.swing.text.StyleConstants','javax.swing.text.StateInvariantError','java.awt.Toolkit']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
this.setSubscript$Z((I$[1]||$incl$(1)).isSubscript$javax_swing_text_AttributeSet(attr));
} else {
throw Clazz.new_((I$[2]||$incl$(2)).c$$S,["LabelView needs StyledDocument"]);
}}});

Clazz.newMeth(C$, 'getFontMetrics', function () {
this.sync();
var c = this.getContainer();
return (c != null ) ? c.getFontMetrics$java_awt_Font(this.font) : (I$[3]||$incl$(3)).getDefaultToolkit().getFontMetrics$java_awt_Font(this.font);
});
