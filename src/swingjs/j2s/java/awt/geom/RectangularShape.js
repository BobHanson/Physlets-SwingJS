(function(){var P$=Clazz.newPackage("java.awt.geom"),I$=[[['java.awt.geom.Rectangle2D','.Double'],'java.awt.Rectangle','java.awt.geom.FlatteningPathIterator','java.lang.InternalError']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
return Clazz.new_((I$[1]||$incl$(1)).c$$D$D$D$D,[this.getX(), this.getY(), this.getWidth(), this.getHeight()]);
});
...
return Clazz.new_((I$[2]||$incl$(2)).c$$I$I$I$I,[(x1|0), (y1|0), ((x2 - x1)|0), ((y2 - y1)|0)]);
});

Clazz.newMeth(C$, 'getPathIterator$java_awt_geom_AffineTransform$D', function (at, flatness) {
return Clazz.new_((I$[3]||$incl$(3)).c$$java_awt_geom_PathIterator$D,[this.getPathIterator$java_awt_geom_AffineTransform(at), flatness]);
});
