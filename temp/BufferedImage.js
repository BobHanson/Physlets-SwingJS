...
case 1:
{
this.colorModel=Clazz.new_(Clazz.load('java.awt.image.DirectColorModel').c$$I$I$I$I$I,[24, 16711680, 65280, 255, 0]);
...
case 2:
{
this.colorModel=Clazz.load('java.awt.image.ColorModel').getRGBdefault$();
this.raster=this.colorModel.createCompatibleWritableRaster$I$I(width, height);
this.raster.setImage$java_awt_image_BufferedImage(this);
this._pix=(this.raster.getDataBuffer$()).data;
}break;
...
this.properties=Clazz.new_(Clazz.load('java.util.Hashtable'));
}this.osis=Clazz.new_(Clazz.load('sun.awt.image.OffScreenImageSource').c$$java_awt_image_BufferedImage$java_util_Hashtable,[this, this.properties]);
}return this.osis;
});
...
return Clazz.load('java.awt.Image').UndefinedProperty;
...
var env=Clazz.load('java.awt.GraphicsEnvironment').getLocalGraphicsEnvironment$();
...
var wr=Clazz.load('java.awt.image.Raster').createWritableRaster$java_awt_image_SampleModel$java_awt_Point(this.raster.getSampleModel$(), Clazz.new_(Clazz.load('java.awt.Point').c$$I$I,[this.raster.getSampleModelTranslateX$(), this.raster.getSampleModelTranslateY$()]));
var tdata=null;
this.checkHavePixels$();
...
var tdata=null;
var rclip=Clazz.new_(Clazz.load('java.awt.Rectangle').c$$I$I$I$I,[startX, startY, width, height]);
...
if (canvas == null ) canvas=Clazz.load('swingjs.api.js.DOMNode').createElement("canvas", null);
var w=this.width;
var h=this.height;
var data=null;
{
...
this._canvas=canvas;
var pix=this._pix;
this._g=Clazz.new_(Clazz.load('swingjs.JSGraphics2D').c$$O,[canvas]);
...
;Clazz.setTVer('3.2.4.00');//Created 2018-10-23 14:02:51 Java2ScriptVisitor version 3.2.4.00 net.sf.j2s.core.jar version 3.2.4.00
