(function(){var P$=Clazz.newPackage("javax.swing"),I$=[['javax.swing.ArrayTable','javax.swing.KeyStroke','java.util.HashMap']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
if (this.arrayTable == null ) {
return null;
}var keys = Clazz.array((I$[2]||$incl$(2)), [this.arrayTable.size()]);
...
return pKeys;
}var keyMap = Clazz.new_((I$[3]||$incl$(3)));
var counter;
...
var allKeys = Clazz.array((I$[2]||$incl$(2)), [keyMap.size()]);
