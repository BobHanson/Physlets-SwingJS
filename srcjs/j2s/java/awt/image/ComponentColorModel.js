(function(){var P$=Clazz.newPackage("java.awt.image"),I$=[['java.awt.image.DataBuffer','java.util.Arrays','java.awt.image.Raster','java.awt.image.ComponentSampleModel']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
var numBits = (I$[1]||$incl$(1)).getDataTypeSize$I(transferType);
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["More than one component per pixel"]);
}if (this.signed) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Component value is signed"]);
...
return p$.getRGBComponent$I$I.apply(this, [pixel, 0]);
});

Clazz.newMeth(C$, 'getGreen$I', function (pixel) {
return p$.getRGBComponent$I$I.apply(this, [pixel, 1]);
});

Clazz.newMeth(C$, 'getBlue$I', function (pixel) {
return p$.getRGBComponent$I$I.apply(this, [pixel, 2]);
});
...
return p$.extractComponent$O$I$I.apply(this, [inData, idx, 8]);
} else if (this.is_LinearRGB_stdScale) {
var lutidx = p$.extractComponent$O$I$I.apply(this, [inData, idx, 16]);
return this.tosRGB8LUT[lutidx] & 255;
} else if (this.is_ICCGray_stdScale) {
var lutidx = p$.extractComponent$O$I$I.apply(this, [inData, 0, 16]);
return this.tosRGB8LUT[lutidx] & 255;
...
return p$.getRGBComponent$O$I.apply(this, [inData, 0]);
});

Clazz.newMeth(C$, 'getGreen$O', function (inData) {
return p$.getRGBComponent$O$I.apply(this, [inData, 1]);
});

Clazz.newMeth(C$, 'getBlue$O', function (inData) {
return p$.getRGBComponent$O$I.apply(this, [inData, 2]);
});
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["This method has not been " + "implemented for transferType " + this.transferType ]);
});
...
}throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["This model returns " + this.numComponents + " elements in the pixel array." ]);
});
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Component array too small" + " (should be " + this.numComponents ]);
}switch (this.transferType) {
case 3:
{
var pixel;
...
return null;
default:
return Clazz.new_((I$[4]||$incl$(4)).c$$I$I$I$I$I$IA,[this.transferType, w, h, this.numComponents, w * this.numComponents, bandOffsets]);
}
});
