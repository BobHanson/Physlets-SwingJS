...
try {
if (this.getWidth() > 0) this.b$['a2s.Applet'].paintMe$java_awt_Graphics(g);
} catch (e) {
...
Clazz.newMeth(C$, 'paintMe$java_awt_Graphics', function (g) {
if (!this.paintMeNotified) {
System.out.println$S("paintMe has not been implemented for " + this);
