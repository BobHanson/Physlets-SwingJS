...
this.quantum = (I$[4]||$incl$(4)).newInt2$I(2);
this.divisors = (I$[4]||$incl$(4)).newDouble2$I(2);
...
C$.$init$.apply(this);
p$.initMatrix$I.apply(this, [quality]);
}, 1);
...
for (var i = 0, index = 0; i < 8; i++) for (var j = 0; j < 8; j++, index++) outputData[index] = ((Math.round(inputData[i][j] * divisorsCode[index]))|0);
