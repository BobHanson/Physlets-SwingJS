(function(){var P$=Clazz.newPackage("javax.swing.table"),I$=[['java.util.Vector']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
var v = Clazz.new_((I$[1]||$incl$(1)).c$$I,[size]);
v.setSize$I(size);
return v;
}, 1);
...
return (v != null ) ? v : Clazz.new_((I$[1]||$incl$(1)));
}, 1);
...
this.dataVector.setElementAt$TE$I(Clazz.new_((I$[1]||$incl$(1))), i);
...
if (anArray == null ) {
return null;
}var v = Clazz.new_((I$[1]||$incl$(1)).c$$I,[anArray.length]);
