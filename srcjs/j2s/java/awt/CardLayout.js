(function(){var P$=Clazz.newPackage("java.awt"),I$=[['java.io.ObjectStreamField','java.util.Hashtable','java.util.Vector','javajs.util.Lst',['java.awt.CardLayout','.Card'],'java.awt.Dimension']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.serialPersistentFields = Clazz.array((I$[1]||$incl$(1)), -1, [Clazz.new_((I$[1]||$incl$(1)).c$$S$Class,["tab", Clazz.getClass((I$[2]||$incl$(2)))]), Clazz.new_((I$[1]||$incl$(1)).c$$S$Class,["hgap", Integer.TYPE]), Clazz.new_((I$[1]||$incl$(1)).c$$S$Class,["vgap", Integer.TYPE]), Clazz.new_((I$[1]||$incl$(1)).c$$S$Class,["vector", Clazz.getClass((I$[3]||$incl$(3)))]), Clazz.new_((I$[1]||$incl$(1)).c$$S$Class,["currentCard", Integer.TYPE])]);
}
...
this.vector = Clazz.new_((I$[4]||$incl$(4)));
this.currentCard = 0;
}, 1);
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["cannot add to layout: constraint must be a string"]);
}}});
...
return Clazz.new_((I$[6]||$incl$(6)).c$$I$I,[2147483647, 2147483647]);
});
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["wrong parent for CardLayout"]);
}});
