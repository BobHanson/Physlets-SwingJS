(function(){var P$=Clazz.newPackage("javajs.util"),I$=[['javax.sound.sampled.AudioFormat','sun.audio.AudioPlayer','sun.audio.AudioDataStream','sun.audio.AudioData',['javax.sound.sampled.DataLine','.Info'],'javax.sound.sampled.SourceDataLine','javax.sound.sampled.AudioSystem']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
(I$[2]||$incl$(2)).player.start$java_io_InputStream(Clazz.new_((I$[3]||$incl$(3)).c$$sun_audio_AudioData,[Clazz.new_((I$[4]||$incl$(4)).c$$BA,[data])]));
});
