(function(){var P$=Clazz.newPackage("javax.swing.text"),I$=[[['javax.swing.text.StringContent','.PosRec'],['javax.swing.text.StringContent','.InsertUndo'],['javax.swing.text.StringContent','.RemoveUndo'],'java.util.Vector',['javax.swing.text.StringContent','.StickyPosition'],['javax.swing.text.StringContent','.UndoPosRef']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
}return Clazz.new_((I$[2]||$incl$(2)).c$$I$I, [this, null, where, str.length$()]);
});
...
var edit = Clazz.new_((I$[3]||$incl$(3)).c$$I$S, [this, null, where, removedString]);
...
var placeIn = (v == null ) ? Clazz.new_((I$[4]||$incl$(4))) : v;
for (var i = 0; i < n; i++) {
var mark = this.marks.elementAt$I(i);
if (mark.unused) {
this.marks.removeElementAt$I(i);
