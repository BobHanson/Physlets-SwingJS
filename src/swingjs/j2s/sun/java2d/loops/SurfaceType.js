...
C$.unusedUID = 1;
C$.surfaceUIDMap = Clazz.new_((I$[1]||$incl$(1)).c$$I,[100]);
C$.Any = Clazz.new_(C$.c$$sun_java2d_loops_SurfaceType$S$sun_awt_image_PixelConverter,[null, "Any Surface", (I$[2]||$incl$(2)).instance]);
...
C$.Custom = C$.Any;
C$.IntRgb = C$.AnyDcm.deriveSubType$S$sun_awt_image_PixelConverter("Integer RGB", (I$[3]||$incl$(3)).$instance);
C$.IntArgb = C$.AnyDcm.deriveSubType$S$sun_awt_image_PixelConverter("Integer ARGB", (I$[4]||$incl$(4)).$instance);
C$.IntArgbPre = C$.AnyDcm.deriveSubType$S$sun_awt_image_PixelConverter("Integer ARGB Premultiplied", (I$[5]||$incl$(5)).$instance);
C$.IntBgr = C$.AnyDcm.deriveSubType$S$sun_awt_image_PixelConverter("Integer BGR", (I$[6]||$incl$(6)).$instance);
C$.ThreeByteBgr = C$.Any3Byte.deriveSubType$S$sun_awt_image_PixelConverter("3 Byte BGR", (I$[3]||$incl$(3)).$instance);
C$.FourByteAbgr = C$.Any4Byte.deriveSubType$S$sun_awt_image_PixelConverter("4 Byte ABGR", (I$[7]||$incl$(7)).$instance);
C$.FourByteAbgrPre = C$.Any4Byte.deriveSubType$S$sun_awt_image_PixelConverter("4 Byte ABGR Premultiplied", (I$[8]||$incl$(8)).$instance);
C$.Ushort565Rgb = C$.AnyShort.deriveSubType$S$sun_awt_image_PixelConverter("Short 565 RGB", (I$[9]||$incl$(9)).$instance);
C$.Ushort555Rgb = C$.AnyShort.deriveSubType$S$sun_awt_image_PixelConverter("Short 555 RGB", (I$[10]||$incl$(10)).$instance);
C$.Ushort555Rgbx = C$.AnyShort.deriveSubType$S$sun_awt_image_PixelConverter("Short 555 RGBx", (I$[11]||$incl$(11)).$instance);
C$.Ushort4444Argb = C$.AnyShort.deriveSubType$S$sun_awt_image_PixelConverter("Short 4444 ARGB", (I$[12]||$incl$(12)).$instance);
C$.UshortIndexed = C$.AnyShort.deriveSubType$S("16-bit Indexed");
C$.ByteGray = C$.AnyByte.deriveSubType$S$sun_awt_image_PixelConverter("8-bit Gray", (I$[13]||$incl$(13)).$instance);
C$.UshortGray = C$.AnyShort.deriveSubType$S$sun_awt_image_PixelConverter("16-bit Gray", (I$[14]||$incl$(14)).$$instance);
...
C$.IntRgbx = C$.AnyDcm.deriveSubType$S$sun_awt_image_PixelConverter("Integer RGBx", (I$[15]||$incl$(15)).$instance);
C$.IntBgrx = C$.AnyDcm.deriveSubType$S$sun_awt_image_PixelConverter("Integer BGRx", (I$[16]||$incl$(16)).$instance);
C$.ThreeByteRgb = C$.Any3Byte.deriveSubType$S$sun_awt_image_PixelConverter("3 Byte RGB", (I$[6]||$incl$(6)).$instance);
C$.IntArgbBm = C$.AnyDcm.deriveSubType$S$sun_awt_image_PixelConverter("Int ARGB (Bitmask)", (I$[17]||$incl$(17)).$instance);
