(function(){var P$=Clazz.newPackage("javax.swing"),I$=[[['javax.swing.MultiUIDefaults','.MultiUIDefaultsEnumerator','.Type'],'javax.swing.UIDefaults',['javax.swing.MultiUIDefaults','.MultiUIDefaultsEnumerator'],'java.util.HashSet','java.lang.StringBuffer']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
return Clazz.new_((I$[3]||$incl$(3)).c$$javax_swing_MultiUIDefaults_MultiUIDefaultsEnumerator_Type$java_util_Set,[(I$[1]||$incl$(1)).KEYS, this.entrySet()]);
});

Clazz.newMeth(C$, 'elements', function () {
return Clazz.new_((I$[3]||$incl$(3)).c$$javax_swing_MultiUIDefaults_MultiUIDefaultsEnumerator_Type$java_util_Set,[(I$[1]||$incl$(1)).ELEMENTS, this.entrySet()]);
});
...
switch (this.type) {
case (I$[1]||$incl$(1)).KEYS:
return this.iterator.next().getKey();
case (I$[1]||$incl$(1)).ELEMENTS:
