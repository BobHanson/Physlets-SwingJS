(function(){var P$=Clazz.newPackage("javax.swing.colorchooser"),I$=[['javax.swing.SwingUtilities','javax.swing.JColorChooser','java.awt.Dimension','java.awt.Color']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
return (I$[1]||$incl$(1)).getAncestorOfClass$Class$java_awt_Component(Clazz.getClass((I$[2]||$incl$(2))), this);
});
...
return Clazz.new_((I$[3]||$incl$(3)).c$$I$I,[x, y]);
});
...
g.setColor$java_awt_Color((I$[4]||$incl$(4)).white);
