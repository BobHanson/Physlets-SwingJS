(function(){var P$=Clazz.newPackage("swingjs.plaf"),I$=[['javax.swing.text.DefaultEditorKit','javax.swing.UIManager','swingjs.JSToolkit','swingjs.plaf.JSCaret','swingjs.JSKeyEvent','javax.swing.SwingUtilities','javax.swing.plaf.InputMapUIResource','javax.swing.plaf.ActionMapUIResource','swingjs.plaf.TextListener','swingjs.api.js.DOMNode']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
switch (eventType) {
case 401:
var keyEvent = (I$[5]||$incl$(5)).newJSKeyEvent$javax_swing_JComponent$O$Z(this.jc, jQueryEvent, false);
if (keyEvent == null ) return true;
this.jc.dispatchEvent$java_awt_AWTEvent(keyEvent);
...
return this.textListener.handleJSTextEvent$swingjs_plaf_JSTextUI$I$O(this, eventType, jQueryEvent);
});
...
if (km != null ) {
(I$[6]||$incl$(6)).replaceUIInputMap$javax_swing_JComponent$I$javax_swing_InputMap(this.editor, 0, km);
}var map = this.getActionMap();
if (map != null ) {
(I$[6]||$incl$(6)).replaceUIActionMap$javax_swing_JComponent$javax_swing_ActionMap(this.editor, map);
}});
...
(I$[6]||$incl$(6)).replaceUIInputMap$javax_swing_JComponent$I$javax_swing_InputMap(this.editor, 2, null);
(I$[6]||$incl$(6)).replaceUIActionMap$javax_swing_JComponent$javax_swing_ActionMap(this.editor, null);
});
