(function(){var P$=Clazz.newPackage("java.text"),I$=[['java.math.RoundingMode','java.lang.InternalError','java.lang.StringBuffer']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
this.roundingMode = (I$[1]||$incl$(1)).HALF_EVEN;
this.isNegative = false;
}, 1);
...
if (this.count == 0) {
return 0.0;
}var temp = p$.getStringBuffer.apply(this, []);
temp.append$C(".");
...
if (this.count == 0) {
return 0;
}if (p$.isLongMIN_VALUE.apply(this, [])) {
...
this.set$Z$S$I$Z(isNegative, Double.toString(source), maximumDigits, fixedPoint);
});
...
p$.round$I.apply(this, [fixedPoint ? (maximumDigits + this.decimalAt) : maximumDigits]);
});

Clazz.newMeth(C$, 'round$I', function (maximumDigits) {
if (maximumDigits >= 0 && maximumDigits < this.count ) {
if (p$.shouldRoundUp$I.apply(this, [maximumDigits])) {
for (; ; ) {
--maximumDigits;
if (maximumDigits < 0) {
this.digits[0] = "1";
...
break;
case (I$[1]||$incl$(1)).DOWN:
break;
case (I$[1]||$incl$(1)).CEILING:
for (var i = maximumDigits; i < this.count; ++i) {
if (this.digits[i] != "0") {
return !this.isNegative;
}}
break;
case (I$[1]||$incl$(1)).FLOOR:
for (var i = maximumDigits; i < this.count; ++i) {
if (this.digits[i] != "0") {
return this.isNegative;
}}
break;
case (I$[1]||$incl$(1)).HALF_UP:
if (this.digits[maximumDigits] >= "5") {
return true;
}break;
case (I$[1]||$incl$(1)).HALF_DOWN:
if (this.digits[maximumDigits] > "5") {
return true;
...
case (I$[1]||$incl$(1)).UNNECESSARY:
for (var i = maximumDigits; i < this.count; ++i) {
if (this.digits[i] != "0") {
throw Clazz.new_(Clazz.load('java.lang.ArithmeticException').c$$S,["Rounding needed with the rounding mode being set to RoundingMode.UNNECESSARY"]);
}}
break;
default:
...
if (this.isZero()) {
return "0";
}var buf = p$.getStringBuffer.apply(this, []);
buf.append$S("0.");
