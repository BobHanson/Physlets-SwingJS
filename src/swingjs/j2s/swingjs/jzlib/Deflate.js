...
this.matches++;
dist--;
($s$[0]=this.dyn_ltree[$k$=((I$[2]||$incl$(2))._length_code[lc] + 256 + 1 ) * 2],this.dyn_ltree[$k$]=(++$s$[0],$s$[0]));
($s$[0]=this.dyn_dtree[$k$=(I$[2]||$incl$(2)).d_code$I(dist) * 2],this.dyn_dtree[$k$]=(++$s$[0],$s$[0]));
...
out_length+=this.dyn_dtree[dcode * 2] * (5 + (I$[2]||$incl$(2)).extra_dbits[dcode]);
}
out_length>>>=3;
...
if (extra != 0) {
lc-=(I$[2]||$incl$(2)).base_length[code];
...
if (extra != 0) {
dist-=(I$[2]||$incl$(2)).base_dist[code];
