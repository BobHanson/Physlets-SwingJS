...
bos=Clazz.new_($I$(4));
bos.write$BA$I$I(this._file.秘bytes, 0, this._file.秘bytes.length);
...
this.秘bytes=this.out.toByteArray$();
if (this._file != null  && this.秘bytes != null  ) this._file.秘bytes=this.秘bytes;
