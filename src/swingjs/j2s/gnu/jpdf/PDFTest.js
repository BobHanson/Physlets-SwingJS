...
this.pane = Clazz.new_((I$[1]||$incl$(1)));
}, 1);
...
var toolkit = (I$[11]||$incl$(11)).getDefaultToolkit();
...
p$.doTest$java_awt_Graphics$java_awt_Dimension.apply(this, [javaGraphics, d]);
...
p$.printPdf.apply(this, []);
return;
}if (source === this.menuBar.helpTopics ) {
System.out.println$S("Help..");
p$.showHelp.apply(this, []);
return;
}if (source === this.menuBar.aboutApp ) {
System.out.println$S("About...");
p$.showAboutBox.apply(this, []);
return;
}if (source === this.menuBar.viewFirstPage ) {
if (this.currentPage != 1) {
p$.doFirstPage$java_awt_Graphics.apply(this, [null]);
return;
}}if (source === this.menuBar.viewSecondPage ) {
if (this.currentPage != 2) {
p$.doSecondPage.apply(this, []);
return;
}}});

Clazz.newMeth(C$, 'showAboutBox', function () {
(I$[12]||$incl$(12)).showMessageDialog$java_awt_Component$O(this, "gnujpdf test application, by Eric Z. Beard.  http://gnujpdf.sourceforge.net");
});

Clazz.newMeth(C$, 'showHelp', function () {
var helpFrame = Clazz.new_((I$[13]||$incl$(13)));
});

Clazz.newMeth(C$, 'printPdf', function () {
System.out.println$S("Printing...");
var jobAttributes = Clazz.new_((I$[14]||$incl$(14)));
var toolkit = (I$[11]||$incl$(11)).getDefaultToolkit();
var pjob = toolkit.getPrintJob$java_awt_Frame$S$java_awt_JobAttributes$java_awt_PageAttributes(this, "PDF Test Print", jobAttributes, null);
if (pjob != null ) {
var printGraphics = pjob.getGraphics();
if (this.currentPage == 1) {
p$.doTest$java_awt_Graphics$java_awt_Dimension.apply(this, [printGraphics, this.documentDimension]);
printGraphics.dispose();
pjob.end();
} else {
p$.doSecondPageTest$java_awt_Graphics.apply(this, [printGraphics]);
printGraphics.dispose();
pjob.end();
}} else {
...
g.setColor$java_awt_Color((I$[15]||$incl$(15)).white);
g.fillRect$I$I$I$I(0, 0, d.width, d.height);
g.setColor$java_awt_Color((I$[15]||$incl$(15)).black);
var boxUpperLeft = Clazz.new_((I$[16]||$incl$(16)).c$$I$I,[60, 60]);
var boxSize = Clazz.new_((I$[10]||$incl$(10)).c$$I$I,[200, 200]);
var f = Clazz.new_((I$[17]||$incl$(17)).c$$S$I$I,["TimesRoman", 0, 14]);
g.setFont$java_awt_Font(f);
var fm = g.getFontMetrics$java_awt_Font(f);
var box = Clazz.new_((I$[18]||$incl$(18)).c$$java_awt_Point$java_awt_Dimension,[boxUpperLeft, boxSize]);
...
var b1 = Clazz.new_((I$[18]||$incl$(18)).c$$java_awt_Point$java_awt_Dimension,[Clazz.new_((I$[16]||$incl$(16)).c$$I$I,[300, 60]), Clazz.new_((I$[10]||$incl$(10)).c$$I$I,[200, 200])]);
...
var b2 = Clazz.new_((I$[18]||$incl$(18)).c$$java_awt_Point$java_awt_Dimension,[Clazz.new_((I$[16]||$incl$(16)).c$$I$I,[10, 10]), Clazz.new_((I$[10]||$incl$(10)).c$$I$I,[100, 100])]);
...
p$.drawStringsInBox$java_awt_Graphics.apply(this, [g]);
p$.drawSampleImage$java_awt_Graphics$java_awt_Dimension.apply(this, [g, d]);
});

Clazz.newMeth(C$, 'drawStringsInBox$java_awt_Graphics', function (g) {
g.setColor$java_awt_Color((I$[15]||$incl$(15)).black);
var box = Clazz.new_((I$[18]||$incl$(18)).c$$java_awt_Point$java_awt_Dimension,[Clazz.new_((I$[16]||$incl$(16)).c$$I$I,[20, 300]), Clazz.new_((I$[10]||$incl$(10)).c$$I$I,[250, 250])]);
...
var f = Clazz.new_((I$[17]||$incl$(17)).c$$S$I$I,["Helvetica", 0, 12]);
g.setFont$java_awt_Font(f);
...
var tracker = Clazz.new_((I$[19]||$incl$(19)).c$$java_awt_Component,[this.drawingArea]);
...
g.drawImage$java_awt_Image$I$I$I$I$java_awt_Color$java_awt_image_ImageObserver(img, 10, 10, img.getWidth$java_awt_image_ImageObserver(this.drawingArea), img.getHeight$java_awt_image_ImageObserver(this.drawingArea), (I$[15]||$incl$(15)).green, this.drawingArea);
} catch (e) {
if (Clazz.exceptionOf(e, "java.lang.Exception")){
e.printStackTrace();
} else {
...
g.setColor$java_awt_Color((I$[15]||$incl$(15)).blue);
...
g.setColor$java_awt_Color((I$[15]||$incl$(15)).black);
var fonts = Clazz.array(java.lang.String, -1, ["SansSerif", "Monospaced", "TimesRoman", "Helvetica", "Courier", "Dialog", "DialogInput"]);
var modes = Clazz.array(java.lang.String, -1, ["Plain", "Bold", "Italic", "Bold+Italic"]);
