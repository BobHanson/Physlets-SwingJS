(function(){var P$=Clazz.newPackage("javax.swing"),I$=[['java.util.BitSet','javax.swing.event.EventListenerList','javax.swing.event.ListSelectionListener','javax.swing.event.ListSelectionEvent']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
this.value = Clazz.new_((I$[1]||$incl$(1)).c$$I,[32]);
...
this.listenerList.add$Class$TT(Clazz.getClass((I$[3]||$incl$(3)),['valueChanged$javax_swing_event_ListSelectionEvent']), l);
});

Clazz.newMeth(C$, 'removeListSelectionListener$javax_swing_event_ListSelectionListener', function (l) {
this.listenerList.remove$Class$TT(Clazz.getClass((I$[3]||$incl$(3)),['valueChanged$javax_swing_event_ListSelectionEvent']), l);
});

Clazz.newMeth(C$, 'getListSelectionListeners', function () {
return this.listenerList.getListeners$Class(Clazz.getClass((I$[3]||$incl$(3)),['valueChanged$javax_swing_event_ListSelectionEvent']));
});
