(function(){var P$=Clazz.newPackage("sun.awt"),I$=[['java.util.HashMap','java.awt.EventQueue','sun.awt.AppContext','sun.awt.PostEventQueue','Thread','sun.awt.AWTAutoShutdown','sun.awt.AWTAccessor','sun.awt.PeerEvent','java.awt.Toolkit','sun.awt.SunToolkit$1','java.awt.Dimension','sun.font.FontDesignMetrics']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.appContextMap = Clazz.new_((I$[1]||$incl$(1)));
C$.imgCache = Clazz.new_((I$[1]||$incl$(1)));
C$.startupLocale = null;
C$.dataTransfererClassName = null;
}
...
var eventQueue;
eventQueue = Clazz.new_((I$[2]||$incl$(2)));
var appContext = (I$[3]||$incl$(3)).getAppContext();
if (appContext != null ) {
appContext.put$O$O((I$[3]||$incl$(3)).EVENT_QUEUE_KEY, eventQueue);
var postEventQueue = Clazz.new_((I$[4]||$incl$(4)).c$$java_awt_EventQueue,[eventQueue]);
...
var appContext = Clazz.new_((I$[3]||$incl$(3)).c$$ThreadGroup,[threadGroup]);
appContext.put$O$O((I$[3]||$incl$(3)).EVENT_QUEUE_KEY, eventQueue);
var postEventQueue = Clazz.new_((I$[4]||$incl$(4)).c$$java_awt_EventQueue,[eventQueue]);
appContext.put$O$O("PostEventQueue", postEventQueue);
return appContext;
...
var pe = Clazz.new_((I$[8]||$incl$(8)).c$$O$Runnable$J,[(I$[9]||$incl$(9)).getDefaultToolkit(), ((
...
), Clazz.new_((I$[10]||$incl$(10)).$init$, [this, {e: e}])), 2]);
...
C$.executeOnEventHandlerThread$sun_awt_PeerEvent(Clazz.new_((I$[8]||$incl$(8)).c$$O$Runnable$J,[target, runnable, 1]));
}, 1);
...
), Clazz.new_((I$[8]||$incl$(8)).c$$O$Runnable$J, [this, {when: when}, target, runnable, 1],P$.SunToolkit$2)));
}, 1);
...
C$.postEvent$sun_awt_AppContext$java_awt_AWTEvent(appContext, Clazz.new_((I$[8]||$incl$(8)).c$$O$Runnable$J,[(I$[9]||$incl$(9)).getDefaultToolkit(), dispatcher, 1]));
}, 1);
...
return Clazz.new_((I$[11]||$incl$(11)).c$$I$I,[this.getScreenWidth(), this.getScreenHeight()]);
});
...
var hardwiredFontList = Clazz.array(java.lang.String, -1, ["Dialog", "SansSerif", "Serif", "Monospaced", "DialogInput"]);
...
Clazz.newMeth(C$, 'isLightweightOrUnknown$java_awt_Component', function (comp) {
