(function(){var P$=Clazz.newPackage("sun.swing"),I$=[['java.util.LinkedList',['sun.swing.ImageCache','.Entry']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
var entry = p$.getEntry$O$java_awt_GraphicsConfiguration$I$I$OA.apply(this, [key, config, w, h, args]);
