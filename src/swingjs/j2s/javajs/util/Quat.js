(function(){var P$=Clazz.newPackage("javajs.util"),I$=[['javajs.util.P4','javajs.util.M3','javajs.util.A4','javajs.util.V3']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
var C$=Clazz.newClass(P$, "Quat");
C$.qZero = null;
var p$=C$.prototype;

C$.$clinit$ = function() {Clazz.load(C$, 1);
C$.qZero = Clazz.new_((I$[1]||$incl$(1)));
}
...
var q = Clazz.new_(C$);
q.setM$javajs_util_M3((I$[2]||$incl$(2)).newM3$javajs_util_M3(mat));
return q;
}, 1);
...
if (qref == null ) {
this.mul$F(p$.getFixFactor.apply(this, []));
return;
...
var vA = (I$[4]||$incl$(4)).newV$javajs_util_T3(x);
var vB = (I$[4]||$incl$(4)).newV$javajs_util_T3(xy);
if (center != null ) {
...
if (this.mat == null ) p$.setMatrix.apply(this, []);
return this.mat;
});
...
if (i == -1) {
scale *= p$.getFixFactor.apply(this, []);
return (I$[4]||$incl$(4)).new3$F$F$F(this.q1 * scale, this.q2 * scale, this.q3 * scale);
}if (this.mat == null ) p$.setMatrix.apply(this, []);
...
v.scale$F(p$.getFixFactor.apply(this, []));
return v;
});

Clazz.newMeth(C$, 'getRawNormal$javajs_util_Quat', function (q) {
var v = (I$[4]||$incl$(4)).new3$F$F$F(q.q1, q.q2, q.q3);
if (v.length$() == 0 ) return (I$[4]||$incl$(4)).new3$F$F$F(0, 0, 1);
v.normalize();
return v;
}, 1);
...
return (I$[1]||$incl$(1)).new4$F$F$F$F(this.q1, this.q2, this.q3, this.q0);
});
...
var mean = (I$[4]||$incl$(4)).new3$F$F$F(0, 0, 1);
