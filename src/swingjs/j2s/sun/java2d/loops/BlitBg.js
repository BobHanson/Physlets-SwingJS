(function(){var P$=Clazz.newPackage("sun.java2d.loops"),I$=[['java.awt.Font','sun.java2d.loops.RenderCache','sun.java2d.loops.GraphicsPrimitiveMgr',['sun.java2d.loops.BlitBg','.General'],['sun.java2d.loops.BlitBg','.TraceBlitBg']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.blitcache = Clazz.new_((I$[2]||$incl$(2)).c$$I,[20]);
{
(I$[3]||$incl$(3)).registerGeneral$sun_java2d_loops_GraphicsPrimitive(Clazz.new_(C$.c$$sun_java2d_loops_SurfaceType$sun_java2d_loops_CompositeType$sun_java2d_loops_SurfaceType,[null, null, null]));
}
;
}
...
return (I$[3]||$incl$(3)).locate$I$sun_java2d_loops_SurfaceType$sun_java2d_loops_CompositeType$sun_java2d_loops_SurfaceType(C$.primTypeID, srctype, comptype, dsttype);
}, 1);
...
return Clazz.new_((I$[4]||$incl$(4)).c$$sun_java2d_loops_SurfaceType$sun_java2d_loops_CompositeType$sun_java2d_loops_SurfaceType,[srctype, comptype, dsttype]);
});

Clazz.newMeth(C$, 'traceWrap', function () {
return Clazz.new_((I$[5]||$incl$(5)).c$$sun_java2d_loops_BlitBg,[this]);
});
;
...
C$.$clinit$ = function() {Clazz.load(C$, 1);
C$.defaultFont = Clazz.new_((I$[1]||$incl$(1)).c$$S$I$I,["Dialog", 0, 12]);
}
