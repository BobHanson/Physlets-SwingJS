(function(){var P$=Clazz.newPackage("javax.swing"),I$=[['java.lang.Boolean','javax.swing.ArrayTable','Boolean','javax.swing.event.SwingPropertyChangeSupport','java.beans.PropertyChangeListener']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
return (I$[1]||$incl$(1)).TRUE.equals(a.getValue$S("SwingSelectedKey"));
}, 1);
...
if (this.changeSupport == null ) {
return Clazz.array((I$[5]||$incl$(5)), [0]);
