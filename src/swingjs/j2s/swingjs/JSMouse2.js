(function(){var P$=Clazz.newPackage("swingjs"),I$=[['javajs.util.V3']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
var v1 = (I$[1]||$incl$(1)).new3$F$F$F(dx1, dy1, 0);
var d1 = v1.length$();
var t2first = t2[0];
...
var v2 = (I$[1]||$incl$(1)).new3$F$F$F(dx2, dy2, 0);
var d2 = v2.length$();
if (d1 < 1  || d2 < 1  ) return;
v1.normalize();
v2.normalize();
