(function(){var P$=Clazz.newPackage("sun.java2d.loops"),I$=[['java.lang.InternalError']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
return C$.AlphaXor;
default:
throw Clazz.new_((I$[1]||$incl$(1)).c$$S,["Unrecognized alpha rule"]);
}
}, 1);
...
if (C$.unusedUID > 255) {
throw Clazz.new_((I$[1]||$incl$(1)).c$$S,["composite type id overflow"]);
}return C$.unusedUID++;
}, 1);
