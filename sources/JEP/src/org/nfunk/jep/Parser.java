    ...
    try {
      ...
      case 0:
        jj_consume_token(0);
             jjtree.closeNodeScope(jjtn000, true);
             jjtc000 = false;
             {if (true) throw new ParseException(token, "No expression entered");} 
      default:
        jj_la1[0] = jj_gen;
        jj_consume_token(-1);
 ...
 /*@bgen(jjtree) Constant */
  ...
  private void jj_add_error_token(int kind, int pos) {
    ...
    if (pos == jj_endpos + 1) {
      ...
      for (java.util.Enumeration enumJJ = jj_expentries.elements(); enumJJ.hasMoreElements();) {
        int[] oldentry = (int[])(enumJJ.nextElement());
