(function(){var P$=Clazz.newPackage("java.awt.image"),I$=[['java.awt.RenderingHints','sun.awt.image.ImagingLib','java.awt.AlphaComposite',['java.awt.geom.Rectangle2D','.Float'],'java.awt.image.BufferedImage','java.lang.InternalError']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
try {
g.setComposite$java_awt_Composite((I$[3]||$incl$(3)).Src);
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Number of src bands (" + src.getNumBands() + ") does not match number of " + " dst bands (" + dst.getNumBands() + ")" ]);
}if ((I$[2]||$incl$(2)).filter$java_awt_image_RasterOp$java_awt_image_Raster$java_awt_image_WritableRaster(this, src, dst) == null ) {
