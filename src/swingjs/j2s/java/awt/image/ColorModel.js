(function(){var P$=Clazz.newPackage("java.awt.image"),I$=[['java.awt.color.ColorSpace','java.awt.image.DirectColorModel']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
this.colorSpace = (I$[1]||$incl$(1)).getInstance$I(1000);
...
if (this.nBits == null ) {
throw Clazz.new_(Clazz.load('java.lang.NullPointerException').c$$S,["Number of bits array is null."]);
...
throw Clazz.new_(Clazz.load('java.lang.UnsupportedOperationException').c$$S,["This method is not supported by this color model"]);
}});
...
throw Clazz.new_(Clazz.load('java.lang.UnsupportedOperationException').c$$S,["This method is not supported.  Unable to determine #bits per component."]);
...
throw Clazz.new_(Clazz.load('java.lang.UnsupportedOperationException').c$$S,["This method has not been implemented for this color model."]);
});
...
throw Clazz.new_(Clazz.load('java.lang.UnsupportedOperationException').c$$S,["This method has not been implemented for this ColorModel."]);
});
