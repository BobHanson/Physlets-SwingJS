...
C$.recognizer = null;
C$.cutAction = Clazz.new_((I$[13]||$incl$(13)).c$$S,["cut"]);
C$.copyAction = Clazz.new_((I$[13]||$incl$(13)).c$$S,["copy"]);
C$.pasteAction = Clazz.new_((I$[13]||$incl$(13)).c$$S,["paste"]);
}
...
action = 0;
}if (action != 0 && !(I$[14]||$incl$(14)).isHeadless() ) {
if (C$.recognizer == null ) {
C$.recognizer = Clazz.new_((I$[15]||$incl$(15)).c$$java_awt_dnd_DragGestureListener,[Clazz.new_((I$[16]||$incl$(16)))]);
...
if (Clazz.exceptionOf(ise, "java.lang.IllegalStateException")){
...
var prop = p$.getPropertyDescriptor$javax_swing_JComponent.apply(this, [comp]);
if (prop != null ) {
...
if (params.length != 1) {
return false;
}var flavor = p$.getPropertyDataFlavor$Class$java_awt_datatransfer_DataFlavorA.apply(this, [params[0], t.getTransferDataFlavors()]);
if (flavor != null ) {
try {
...
if (params.length != 1) {
return false;
}var flavor = p$.getPropertyDataFlavor$Class$java_awt_datatransfer_DataFlavorA.apply(this, [params[0], transferFlavors]);
if (flavor != null ) {
return true;
}}return false;
});
...
var prop = p$.getPropertyDescriptor$javax_swing_JComponent.apply(this, [c]);
if (prop != null ) {
return 1;
}return 0;
});
...
var property = p$.getPropertyDescriptor$javax_swing_JComponent.apply(this, [c]);
if (property != null ) {
return Clazz.new_((I$[17]||$incl$(17)).c$$java_beans_PropertyDescriptor$javax_swing_JComponent,[property, c]);
}return null;
});
...
{
var handler = (I$[18]||$incl$(18)).getAppContext().get$O(Clazz.getClass((I$[19]||$incl$(19))));
if (handler == null ) {
handler = Clazz.new_((I$[19]||$incl$(19)));
(I$[18]||$incl$(18)).getAppContext().put$O$O(Clazz.getClass((I$[19]||$incl$(19))), handler);
}return handler;
}}, 1);
;
...
C$.$init$.apply(this);
if (dropPoint == null ) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Point cannot be null"]);
}this.dropPoint = Clazz.new_((I$[1]||$incl$(1)).c$$java_awt_Point,[dropPoint]);
}, 1);

Clazz.newMeth(C$, 'getDropPoint', function () {
return Clazz.new_((I$[1]||$incl$(1)).c$$java_awt_Point,[this.dropPoint]);
});
...
C$.$init$.apply(this);
this.$isDrop = true;
p$.setDNDVariables$java_awt_Component$java_awt_dnd_DropTargetEvent.apply(this, [component, event]);
}, 1);

Clazz.newMeth(C$, 'c$$java_awt_Component$java_awt_datatransfer_Transferable', function (component, transferable) {
C$.$init$.apply(this);
if (component == null ) {
throw Clazz.new_(Clazz.load('java.lang.NullPointerException').c$$S,["component is null"]);
}if (transferable == null ) {
throw Clazz.new_(Clazz.load('java.lang.NullPointerException').c$$S,["transferable is null"]);
}this.$isDrop = false;
...
if (!this.$isDrop) {
throw Clazz.new_(Clazz.load('java.lang.IllegalStateException').c$$S,["Not a drop"]);
}});

Clazz.newMeth(C$, 'getDropLocation', function () {
p$.assureIsDrop.apply(this, []);
if (this.dropLocation == null ) {
var p = Clazz.instanceOf(this.source, "java.awt.dnd.DropTargetDragEvent") ? (this.source).getLocation() : (this.source).getLocation();
this.dropLocation = Clazz.new_((I$[2]||$incl$(2)).c$$java_awt_Point,[p]);
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["unsupported drop action: " + dropAction]);
...
var flavors = Clazz.array((I$[3]||$incl$(3)), [1]);
...
try {
flavors[0] = Clazz.new_((I$[3]||$incl$(3)).c$$S,[mimeType]);
} catch (cnfe) {
if (Clazz.exceptionOf(cnfe, "java.lang.ClassNotFoundException")){
flavors = Clazz.array((I$[3]||$incl$(3)), [0]);
} else {
throw cnfe;
}
}
...
this.listenerList = Clazz.new_((I$[4]||$incl$(4)));
}this.listenerList.add$Class$TT(Clazz.getClass((I$[5]||$incl$(5)),['dragEnter$java_awt_dnd_DropTargetDragEvent','dragExit$java_awt_dnd_DropTargetEvent','dragOver$java_awt_dnd_DropTargetDragEvent','drop$java_awt_dnd_DropTargetDropEvent','dropActionChanged$java_awt_dnd_DropTargetDragEvent']), dtl);
});

Clazz.newMeth(C$, 'removeDropTargetListener$java_awt_dnd_DropTargetListener', function (dtl) {
if (this.listenerList != null ) {
this.listenerList.remove$Class$TT(Clazz.getClass((I$[5]||$incl$(5)),['dragEnter$java_awt_dnd_DropTargetDragEvent','dragExit$java_awt_dnd_DropTargetEvent','dragOver$java_awt_dnd_DropTargetDragEvent','drop$java_awt_dnd_DropTargetDropEvent','dropActionChanged$java_awt_dnd_DropTargetDragEvent']), dtl);
}});
...
if (listeners[i] === Clazz.getClass((I$[5]||$incl$(5)),['dragEnter$java_awt_dnd_DropTargetDragEvent','dragExit$java_awt_dnd_DropTargetEvent','dragOver$java_awt_dnd_DropTargetDragEvent','drop$java_awt_dnd_DropTargetDropEvent','dropActionChanged$java_awt_dnd_DropTargetDragEvent']) ) {
...
Clazz.newMeth(C$, '$init$', function () {
this.outer = Clazz.new_((I$[6]||$incl$(6)));
this.inner = Clazz.new_((I$[6]||$incl$(6)));
this.hysteresis = 10;
this.support = Clazz.new_((I$[7]||$incl$(7)).c$$java_awt_Component$java_awt_dnd_DropTargetEvent,[null, null]);
}, 1);
...
var i = Clazz.new_((I$[8]||$incl$(8)).c$$I$I$I$I,[0, 0, 0, 0]);
...
var r = Clazz.new_((I$[6]||$incl$(6)).c$$I$I$I$I,[this.inner.x, this.outer.y - dy, this.inner.width, dy]);
c.scrollRectToVisible$java_awt_Rectangle(r);
} else if (pos.y > (this.inner.y + this.inner.height)) {
var dy = s.getScrollableUnitIncrement$java_awt_Rectangle$I$I(this.outer, 1, 1);
var r = Clazz.new_((I$[6]||$incl$(6)).c$$I$I$I$I,[this.inner.x, this.outer.y + this.outer.height, this.inner.width, dy]);
c.scrollRectToVisible$java_awt_Rectangle(r);
}if (pos.x < this.inner.x) {
var dx = s.getScrollableUnitIncrement$java_awt_Rectangle$I$I(this.outer, 0, -1);
var r = Clazz.new_((I$[6]||$incl$(6)).c$$I$I$I$I,[this.outer.x - dx, this.inner.y, dx, this.inner.height]);
c.scrollRectToVisible$java_awt_Rectangle(r);
} else if (pos.x > (this.inner.x + this.inner.width)) {
var dx = s.getScrollableUnitIncrement$java_awt_Rectangle$I$I(this.outer, 0, 1);
var r = Clazz.new_((I$[6]||$incl$(6)).c$$I$I$I$I,[this.outer.x + this.outer.width, this.inner.y, dx, this.inner.height]);
c.scrollRectToVisible$java_awt_Rectangle(r);
}}});

Clazz.newMeth(C$, 'initPropertiesIfNecessary', function () {
if (this.timer == null ) {
var t = (I$[9]||$incl$(9)).getDefaultToolkit();
var prop;
prop = t.getDesktopProperty$S("DnD.Autoscroll.interval");
this.timer = Clazz.new_((I$[10]||$incl$(10)).c$$I$java_awt_event_ActionListener,[prop == null  ? 100 : prop.intValue(), this]);
...
p$.updateAutoscrollRegion$javax_swing_JComponent.apply(this, [this.component]);
if (this.outer.contains$java_awt_Point(this.lastPosition) && !this.inner.contains$java_awt_Point(this.lastPosition) ) {
p$.autoscroll$javax_swing_JComponent$java_awt_Point.apply(this, [this.component, this.lastPosition]);
}});
...
if (importer == null ) {
e.rejectDrag();
p$.setComponentDropLocation$javax_swing_TransferHandler_TransferSupport$Z.apply(this, [null, false]);
return;
}this.support.setDNDVariables$java_awt_Component$java_awt_dnd_DropTargetEvent(this.component, e);
...
p$.setComponentDropLocation$javax_swing_TransferHandler_TransferSupport$Z.apply(this, [showLocation ? this.support : null, false]);
});

Clazz.newMeth(C$, 'dragEnter$java_awt_dnd_DropTargetDragEvent', function (e) {
this.state = null;
this.component = e.getDropTargetContext().getComponent();
p$.handleDrag$java_awt_dnd_DropTargetDragEvent.apply(this, [e]);
if (Clazz.instanceOf(this.component, "javax.swing.JComponent")) {
this.lastPosition = e.getLocation();
p$.updateAutoscrollRegion$javax_swing_JComponent.apply(this, [this.component]);
p$.initPropertiesIfNecessary.apply(this, []);
}});
...
if (Clazz.exceptionOf(re, "java.lang.RuntimeException")){
success = false;
} else {
throw re;
}
...
p$.cleanup$Z.apply(this, [success]);
} else {
e.rejectDrop();
p$.cleanup$Z.apply(this, [false]);
}});
...
p$.setComponentDropLocation$javax_swing_TransferHandler_TransferSupport$Z.apply(this, [null, forDrop]);
if (Clazz.instanceOf(this.component, "javax.swing.JComponent")) {
...
C$.superclazz.c$$java_awt_dnd_DragSource$java_awt_Component$I$java_awt_dnd_DragGestureListener.apply(this, [(I$[11]||$incl$(11)).getDefaultDragSource(), null, 0, dgl]);
C$.$init$.apply(this);
}, 1);
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent', function (e) {
var src = e.getSource();
p$.actionPerformedImpl$java_awt_event_ActionEvent.apply(this, [e]);
});
...
var c = src;
var th = c.getTransferHandler();
var clipboard = p$.getClipboard$javax_swing_JComponent.apply(this, [c]);
...
if (Clazz.exceptionOf(ise, "java.lang.IllegalStateException")){
(I$[12]||$incl$(12)).getLookAndFeel().provideErrorFeedback$java_awt_Component(c);
return;
} else {
throw ise;
}
...
if (trans != null ) {
th.importData$javax_swing_TransferHandler_TransferSupport(Clazz.new_((I$[7]||$incl$(7)).c$$java_awt_Component$java_awt_datatransfer_Transferable,[c, trans]));
}}});
