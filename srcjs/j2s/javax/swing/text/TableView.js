(function(){var P$=Clazz.newPackage("javax.swing.text"),I$=[['java.util.BitSet','javax.swing.text.TableView','java.util.Vector',['javax.swing.text.TableView','.TableRow'],['javax.swing.text.TableView','.TableCell'],'javax.swing.SizeRequirements']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
return Clazz.new_((I$[4]||$incl$(4)).c$$javax_swing_text_Element, [this, null, elem]);
});

Clazz.newMeth(C$, 'createTableCell$javax_swing_text_Element', function (elem) {
return Clazz.new_((I$[5]||$incl$(5)).c$$javax_swing_text_Element, [this, null, elem]);
});
...
(I$[6]||$incl$(6)).calculateTiledPositions$I$javax_swing_SizeRequirements$javax_swing_SizeRequirementsA$IA$IA(targetSpan, null, reqs, offsets, spans);
});
...
this.fillColumns.and$javajs_util_BS((I$[2]||$incl$(2)).EMPTY);
});
...
if ((col + j) < n) {
spans[cell] = spans[cell]+(this.this$0.columnSpans[col + j]);
}}
col = col+(colSpan - 1);
}}
});
