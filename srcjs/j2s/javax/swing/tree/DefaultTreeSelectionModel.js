(function(){var P$=Clazz.newPackage("javax.swing.tree"),I$=[['javax.swing.event.EventListenerList','javax.swing.DefaultListSelectionModel','java.util.Hashtable','javax.swing.tree.TreePath','java.util.Vector','java.lang.Boolean','javax.swing.tree.PathPlaceHolder','javax.swing.event.TreeSelectionEvent','javax.swing.event.TreeSelectionListener','javax.swing.event.SwingPropertyChangeSupport','java.beans.PropertyChangeListener','java.util.BitSet','java.lang.StringBuffer']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
var result = Clazz.array((I$[4]||$incl$(4)), [pathSize]);
...
this.listenerList.add$Class$TT(Clazz.getClass((I$[9]||$incl$(9)),['valueChanged$javax_swing_event_TreeSelectionEvent']), x);
});

Clazz.newMeth(C$, 'removeTreeSelectionListener$javax_swing_event_TreeSelectionListener', function (x) {
this.listenerList.remove$Class$TT(Clazz.getClass((I$[9]||$incl$(9)),['valueChanged$javax_swing_event_TreeSelectionEvent']), x);
});

Clazz.newMeth(C$, 'getTreeSelectionListeners', function () {
return this.listenerList.getListeners$Class(Clazz.getClass((I$[9]||$incl$(9)),['valueChanged$javax_swing_event_TreeSelectionEvent']));
});
...
if (this.changeSupport == null ) {
return Clazz.array((I$[11]||$incl$(11)), [0]);
...
var newSel = Clazz.array((I$[4]||$incl$(4)), [counter - min]);
...
var bitSet = Clazz.new_((I$[12]||$incl$(12)).c$$I,[32]);
var anIndex;
var counter;
var min;
...
var bitSet = Clazz.new_((I$[12]||$incl$(12)));
var lModel = this.listSelectionModel;
var anIndex;
var counter;
var min = lModel.getMinSelectionIndex();
