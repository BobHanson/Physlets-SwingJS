(function(){var P$=Clazz.newPackage("sun.awt.image"),I$=[['Thread','sun.awt.image.ImageConsumerQueue']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
return (I$[2]||$incl$(2)).isConsumer$sun_awt_image_ImageConsumerQueue$java_awt_image_ImageConsumer(this.queue, ic);
});
