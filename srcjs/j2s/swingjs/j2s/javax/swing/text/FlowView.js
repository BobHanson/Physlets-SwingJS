(function(){var P$=Clazz.newPackage("javax.swing.text"),I$=[['java.util.Vector','javax.swing.text.View',['javax.swing.text.Position','.Bias'],'javax.swing.text.LabelView',['javax.swing.text.FlowView','.FlowStrategy'],['javax.swing.text.FlowView','.LogicalView'],'javax.swing.SizeRequirements']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
this.strategy = Clazz.new_((I$[5]||$incl$(5)));
}, 1);
...
this.layoutPool = Clazz.new_((I$[6]||$incl$(6)).c$$javax_swing_text_Element,[this.getElement()]);
...
this.viewBuffer = Clazz.new_((I$[1]||$incl$(1)).c$$I$I,[10, 10]);
...
var views = Clazz.array((I$[2]||$incl$(2)), [this.viewBuffer.size()]);
...
var va = Clazz.array((I$[2]||$incl$(2)), [1]);
va[0] = v;
...
var n = pool.getViewIndex$I$javax_swing_text_Position_Bias(startPos, (I$[3]||$incl$(3)).Forward);
if (n >= 0) {
...
var lv = this.getLogicalView$javax_swing_text_FlowView(fv);
var childIndex = lv.getViewIndex$I$javax_swing_text_Position_Bias(startOffset, (I$[3]||$incl$(3)).Forward);
...
var elem = this.getElement();
if (elem.isLeaf()) {
var v = Clazz.new_((I$[4]||$incl$(4)).c$$javax_swing_text_Element,[elem]);
