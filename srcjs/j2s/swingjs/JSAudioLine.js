(function(){var P$=Clazz.newPackage("swingjs"),I$=[[['javax.sound.sampled.AudioFormat','.Encoding'],'swingjs.JSUtil']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
for (var i = this.nChannels; --i >= 0; ) p$.setChannelData$I$BA$I$I.apply(this, [i, b, off, len]);
