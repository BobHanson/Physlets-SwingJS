(function(){var P$=Clazz.newPackage("sun.awt.geom"),I$=[['java.awt.geom.QuadCurve2D','sun.awt.geom.Order2']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
if (this.ycoeff3 == 0.0 ) {
return (I$[2]||$incl$(2)).TforY$D$D$D$D(y, this.ycoeff0, this.ycoeff1, this.ycoeff2);
