(function(){var P$=Clazz.newPackage("javax.swing.text"),I$=[['java.lang.Boolean','java.util.Arrays','javax.swing.text.StateInvariantError','javax.swing.text.StyleConstants','java.awt.font.TextAttribute',['javax.swing.text.Position','.Bias'],['javax.swing.text.ParagraphView','.Row'],'javax.swing.text.Segment']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
if ((i18nFlag != null ) && i18nFlag.equals$O((I$[1]||$incl$(1)).TRUE) ) {
try {
...
var a = attr.getAttribute$O((I$[4]||$incl$(4)).Alignment);
var alignment;
if (a == null ) {
...
return Clazz.new_((I$[7]||$incl$(7)).c$$javax_swing_text_Element, [this, null, this.getElement()]);
});
...
return (I$[4]||$incl$(4)).getTabSet$javax_swing_text_AttributeSet(this.getElement().getAttributes());
});
...
return (!(I$[1]||$incl$(1)).TRUE.equals(this.getDocument().getProperty$O("i18n")));
});
...
(I$[2]||$incl$(2)).fill$IA$I(spaceMap, 0);
...
return ($s$[0] = (C$.superclazz.prototype.getBottomInset.apply(this, []) + ((this.minorRequest != null ) ? this.minorRequest.preferred : 0) * this.this$0.lineSpacing), $s$[0]);
});
