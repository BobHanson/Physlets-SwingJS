...
p$.setByteInterRaster$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Rectangle$java_awt_Point$sun_awt_image_ByteInterleavedRaster.apply(this, [sampleModel, sampleModel.createDataBuffer(), Clazz.new_((I$[1]||$incl$(1)).c$$I$I$I$I,[origin.x, origin.y, sampleModel.getWidth(), sampleModel.getHeight()]), origin, null]);
}, 1);
...
p$.setByteInterRaster$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Rectangle$java_awt_Point$sun_awt_image_ByteInterleavedRaster.apply(this, [sampleModel, dataBuffer, Clazz.new_((I$[1]||$incl$(1)).c$$I$I$I$I,[origin.x, origin.y, sampleModel.getWidth(), sampleModel.getHeight()]), origin, null]);
});
...
Clazz.super_(C$, this,1);
p$.setByteInterRaster$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Rectangle$java_awt_Point$sun_awt_image_ByteInterleavedRaster.apply(this, [sampleModel, dataBuffer, aRegion, origin, parent]);
}, 1);
...
throw Clazz.new_(Clazz.load('java.lang.ArrayIndexOutOfBoundsException').c$$S,["Coordinate out of bounds!"]);
}p$.setDataElements$I$I$I$I$I$I$java_awt_image_Raster.apply(this, [dstOffX, dstOffY, srcOffX, srcOffY, width, height, inRaster]);
});
