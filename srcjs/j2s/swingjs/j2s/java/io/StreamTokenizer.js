(function(){var P$=java.io,I$=[['java.util.Arrays']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
while (low <= hi)this.ctype[low++] = (this.ctype[low++]|(4)|0);
...
if (this.reader != null ) return this.reader.read();
 ...
 else throw Clazz.new_(Clazz.load('java.lang.IllegalStateException'));
});
...
this.buf = (I$[1]||$incl$(1)).copyOf$CA$I(this.buf, this.buf.length * 2);
...
if (c >= 48  && c <= 55  ) {
c = c - 48;
var c2 = p$.read.apply(this, []);
if (48 <= c2  && c2 <= 55  ) {
c = (c << 3) + (c2 - 48);
c2 = p$.read.apply(this, []);
...
var prevc = 0;
while ((c = p$.read.apply(this, [])) != 47  || prevc != 42  ){
if (c == 13 ) {
this.LINENO++;
c = p$.read.apply(this, []);
if (c == 10 ) {
...
while ((c = p$.read.apply(this, [])) != 10  && c != 13   && c >= 0 );
this.peekc = c;
return this.nextToken();
} else {
if ((ct[47] & 16) != 0) {
