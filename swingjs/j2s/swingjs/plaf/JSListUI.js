...
var d=this.list.getFontMetrics$java_awt_Font(this.getFont$()).stringWidth$S(o.toString());
if (d > w) w=d;
}}
...
return Clazz.new_($I$(14).c$$I$I,[this.getFont$().getSize$() * 10, h]);
});
;
...
;Clazz.setTVer('3.2.4.07');//Created 2019-06-16 22:44:31 Java2ScriptVisitor version 3.2.4.07 net.sf.j2s.core.jar version 3.2.4.07
