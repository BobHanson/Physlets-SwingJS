...
try {
if (this.$in == null ) {
this.$in=this.this$0.getStream$java_net_URL.apply(this.this$0, [this.page]);
...
}this.this$0.read$java_io_InputStream$javax_swing_text_Document.apply(this.this$0, [this.$in, this.doc]);
