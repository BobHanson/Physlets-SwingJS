(function(){var P$=Clazz.newPackage("javajs.img"),I$=[['javajs.export.PDFCreator','java.util.Hashtable']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
