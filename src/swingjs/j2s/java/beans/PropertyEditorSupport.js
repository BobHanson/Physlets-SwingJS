(function(){var P$=Clazz.newPackage("java.beans"),I$=[['java.util.Vector','java.beans.PropertyChangeEvent']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
return;
}throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,[text]);
});
