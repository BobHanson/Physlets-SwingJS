(function(){var P$=java.util,I$=[['java.util.TreeMap','java.lang.InternalError']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.c$$java_util_NavigableMap.apply(this, [Clazz.new_((I$[1]||$incl$(1)))]);
}, 1);

Clazz.newMeth(C$, 'c$$java_util_Comparator', function (comparator) {
C$.c$$java_util_NavigableMap.apply(this, [Clazz.new_((I$[1]||$incl$(1)).c$$java_util_Comparator,[comparator])]);
}, 1);
...
for (var i = this.m.keySet().iterator(); i.hasNext(); ) s.writeObject$O(i.next());
