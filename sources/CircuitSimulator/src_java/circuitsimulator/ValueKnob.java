...
public class ValueKnob extends java.awt.Dialog
{
	...
	public ValueKnob(String t, CircuitBuilder cirbuilder, Frame parent)
	{
		...
		recalc();
		setTitle(cb.cirProp.getProperty(ce.name())+" "+ce.getlabel());
		setVisible(true);
	}
	...
	//{{DECLARE_CONTROLS
	java.awt.Label numeric = new java.awt.Label();
	java.awt.Label scale = new java.awt.Label();
	symantec.itools.awt.util.spinner.ListSpinner mode = new symantec.itools.awt.util.spinner.ListSpinner();
	java.awt.Scrollbar scrollbar = new java.awt.Scrollbar(Scrollbar.HORIZONTAL,50,1,1,101);
	//}}
