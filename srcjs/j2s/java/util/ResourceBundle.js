(function(){var P$=java.util,I$=[['java.lang.InternalError','java.util.Collections','java.util.Arrays',['java.util.ResourceBundle','.SingleFormatControl'],['java.util.ResourceBundle','.NoFallbackControl'],'java.util.ArrayList','java.util.Locale','swingjs.api.Interface','swingjs.JSUtil','java.io.BufferedInputStream','java.io.ByteArrayInputStream','java.lang.StringBuilder',['java.util.ResourceBundle','.Control'],'java.util.HashMap',['java.util.ResourceBundle','.CacheKey'],'Thread','java.util.HashSet']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.cacheList = Clazz.new_((I$[14]||$incl$(14)).c$$I,[32]);
}
...
return C$.getBundleImpl$S$java_util_Locale$O$java_util_ResourceBundle_Control(baseName, (I$[7]||$incl$(7)).getDefault(), null, (I$[13]||$incl$(13)).INSTANCE);
}, 1);

Clazz.newMeth(C$, 'getBundle$S$java_util_ResourceBundle_Control', function (baseName, control) {
return C$.getBundleImpl$S$java_util_Locale$O$java_util_ResourceBundle_Control(baseName, (I$[7]||$incl$(7)).getDefault(), null, control);
}, 1);

Clazz.newMeth(C$, 'getBundle$S$java_util_Locale', function (baseName, locale) {
return C$.getBundleImpl$S$java_util_Locale$O$java_util_ResourceBundle_Control(baseName, locale, null, (I$[13]||$incl$(13)).INSTANCE);
}, 1);
...
if (control == null ) {
throw Clazz.new_(Clazz.load('java.lang.NullPointerException').c$$S,["ResourceBundle locale or control is null"]);
}var cacheKey = Clazz.new_((I$[15]||$incl$(15)).c$$S$java_util_Locale$O,[baseName, locale, loader]);
var bundle = null;
...
if (Clazz.instanceOf(constKey.getCause(), "java.lang.InterruptedException")) {
(I$[16]||$incl$(16)).currentThread().interrupt();
}}
}return parent;
}, 1);
...
var error = e$$;
{
cacheKey.setCause$Throwable(error);
}
} else if (Clazz.exceptionOf(e$$, "java.lang.Exception")){
var cause = e$$;
{
cacheKey.setCause$Throwable(cause);
}
} else {
throw e$$;
}
...
C$.$clinit$ = function() {Clazz.load(C$, 1);
C$.FORMAT_DEFAULT = (I$[2]||$incl$(2)).unmodifiableList$java_util_List((I$[3]||$incl$(3)).asList$TTA(["java.class", "java.properties"]));
C$.FORMAT_CLASS = (I$[2]||$incl$(2)).unmodifiableList$java_util_List((I$[3]||$incl$(3)).asList$TTA(["java.class"]));
C$.FORMAT_PROPERTIES = (I$[2]||$incl$(2)).unmodifiableList$java_util_List((I$[3]||$incl$(3)).asList$TTA(["java.properties"]));
...
return (I$[4]||$incl$(4)).PROPERTIES_ONLY;
}if (formats.equals$O(C$.FORMAT_CLASS)) {
return (I$[4]||$incl$(4)).CLASS_ONLY;
...
if (formats.equals$O(C$.FORMAT_DEFAULT)) {
return (I$[5]||$incl$(5)).NO_FALLBACK;
}if (formats.equals$O(C$.FORMAT_PROPERTIES)) {
return (I$[5]||$incl$(5)).PROPERTIES_ONLY_NO_FALLBACK;
}if (formats.equals$O(C$.FORMAT_CLASS)) {
return (I$[5]||$incl$(5)).CLASS_ONLY_NO_FALLBACK;
}throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException'));
}, 1);
...
var locales = Clazz.new_((I$[6]||$incl$(6)).c$$I,[4]);
if (variant.length$() > 0) {
locales.add$TE(locale);
}if (country.length$() > 0) {
locales.add$TE((locales.size() == 0) ? locale : (I$[7]||$incl$(7)).getInstance$S$S$S(language, country, ""));
}if (language.length$() > 0) {
locales.add$TE((locales.size() == 0) ? locale : (I$[7]||$incl$(7)).getInstance$S$S$S(language, "", ""));
}locales.add$TE((I$[7]||$incl$(7)).ROOT);
return locales;
});
...
if (baseName == null ) {
throw Clazz.new_(Clazz.load('java.lang.NullPointerException'));
}var defaultLocale = (I$[7]||$incl$(7)).getDefault();
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["unknown format: " + format]);
}return bundle;
});

Clazz.newMeth(C$, 'getBundle$S', function (baseName) {
return P$.ResourceBundle.getBundleImpl$S$java_util_Locale$O$java_util_ResourceBundle_Control(baseName, (I$[7]||$incl$(7)).getDefault(), null, C$.INSTANCE);
}, 1);

Clazz.newMeth(C$, 'newPropertyBundle$java_io_InputStream', function (stream) {
return ((I$[8]||$incl$(8)).getInstance$S$Z("java.util.PropertyResourceBundle", false)).setStream$java_io_InputStream(stream);
});
...
return baseName;
}var sb = Clazz.new_((I$[12]||$incl$(12)).c$$S,[baseName]);
sb.append$C("_");
if (variant != "") {
...
var sb = Clazz.new_((I$[12]||$incl$(12)).c$$I,[bundleName.length$() + 1 + suffix.length$() ]);
sb.append$S(bundleName.$replace(".", "/")).append$C(".").append$S(suffix);
return sb.toString();
});
...
C$.$clinit$ = function() {Clazz.load(C$, 1);
C$.PROPERTIES_ONLY = Clazz.new_(C$.c$$java_util_List,[(I$[13]||$incl$(13)).FORMAT_PROPERTIES]);
C$.CLASS_ONLY = Clazz.new_(C$.c$$java_util_List,[(I$[13]||$incl$(13)).FORMAT_CLASS]);
}
...
Clazz.newInstance(this, arguments[0],false,C$);
}, ['java.util.ResourceBundle','java.util.ResourceBundle.SingleFormatControl']);
C$.NO_FALLBACK = null;
C$.PROPERTIES_ONLY_NO_FALLBACK = null;
C$.CLASS_ONLY_NO_FALLBACK = null;

C$.$clinit$ = function() {Clazz.load(C$, 1);
C$.NO_FALLBACK = Clazz.new_(C$.c$$java_util_List,[(I$[13]||$incl$(13)).FORMAT_DEFAULT]);
C$.PROPERTIES_ONLY_NO_FALLBACK = Clazz.new_(C$.c$$java_util_List,[(I$[13]||$incl$(13)).FORMAT_PROPERTIES]);
C$.CLASS_ONLY_NO_FALLBACK = Clazz.new_(C$.c$$java_util_List,[(I$[13]||$incl$(13)).FORMAT_CLASS]);
}
