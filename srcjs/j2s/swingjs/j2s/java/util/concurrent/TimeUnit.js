(function(){var P$=Clazz.newPackage("java.util.concurrent"),I$=[['java.lang.AbstractMethodError']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
Clazz.newEnumConst($vals, C$.c$, "NANOSECONDS", 0, [], P$.TimeUnit$1);
(
...
Clazz.newEnumConst($vals, C$.c$, "MICROSECONDS", 1, [], P$.TimeUnit$2);
(
...
Clazz.newEnumConst($vals, C$.c$, "MILLISECONDS", 2, [], P$.TimeUnit$3);
(
...
Clazz.newEnumConst($vals, C$.c$, "SECONDS", 3, [], P$.TimeUnit$4);
(
...
Clazz.newEnumConst($vals, C$.c$, "MINUTES", 4, [], P$.TimeUnit$5);
(
...
Clazz.newEnumConst($vals, C$.c$, "HOURS", 5, [], P$.TimeUnit$6);
(
...
Clazz.newEnumConst($vals, C$.c$, "DAYS", 6, [], P$.TimeUnit$7);
}
