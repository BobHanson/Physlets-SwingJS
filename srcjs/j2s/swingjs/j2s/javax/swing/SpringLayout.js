...
C$.ALL_HORIZONTAL = Clazz.array(java.lang.String, -1, ["West", "Width", "East", "HorizontalCenter"]);
C$.ALL_VERTICAL = Clazz.array(java.lang.String, -1, ["North", "Height", "South", "VerticalCenter", "Baseline"]);
}
...
this.componentConstraints = Clazz.new_((I$[6]||$incl$(6)));
this.cyclicReference = (I$[2]||$incl$(2)).constant$I(-2147483648);
}, 1);
...
pc.setX$javax_swing_Spring((I$[2]||$incl$(2)).constant$I(0));
pc.setY$javax_swing_Spring((I$[2]||$incl$(2)).constant$I(0));
var width = pc.getWidth();
if (Clazz.instanceOf(width, "javax.swing.Spring.WidthSpring") && (width).c === p  ) {
pc.setWidth$javax_swing_Spring((I$[2]||$incl$(2)).constant$I$I$I(0, 0, 2147483647));
}var height = pc.getHeight();
if (Clazz.instanceOf(height, "javax.swing.Spring.HeightSpring") && (height).c === p  ) {
pc.setHeight$javax_swing_Spring((I$[2]||$incl$(2)).constant$I$I$I(0, 0, 2147483647));
}});
...
var i = p.getInsets();
return Clazz.new_((I$[8]||$incl$(8)).c$$I$I,[width + i.left + i.right , height + i.top + i.bottom ]);
}, 1);
...
this.putConstraint$S$java_awt_Component$javax_swing_Spring$S$java_awt_Component(e1, c1, (I$[2]||$incl$(2)).constant$I(pad), e2, c2);
});

Clazz.newMeth(C$, 'putConstraint$S$java_awt_Component$javax_swing_Spring$S$java_awt_Component', function (e1, c1, s, e2, c2) {
p$.putConstraint$S$java_awt_Component$javax_swing_Spring.apply(this, [e1, c1, (I$[2]||$incl$(2)).sum$javax_swing_Spring$javax_swing_Spring(s, this.getConstraint$S$java_awt_Component(e2, c2))]);
});
...
p$.applyDefaults$javax_swing_SpringLayout_Constraints$S$javax_swing_Spring$S$javax_swing_Spring$java_util_List.apply(this, [constraints, "North", (I$[2]||$incl$(2)).constant$I(0), "Height", (I$[2]||$incl$(2)).height$java_awt_Component(c), constraints.verticalHistory]);
}return constraints;
});
...
constraints.setConstraint$S$javax_swing_Spring(name1, spring1);
}(I$[10]||$incl$(10)).rotate$java_util_List$I(history, 1);
}});
...
Clazz.newMeth(C$, '$init$', function () {
this.horizontalHistory = Clazz.new_((I$[1]||$incl$(1)));
this.verticalHistory = Clazz.new_((I$[1]||$incl$(1)));
}, 1);
...
this.setHeight$javax_swing_Spring((I$[2]||$incl$(2)).height$java_awt_Component(c));
}, 1);
...
var all = horizontal ? (I$[3]||$incl$(3)).ALL_HORIZONTAL : (I$[3]||$incl$(3)).ALL_VERTICAL;
...
return (s1 == null  || s2 == null  ) ? null : (I$[2]||$incl$(2)).sum$javax_swing_Spring$javax_swing_Spring(s1, s2);
});

Clazz.newMeth(C$, 'difference$javax_swing_Spring$javax_swing_Spring', function (s1, s2) {
return (s1 == null  || s2 == null  ) ? null : (I$[2]||$incl$(2)).difference$javax_swing_Spring$javax_swing_Spring(s1, s2);
});

Clazz.newMeth(C$, 'scale$javax_swing_Spring$F', function (s, factor) {
return (s == null ) ? null : (I$[2]||$incl$(2)).scale$javax_swing_Spring$F(s, factor);
});
...
case (I$[4]||$incl$(4)).CONSTANT_DESCENT:
return prefHeight + (baseline - prefBaseline);
case (I$[4]||$incl$(4)).CENTER_OFFSET:
return prefHeight + 2 * (baseline - prefBaseline);
case (I$[4]||$incl$(4)).CONSTANT_ASCENT:
default:
}
return -2147483648;
});
...
return ((
(function(){var C$=Clazz.newClass(P$, "SpringLayout$Constraints$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load(['javax.swing.Spring','.SpringMap']), null, 1);
...
), Clazz.new_((I$[5]||$incl$(5)).c$$javax_swing_Spring, [this, null, s],P$.SpringLayout$Constraints$1));
});

Clazz.newMeth(C$, 'relativeBaselineToHeight$javax_swing_Spring', function (s) {
return ((
(function(){var C$=Clazz.newClass(P$, "SpringLayout$Constraints$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load(['javax.swing.Spring','.SpringMap']), null, 1);
...
), Clazz.new_((I$[5]||$incl$(5)).c$$javax_swing_Spring, [this, null, s],P$.SpringLayout$Constraints$2));
});
...
var allSprings = Clazz.array((I$[2]||$incl$(2)), -1, [this.x, this.y, this.width, this.height, this.east, this.south, this.horizontalCenter, this.verticalCenter, this.baseline]);
