(function(){var P$=Clazz.newPackage("swingjs.plaf"),I$=[['javax.swing.JPanel','swingjs.plaf.CenterLayout','javax.swing.colorchooser.ColorChooserComponentFactory','swingjs.plaf.JComboPane','java.awt.BorderLayout','sun.swing.DefaultLookup','javax.swing.border.TitledBorder','java.awt.Dimension','javax.swing.LookAndFeel','java.lang.Boolean',['swingjs.plaf.JSColorChooserUI','.Handler']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
var panels = (I$[3]||$incl$(3)).getDefaultChooserPanels();
return panels;
});
...
this.previewPanelHolder.setBorder$javax_swing_border_Border(Clazz.new_((I$[7]||$incl$(7)).c$$S,[previewString]));
...
(I$[9]||$incl$(9)).installColorsAndFont$javax_swing_JComponent$S$S$S(this.chooser, "ColorChooser.background", "ColorChooser.foreground", "ColorChooser.font");
(I$[9]||$incl$(9)).installProperty$javax_swing_JComponent$S$O(this.chooser, "opaque", (I$[10]||$incl$(10)).TRUE);
});
