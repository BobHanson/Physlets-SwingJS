(function(){var P$=Clazz.newPackage("javax.swing"),I$=[['javax.swing.DefaultBoundedRangeModel','java.text.NumberFormat',['javax.swing.JProgressBar','.ModelListener'],'javax.swing.event.ChangeListener','javax.swing.event.ChangeEvent']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
break;
default:
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,[newOrientation + " is not a legal orientation"]);
}
this.revalidate();
}});
...
this.listenerList.add$Class$TT(Clazz.getClass((I$[4]||$incl$(4)),['stateChanged$javax_swing_event_ChangeEvent']), l);
});

Clazz.newMeth(C$, 'removeChangeListener$javax_swing_event_ChangeListener', function (l) {
this.listenerList.remove$Class$TT(Clazz.getClass((I$[4]||$incl$(4)),['stateChanged$javax_swing_event_ChangeEvent']), l);
});

Clazz.newMeth(C$, 'getChangeListeners', function () {
return this.listenerList.getListeners$Class(Clazz.getClass((I$[4]||$incl$(4)),['stateChanged$javax_swing_event_ChangeEvent']));
});
