...
this.componentConstraints=Clazz.new_($I$(6));
...
this.cyclicSprings=Clazz.new_($I$(7));
this.acyclicSprings=Clazz.new_($I$(7));
}, p$3);
...
var i=p.getInsets$();
return Clazz.new_($I$(8).c$$I$I,[width + i.left + i.right , height + i.top + i.bottom ]);
}, 1);
...
this.componentConstraints.put$TK$TV(component, p$3.applyDefaults$java_awt_Component$javax_swing_SpringLayout_Constraints.apply(this, [component, constraints]));
}, p$3);
...
return Clazz.new_($I$(11).c$$S$java_awt_Component$javax_swing_SpringLayout,[edgeName, c, this]);
});
...
Clazz.newMeth(C$, '$init$', function () {
this.horizontalHistory=Clazz.new_($I$(1));
this.verticalHistory=Clazz.new_($I$(1));
}, 1);
...
), Clazz.new_($I$(5).c$$javax_swing_Spring, [this, null, s],P$.SpringLayout$Constraints$1));
}, p$1);
...
), Clazz.new_($I$(5).c$$javax_swing_Spring, [this, null, s],P$.SpringLayout$Constraints$2));
}, p$1);
...
;Clazz.setTVer('3.2.4.07');//Created 2019-06-16 22:44:13 Java2ScriptVisitor version 3.2.4.07 net.sf.j2s.core.jar version 3.2.4.07
