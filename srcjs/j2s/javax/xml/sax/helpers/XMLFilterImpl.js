(function(){var P$=Clazz.newPackage("javax.xml.sax.helpers"),I$=[['javax.xml.sax.InputSource']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
p$.setupParse.apply(this, []);
this.parent.parse$javax_xml_sax_InputSource(input);
});

Clazz.newMeth(C$, 'parse$S', function (systemId) {
this.parse$javax_xml_sax_InputSource(Clazz.new_((I$[1]||$incl$(1)).c$$S,[systemId]));
});
...
if (this.parent == null ) {
throw Clazz.new_(Clazz.load('java.lang.NullPointerException').c$$S,["No parent for filter"]);
