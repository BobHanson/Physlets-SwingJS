(function(){var P$=Clazz.newPackage("javax.swing"),I$=[['javax.swing.LookAndFeel','javax.swing.JComponent','swingjs.JSToolkit','java.awt.Dimension']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["rows: " + rows]);
}if (columns < 0) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["columns: " + columns]);
}(I$[1]||$incl$(1)).installProperty$javax_swing_JComponent$S$O(this, "focusTraversalKeysForward", (I$[2]||$incl$(2)).getManagingFocusForwardTraversalKeys());
(I$[1]||$incl$(1)).installProperty$javax_swing_JComponent$S$O(this, "focusTraversalKeysBackward", (I$[2]||$incl$(2)).getManagingFocusBackwardTraversalKeys());
}, 1);

Clazz.newMeth(C$, 'createDefaultModel', function () {
return (I$[3]||$incl$(3)).getPlainDocument$javax_swing_JComponent(this);
});
...
if (end < start) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["end before start"]);
}var doc = this.getDocument();
if (doc != null ) {
try {
