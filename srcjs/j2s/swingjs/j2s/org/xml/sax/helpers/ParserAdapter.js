(function(){var P$=Clazz.newPackage("org.xml.sax.helpers"),I$=[['org.xml.sax.helpers.ParserFactory','org.xml.sax.helpers.AttributesImpl','org.xml.sax.helpers.NamespaceSupport',['org.xml.sax.helpers.ParserAdapter','.AttributeListAdapter'],'org.xml.sax.InputSource','java.util.Vector']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
try {
p$.setup$org_xml_sax_Parser.apply(this, [(I$[1]||$incl$(1)).makeParser()]);
} catch (e$$) {
...
C$.$init$.apply(this);
p$.setup$org_xml_sax_Parser.apply(this, [parser]);
}, 1);
...
this.parse$org_xml_sax_InputSource(Clazz.new_((I$[5]||$incl$(5)).c$$S,[systemId]));
});
...
if (this.errorHandler != null ) this.errorHandler.error$org_xml_sax_SAXParseException(p$.makeException$S.apply(this, [message]));
});
