...
case (I$[3]||$incl$(3)).DOCUMENT_MODAL:
return Clazz.new_((I$[4]||$incl$(4)).c$$java_awt_Dialog,[modalDialog]);
case (I$[3]||$incl$(3)).APPLICATION_MODAL:
return Clazz.new_((I$[5]||$incl$(5)).c$$java_awt_Dialog,[modalDialog]);
case (I$[3]||$incl$(3)).TOOLKIT_MODAL:
return Clazz.new_((I$[6]||$incl$(6)).c$$java_awt_Dialog,[modalDialog]);
}
return null;
}, 1);
;
...
if (w.isModalExcluded$java_awt_Dialog_ModalExclusionType((I$[1]||$incl$(1)).TOOLKIT_EXCLUDE)) {
return (I$[2]||$incl$(2)).ACCEPT;
...
Clazz.newMeth(C$, 'acceptWindow$java_awt_Window', function (w) {
if (w.isModalExcluded$java_awt_Dialog_ModalExclusionType((I$[1]||$incl$(1)).APPLICATION_EXCLUDE)) {
return (I$[2]||$incl$(2)).ACCEPT;
}if (w.appContext === this.appContext ) {
while (w != null ){
if (w === this.modalDialog ) {
