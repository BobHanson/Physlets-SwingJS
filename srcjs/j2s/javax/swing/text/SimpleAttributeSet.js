(function(){var P$=Clazz.newPackage("javax.swing.text"),I$=[['javax.swing.text.SimpleAttributeSet$EmptyAttributeSet$1',['javax.swing.text.SimpleAttributeSet','.EmptyAttributeSet'],'java.util.Hashtable','javax.swing.text.StyleConstants']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
this.table = Clazz.new_((I$[3]||$incl$(3)).c$$I,[3]);
}, 1);
...
return this.table.get$O((I$[4]||$incl$(4)).ResolveAttribute);
});

Clazz.newMeth(C$, 'setResolveParent$javax_swing_text_AttributeSet', function (parent) {
this.addAttribute$O$O((I$[4]||$incl$(4)).ResolveAttribute, parent);
});
