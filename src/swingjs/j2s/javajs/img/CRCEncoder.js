(function(){var P$=Clazz.newPackage("javajs.img"),I$=[['java.util.zip.CRC32','javajs.util.AU']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
return (this.dataLen == this.pngBytes.length ? this.pngBytes : (I$[2]||$incl$(2)).arrayCopyByte$BA$I(this.pngBytes, this.dataLen));
});
