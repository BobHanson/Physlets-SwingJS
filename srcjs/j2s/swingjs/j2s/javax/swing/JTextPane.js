(function(){var P$=Clazz.newPackage("javax.swing"),I$=[['javax.swing.JEditorPane','javax.swing.UIManager','javax.swing.text.StyleConstants','javax.swing.text.StyledEditorKit']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
if (contentType != null  && P$.JEditorPane.getEditorKitClassNameForContentType$S(contentType) == (I$[1]||$incl$(1)).defaultEditorKitMap.get$O(contentType) ) {
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Model must be StyledDocument"]);
}});
...
(I$[2]||$incl$(2)).getLookAndFeel().provideErrorFeedback$java_awt_Component(this);
return;
...
(I$[3]||$incl$(3)).setComponent$javax_swing_text_MutableAttributeSet$java_awt_Component(inputAttributes, c);
...
var inputAttributes = this.getInputAttributes();
inputAttributes.removeAttributes$javax_swing_text_AttributeSet(inputAttributes);
(I$[3]||$incl$(3)).setIcon$javax_swing_text_MutableAttributeSet$javax_swing_Icon(inputAttributes, g);
p$.replaceSelection$S$Z.apply(this, [" ", false]);
inputAttributes.removeAttributes$javax_swing_text_AttributeSet(inputAttributes);
});
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Must be StyledEditorKit"]);
}});
