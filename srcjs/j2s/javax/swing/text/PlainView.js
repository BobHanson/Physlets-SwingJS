(function(){var P$=Clazz.newPackage("javax.swing.text"),I$=[['javax.swing.text.Segment','javax.swing.text.SegmentCache','javax.swing.text.Utilities',['javax.swing.text.Position','.Bias'],['javax.swing.event.DocumentEvent','.EventType'],'java.awt.Rectangle']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
switch (axis) {
case 0:
return p$.getLineWidth$javax_swing_text_Element.apply(this, [this.longLine]);
case 1:
...
if (added != null ) {
var currWide = p$.getLineWidth$javax_swing_text_Element.apply(this, [this.longLine]);
...
if (changes.getType() === (I$[5]||$incl$(5)).INSERT ) {
var w = p$.getLineWidth$javax_swing_text_Element.apply(this, [this.longLine]);
