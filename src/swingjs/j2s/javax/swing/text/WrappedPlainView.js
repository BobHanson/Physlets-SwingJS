...
alloc.x+=(I$[3]||$incl$(3)).getTabbedTextWidth$javax_swing_text_Segment$java_awt_FontMetrics$I$javax_swing_text_TabExpander$I(segment, this.this$0.metrics, alloc.x, this.this$0, p0);
(I$[2]||$incl$(2)).releaseSharedSegment$javax_swing_text_Segment(segment);
}return alloc;
});
