(function(){var P$=Clazz.newPackage("java.awt.image"),I$=[['java.awt.image.DataBuffer','java.awt.image.DataBufferByte','java.awt.image.DataBufferInt']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.c$$I$I$I$I$I$I.apply(this, [dataType, w, h, numberOfBits, ((w * numberOfBits + (I$[1]||$incl$(1)).getDataTypeSize$I(dataType) - 1)/(I$[1]||$incl$(1)).getDataTypeSize$I(dataType)|0), 0]);
