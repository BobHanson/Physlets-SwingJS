(function(){var P$=Clazz.newPackage("javax.sound.sampled"),I$=[['java.util.HashMap',['javax.sound.sampled.AudioFormat','.Encoding'],'java.util.Collections']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.c$$javax_sound_sampled_AudioFormat_Encoding$F$I$I$I$F$Z.apply(this, [(signed == true  ? (I$[2]||$incl$(2)).PCM_SIGNED : (I$[2]||$incl$(2)).PCM_UNSIGNED), sampleRate, sampleSizeInBits, channels, (channels == -1 || sampleSizeInBits == -1 ) ? -1 : (((sampleSizeInBits + 7)/8|0)) * channels, sampleRate, bigEndian]);
}, 1);
