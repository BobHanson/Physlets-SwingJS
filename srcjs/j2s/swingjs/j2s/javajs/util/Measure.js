(function(){var P$=Clazz.newPackage("javajs.util"),I$=[['javajs.util.V3','javajs.util.P3','javajs.util.T3','javajs.util.Lst','javajs.util.Quat','javajs.api.Interface','javajs.util.P4']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
var C$=Clazz.newClass(P$, "Measure");
C$.axisY = null;

C$.$clinit$ = function() {Clazz.load(C$, 1);
C$.axisY = (I$[1]||$incl$(1)).new3$F$F$F(0, 1, 0);
}
...
var vectorBA = Clazz.new_((I$[1]||$incl$(1)));
var vectorBC = Clazz.new_((I$[1]||$incl$(1)));
...
var r = (I$[1]||$incl$(1)).newV$javajs_util_T3(va_prime_d);
if (theta != 0 ) r.add$javajs_util_T3(vda);
var pt_a_prime = (I$[2]||$incl$(2)).newP$javajs_util_T3(a);
...
if (ptRef != null ) {
var pt0 = (I$[2]||$incl$(2)).newP$javajs_util_T3(pointA);
...
vNormNorm.normalize();
if (Float.isNaN(vNormNorm.x)) vNormNorm.set$F$F$F(1, 0, 0);
}, 1);
...
var tempA = (I$[2]||$incl$(2)).newP$javajs_util_T3(points[0]);
...
var sumXiYi = Clazz.new_((I$[1]||$incl$(1)));
var vTemp = Clazz.new_((I$[1]||$incl$(1)));
var pt = Clazz.new_((I$[2]||$incl$(2)));
var ptProj = Clazz.new_((I$[2]||$incl$(2)));
var a = (I$[1]||$incl$(1)).newV$javajs_util_T3(axisUnitVector);
var sum_Xi2 = 0;
...
var m = (I$[1]||$incl$(1)).newV$javajs_util_T3(sumXiYi);
m.scale$F(1 / sum_Xi2);
...
var v = Clazz.new_((I$[4]||$incl$(4)));
for (var i = 0; i < vPts.size(); i++) {
var pt = (I$[2]||$incl$(2)).newP$javajs_util_T3(vPts.get$I(i));
...
var c2 = plane2.z;
var d2 = plane2.w;
var norm1 = (I$[1]||$incl$(1)).new3$F$F$F(a1, b1, c1);
var norm2 = (I$[1]||$incl$(1)).new3$F$F$F(a2, b2, c2);
var nxn = Clazz.new_((I$[1]||$incl$(1)));
...
var Szy = 0;
var Szz = 0;
var ptA = Clazz.new_((I$[2]||$incl$(2)));
var ptB = Clazz.new_((I$[2]||$incl$(2)));
var ptA0 = ptsA[0];
var ptB0 = ptsB[0];
...
var q = C$.calculateQuaternionRotation$javajs_util_P3AA$FA(Clazz.array((I$[2]||$incl$(2)), -2, [cptsA, cptsB]), retStddev);
var r = q.getMatrix();
if (centerA == null ) r.rotate$javajs_util_T3(cptsA[0]);
 else centerA.setT$javajs_util_T3(cptsA[0]);
var t = (I$[1]||$incl$(1)).newVsub$javajs_util_T3$javajs_util_T3(cptsB[0], cptsA[0]);
...
var cB = ptsB[0];
var n = ptsA.length - 1;
var ptAnew = Clazz.new_((I$[2]||$incl$(2)));
for (var i = n + 1; --i >= 1; ) {
