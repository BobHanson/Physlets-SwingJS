(function(){var P$=Clazz.newPackage("javax.swing"),p$1={},I$=[[0,'java.util.Hashtable','java.util.Vector','Thread',['javax.swing.KeyboardManager','.ComponentKeyStrokePair'],'javax.swing.KeyStroke','javax.swing.JMenuBar','java.awt.JSComponent']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
...
this.containerMap=Clazz.new_($I$(1));
this.componentKeyStrokeMap=Clazz.new_($I$(1));
}, 1);
...
var ckp=Clazz.new_($I$(4).c$$O$O, [this, null, c, ks]);
...
if (menuBars == null ) {
menuBars=Clazz.new_($I$(2));
keyMap.put$TK$TV(Clazz.getClass($I$(6)), menuBars);
...
}if (k != null ) this.componentKeyStrokeMap.put$TK$TV(Clazz.new_($I$(4).c$$O$O, [this, null, c, k]), top);
return keyMap;
}, p$1);
