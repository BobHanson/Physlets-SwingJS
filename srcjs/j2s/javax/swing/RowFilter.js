(function(){var P$=Clazz.newPackage("javax.swing"),I$=[[['javax.swing.RowFilter','.ComparisonType'],'java.util.ArrayList',['javax.swing.RowFilter','.RegexFilter'],'java.util.regex.Pattern',['javax.swing.RowFilter','.DateFilter'],['javax.swing.RowFilter','.NumberFilter'],['javax.swing.RowFilter','.OrFilter'],['javax.swing.RowFilter','.AndFilter'],['javax.swing.RowFilter','.NotFilter']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
if (columns[i] < 0) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Index must be >= 0"]);
}}
}, 1);

Clazz.newMeth(C$, 'regexFilter$S$IA', function (regex, indices) {
return Clazz.new_((I$[3]||$incl$(3)).c$$java_util_regex_Pattern$IA,[(I$[4]||$incl$(4)).compile$S(regex), indices]);
}, 1);

Clazz.newMeth(C$, 'dateFilter$javax_swing_RowFilter_ComparisonType$java_util_Date$IA', function (type, date, indices) {
return Clazz.new_((I$[5]||$incl$(5)).c$$javax_swing_RowFilter_ComparisonType$J$IA,[type, date.getTime(), indices]);
}, 1);

Clazz.newMeth(C$, 'numberFilter$javax_swing_RowFilter_ComparisonType$Number$IA', function (type, number, indices) {
return Clazz.new_((I$[6]||$incl$(6)).c$$javax_swing_RowFilter_ComparisonType$Number$IA,[type, number, indices]);
}, 1);

Clazz.newMeth(C$, 'orFilter$Iterable', function (filters) {
return Clazz.new_((I$[7]||$incl$(7)).c$$Iterable,[filters]);
}, 1);

Clazz.newMeth(C$, 'andFilter$Iterable', function (filters) {
return Clazz.new_((I$[8]||$incl$(8)).c$$Iterable,[filters]);
}, 1);

Clazz.newMeth(C$, 'notFilter$javax_swing_RowFilter', function (filter) {
return Clazz.new_((I$[9]||$incl$(9)).c$$javax_swing_RowFilter,[filter]);
}, 1);
;
...
Clazz.newInstance(this, arguments[0],false,C$);
}, ['javax.swing.RowFilter','javax.swing.RowFilter.GeneralFilter']);
...
case (I$[1]||$incl$(1)).AFTER:
return (vDate > this.date);
case (I$[1]||$incl$(1)).EQUAL:
return (vDate == this.date);
case (I$[1]||$incl$(1)).NOT_EQUAL:
return (vDate != this.date);
default:
break;
}
...
Clazz.newInstance(this, arguments[0],false,C$);
}, ['javax.swing.RowFilter','javax.swing.RowFilter.OrFilter']);
