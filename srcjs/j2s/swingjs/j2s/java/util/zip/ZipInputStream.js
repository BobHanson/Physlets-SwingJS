(function(){var P$=Clazz.newPackage("java.util.zip"),I$=[['java.util.zip.CRC32','java.io.PushbackInputStream','java.util.zip.Inflater','java.util.zip.ZipEntry']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.superclazz.c$$java_io_InputStream$java_util_zip_Inflater$I.apply(this, [Clazz.new_((I$[2]||$incl$(2)).c$$java_io_InputStream$I,[$in, 1024]), C$.newInflater(), 512]);
C$.$init$.apply(this);
var charset = "UTF-8";
try {
...
throw Clazz.new_(Clazz.load('java.lang.NullPointerException').c$$S,["charset is invalid"]);
} else {
throw e;
}
}
...
return Clazz.new_((I$[3]||$incl$(3))).init$I$Z(0, true);
}, 1);
...
if ((this.entry = p$.readLOC.apply(this, [])) == null ) {
return null;
...
if (len == -1) {
p$.readEnd$java_util_zip_ZipEntry.apply(this, [this.entry]);
this.entryEOF = true;
this.entry = null;
} else {
...
this.remaining = this.remaining-(len);
if (this.remaining == 0 && this.entry.crc != this.crc.getValue() ) {
throw Clazz.new_(Clazz.load('java.util.zip.ZipException').c$$S,["invalid entry CRC (expected 0x" + Long.toHexString(this.entry.crc) + " but got 0x" + Long.toHexString(this.crc.getValue()) + ")" ]);
}return len;
default:
...
if (n < 0) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["negative skip length"]);
}p$.ensureOpen.apply(this, []);
...
try {
p$.readFully$BA$I$I.apply(this, [this.tmpbuf, 0, 30]);
} catch (e) {
...
}p$.readFully$BA$I$I.apply(this, [this.$b, 0, len]);
var e = this.createZipEntry$S(((this.flag & 2048) != 0) ? p$.toStringUTF8$BA$I.apply(this, [this.$b, len]) : p$.toStringb2$BA$I.apply(this, [this.$b, len]));
if ((this.flag & 1) == 1) {
...
p$.readFully$BA$I$I.apply(this, [bb, 0, len]);
e.setExtra$BA(bb);
...
if (Clazz.exceptionOf(e, "java.io.UnsupportedEncodingException")){
return p$.toStringb2$BA$I.apply(this, [b2, len]);
} else {
throw e;
}
}
...
return Clazz.new_((I$[4]||$incl$(4)).c$$S,[name]);
});
...
p$.readFully$BA$I$I.apply(this, [this.tmpbuf, 0, 24]);
...
p$.readFully$BA$I$I.apply(this, [this.tmpbuf, 0, 16]);
var sig = C$.get32$BA$I(this.tmpbuf, 0);
if (sig != 134695760) {
e.crc = sig;
...
throw Clazz.new_(Clazz.load('java.util.zip.ZipException').c$$S,["invalid entry CRC (expected 0x" + Long.toHexString(e.crc) + " but got 0x" + Long.toHexString(this.crc.getValue()) + ")" ]);
}});
