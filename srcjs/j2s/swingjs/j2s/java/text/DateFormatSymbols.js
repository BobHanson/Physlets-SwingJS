(function(){var P$=Clazz.newPackage("java.text"),I$=[['java.util.Hashtable','java.util.Locale','java.lang.InternalError','java.util.Arrays','sun.util.resources.LocaleData']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.$init$.apply(this);
p$.initializeData$java_util_Locale.apply(this, [(I$[2]||$incl$(2)).getDefault()]);
}, 1);

Clazz.newMeth(C$, 'c$$java_util_Locale', function (locale) {
C$.$init$.apply(this);
p$.initializeData$java_util_Locale.apply(this, [locale]);
}, 1);
...
return p$.duplicate$SA.apply(this, [this.eras]);
});
...
return p$.duplicate$SA.apply(this, [this.months]);
});
...
return p$.duplicate$SA.apply(this, [this.shortMonths]);
});
...
return p$.duplicate$SA.apply(this, [this.weekdays]);
});
...
return p$.duplicate$SA.apply(this, [this.shortWeekdays]);
});
...
return p$.duplicate$SA.apply(this, [this.ampms]);
});
...
var aCopy = Clazz.array(java.lang.String, [newZoneStrings.length, null]);
...
p$.copyMembers$java_text_DateFormatSymbols$java_text_DateFormatSymbols.apply(this, [this, other]);
return other;
} catch (e) {
...
var that = obj;
return ((I$[4]||$incl$(4)).equals$OA$OA(this.eras, that.eras) && (I$[4]||$incl$(4)).equals$OA$OA(this.months, that.months) && (I$[4]||$incl$(4)).equals$OA$OA(this.shortMonths, that.shortMonths) && (I$[4]||$incl$(4)).equals$OA$OA(this.weekdays, that.weekdays) && (I$[4]||$incl$(4)).equals$OA$OA(this.shortWeekdays, that.shortWeekdays) && (I$[4]||$incl$(4)).equals$OA$OA(this.ampms, that.ampms) && ((this.localPatternChars != null  && this.localPatternChars.equals$O(that.localPatternChars) ) || (this.localPatternChars == null  && that.localPatternChars == null  ) )  );
});
...
var dstArray = Clazz.array(java.lang.String, [srcArray.length]);
