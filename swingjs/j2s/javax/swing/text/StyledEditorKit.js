...
C$.defaultFactory=Clazz.new_($I$(10));
C$.$defaultActions=Clazz.array($I$(11), -1, [Clazz.new_($I$(12).c$$S$S,["font-family-SansSerif", "SansSerif"]), Clazz.new_($I$(12).c$$S$S,["font-family-Monospaced", "Monospaced"]), Clazz.new_($I$(12).c$$S$S,["font-family-Serif", "Serif"]), Clazz.new_($I$(13).c$$S$I,["font-size-8", 8]), Clazz.new_($I$(13).c$$S$I,["font-size-10", 10]), Clazz.new_($I$(13).c$$S$I,["font-size-12", 12]), Clazz.new_($I$(13).c$$S$I,["font-size-14", 14]), Clazz.new_($I$(13).c$$S$I,["font-size-16", 16]), Clazz.new_($I$(13).c$$S$I,["font-size-18", 18]), Clazz.new_($I$(13).c$$S$I,["font-size-24", 24]), Clazz.new_($I$(13).c$$S$I,["font-size-36", 36]), Clazz.new_($I$(13).c$$S$I,["font-size-48", 48]), Clazz.new_($I$(14).c$$S$I,["left-justify", 0]), Clazz.new_($I$(14).c$$S$I,["center-justify", 1]), Clazz.new_($I$(14).c$$S$I,["right-justify", 2]), Clazz.new_($I$(15)), Clazz.new_($I$(16)), Clazz.new_($I$(17)), Clazz.new_($I$(18))]);
}
...
Clazz.newMeth(C$, 'clone$', function () {
return Clazz.new_($I$(6).c$$javax_swing_text_AttributeSet,[this]);
});
})()
), Clazz.new_($I$(6), [this, null],P$.StyledEditorKit$1));
}, p$1);

Clazz.newMeth(C$, 'createInputAttributeUpdated', function () {
this.inputAttributeUpdater=Clazz.new_($I$(21), [this, null]);
}, p$1);
...
this.this$0.createInputAttributes$javax_swing_text_Element$javax_swing_text_MutableAttributeSet.apply(this.this$0, [this.this$0.currentRun, this.this$0.getInputAttributes$.apply(this.this$0, [])]);
}});
...
return Clazz.new_($I$(1).c$$javax_swing_text_Element,[elem]);
} else if (kind.equals$O("paragraph")) {
return Clazz.new_($I$(2).c$$javax_swing_text_Element,[elem]);
} else if (kind.equals$O("section")) {
return Clazz.new_($I$(3).c$$javax_swing_text_Element$I,[elem, 1]);
} else if (kind.equals$O("component")) {
return Clazz.new_($I$(4).c$$javax_swing_text_Element,[elem]);
} else if (kind.equals$O("icon")) {
return Clazz.new_($I$(5).c$$javax_swing_text_Element,[elem]);
}}return Clazz.new_($I$(1).c$$javax_swing_text_Element,[elem]);
});
...
;Clazz.setTVer('3.2.4.07');//Created 2019-06-16 22:44:15 Java2ScriptVisitor version 3.2.4.07 net.sf.j2s.core.jar version 3.2.4.07
