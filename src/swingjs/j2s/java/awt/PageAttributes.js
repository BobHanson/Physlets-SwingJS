(function(){var P$=Clazz.newPackage("java.awt"),I$=[[['java.awt.PageAttributes','.ColorType'],['java.awt.PageAttributes','.OriginType'],'java.lang.InternalError','java.util.Locale',['java.awt.PageAttributes','.MediaType'],['java.awt.PageAttributes','.OrientationRequestedType'],['java.awt.PageAttributes','.PrintQualityType']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.$init$.apply(this);
this.setColor$java_awt_PageAttributes_ColorType((I$[1]||$incl$(1)).MONOCHROME);
this.setMediaToDefault();
this.setOrientationRequestedToDefault();
this.setOrigin$java_awt_PageAttributes_OriginType((I$[2]||$incl$(2)).PHYSICAL);
...
var defaultCountry = (I$[4]||$incl$(4)).getDefault().getCountry();
if (defaultCountry != null  && (defaultCountry.equals$O((I$[4]||$incl$(4)).US.getCountry())) ) {
this.setMedia$java_awt_PageAttributes_MediaType((I$[5]||$incl$(5)).NA_LETTER);
} else {
this.setMedia$java_awt_PageAttributes_MediaType((I$[5]||$incl$(5)).ISO_A4);
}});
...
case 3:
this.setOrientationRequested$java_awt_PageAttributes_OrientationRequestedType((I$[6]||$incl$(6)).PORTRAIT);
break;
case 4:
this.setOrientationRequested$java_awt_PageAttributes_OrientationRequestedType((I$[6]||$incl$(6)).LANDSCAPE);
break;
default:
...
switch (printQuality) {
case 3:
this.setPrintQuality$java_awt_PageAttributes_PrintQualityType((I$[7]||$incl$(7)).DRAFT);
break;
case 4:
this.setPrintQuality$java_awt_PageAttributes_PrintQualityType((I$[7]||$incl$(7)).NORMAL);
break;
case 5:
this.setPrintQuality$java_awt_PageAttributes_PrintQualityType((I$[7]||$incl$(7)).HIGH);
break;
default:
...
C$.$clinit$ = function() {Clazz.load(C$, 1);
C$.NAMES = Clazz.array(java.lang.String, -1, ["color", "monochrome"]);
...
C$.$clinit$ = function() {Clazz.load(C$, 1);
C$.NAMES = Clazz.array(java.lang.String, -1, ["portrait", "landscape"]);
...
C$.$clinit$ = function() {Clazz.load(C$, 1);
C$.NAMES = Clazz.array(java.lang.String, -1, ["physical", "printable"]);
...
C$.$clinit$ = function() {Clazz.load(C$, 1);
C$.NAMES = Clazz.array(java.lang.String, -1, ["high", "normal", "draft"]);
