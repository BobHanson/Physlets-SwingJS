(function(){var P$=Clazz.newPackage("java.awt"),I$=[['java.awt.Cursor','java.awt.Window']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
var C$=Clazz.newClass(P$, "Frame", null, 'java.awt.Window');
C$.$nameCounter = 0;
var p$=C$.prototype;
