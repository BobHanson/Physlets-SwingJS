(function(){var P$=Clazz.newPackage("java.awt"),I$=[[['java.awt.JobAttributes','.DefaultSelectionType'],['java.awt.JobAttributes','.DestinationType'],['java.awt.JobAttributes','.DialogType'],'java.lang.InternalError',['java.awt.JobAttributes','.MultipleDocumentHandlingType'],['java.awt.JobAttributes','.SidesType']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
this.setDefaultSelection$java_awt_JobAttributes_DefaultSelectionType((I$[1]||$incl$(1)).ALL);
this.setDestination$java_awt_JobAttributes_DestinationType((I$[2]||$incl$(2)).PRINTER);
this.setDialog$java_awt_JobAttributes_DialogType((I$[3]||$incl$(3)).NATIVE);
...
this.setMultipleDocumentHandling$java_awt_JobAttributes_MultipleDocumentHandlingType((I$[5]||$incl$(5)).SEPARATE_DOCUMENTS_UNCOLLATED_COPIES);
});
...
this.setSides$java_awt_JobAttributes_SidesType((I$[6]||$incl$(6)).ONE_SIDED);
});
...
C$.$clinit$ = function() {Clazz.load(C$, 1);
C$.NAMES = Clazz.array(java.lang.String, -1, ["all", "range", "selection"]);
...
C$.$clinit$ = function() {Clazz.load(C$, 1);
C$.NAMES = Clazz.array(java.lang.String, -1, ["file", "printer"]);
...
C$.$clinit$ = function() {Clazz.load(C$, 1);
C$.NAMES = Clazz.array(java.lang.String, -1, ["common", "native", "none"]);
...
C$.$clinit$ = function() {Clazz.load(C$, 1);
C$.NAMES = Clazz.array(java.lang.String, -1, ["separate-documents-collated-copies", "separate-documents-uncollated-copies"]);
...
C$.$clinit$ = function() {Clazz.load(C$, 1);
C$.NAMES = Clazz.array(java.lang.String, -1, ["one-sided", "two-sided-long-edge", "two-sided-short-edge"]);
