(function(){var P$=Clazz.newPackage("a2s"),I$=[['java.awt.Event','Boolean']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
return null;
}return Clazz.new_((I$[1]||$incl$(1)).c$$O$J$I$I$I$I$I,[src, ke.getWhen(), newid, 0, 0, C$.getOldEventKey$java_awt_event_KeyEvent(ke), (ke.getModifiers() & -17)]);
case 500:
case 501:
case 502:
case 503:
...
case 1005:
return Clazz.new_((I$[1]||$incl$(1)).c$$O$I$O,[src, 1005, null]);
case 201:
case 203:
case 204:
return Clazz.new_((I$[1]||$incl$(1)).c$$O$I$O,[src, newid, null]);
case 100:
if (Clazz.instanceOf(src, "a2s.Frame") || Clazz.instanceOf(src, "a2s.Dialog") ) {
var p = (src).getLocation();
return Clazz.new_((I$[1]||$incl$(1)).c$$O$J$I$I$I$I$I,[src, 0, 205, p.x, p.y, 0, 0]);
}break;
case 1001:
var ae = e;
var cmd;
...
return Clazz.new_((I$[1]||$incl$(1)).c$$O$I$O,[src, newid, Integer.$valueOf(aje.getValue())]);
default:
}
return null;
}, 1);
