(function(){var P$=Clazz.newPackage("java.awt.image"),I$=[[['sun.java2d.StateTrackable','.State']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
var C$=Clazz.newClass(P$, "DataBufferShort", null, 'java.awt.image.DataBuffer');
...
C$.superclazz.c$$sun_java2d_StateTrackable_State$I$I.apply(this, [(I$[1]||$incl$(1)).STABLE, 2, size]);
C$.$init$.apply(this);
...
C$.superclazz.c$$sun_java2d_StateTrackable_State$I$I$I.apply(this, [(I$[1]||$incl$(1)).STABLE, 2, size, numBanks]);
C$.$init$.apply(this);
...
C$.superclazz.c$$sun_java2d_StateTrackable_State$I$I.apply(this, [(I$[1]||$incl$(1)).UNTRACKABLE, 2, size]);
C$.$init$.apply(this);
this.data = dataArray;
this.bankdata = Clazz.array(Short.TYPE, [1, null]);
this.bankdata[0] = this.data;
...
C$.superclazz.c$$sun_java2d_StateTrackable_State$I$I$I$I.apply(this, [(I$[1]||$incl$(1)).UNTRACKABLE, 2, size, 1, offset]);
C$.$init$.apply(this);
this.data = dataArray;
this.bankdata = Clazz.array(Short.TYPE, [1, null]);
this.bankdata[0] = this.data;
...
C$.superclazz.c$$sun_java2d_StateTrackable_State$I$I$I.apply(this, [(I$[1]||$incl$(1)).UNTRACKABLE, 2, size, dataArray.length]);
C$.$init$.apply(this);
...
C$.superclazz.c$$sun_java2d_StateTrackable_State$I$I$I$IA.apply(this, [(I$[1]||$incl$(1)).UNTRACKABLE, 2, size, dataArray.length, offsets]);
C$.$init$.apply(this);
this.bankdata = dataArray.clone();
this.data = this.bankdata[0];
}, 1);
