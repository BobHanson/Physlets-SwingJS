(function(){var P$=Clazz.newPackage("javax.swing"),I$=[['javax.swing.SwingUtilities','Boolean','java.lang.Boolean','javax.swing.DefaultSingleSelectionModel','javax.swing.MenuSelectionManager','javax.swing.JMenuItem','java.awt.Point','java.awt.GraphicsEnvironment',['javax.swing.JPopupMenu','.Separator'],'java.util.Vector','javax.swing.event.PopupMenuListener','javax.swing.event.MenuKeyListener','javax.swing.event.PopupMenuEvent','javax.swing.PopupFactory','java.awt.Dimension','java.awt.Insets','javax.swing.event.MenuKeyEvent','javax.swing.MenuElement']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
return this.add$javax_swing_JMenuItem(Clazz.new_((I$[6]||$incl$(6)).c$$S,[s]));
});
...
var p = Clazz.new_((I$[7]||$incl$(7)).c$$I$I,[xposition, yposition]);
...
), Clazz.new_((I$[6]||$incl$(6)), [this, null],P$.JPopupMenu$1));
...
if (pos < 0) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["index less than zero."]);
}if (pos > this.getComponentCount() - 1) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["index greater than the number of items."]);
...
this.add$java_awt_Component(Clazz.new_((I$[9]||$incl$(9))));
});
...
var tempItems = Clazz.new_((I$[10]||$incl$(10)));
...
this.listenerList.add$Class$TT(Clazz.getClass((I$[11]||$incl$(11)),['popupMenuCanceled$javax_swing_event_PopupMenuEvent','popupMenuWillBecomeInvisible$javax_swing_event_PopupMenuEvent','popupMenuWillBecomeVisible$javax_swing_event_PopupMenuEvent']), l);
});

Clazz.newMeth(C$, 'removePopupMenuListener$javax_swing_event_PopupMenuListener', function (l) {
this.listenerList.remove$Class$TT(Clazz.getClass((I$[11]||$incl$(11)),['popupMenuCanceled$javax_swing_event_PopupMenuEvent','popupMenuWillBecomeInvisible$javax_swing_event_PopupMenuEvent','popupMenuWillBecomeVisible$javax_swing_event_PopupMenuEvent']), l);
});

Clazz.newMeth(C$, 'getPopupMenuListeners', function () {
return this.listenerList.getListeners$Class(Clazz.getClass((I$[11]||$incl$(11)),['popupMenuCanceled$javax_swing_event_PopupMenuEvent','popupMenuWillBecomeInvisible$javax_swing_event_PopupMenuEvent','popupMenuWillBecomeVisible$javax_swing_event_PopupMenuEvent']));
});

Clazz.newMeth(C$, 'addMenuKeyListener$javax_swing_event_MenuKeyListener', function (l) {
this.listenerList.add$Class$TT(Clazz.getClass((I$[12]||$incl$(12)),['menuKeyPressed$javax_swing_event_MenuKeyEvent','menuKeyReleased$javax_swing_event_MenuKeyEvent','menuKeyTyped$javax_swing_event_MenuKeyEvent']), l);
});

Clazz.newMeth(C$, 'removeMenuKeyListener$javax_swing_event_MenuKeyListener', function (l) {
this.listenerList.remove$Class$TT(Clazz.getClass((I$[12]||$incl$(12)),['menuKeyPressed$javax_swing_event_MenuKeyEvent','menuKeyReleased$javax_swing_event_MenuKeyEvent','menuKeyTyped$javax_swing_event_MenuKeyEvent']), l);
});

Clazz.newMeth(C$, 'getMenuKeyListeners', function () {
return this.listenerList.getListeners$Class(Clazz.getClass((I$[12]||$incl$(12)),['menuKeyPressed$javax_swing_event_MenuKeyEvent','menuKeyReleased$javax_swing_event_MenuKeyEvent','menuKeyTyped$javax_swing_event_MenuKeyEvent']));
});
...
this.setPopupSize$java_awt_Dimension(Clazz.new_((I$[15]||$incl$(15)).c$$I$I,[width, height]));
});
...
if (this.margin == null ) {
return Clazz.new_((I$[16]||$incl$(16)).c$$I$I$I$I,[0, 0, 0, 0]);
} else {
return this.margin;
}});
...
var mke = Clazz.new_((I$[17]||$incl$(17)).c$$java_awt_Component$I$J$I$I$C$javax_swing_MenuElementA$javax_swing_MenuSelectionManager,[e.getComponent(), e.getID(), e.getWhen(), e.getModifiers(), e.getKeyCode(), e.getKeyChar(), path, manager]);
...
var result;
var tmp = Clazz.new_((I$[10]||$incl$(10)));
