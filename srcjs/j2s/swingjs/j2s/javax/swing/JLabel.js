(function(){var P$=Clazz.newPackage("javax.swing"),I$=[['javax.swing.SwingUtilities','javax.swing.UIManager']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,[message]);
}});
