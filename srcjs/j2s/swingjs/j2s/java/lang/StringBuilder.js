...
var C$=Clazz.newClass(java.lang, "StringBuilder", null, 'AbstractStringBuilder', ['Appendable', 'CharSequence', 'java.io.Serializable']);
var p$=C$.prototype;
...
this.append0$CA(Character.toChars(codePoint));
return this;
});
