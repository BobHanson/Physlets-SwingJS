(function(){var P$=Clazz.newPackage("javax.swing"),I$=[['javax.swing.DefaultSingleSelectionModel','java.lang.Error','java.awt.Insets','java.util.Vector','javax.swing.MenuElement','javax.swing.KeyboardManager']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
throw Clazz.new_((I$[2]||$incl$(2)).c$$S,["setHelpMenu() not yet implemented."]);
});

Clazz.newMeth(C$, 'getHelpMenu', function () {
throw Clazz.new_((I$[2]||$incl$(2)).c$$S,["getHelpMenu() not yet implemented."]);
});
