(function(){var P$=Clazz.newPackage("java.awt.geom"),I$=[[['java.awt.geom.Path2D','.Iterator'],'java.util.Arrays',['java.awt.geom.Point2D','.Float'],'sun.awt.geom.Curve',['java.awt.geom.Rectangle2D','.Float'],['java.awt.geom.Path2D','.Float','.CopyIterator'],['java.awt.geom.Path2D','.Float','.TxIterator'],['java.awt.geom.Point2D','.Double'],['java.awt.geom.Rectangle2D','.Double'],['java.awt.geom.Path2D','.Double','.CopyIterator'],['java.awt.geom.Path2D','.Double','.TxIterator'],'java.awt.geom.FlatteningPathIterator']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
var cross = (I$[4]||$incl$(4)).pointCrossingsForPath$java_awt_geom_PathIterator$D$D(pi, x, y);
return ((cross & mask) != 0);
} else {
return false;
}}, 1);
...
var crossings = (I$[4]||$incl$(4)).rectCrossingsForPath$java_awt_geom_PathIterator$D$D$D$D(pi, x, y, x + w, y + h);
...
Clazz.super_(C$, this,1);
p$.setPath$java_awt_Shape$java_awt_geom_AffineTransform.apply(this, [s, at]);
}, 1);
...
return Clazz.new_((I$[3]||$incl$(3)).c$$F$F,[this.floatCoords[coordindex], this.floatCoords[coordindex + 1]]);
});
...
if (at == null ) {
return Clazz.new_((I$[6]||$incl$(6)).c$$java_awt_geom_Path2D_Float,[this]);
} else {
return Clazz.new_((I$[7]||$incl$(7)).c$$java_awt_geom_Path2D_Float$java_awt_geom_AffineTransform,[this, at]);
}});
...
Clazz.newInstance(this, arguments[0],false,C$);
}, ['java.awt.geom.Path2D','java.awt.geom.Path2D.Iterator']);
...
Clazz.newMeth(C$, 'getPoint$I', function (coordindex) {
return Clazz.new_((I$[8]||$incl$(8)).c$$D$D,[this.doubleCoords[coordindex], this.doubleCoords[coordindex + 1]]);
});
...
Clazz.newMeth(C$, 'getPathIterator$java_awt_geom_AffineTransform', function (at) {
if (at == null ) {
return Clazz.new_((I$[10]||$incl$(10)).c$$java_awt_geom_Path2D_Double,[this]);
} else {
return Clazz.new_((I$[11]||$incl$(11)).c$$java_awt_geom_Path2D_Double$java_awt_geom_AffineTransform,[this, at]);
}});
