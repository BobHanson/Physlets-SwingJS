(function(){var P$=Clazz.newPackage("org.xml.sax.helpers"),I$=[['org.xml.sax.helpers.NewInstance','java.io.BufferedReader','java.io.InputStreamReader','org.xml.sax.helpers.ParserAdapter','org.xml.sax.helpers.ParserFactory']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
try {
return Clazz.new_((I$[4]||$incl$(4)).c$$org_xml_sax_Parser,[(I$[5]||$incl$(5)).makeParser()]);
} catch (e) {
if (Clazz.exceptionOf(e, "java.lang.Exception")){
