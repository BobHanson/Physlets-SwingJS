(function(){var P$=Clazz.newPackage("java.awt.geom"),I$=[[['java.awt.geom.Point2D','.Float'],['java.awt.geom.Rectangle2D','.Float'],['java.awt.geom.Point2D','.Double'],['java.awt.geom.Rectangle2D','.Double'],'java.awt.geom.Line2D','java.awt.geom.QuadIterator','java.awt.geom.FlatteningPathIterator']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
return (I$[5]||$incl$(5)).ptSegDistSq$D$D$D$D$D$D(x1, y1, x2, y2, ctrlx, ctrly);
}, 1);

Clazz.newMeth(C$, 'getFlatness$D$D$D$D$D$D', function (x1, y1, ctrlx, ctrly, x2, y2) {
return (I$[5]||$incl$(5)).ptSegDist$D$D$D$D$D$D(x1, y1, x2, y2, ctrlx, ctrly);
}, 1);

Clazz.newMeth(C$, 'getFlatnessSq$DA$I', function (coords, offset) {
return (I$[5]||$incl$(5)).ptSegDistSq$D$D$D$D$D$D(coords[offset + 0], coords[offset + 1], coords[offset + 4], coords[offset + 5], coords[offset + 2], coords[offset + 3]);
}, 1);

Clazz.newMeth(C$, 'getFlatness$DA$I', function (coords, offset) {
return (I$[5]||$incl$(5)).ptSegDist$D$D$D$D$D$D(coords[offset + 0], coords[offset + 1], coords[offset + 4], coords[offset + 5], coords[offset + 2], coords[offset + 3]);
}, 1);

Clazz.newMeth(C$, 'getFlatnessSq', function () {
return (I$[5]||$incl$(5)).ptSegDistSq$D$D$D$D$D$D(this.getX1(), this.getY1(), this.getX2(), this.getY2(), this.getCtrlX(), this.getCtrlY());
});

Clazz.newMeth(C$, 'getFlatness', function () {
return (I$[5]||$incl$(5)).ptSegDist$D$D$D$D$D$D(this.getX1(), this.getY1(), this.getX2(), this.getY2(), this.getCtrlX(), this.getCtrlY());
});
...
return Clazz.new_((I$[6]||$incl$(6)).c$$java_awt_geom_QuadCurve2D$java_awt_geom_AffineTransform,[this, at]);
});

Clazz.newMeth(C$, 'getPathIterator$java_awt_geom_AffineTransform$D', function (at, flatness) {
return Clazz.new_((I$[7]||$incl$(7)).c$$java_awt_geom_PathIterator$D,[this.getPathIterator$java_awt_geom_AffineTransform(at), flatness]);
});
;
...
return Clazz.new_((I$[1]||$incl$(1)).c$$F$F,[this.x1, this.y1]);
});
...
return Clazz.new_((I$[1]||$incl$(1)).c$$F$F,[this.ctrlx, this.ctrly]);
});
...
return Clazz.new_((I$[1]||$incl$(1)).c$$F$F,[this.x2, this.y2]);
});
...
return Clazz.new_((I$[2]||$incl$(2)).c$$F$F$F$F,[left, top, right - left, bottom - top]);
});
})()
;
...
Clazz.newMeth(C$, 'getP1', function () {
return Clazz.new_((I$[3]||$incl$(3)).c$$D$D,[this.x1, this.y1]);
});
...
Clazz.newMeth(C$, 'getCtrlPt', function () {
return Clazz.new_((I$[3]||$incl$(3)).c$$D$D,[this.ctrlx, this.ctrly]);
});
...
Clazz.newMeth(C$, 'getP2', function () {
return Clazz.new_((I$[3]||$incl$(3)).c$$D$D,[this.x2, this.y2]);
});
...
var right = Math.max(Math.max(this.x1, this.x2), this.ctrlx);
var bottom = Math.max(Math.max(this.y1, this.y2), this.ctrly);
return Clazz.new_((I$[4]||$incl$(4)).c$$D$D$D$D,[left, top, right - left, bottom - top]);
});
})()
})();
