(function(){var P$=Clazz.newPackage("swingjs.plaf"),I$=[['java.awt.Dimension','swingjs.plaf.JSToolBarUI','javax.swing.UIManager','java.awt.Color','javax.swing.plaf.basic.BasicGraphicsUtils','java.awt.Point','java.awt.Insets','java.util.HashMap','java.util.Hashtable','swingjs.api.js.DOMNode','javax.swing.LookAndFeel','java.lang.Boolean','javax.swing.SwingUtilities','swingjs.plaf.LazyActionMap','sun.swing.DefaultLookup',['swingjs.plaf.JSToolBarUI','.Actions'],'javax.swing.border.CompoundBorder',['javax.swing.plaf.basic.BasicBorders','.RolloverButtonBorder'],['javax.swing.plaf.basic.BasicBorders','.RolloverMarginBorder'],['javax.swing.plaf.basic.BasicBorders','.ButtonBorder'],['javax.swing.plaf.basic.BasicBorders','.RadioButtonBorder'],'javax.swing.JRootPane','javax.swing.JFrame','swingjs.plaf.JSToolBarUI$1ToolBarDialog',['swingjs.plaf.JSToolBarUI','.DragWindow'],'java.awt.event.WindowAdapter',['swingjs.plaf.JSToolBarUI','.Handler'],['swingjs.plaf.JSToolBarUI','.FrameListener']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
this.rolloverBorders = false;
this.borderTable = Clazz.new_((I$[8]||$incl$(8)));
this.rolloverTable = Clazz.new_((I$[9]||$incl$(9)));
}, 1);
...
(I$[13]||$incl$(13)).replaceUIInputMap$javax_swing_JComponent$I$javax_swing_InputMap(this.toolBar, 1, km);
(I$[14]||$incl$(14)).installLazyActionMap$javax_swing_JComponent$Class$S(this.toolBar, Clazz.getClass(C$), "ToolBar.actionMap");
});

Clazz.newMeth(C$, 'getInputMap$I', function (condition) {
if (condition == 1) {
return (I$[15]||$incl$(15)).get$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S(this.toolBar, this, "ToolBar.ancestorInputMap");
}return null;
});

Clazz.newMeth(C$, 'loadActionMap$swingjs_plaf_LazyActionMap', function (map) {
map.put$javax_swing_Action(Clazz.new_((I$[16]||$incl$(16)).c$$S,["navigateRight"]));
map.put$javax_swing_Action(Clazz.new_((I$[16]||$incl$(16)).c$$S,["navigateLeft"]));
map.put$javax_swing_Action(Clazz.new_((I$[16]||$incl$(16)).c$$S,["navigateUp"]));
map.put$javax_swing_Action(Clazz.new_((I$[16]||$incl$(16)).c$$S,["navigateDown"]));
}, 1);

Clazz.newMeth(C$, 'uninstallKeyboardActions', function () {
(I$[13]||$incl$(13)).replaceUIActionMap$javax_swing_JComponent$javax_swing_ActionMap(this.toolBar, null);
(I$[13]||$incl$(13)).replaceUIInputMap$javax_swing_JComponent$I$javax_swing_InputMap(this.toolBar, 1, null);
});
...
var border = (I$[3]||$incl$(3)).get$O("ToolBar.rolloverBorder");
if (border != null ) {
return border;
}var table = (I$[3]||$incl$(3)).getLookAndFeelDefaults();
return Clazz.new_((I$[17]||$incl$(17)).c$$javax_swing_border_Border$javax_swing_border_Border,[Clazz.new_((I$[18]||$incl$(18)).c$$java_awt_Color$java_awt_Color$java_awt_Color$java_awt_Color,[table.getColor$O("controlShadow"), table.getColor$O("controlDkShadow"), table.getColor$O("controlHighlight"), table.getColor$O("controlLtHighlight")]), Clazz.new_((I$[19]||$incl$(19)))]);
});

Clazz.newMeth(C$, 'createNonRolloverBorder', function () {
var border = (I$[3]||$incl$(3)).get$O("ToolBar.nonrolloverBorder");
if (border != null ) {
return border;
}var table = (I$[3]||$incl$(3)).getLookAndFeelDefaults();
return Clazz.new_((I$[17]||$incl$(17)).c$$javax_swing_border_Border$javax_swing_border_Border,[Clazz.new_((I$[20]||$incl$(20)).c$$java_awt_Color$java_awt_Color$java_awt_Color$java_awt_Color,[table.getColor$O("Button.shadow"), table.getColor$O("Button.darkShadow"), table.getColor$O("Button.light"), table.getColor$O("Button.highlight")]), Clazz.new_((I$[19]||$incl$(19)))]);
});

Clazz.newMeth(C$, 'createNonRolloverToggleBorder', function () {
var table = (I$[3]||$incl$(3)).getLookAndFeelDefaults();
return Clazz.new_((I$[17]||$incl$(17)).c$$javax_swing_border_Border$javax_swing_border_Border,[Clazz.new_((I$[21]||$incl$(21)).c$$java_awt_Color$java_awt_Color$java_awt_Color$java_awt_Color,[table.getColor$O("ToggleButton.shadow"), table.getColor$O("ToggleButton.darkShadow"), table.getColor$O("ToggleButton.light"), table.getColor$O("ToggleButton.highlight")]), Clazz.new_((I$[19]||$incl$(19)))]);
});
...
), Clazz.new_((I$[23]||$incl$(23)).c$$S$java_awt_GraphicsConfiguration, [this, null, toolbar.getName(), (window != null ) ? window.getGraphicsConfiguration() : null],P$.JSToolBarUI$1));
...
this.setBorderToRollover$java_awt_Component(components[i]);
}}
});
...
}this.rolloverTable.put$TK$TV(b, b.isRolloverEnabled() ? (I$[12]||$incl$(12)).TRUE : (I$[12]||$incl$(12)).FALSE);
...
ancestor.addWindowListener$java_awt_event_WindowListener(((
...
return (p != null  && p$.getDockingConstraint$java_awt_Component$java_awt_Point.apply(this, [c, p]) != null  );
});
...
return "East";
}if (p.x < this.dockingSensitivity && !p$.isBlocked$java_awt_Component$O.apply(this, [c, "West"]) ) {
return "West";
}if (p.y >= c.getHeight() - this.dockingSensitivity && !p$.isBlocked$java_awt_Component$O.apply(this, [c, "South"]) ) {
return "South";
}}return null;
});
...
var constraint = p$.getDockingConstraint$java_awt_Component$java_awt_Point.apply(this, [this.dockingSource, comparisonPoint]);
var orientation = p$.mapConstraintToOrientation$S.apply(this, [constraint]);
...
return Clazz.new_((I$[28]||$incl$(28)), [this, null]);
});
...
this.this$0.setBorderToRollover$java_awt_Component(c);
} else {
this.this$0.setBorderToNonRollover$java_awt_Component(c);
}});
...
}this.this$0.setBorderToNormal$java_awt_Component(c);
});
...
var components = this.this$0.toolBar.getComponents();
...
var newSize = Clazz.new_((I$[1]||$incl$(1)).c$$I$I,[size.height, size.width]);
separator.setSeparatorSize$java_awt_Dimension(newSize);
}}}
} else if (propertyName == (I$[2]||$incl$(2)).IS_ROLLOVER) {
this.this$0.installNormalBorders$javax_swing_JComponent(this.this$0.toolBar);
this.this$0.setRolloverBorders$Z((evt.getNewValue()).booleanValue());
}});
...
this.this$0.getHandler().componentAdded$java_awt_event_ContainerEvent(e);
});

Clazz.newMeth(C$, 'componentRemoved$java_awt_event_ContainerEvent', function (e) {
this.this$0.getHandler().componentRemoved$java_awt_event_ContainerEvent(e);
});
...
Clazz.newMeth(C$, '$init$', function () {
this.borderColor = (I$[4]||$incl$(4)).gray;
...
if (this.offset != null ) {
if ((I$[5]||$incl$(5)).isLeftToRight$java_awt_Component(this.this$0.toolBar)) {
this.setOffset$java_awt_Point(Clazz.new_((I$[6]||$incl$(6)).c$$I$I,[this.offset.y, this.offset.x]));
} else if (o == 0) {
this.setOffset$java_awt_Point(Clazz.new_((I$[6]||$incl$(6)).c$$I$I,[size.height - this.offset.y, this.offset.x]));
} else {
this.setOffset$java_awt_Point(Clazz.new_((I$[6]||$incl$(6)).c$$I$I,[this.offset.y, size.width - this.offset.x]));
}}this.repaint();
}});
...
this.this$0.paintDragWindow$java_awt_Graphics(g);
C$.superclazz.prototype.paint$java_awt_Graphics.apply(this, [g]);
});

Clazz.newMeth(C$, 'getInsets', function () {
return Clazz.new_((I$[7]||$incl$(7)).c$$I$I$I$I,[1, 1, 1, 1]);
});

Clazz.newMeth(C$);
})()
})();
//Created 2018-02-06 09:00:58
