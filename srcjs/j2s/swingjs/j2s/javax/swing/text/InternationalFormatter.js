(function(){var P$=Clazz.newPackage("javax.swing.text"),I$=[[['java.text.Format','.Field'],'java.util.ArrayList','javax.swing.Action',['javax.swing.text.InternationalFormatter','.IncrementAction'],'java.lang.StringBuffer','java.util.BitSet',['javax.swing.text.InternationalFormatter','.ExtendedReplaceHolder']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.EMPTY_FIELD_ARRAY = Clazz.array((I$[1]||$incl$(1)), [0]);
}
...
if (Clazz.exceptionOf(cce, "java.lang.ClassCastException")){
...
return Clazz.array((I$[3]||$incl$(3)), -1, [Clazz.new_((I$[4]||$incl$(4)).c$$S$I, [this, null, "increment", 1]), Clazz.new_((I$[4]||$incl$(4)).c$$S$I, [this, null, "decrement", -1])]);
}return null;
});
...
try {
if (min != null  && min.compareTo$TT(value) > 0 ) {
return false;
}} catch (cce) {
if (Clazz.exceptionOf(cce, "java.lang.ClassCastException")){
if (wantsCCE) {
...
try {
if (max != null  && max.compareTo$TT(value) < 0 ) {
return false;
}} catch (cce) {
if (Clazz.exceptionOf(cce, "java.lang.ClassCastException")){
if (wantsCCE) {
...
p$.updateMask$java_text_AttributedCharacterIterator.apply(this, [iterator]);
} catch (e$$) {
...
rh.offset = p$.getNextNonliteralIndex$I$I.apply(this, [rh.offset, -1]);
...
}if (textIndex < tl && text.charAt(textIndex) == this.getLiteral$I(rh.offset + counter) ) {
textIndex++;
} else if (textIndex == 0) {
rh.offset++;
rh.length--;
...
replace = Clazz.new_((I$[5]||$incl$(5)).c$$I,[max]);
replace.append$S(text.substring(0, textIndex));
replace.append$C(this.getLiteral$I(rh.offset + counter));
}} else if (textIndex < tl) {
if (replace != null ) {
replace.append$C(text.charAt(textIndex));
}textIndex++;
} else {
if (replace == null ) {
replace = Clazz.new_((I$[5]||$incl$(5)).c$$I,[max]);
...
end = end+((rh).endTextLength);
p$.repositionCursor$I$I$I.apply(this, [literalCount, end, direction]);
} else {
start = (rh).endOffset;
if (direction == 1) {
start = start+((rh).endTextLength);
...
this.literalMask = Clazz.new_((I$[6]||$incl$(6)));
} else {
...
this.replaceHolder = Clazz.new_((I$[7]||$incl$(7)));
...
}, ['javax.swing.text.DefaultFormatter','javax.swing.text.DefaultFormatter.ReplaceHolder']);
...
if (this.this$0.getFormattedTextField().isEditable()) {
if (this.this$0.getAllowsInvalid()) {
this.this$0.updateMask();
}var validEdit = false;
if (this.this$0.isValidMask()) {
var start = this.this$0.getFormattedTextField().getSelectionStart();
if (start != -1) {
var iterator = this.this$0.getIterator();
iterator.setIndex$I(start);
var attributes = iterator.getAttributes();
var field = this.this$0.getAdjustField$I$java_util_Map(start, attributes);
if (this.this$0.canIncrement$O$I(field, start)) {
try {
var value = this.this$0.stringToValue$S(this.this$0.getFormattedTextField().getText());
var fieldTypeCount = this.this$0.getFieldTypeCountTo$O$I.apply(this.this$0, [field, start]);
value = this.this$0.adjustValue$O$java_util_Map$O$I(value, attributes, field, this.direction);
if (value != null  && this.this$0.isValidValue$O$Z(value, false) ) {
this.this$0.resetValue$O(value);
this.this$0.updateMask();
if (this.this$0.isValidMask()) {
this.this$0.selectField$O$I(field, fieldTypeCount);
}validEdit = true;
}} catch (e$$) {
if (Clazz.exceptionOf(e$$, "java.text.ParseException")){
var pe = e$$;
...
this.this$0.invalidEdit();
}}});

Clazz.newMeth(C$);
})()
})();
//Created 2018-02-08 10:02:56
