(function(){var P$=Clazz.newPackage("java.awt.font"),p$1={},p$2={},I$=[[0,'java.util.EnumSet',['java.awt.font.NumericShaper','.Range'],'java.util.Arrays','StringBuilder']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
var C$=Clazz.newClass(P$, "NumericShaper", function(){
...
return Clazz.new_(C$.c$$java_awt_font_NumericShaper_Range$java_util_Set,[singleRange, $I$(1).of$TE(singleRange)]);
}, 1);
...
}this.rangeArray=this.rangeSet.toArray$TTA(Clazz.array($I$(2), [this.rangeSet.size$()]));
if (this.rangeArray.length > 3) {
$I$(3).sort$TTA$java_util_Comparator(this.rangeArray, ((P$.NumericShaper$1||
(function(){var C$=Clazz.newClass(P$, "NumericShaper$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.Comparator', 1);
...
Clazz.newMeth(C$, ['compare$java_awt_font_NumericShaper_Range$java_awt_font_NumericShaper_Range','compare$','compare$TT$TT'], function (s1, s2) {
...
var key=C$.Range.toRangeIndex$java_awt_font_NumericShaper_Range(context);
if (key >= 0) {
...
}return C$.Range.maskToRangeSet$I(this.mask);
});
...
}return this.isContextual$() == rhs.isContextual$()  && this.rangeSet.equals$O(C$.Range.maskToRangeSet$I(rhs.mask))  && this.shapingRange === C$.Range.indexToRange$I(rhs.key)  ;
} else if (rhs.rangeSet != null ) {
var rset=C$.Range.maskToRangeSet$I(this.mask);
var srange=C$.Range.indexToRange$I(this.key);
...
var buf=Clazz.new_($I$(4).c$$S,[C$.superclazz.prototype.toString.apply(this, [])]);
...
if (this.shapingRange != null ) {
var index=C$.Range.toRangeIndex$java_awt_font_NumericShaper_Range(this.shapingRange);
if (index >= 0) {
this.key=index;
}}if (this.rangeSet != null ) {
this.mask|=C$.Range.toRangeMask$java_util_Set(this.rangeSet);
}stream.defaultWriteObject$();
}, p$2);
;
(function(){var C$=Clazz.newClass(P$.NumericShaper, "Range", function(){
...
(function(){var C$=Clazz.newClass(P$, "NumericShaper$Range$1", null, Clazz.load(['java.awt.font.NumericShaper','.Range']), null, 1);
...
;Clazz.setTVer('3.2.4.07');//Created 2019-06-16 21:46:49 Java2ScriptVisitor version 3.2.4.07 net.sf.j2s.core.jar version 3.2.4.07
