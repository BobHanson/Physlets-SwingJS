(function(){var P$=Clazz.newPackage("javax.swing.text"),p$1={},I$=[[0,'javax.swing.text.Utilities',['javax.swing.text.DefaultFormatter','.DefaultDocumentFilter'],['javax.swing.text.DefaultFormatter','.DefaultNavigationFilter'],['javax.swing.text.Position','.Bias'],['javax.swing.text.DefaultFormatter','.ReplaceHolder']]],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
...
this.documentFilter=Clazz.new_($I$(2), [this, null]);
}return this.documentFilter;
});

Clazz.newMeth(C$, 'getNavigationFilter$', function () {
if (this.navigationFilter == null ) {
this.navigationFilter=Clazz.new_($I$(3), [this, null]);
...
this.replaceHolder=Clazz.new_($I$(5));
...
Clazz.newMeth(C$, 'setDot$javax_swing_text_NavigationFilter_FilterBypass$I$javax_swing_text_Position_Bias', function (fb, dot, bias) {
var tc=this.this$0.getFormattedTextField$.apply(this.this$0, []);
if (tc.composedTextExists$()) {
fb.setDot$I$javax_swing_text_Position_Bias(dot, bias);
} else {
this.this$0.setDot$javax_swing_text_NavigationFilter_FilterBypass$I$javax_swing_text_Position_Bias.apply(this.this$0, [fb, dot, bias]);
}});
...
this.this$0.moveDot$javax_swing_text_NavigationFilter_FilterBypass$I$javax_swing_text_Position_Bias.apply(this.this$0, [fb, dot, bias]);
}});
...
return this.this$0.getNextVisualPositionFrom$javax_swing_text_JTextComponent$I$javax_swing_text_Position_Bias$I$javax_swing_text_Position_BiasA.apply(this.this$0, [text, pos, bias, direction, biasRet]);
}});
...
this.this$0.replace$javax_swing_text_DocumentFilter_FilterBypass$I$I$S$javax_swing_text_AttributeSet.apply(this.this$0, [fb, offset, length, null, null]);
}});
...
this.this$0.replace$javax_swing_text_DocumentFilter_FilterBypass$I$I$S$javax_swing_text_AttributeSet.apply(this.this$0, [fb, offset, 0, string, attr]);
}});
...
this.this$0.replace$javax_swing_text_DocumentFilter_FilterBypass$I$I$S$javax_swing_text_AttributeSet.apply(this.this$0, [fb, offset, length, text, attr]);
}});

Clazz.newMeth(C$);
})()
})();
;Clazz.setTVer('3.2.4.07');//Created 2019-06-16 22:44:36 Java2ScriptVisitor version 3.2.4.07 net.sf.j2s.core.jar version 3.2.4.07
