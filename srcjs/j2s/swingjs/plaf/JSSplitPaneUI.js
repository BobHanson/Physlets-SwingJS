(function(){var P$=Clazz.newPackage("swingjs.plaf"),I$=[['java.awt.Component','java.awt.Dimension','swingjs.api.js.DOMNode','javax.swing.LookAndFeel','java.lang.Boolean',['swingjs.plaf.JSSplitPaneUI','.SplitPaneDivider'],'javax.swing.UIManager',['swingjs.plaf.JSSplitPaneUI','.Handler'],'java.awt.Color','javax.swing.JLabel',['swingjs.plaf.JSSplitPaneUI','.SplitPaneLayoutManager']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
Clazz.newMeth(C$, 'fHandleDrag$I$I$I', function (dx, dy, type) {
switch (type) {
case 501:
(I$[3]||$incl$(3)).setCursor("nwse-resize");
break;
case 506:
break;
case 502:
(I$[3]||$incl$(3)).setCursor(null);
break;
}
});
...
this.setBackground$java_awt_Color((I$[9]||$incl$(9)).BLACK);
}
}, 1);
})()
), Clazz.new_((I$[10]||$incl$(10)), [this, null],P$.JSSplitPaneUI$1));
});
...
return Clazz.new_((I$[2]||$incl$(2)).c$$I$I,[0, 0]);
});
...
this.splitPane.setDividerLocationInt$I(location);
...
C$.$init$.apply(this);
this.setOpaque$Z(true);
var fHandleDrag = null;
{
fHandleDrag = function(xyev,type){ui.fHandleDrag$I$I$I(xyev.dx, xyev.dy,type)};
}
ui.setDraggable$javajs_api_JSFunction(fHandleDrag);
}, 1);
...
this.this$0.getHandler().focusGained$java_awt_event_FocusEvent(ev);
});

Clazz.newMeth(C$, 'focusLost$java_awt_event_FocusEvent', function (ev) {
this.this$0.getHandler().focusLost$java_awt_event_FocusEvent(ev);
});
...
this.this$0.splitPane.setDividerLocationInt$I(Math.max(0, this.this$0.getDividerLocation$javax_swing_JSplitPane(this.this$0.splitPane) - this.this$0.getKeyboardMoveIncrement()));
}});
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent', function (ev) {
if (this.this$0.dividerKeyboardResize) {
this.this$0.splitPane.setDividerLocationInt$I(this.this$0.getDividerLocation$javax_swing_JSplitPane(this.this$0.splitPane) + this.this$0.getKeyboardMoveIncrement());
}});
...
Clazz.newMeth(C$, 'actionPerformed$java_awt_event_ActionEvent', function (ev) {
if (this.this$0.dividerKeyboardResize) {
this.this$0.splitPane.setDividerLocationInt$I(0);
}});
...
this.this$0.splitPane.setDividerLocationInt$I(this.this$0.splitPane.getHeight() - bottomI);
} else {
this.this$0.splitPane.setDividerLocationInt$I(this.this$0.splitPane.getWidth() - rightI);
}}});
...
return Clazz.new_((I$[2]||$incl$(2)).c$$I$I,[2147483647, 2147483647]);
});
...
Clazz.newInstance(this, arguments[0],true,C$);
}, ['swingjs.plaf.JSSplitPaneUI','swingjs.plaf.JSSplitPaneUI.SplitPaneLayoutManager']);
...
this.this$0.setNonContinuousLayoutDivider$java_awt_Component$Z(this.this$0.createDefaultNonContinuousLayoutDivider(), true);
