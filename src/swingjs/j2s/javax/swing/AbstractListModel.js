(function(){var P$=Clazz.newPackage("javax.swing"),I$=[['javax.swing.event.EventListenerList','javax.swing.event.ListDataListener','javax.swing.event.ListDataEvent']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
this.listenerList.add$Class$TT(Clazz.getClass((I$[2]||$incl$(2)),['contentsChanged$javax_swing_event_ListDataEvent','intervalAdded$javax_swing_event_ListDataEvent','intervalRemoved$javax_swing_event_ListDataEvent']), l);
});

Clazz.newMeth(C$, 'removeListDataListener$javax_swing_event_ListDataListener', function (l) {
this.listenerList.remove$Class$TT(Clazz.getClass((I$[2]||$incl$(2)),['contentsChanged$javax_swing_event_ListDataEvent','intervalAdded$javax_swing_event_ListDataEvent','intervalRemoved$javax_swing_event_ListDataEvent']), l);
});

Clazz.newMeth(C$, 'getListDataListeners', function () {
return this.listenerList.getListeners$Class(Clazz.getClass((I$[2]||$incl$(2)),['contentsChanged$javax_swing_event_ListDataEvent','intervalAdded$javax_swing_event_ListDataEvent','intervalRemoved$javax_swing_event_ListDataEvent']));
});
