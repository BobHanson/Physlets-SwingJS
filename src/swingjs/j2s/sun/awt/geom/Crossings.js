(function(){var P$=Clazz.newPackage("sun.awt.geom"),I$=[['java.util.Vector',['sun.awt.geom.Crossings','.EvenOdd'],'sun.awt.geom.Curve']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
this.tmp = Clazz.new_((I$[1]||$incl$(1)));
}, 1);
...
var cross = Clazz.new_((I$[2]||$incl$(2)).c$$D$D$D$D,[xlo, ylo, xhi, yhi]);
...
}(I$[3]||$incl$(3)).insertQuad$java_util_Vector$D$D$DA(this.tmp, x0, y0, coords);
...
}(I$[3]||$incl$(3)).insertCubic$java_util_Vector$D$D$DA(this.tmp, x0, y0, coords);
var enum_ = this.tmp.elements();
while (enum_.hasMoreElements()){
var c = enum_.nextElement();
if (c.accumulateCrossings$sun_awt_geom_Crossings(this)) {
...
System.arraycopy(this.crosscounts, (cur/2|0) + 1, this.crosscounts, (cur/2|0), (rem/2|0));
}});
