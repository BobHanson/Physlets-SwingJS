(function(){var P$=Clazz.newPackage("javax.swing"),I$=[['javax.swing.SwingUtilities','java.awt.Point','javajs.util.Lst','javax.swing.DefaultSingleSelectionModel',['javax.swing.JTabbedPane','.ModelListener'],'javax.swing.event.ChangeListener','javax.swing.event.ChangeEvent',['javax.swing.JTabbedPane','.Page'],'javax.swing.UIManager']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
this.listenerList.add$Class$TT(Clazz.getClass((I$[6]||$incl$(6)),['stateChanged$javax_swing_event_ChangeEvent']), l);
});

Clazz.newMeth(C$, 'removeChangeListener$javax_swing_event_ChangeListener', function (l) {
this.listenerList.remove$Class$TT(Clazz.getClass((I$[6]||$incl$(6)),['stateChanged$javax_swing_event_ChangeEvent']), l);
});

Clazz.newMeth(C$, 'getChangeListeners', function () {
return this.listenerList.getListeners$Class(Clazz.getClass((I$[6]||$incl$(6)),['stateChanged$javax_swing_event_ChangeEvent']));
});
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["component not found in tabbed pane"]);
}});
...
this.pages.add$I$TE(newIndex, Clazz.new_((I$[8]||$incl$(8)).c$$javax_swing_JTabbedPane$S$javax_swing_Icon$javax_swing_Icon$java_awt_Component$S, [this, null, this, title != null  ? title : "", icon, null, component, tip]));
if (component != null ) {
...
throw Clazz.new_(Clazz.load('java.lang.IndexOutOfBoundsException').c$$S,["Index: " + index + ", Tab count: " + this.pages.size() ]);
}});
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Component is already added to this JTabbedPane"]);
...
this.setDisplayedMnemonicIndex$I((I$[1]||$incl$(1)).findDisplayedMnemonicIndex$S$I(this.title, this.mnemonic));
});
...
var r = this.getBounds();
return Clazz.new_((I$[2]||$incl$(2)).c$$I$I,[r.x, r.y]);
});
