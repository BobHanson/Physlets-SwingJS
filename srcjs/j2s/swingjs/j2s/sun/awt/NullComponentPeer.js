(function(){var P$=Clazz.newPackage("sun.awt"),I$=[['java.awt.Dimension','java.awt.Point','java.awt.Insets','java.awt.Rectangle']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
return Clazz.new_((I$[1]||$incl$(1)).c$$I$I,[1, 1]);
});
...
throw Clazz.new_(Clazz.load('java.lang.IllegalStateException').c$$S,["Page-flipping is not allowed on a lightweight component"]);
});
...
return Clazz.new_((I$[4]||$incl$(4)).c$$I$I$I$I,[0, 0, 0, 0]);
});
