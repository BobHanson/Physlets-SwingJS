(function(){var P$=Clazz.newPackage("sun.util.calendar"),I$=[['java.util.Date','sun.util.calendar.CalendarSystem','java.util.SimpleTimeZone']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
return p$.getOffsets$J$IA$I.apply(this, [date, null, 0]);
});

Clazz.newMeth(C$, 'getOffsets$J$IA', function (utc, offsets) {
return p$.getOffsets$J$IA$I.apply(this, [utc, offsets, 0]);
});

Clazz.newMeth(C$, 'getOffsetsByStandard$J$IA', function (standard, offsets) {
return p$.getOffsets$J$IA$I.apply(this, [standard, offsets, 1]);
});

Clazz.newMeth(C$, 'getOffsetsByWall$J$IA', function (wall, offsets) {
return p$.getOffsets$J$IA$I.apply(this, [wall, offsets, 2]);
});
...
p$.getOffsets$J$IA$I.apply(this, [System.currentTimeMillis(), offsets, 0]);
return offsets[0];
});
...
var index = p$.getTransitionIndex$J$I.apply(this, [utc, 0]);
if (index < 0) {
return false;
}if (index < this.transitions.length) {
...
return this.getClass().getName() + "[id=\"" + this.getID() + "\"" + ",offset=" + p$.getLastRawOffset.apply(this, []) + ",dstSavings=" + this.dstSavings + ",useDaylight=" + this.useDaylightTime() + ",transitions=" + ((this.transitions != null ) ? this.transitions.length : 0) + ",lastRule=" + (this.lastRule == null  ? this.getLastRuleInstance() : this.lastRule) + "]" ;
});
...
return Clazz.new_((I$[3]||$incl$(3)).c$$I$S$I$I$I$I$I$I$I$I$I$I$I,[p$.getLastRawOffset.apply(this, []), this.getID(), this.simpleTimeZoneParams[0], this.simpleTimeZoneParams[1], this.simpleTimeZoneParams[2], this.simpleTimeZoneParams[3], this.simpleTimeZoneParams[4], this.simpleTimeZoneParams[5], this.simpleTimeZoneParams[6], this.simpleTimeZoneParams[7], this.simpleTimeZoneParams[8], this.simpleTimeZoneParams[9], this.dstSavings]);
}return Clazz.new_((I$[3]||$incl$(3)).c$$I$S$I$I$I$I$I$I$I$I$I,[p$.getLastRawOffset.apply(this, []), this.getID(), this.simpleTimeZoneParams[0], this.simpleTimeZoneParams[1], this.simpleTimeZoneParams[2], this.simpleTimeZoneParams[3], this.simpleTimeZoneParams[4], this.simpleTimeZoneParams[5], this.simpleTimeZoneParams[6], this.simpleTimeZoneParams[7], this.dstSavings]);
});
...
return p$.getLastRawOffset.apply(this, []) ^ this.checksum;
});
...
return (this.getID().equals$O(that.getID()) && (p$.getLastRawOffset.apply(this, []) == that.getLastRawOffset()) && (this.checksum == that.checksum)  );
});
...
}if (p$.getLastRawOffset.apply(this, []) != (other).getLastRawOffset()) {
return false;
