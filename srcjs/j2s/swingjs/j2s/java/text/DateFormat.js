(function(){var P$=Clazz.newPackage("java.text"),I$=[['java.util.HashMap','java.util.Date','java.lang.StringBuffer','java.text.DontCareFieldPosition','java.text.ParsePosition','java.util.Locale','java.text.SimpleDateFormat']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
if (Clazz.instanceOf(obj, "java.util.Date")) return this.format$java_util_Date$StringBuffer$java_text_FieldPosition(obj, toAppendTo, fieldPosition);
 else if (Clazz.instanceOf(obj, "java.lang.Number")) return this.format$java_util_Date$StringBuffer$java_text_FieldPosition(Clazz.new_((I$[2]||$incl$(2)),[(obj).longValue()]), toAppendTo, fieldPosition);
 else throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Cannot format given Object as a Date"]);
});

Clazz.newMeth(C$, 'format$java_util_Date', function (date) {
return this.format$java_util_Date$StringBuffer$java_text_FieldPosition(date, Clazz.new_((I$[3]||$incl$(3))), (I$[4]||$incl$(4)).INSTANCE).toString();
});

Clazz.newMeth(C$, 'parse$S', function (source) {
var pos = Clazz.new_((I$[5]||$incl$(5)).c$$I,[0]);
...
return C$.get$I$I$I$java_util_Locale(2, 0, 1, (I$[6]||$incl$(6)).getDefault());
}, 1);

Clazz.newMeth(C$, 'getTimeInstance$I', function (style) {
return C$.get$I$I$I$java_util_Locale(style, 0, 1, (I$[6]||$incl$(6)).getDefault());
}, 1);
...
return C$.get$I$I$I$java_util_Locale(0, 2, 2, (I$[6]||$incl$(6)).getDefault());
}, 1);

Clazz.newMeth(C$, 'getDateInstance$I', function (style) {
return C$.get$I$I$I$java_util_Locale(0, style, 2, (I$[6]||$incl$(6)).getDefault());
}, 1);
...
return C$.get$I$I$I$java_util_Locale(2, 2, 3, (I$[6]||$incl$(6)).getDefault());
}, 1);

Clazz.newMeth(C$, 'getDateTimeInstance$I$I', function (dateStyle, timeStyle) {
return C$.get$I$I$I$java_util_Locale(timeStyle, dateStyle, 3, (I$[6]||$incl$(6)).getDefault());
}, 1);
...
return Clazz.new_((I$[7]||$incl$(7)).c$$S,["M/d/yy h:mm a"]);
} else {
throw e;
}
}
...
}, ['java.text.Format','java.text.Format.Field']);
C$.$instanceMap = null;
...
C$.$clinit$ = function() {Clazz.load(C$, 1);
C$.$instanceMap = Clazz.new_((I$[1]||$incl$(1)).c$$I,[18]);
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Unknown Calendar constant " + calendarField]);
