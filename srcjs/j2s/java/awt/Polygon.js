(function(){var P$=Clazz.newPackage("java.awt"),I$=[['java.util.Arrays','java.awt.Rectangle',['sun.awt.geom.Crossings','.EvenOdd'],['java.awt.Polygon','.PolygonPathIterator']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
var cross = Clazz.new_((I$[3]||$incl$(3)).c$$D$D$D$D,[xlo, ylo, xhi, yhi]);
var lastx = this.xpoints[this.npoints - 1];
var lasty = this.ypoints[this.npoints - 1];
var curx;
var cury;
...
return false;
}var cross = p$.getCrossings$D$D$D$D.apply(this, [x, y, x + w, y + h]);
...
return Clazz.new_((I$[4]||$incl$(4)).c$$java_awt_Polygon$java_awt_geom_AffineTransform, [this, null, this, at]);
});
