(function(){var P$=Clazz.newPackage("gnu.jpdf"),I$=[['javax.print.attribute.HashPrintRequestAttributeSet','gnu.jpdf.PDFInfo','javax.print.attribute.standard.Copies','javax.print.attribute.standard.JobName','javax.print.attribute.standard.RequestingUserName','java.io.File','java.io.FileOutputStream','gnu.jpdf.PDFJob','javax.swing.JFileChooser','java.util.Locale']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
return (this.attributes.get$Class(Clazz.getClass((I$[3]||$incl$(3))))).getValue();
});

Clazz.newMeth(C$, 'getJobName', function () {
return (this.attributes.get$Class(Clazz.getClass((I$[4]||$incl$(4))))).getValue();
});
...
return (this.attributes.get$Class(Clazz.getClass((I$[5]||$incl$(5))))).getValue();
});
...
this.attributes.add$javax_print_attribute_Attribute(Clazz.new_((I$[3]||$incl$(3)).c$$I,[copies]));
});
...
this.attributes.add$javax_print_attribute_Attribute(Clazz.new_((I$[4]||$incl$(4)).c$$S$java_util_Locale,[jobName, (I$[10]||$incl$(10)).getDefault()]));
