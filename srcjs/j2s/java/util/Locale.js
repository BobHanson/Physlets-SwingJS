(function(){var P$=java.util,I$=[['java.util.HashMap','java.lang.StringBuilder','java.lang.InternalError']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.cache = Clazz.new_((I$[1]||$incl$(1)).c$$I,[32]);
...
var result = Clazz.new_((I$[2]||$incl$(2)).c$$S,[this.language]);
if (c || (l && v ) ) {
