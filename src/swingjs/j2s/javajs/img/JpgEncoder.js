(function(){var P$=Clazz.newPackage("javajs.img"),I$=[['javajs.img.JpegObj','javajs.img.DCT','javajs.img.Huffman','javajs.util.AU']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
this.jpegObj = Clazz.new_((I$[1]||$incl$(1)));
...
this.dct = Clazz.new_((I$[2]||$incl$(2)).c$$I,[this.quality]);
this.huf = Clazz.new_((I$[3]||$incl$(3)).c$$I$I,[this.width, this.height]);
...
dctArray2 = (I$[2]||$incl$(2)).forwardDCT$FAA(dctArray1);
dctArray3 = (I$[2]||$incl$(2)).quantizeBlock$DAA$DA(dctArray2, dct.divisors[qNumber]);
...
for (j = 0; j < 64; j++) {
dqt[offset++] = ((tempArray[(I$[3]||$incl$(3)).jpegNaturalOrder[j]]|0)|0);
}
}
...
this.WriteDHTHeader$IA$IA((I$[3]||$incl$(3)).bitsDCluminance, (I$[3]||$incl$(3)).valDCluminance);
this.WriteDHTHeader$IA$IA((I$[3]||$incl$(3)).bitsACluminance, (I$[3]||$incl$(3)).valACluminance);
this.WriteDHTHeader$IA$IA((I$[3]||$incl$(3)).bitsDCchrominance, (I$[3]||$incl$(3)).valDCchrominance);
this.WriteDHTHeader$IA$IA((I$[3]||$incl$(3)).bitsACchrominance, (I$[3]||$incl$(3)).valACchrominance);
