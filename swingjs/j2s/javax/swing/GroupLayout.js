...
this.$max=max;
this.$pref=pref;
p$4.getComponentInfo$java_awt_Component.apply(this.this$0, [component]);
}, 1);
...
return p$4.getComponentInfo$java_awt_Component.apply(this.this$0, [this.getComponent$()]).isVisible$();
});
...
if (!this.isVisible$()) {
return 0;
}var ci=p$4.getComponentInfo$java_awt_Component.apply(this.this$0, [this.component]);
...
Clazz.newMeth(C$, 'getBaseline$', function () {
if (this.baseline == -1) {
var horizontalSpring=p$4.getComponentInfo$java_awt_Component.apply(this.this$0, [this.component]).horizontalSpring;
...
return p$4.getComponentInfo$java_awt_Component.apply(this.this$0, [this.component]).isLinked$I(axis);
}, p$5);
...
this.installed=true;
if (axis == 0) {
p$4.getComponentInfo$java_awt_Component.apply(this.this$0, [this.component]).horizontalSpring=this;
} else {
p$4.getComponentInfo$java_awt_Component.apply(this.this$0, [this.component]).verticalSpring=this;
}}});
...
position=5;
}return p$4.getLayoutStyle0.apply(this.this$0, []).getPreferredGap$javax_swing_JComponent$javax_swing_JComponent$javax_swing_LayoutStyle_ComponentPlacement$I$java_awt_Container(this.source, this.target, this.type, position, this.this$0.host);
}, p$6);
...
var p=p$4.getLayoutStyle0.apply(this.this$0, []);
var position;
if (axis == 0) {
if (p$4.isLeftToRight.apply(this.this$0, [])) {
position=3;
} else {
position=7;
}} else {
...
if (this.source != null ) {
if (p$4.areParallelSiblings$java_awt_Component$java_awt_Component$I.apply(this.this$0, [this.source.getComponent$(), spring.getComponent$(), oAxis])) {
...
if (p$4.areParallelSiblings$java_awt_Component$java_awt_Component$I.apply(this.this$0, [source.getComponent$(), component, oAxis])) {
