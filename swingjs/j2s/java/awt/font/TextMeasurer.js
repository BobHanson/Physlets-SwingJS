...
text.first$();
this.fBidi=Clazz.new_($I$(2).c$$java_text_AttributedCharacterIterator,[text]);
if (this.fBidi.isLeftToRight$()) {
this.fBidi=null;
}text.first$();
var paragraphAttrs=text.getAttributes$();
this.fParagraph=Clazz.new_($I$(3).c$$java_text_AttributedCharacterIterator$CA,[text, this.fChars]);
{
...
var lm=defaultFont.getLineMetrics$CA$I$I$O(this.fChars, charsStart, charsStart + 1, this.fFrc);
this.fBaseline=($b$[0] = (lm.getBaselineIndex$()|0), $b$[0]);
this.fBaselineOffsets=lm.getBaselineOffsets$();
} else {
var graphic=paragraphAttrs.get$O($I$(6).CHAR_REPLACEMENT);
this.fBaseline=($b$[0] = $I$(7).getBaselineFromGraphic$java_awt_font_GraphicAttribute(graphic), $b$[0]);
var fmap=Clazz.new_($I$(8).c$$I$F,[5, 0.9]);
var dummyFont=Clazz.new_($I$(9).c$$java_util_Map,[fmap]);
var lm=dummyFont.getLineMetrics$S$I$I$O(" ", 0, 1, this.fFrc);
this.fBaselineOffsets=lm.getBaselineOffsets$();
}this.fBaselineOffsets=$I$(5).getNormalizedOffsets$FA$B(this.fBaselineOffsets, ($b$[0] = this.fBaseline, $b$[0]));
...
var factory=Clazz.new_($I$(10).c$$java_awt_font_FontRenderContext$CA$java_text_Bidi$I,[this.fFrc, this.fChars, this.fBidi, layoutFlags]);
var charsLtoV=null;
if (this.fBidi != null ) {
...
var baseLevel=($b$[0] = ((this.fIsDirectionLTR ? 0 : 1)|0), $b$[0]);
...
return Clazz.new_($I$(5).c$$java_awt_font_FontRenderContext$sun_font_TextLineComponentA$FA$CA$I$I$IA$BA$Z,[this.fFrc, components, this.fBaselineOffsets, this.fChars, startPos, limitPos, charsLtoV, charLevels, this.fIsDirectionLTR]);
}, p$1);
...
this.charIter=Clazz.new_($I$(13).c$$CA,[this.fChars]);
} else {
...
this.layoutCount++;
}return Clazz.new_($I$(7).c$$java_awt_font_TextLine$B$FA$F,[textLine, ($b$[0] = this.fBaseline, $b$[0]), this.fBaselineOffsets, this.fJustifyRatio]);
});
...
this.fBidi=Clazz.new_($I$(2).c$$java_text_AttributedCharacterIterator,[newParagraph]);
if (this.fBidi.isLeftToRight$()) {
this.fBidi=null;
