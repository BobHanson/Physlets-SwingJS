(function(){var P$=Clazz.newPackage("swingjs.plaf"),I$=[['swingjs.plaf.JSTableHeaderUI','javax.swing.SwingUtilities','java.awt.Cursor','swingjs.plaf.JSTableHeaderUI$1','swingjs.api.js.DOMNode','java.awt.Component','swingjs.plaf.CellHolder',['swingjs.plaf.JSTableHeaderUI','.MouseInputHandler'],'javax.swing.CellRendererPane','javax.swing.LookAndFeel','java.lang.Boolean','sun.swing.DefaultLookup','swingjs.plaf.LazyActionMap',['swingjs.plaf.JSTableHeaderUI','.Actions'],'java.awt.Point','java.awt.Dimension']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.resizeCursor = (I$[3]||$incl$(3)).getPredefinedCursor$I(11);
C$.focusListener = ((
...
p$.repaintHeader$O.apply(this, [e.getSource()]);
});
...
if (ui == null ) {
return;
}System.out.println$S("repaintHeader");
th.repaint$java_awt_Rectangle(th.getHeaderRect$I(ui.getSelectedColumnIndex()));
}});
})()
...
var td = (I$[7]||$incl$(7)).createCellNode$swingjs_plaf_JSComponentUI$I$I(this, -1, col);
(I$[5]||$incl$(5)).setStyles(td, ["width", cw[col] + "px"]);
(I$[5]||$incl$(5)).setStyles(td, ["height", thh + "px"]);
...
(I$[10]||$incl$(10)).installColorsAndFont$javax_swing_JComponent$S$S$S(this.tableHeader, "TableHeader.background", "TableHeader.foreground", "TableHeader.font");
(I$[10]||$incl$(10)).installProperty$javax_swing_JComponent$S$O(this.tableHeader, "opaque", (I$[11]||$incl$(11)).TRUE);
});
...
var keyMap = (I$[12]||$incl$(12)).get$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S(this.tableHeader, this, "TableHeader.ancestorInputMap");
(I$[2]||$incl$(2)).replaceUIInputMap$javax_swing_JComponent$I$javax_swing_InputMap(this.tableHeader, 1, keyMap);
(I$[13]||$incl$(13)).installLazyActionMap$javax_swing_JComponent$Class$S(this.tableHeader, Clazz.getClass(C$), "TableHeader.actionMap");
});
...
(I$[2]||$incl$(2)).replaceUIInputMap$javax_swing_JComponent$I$javax_swing_InputMap(this.tableHeader, 0, null);
(I$[2]||$incl$(2)).replaceUIActionMap$javax_swing_JComponent$javax_swing_ActionMap(this.tableHeader, null);
});

Clazz.newMeth(C$, 'loadActionMap$swingjs_plaf_LazyActionMap', function (map) {
map.put$javax_swing_Action(Clazz.new_((I$[14]||$incl$(14)).c$$S,["toggleSortOrder"]));
map.put$javax_swing_Action(Clazz.new_((I$[14]||$incl$(14)).c$$S,["selectColumnToLeft"]));
map.put$javax_swing_Action(Clazz.new_((I$[14]||$incl$(14)).c$$S,["selectColumnToRight"]));
map.put$javax_swing_Action(Clazz.new_((I$[14]||$incl$(14)).c$$S,["moveColumnLeft"]));
map.put$javax_swing_Action(Clazz.new_((I$[14]||$incl$(14)).c$$S,["moveColumnRight"]));
map.put$javax_swing_Action(Clazz.new_((I$[14]||$incl$(14)).c$$S,["resizeLeft"]));
map.put$javax_swing_Action(Clazz.new_((I$[14]||$incl$(14)).c$$S,["resizeRight"]));
map.put$javax_swing_Action(Clazz.new_((I$[14]||$incl$(14)).c$$S,["focusTable"]));
}, 1);
...
var newIndex = p$.getSelectedColumnIndex.apply(this, []);
...
var right = Clazz.new_((I$[15]||$incl$(15)).c$$I$I,[clip.x + clip.width - 1, clip.y]);
...
Clazz.newMeth(C$, 'getHeaderRenderer$I', function (columnIndex) {
...
var component = p$.getHeaderRenderer$I.apply(this, [columnIndex]);
...
Clazz.newMeth(C$, '$init$', function () {
this.otherCursor = (I$[1]||$incl$(1)).resizeCursor;
}, 1);
...
return p$.getResizingColumn$java_awt_Point$I.apply(this, [p, this.this$0.tableHeader.columnAtPoint$java_awt_Point(p)]);
});
...
if (index != -1) {
var resizingColumn = p$.getResizingColumn$java_awt_Point$I.apply(this, [p, index]);
...
if (P$.JSTableHeaderUI.canResize$javax_swing_table_TableColumn$javax_swing_table_JTableHeader(p$.getResizingColumn$java_awt_Point.apply(this, [e.getPoint()]), this.this$0.tableHeader) != (this.this$0.tableHeader.getCursor() === (I$[1]||$incl$(1)).resizeCursor ) ) {
p$.swapCursor.apply(this, []);
}this.this$0.updateRolloverColumn$java_awt_event_MouseEvent.apply(this.this$0, [e]);
});
...
var columnIndex = this.this$0.viewIndexForColumn$javax_swing_table_TableColumn.apply(this.this$0, [draggedColumn]);
...
this.this$0.selectColumn$I$Z(table.convertColumnIndexToView$I(selectedIndex), false);
return;
}}p$.setDraggedDistance$I$I.apply(this, [draggedDistance, columnIndex]);
}this.this$0.updateRolloverColumn$java_awt_event_MouseEvent.apply(this.this$0, [e]);
});

Clazz.newMeth(C$, 'mouseReleased$java_awt_event_MouseEvent', function (e) {
p$.setDraggedDistance$I$I.apply(this, [0, this.this$0.viewIndexForColumn$javax_swing_table_TableColumn.apply(this.this$0, [this.this$0.tableHeader.getDraggedColumn()])]);
this.this$0.tableHeader.setResizingColumn$javax_swing_table_TableColumn(null);
this.this$0.tableHeader.setDraggedColumn$javax_swing_table_TableColumn(null);
this.this$0.updateRolloverColumn$java_awt_event_MouseEvent.apply(this.this$0, [e]);
});
...
return th.getReorderingAllowed() && p$.maybeMoveColumn$Z$javax_swing_table_JTableHeader$swingjs_plaf_JSTableHeaderUI$Z.apply(this, [true, th, ui, false]) ;
} else if (key == "moveColumnRight") {
return th.getReorderingAllowed() && p$.maybeMoveColumn$Z$javax_swing_table_JTableHeader$swingjs_plaf_JSTableHeaderUI$Z.apply(this, [false, th, ui, false]) ;
} else if (key == "resizeLeft" || key == "resizeRight" ) {
return P$.JSTableHeaderUI.canResize$javax_swing_table_TableColumn$javax_swing_table_JTableHeader(cm.getColumn$I(ui.getSelectedColumnIndex()), th);
...
ui.selectPreviousColumn$Z(true);
} else {
ui.selectNextColumn$Z(true);
...
p$.moveColumn$Z$javax_swing_table_JTableHeader$swingjs_plaf_JSTableHeaderUI.apply(this, [true, th, ui]);
} else if ("moveColumnRight" == name) {
p$.moveColumn$Z$javax_swing_table_JTableHeader$swingjs_plaf_JSTableHeaderUI.apply(this, [false, th, ui]);
} else if ("resizeLeft" == name) {
p$.resize$Z$javax_swing_table_JTableHeader$swingjs_plaf_JSTableHeaderUI.apply(this, [true, th, ui]);
} else if ("resizeRight" == name) {
p$.resize$Z$javax_swing_table_JTableHeader$swingjs_plaf_JSTableHeaderUI.apply(this, [false, th, ui]);
...
p$.maybeMoveColumn$Z$javax_swing_table_JTableHeader$swingjs_plaf_JSTableHeaderUI$Z.apply(this, [leftArrow, th, ui, true]);
});
