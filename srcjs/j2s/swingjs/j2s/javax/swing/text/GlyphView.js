(function(){var P$=Clazz.newPackage("javax.swing.text"),I$=[[['javax.swing.text.Position','.Bias'],'javax.swing.text.SegmentCache','javax.swing.text.StateInvariantError','javax.swing.text.StyleConstants','java.lang.Boolean','javax.swing.text.AbstractDocument','java.util.BitSet',['javax.swing.text.GlyphView','.JustificationInfo']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
if (attr.isDefined$O((I$[4]||$incl$(4)).Background)) {
...
var attr = this.getAttributes();
return (I$[4]||$incl$(4)).isUnderline$javax_swing_text_AttributeSet(attr);
});

Clazz.newMeth(C$, 'isStrikeThrough', function () {
var attr = this.getAttributes();
return (I$[4]||$incl$(4)).isStrikeThrough$javax_swing_text_AttributeSet(attr);
});

Clazz.newMeth(C$, 'isSubscript', function () {
var attr = this.getAttributes();
return (I$[4]||$incl$(4)).isSubscript$javax_swing_text_AttributeSet(attr);
});

Clazz.newMeth(C$, 'isSuperscript', function () {
var attr = this.getAttributes();
return (I$[4]||$incl$(4)).isSuperscript$javax_swing_text_AttributeSet(attr);
});
...
var doc = this.getDocument();
if (doc != null  && (I$[5]||$incl$(5)).TRUE.equals(doc.getProperty$O((I$[6]||$incl$(6)).MultiByteProperty)) ) {
...
var leadingSpaces = 0;
var hasTab = false;
var spaceMap = Clazz.new_((I$[7]||$incl$(7)).c$$I,[endOffset - startOffset + 1]);
