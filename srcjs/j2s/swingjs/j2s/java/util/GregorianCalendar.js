(function(){var P$=java.util,I$=[['sun.util.calendar.CalendarSystem','java.util.TimeZone','java.util.Locale','java.util.Date','sun.util.calendar.AbstractCalendar','sun.util.calendar.CalendarUtils']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.c$$java_util_TimeZone$java_util_Locale.apply(this, [zone, (I$[3]||$incl$(3)).getDefault()]);
}, 1);

Clazz.newMeth(C$, 'c$$java_util_Locale', function (aLocale) {
C$.c$$java_util_TimeZone$java_util_Locale.apply(this, [(I$[2]||$incl$(2)).getDefaultRef(), aLocale]);
this.setZoneShared$Z(true);
}, 1);
...
C$.$init$.apply(this);
this.gdate = p$.getGcal.apply(this, []).newCalendarDate$java_util_TimeZone(zone);
...
C$.$init$.apply(this);
this.gdate = p$.getGcal.apply(this, []).newCalendarDate$java_util_TimeZone(this.getZone());
this.set$I$I(1, year);
...
return Clazz.new_((I$[4]||$incl$(4)),[this.gregorianCutover]);
});
...
var d = p$.getCalendarDate$J.apply(this, [this.gregorianCutoverDate]);
...
if (p$.internalGetEra.apply(this, []) == 1) {
year = year+(amount);
if (year > 0) {
this.set$I$I(1, year);
} else {
...
return;
}var fd = p$.getCurrentFixedDate.apply(this, []);
timeOfDay = timeOfDay+(this.internalGet$I(11));
timeOfDay = timeOfDay*(60);
timeOfDay = timeOfDay+(this.internalGet$I(12));
timeOfDay = timeOfDay*(60);
timeOfDay = timeOfDay+(this.internalGet$I(13));
timeOfDay = timeOfDay*(1000);
timeOfDay = timeOfDay+(this.internalGet$I(14));
if (timeOfDay >= 86400000) {
fd++;
timeOfDay = timeOfDay-(86400000);
} else if (timeOfDay < 0) {
fd--;
timeOfDay = timeOfDay+(86400000);
}fd = fd+(delta);
...
zoneOffset = zoneOffset-(this.internalGet$I(15) + this.internalGet$I(16));
if (zoneOffset != 0) {
this.setTimeInMillis$J(this.time + zoneOffset);
var fd2 = p$.getCurrentFixedDate.apply(this, []);
if (fd2 != fd) {
this.setTimeInMillis$J(this.time - zoneOffset);
}}}});
...
if (nh < 0) {
nh = nh+(unit);
}this.time = this.time+(3600000 * (nh - h));
...
var monthLen = p$.monthLength$I.apply(this, [mon]);
...
min++;
}fd = fd+(7 * (max - this.internalGet$I(3)));
...
var monthDay1st = (I$[5]||$incl$(5)).getDayOfWeekDateOnOrBefore$J$I(month1 + 6, this.getFirstDayOfWeek());
if (((monthDay1st - month1)|0) >= this.getMinimalDaysInFirstWeek()) {
monthDay1st = monthDay1st-(7);
...
}var gc = p$.getNormalizedCalendar.apply(this, []);
var date = gc.cdate;
var cal = gc.calsys;
var value = -1;
var d;
...
case 3:
{
dd = cal.newCalendarDate$java_util_TimeZone((I$[2]||$incl$(2)).NO_TIMEZONE);
...
value++;
}monthLength = monthLength-(nDaysFirstWeek + 21);
if (monthLength > 0) {
value++;
if (monthLength > 7) {
value++;
...
var mincal = p$.getGcal.apply(this, []);
...
maxEnd = maxEnd*(60);
maxEnd = maxEnd+(dd.getMinutes());
maxEnd = maxEnd*(60);
maxEnd = maxEnd+(dd.getSeconds());
maxEnd = maxEnd*(1000);
maxEnd = maxEnd+(dd.getMillis());
value = dd.getYear();
if (value <= 0) {
Clazz.assert(C$, this, function(){return mincal === p$.getGcal.apply(this, []) });
value = 1 - value;
}if (current < maxEnd) {
value--;
}}}break;
default:
throw Clazz.new_(Clazz.load('java.lang.ArrayIndexOutOfBoundsException').c$$I,[field]);
}
return value;
});
...
t = t+(this.internalGet$I(11));
t = t*(60);
t = t+(this.internalGet$I(12));
t = t*(60);
t = t+(this.internalGet$I(13));
t = t*(1000);
...
mask = mask|(p$.computeFields$I$I.apply(this, [fieldMask, mask & 98304]));
Clazz.assert(C$, this, function(){return mask == 131071});
}} else {
mask = 131071;
p$.computeFields$I$I.apply(this, [mask, 0]);
...
fixedDate = fixedDate+((this.time/86400000|0));
timeOfDay = timeOfDay+(((this.time % 86400000)|0));
if (timeOfDay >= 86400000) {
timeOfDay = timeOfDay-(86400000);
++fixedDate;
} else {
...
Clazz.assert(C$, this, function(){return this.cachedFixedDate == -9223372036854775808 || p$.getGcal.apply(this, []).getFixedDate$I$I$I$sun_util_calendar_BaseCalendar_Date(this.gdate.getNormalizedYear(), this.gdate.getMonth(), this.gdate.getDayOfMonth(), this.gdate) == this.cachedFixedDate }, function(){return "cache control: inconsictency, cachedFixedDate=" + this.cachedFixedDate + ", computed=" + p$.getGcal.apply(this, []).getFixedDate$I$I$I$sun_util_calendar_BaseCalendar_Date(this.gdate.getNormalizedYear(), this.gdate.getMonth(), this.gdate.getDayOfMonth(), this.gdate) + ", date=" + this.gdate });
if (fixedDate != this.cachedFixedDate) {
p$.getGcal.apply(this, []).getCalendarDateFromFixedDate$sun_util_calendar_CalendarDate$J(this.gdate, fixedDate);
this.cachedFixedDate = fixedDate;
}year = this.gdate.getYear();
if (year <= 0) {
year = 1 - year;
era = 0;
}this.calsys = p$.getGcal.apply(this, []);
...
var cutoverYear = (this.calsys === p$.getGcal.apply(this, []) ) ? this.gregorianCutoverYear : this.gregorianCutoverYearJulian;
...
var weekOfYear = p$.getWeekNumber$J$J.apply(this, [fixedDateJan1, fixedDate]);
if (weekOfYear == 0) {
var fixedDec31 = fixedDateJan1 - 1;
var prevJan1;
prevJan1 = fixedDateJan1 - 365;
if ((I$[6]||$incl$(6)).isGregorianLeapYear$I(normalizedYear - 1)) {
--prevJan1;
}weekOfYear = p$.getWeekNumber$J$J.apply(this, [prevJan1, fixedDec31]);
} else {
...
nextJan1++;
}var nextJan1st = (I$[5]||$incl$(5)).getDayOfWeekDateOnOrBefore$J$I(nextJan1 + 6, this.getFirstDayOfWeek());
...
calForJan1 = p$.getGcal.apply(this, []);
}var nextJan1st = (I$[5]||$incl$(5)).getDayOfWeekDateOnOrBefore$J$I(nextJan1 + 6, this.getFirstDayOfWeek());
var ndays = ((nextJan1st - nextJan1)|0);
if (ndays >= this.getMinimalDaysInFirstWeek() && fixedDate >= (nextJan1st - 7) ) {
weekOfYear = 1;
}}}this.internalSet$I$I(3, weekOfYear);
this.internalSet$I$I(4, p$.getWeekNumber$J$J.apply(this, [fixedDateMonth1, fixedDate]));
mask = mask|(344);
}return mask;
});

Clazz.newMeth(C$, 'getWeekNumber$J$J', function (fixedDay1, fixedDate) {
var fixedDay1st = (I$[5]||$incl$(5)).getDayOfWeekDateOnOrBefore$J$I(fixedDay1 + 6, this.getFirstDayOfWeek());
...
}return (I$[6]||$incl$(6)).floorDivide$I$I(normalizedDayOfPeriod, 7) + 1;
});
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,[P$.Calendar.getFieldName$I(field)]);
}}this.originalFields[field] = value;
}
}var fieldMask = this.selectFields();
var year = this.isSet$I(1) ? this.internalGet$I(1) : 1970;
var era = p$.internalGetEra.apply(this, []);
if (era == 0) {
year = 1 - year;
} else if (era != 1) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Invalid era"]);
...
timeOfDay = timeOfDay+(this.internalGet$I(10));
if (P$.Calendar.isFieldSet$I$I(fieldMask, 9)) {
timeOfDay = timeOfDay+(12 * this.internalGet$I(9));
}}timeOfDay = timeOfDay*(60);
timeOfDay = timeOfDay+(this.internalGet$I(12));
timeOfDay = timeOfDay*(60);
timeOfDay = timeOfDay+(this.internalGet$I(13));
...
calculateFixedDate : {
var gfd;
gfd = fixedDate + p$.getFixedDate$sun_util_calendar_BaseCalendar$I$I.apply(this, [p$.getGcal.apply(this, []), year, fieldMask]);
fixedDate = gfd;
...
this.zoneOffsets[1] = this.internalGet$I(16);
}}millis = millis-(this.zoneOffsets[0] + this.zoneOffsets[1]);
this.time = millis;
var mask = p$.computeFields$I$I.apply(this, [fieldMask | this.getSetStateFields(), tzMask]);
if (!this.isLenient()) {
for (var field = 0; field < 17; field++) {
if (!this.isExternallySet$I(field)) {
continue;
...
year = year+((I$[6]||$incl$(6)).floorDivide$I$I$IA(month, 12, rem));
month = rem[0];
}}var fixedDate = cal.getFixedDate$I$I$I$sun_util_calendar_BaseCalendar_Date(year, month + 1, 1, cal === p$.getGcal.apply(this, [])  ? this.gdate : null);
if (P$.Calendar.isFieldSet$I$I(fieldMask, 2)) {
if (P$.Calendar.isFieldSet$I$I(fieldMask, 5)) {
if (this.isSet$I(5)) {
fixedDate = fixedDate+(this.internalGet$I(5));
fixedDate--;
}} else {
if (P$.Calendar.isFieldSet$I$I(fieldMask, 4)) {
var firstDayOfWeek = (I$[5]||$incl$(5)).getDayOfWeekDateOnOrBefore$J$I(fixedDate + 6, this.getFirstDayOfWeek());
if ((firstDayOfWeek - fixedDate) >= this.getMinimalDaysInFirstWeek()) {
firstDayOfWeek = firstDayOfWeek-(7);
}if (P$.Calendar.isFieldSet$I$I(fieldMask, 7)) {
firstDayOfWeek = (I$[5]||$incl$(5)).getDayOfWeekDateOnOrBefore$J$I(firstDayOfWeek + 6, this.internalGet$I(7));
...
fixedDate = (I$[5]||$incl$(5)).getDayOfWeekDateOnOrBefore$J$I(fixedDate + (7 * dowim) - 1, dayOfWeek);
} else {
var lastDate = p$.monthLength$I$I.apply(this, [month, year]) + (7 * (dowim + 1));
fixedDate = (I$[5]||$incl$(5)).getDayOfWeekDateOnOrBefore$J$I(fixedDate + lastDate - 1, dayOfWeek);
}}}} else {
if (year == this.gregorianCutoverYear && cal === p$.getGcal.apply(this, [])   && fixedDate < this.gregorianCutoverDate  && this.gregorianCutoverYear != this.gregorianCutoverYearJulian ) {
fixedDate = this.gregorianCutoverDate;
}if (P$.Calendar.isFieldSet$I$I(fieldMask, 6)) {
fixedDate = fixedDate+(this.internalGet$I(6));
fixedDate--;
} else {
var firstDayOfWeek = (I$[5]||$incl$(5)).getDayOfWeekDateOnOrBefore$J$I(fixedDate + 6, this.getFirstDayOfWeek());
if ((firstDayOfWeek - fixedDate) >= this.getMinimalDaysInFirstWeek()) {
...
firstDayOfWeek = (I$[5]||$incl$(5)).getDayOfWeekDateOnOrBefore$J$I(firstDayOfWeek + 6, dayOfWeek);
...
var d = cal.newCalendarDate$java_util_TimeZone((I$[2]||$incl$(2)).NO_TIMEZONE);
...
var year = this.internalGet$I(1);
if (p$.internalGetEra.apply(this, []) == 0) {
year = 1 - year;
}return p$.monthLength$I$I.apply(this, [month, year]);
});
...
monthLen = p$.monthLength$I.apply(this, [this.internalGet$I(2)]);
} else {
var gc = p$.getNormalizedCalendar.apply(this, []);
...
return (this.calsys === p$.getGcal.apply(this, []) ) ? this.cachedFixedDate : this.calsys.getFixedDate$sun_util_calendar_CalendarDate(this.cdate);
});
