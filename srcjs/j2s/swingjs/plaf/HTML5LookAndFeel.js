(function(){var P$=Clazz.newPackage("swingjs.plaf"),I$=[['javax.swing.UIDefaults','java.awt.Color','javax.swing.plaf.ColorUIResource','javax.swing.plaf.FontUIResource','javax.swing.plaf.InsetsUIResource',['javax.swing.plaf.BorderUIResource','.EtchedBorderUIResource'],'sun.swing.SwingLazyValue','javax.swing.BorderFactory',['javax.swing.DefaultListCellRenderer','.UIResource'],'swingjs.plaf.HTML5LookAndFeel$1','javax.swing.plaf.DimensionUIResource',['javax.swing.plaf.BorderUIResource','.EmptyBorderUIResource'],'java.awt.Dimension','java.lang.Boolean',['javax.swing.UIDefaults','.LazyInputMap']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
var table = Clazz.new_((I$[1]||$incl$(1)).c$$I$F,[610, 0.75]);
...
var defaultSystemColors = Clazz.array(java.lang.String, -1, ["window", "#FFFFFF", "windowBorder", "#000000", "windowText", "#333333", "menu", "#C0C0C0", "menuText", "#333333", "text", "#C0C0C0", "textText", "#333333", "textHighlight", "#B8CFE5", "textHighlightText", "#000000", "textInactiveText", "#808080", "control", "#EEEEEE", "controlText", "#333333", "controlHighlight", "#C0C0C0", "controlLtHighlight", "#B8CFE5", "controlShadow", "#808080", "controlDkShadow", "#000000", "scrollbar", "#E0E0E0", "info", "#FFFFE1", "infoText", "#000000"]);
...
table.put$O$O(systemColors[i], Clazz.new_((I$[3]||$incl$(3)).c$$java_awt_Color,[color]));
}
});
...
var serifPlain12 = Clazz.new_((I$[4]||$incl$(4)).c$$S$I$I,["Serif", 0, 12]);
var sansSerifPlain12 = Clazz.new_((I$[4]||$incl$(4)).c$$S$I$I,["SansSerif", 0, 12]);
var dialogPlain12 = Clazz.new_((I$[4]||$incl$(4)).c$$S$I$I,["Dialog", 0, 12]);
var monospacedPlain12 = Clazz.new_((I$[4]||$incl$(4)).c$$S$I$I,["Monospaced", 0, 12]);
var red = Clazz.new_((I$[3]||$incl$(3)).c$$java_awt_Color,[(I$[2]||$incl$(2)).red]);
var black = Clazz.new_((I$[3]||$incl$(3)).c$$java_awt_Color,[(I$[2]||$incl$(2)).black]);
var white = Clazz.new_((I$[3]||$incl$(3)).c$$java_awt_Color,[(I$[2]||$incl$(2)).white]);
var gray = Clazz.new_((I$[3]||$incl$(3)).c$$java_awt_Color,[(I$[2]||$incl$(2)).gray]);
var darkGray = Clazz.new_((I$[3]||$incl$(3)).c$$java_awt_Color,[(I$[2]||$incl$(2)).darkGray]);
var scrollBarTrack = Clazz.new_((I$[3]||$incl$(3)).c$$I$I$I,[224, 224, 224]);
...
var zeroInsets = Clazz.new_((I$[5]||$incl$(5)).c$$I$I$I$I,[0, 0, 0, 0]);
var twoInsets = Clazz.new_((I$[5]||$incl$(5)).c$$I$I$I$I,[2, 2, 2, 2]);
var threeInsets = Clazz.new_((I$[5]||$incl$(5)).c$$I$I$I$I,[3, 3, 3, 3]);
var etchedBorder = Clazz.new_((I$[6]||$incl$(6)));
var loweredBevelBorder = Clazz.new_((I$[7]||$incl$(7)).c$$S$S,["javax.swing.plaf.BorderUIResource", "getLoweredBevelBorderUIResource"]);
