(function(){var P$=java.lang,I$=[['org.apache.harmony.luni.util.Msg']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
var C$=Clazz.newClass(java.lang, "AbstractStringBuilder");
var p$=C$.prototype;
...
if (index < 0 || index >= this.count ) throw Clazz.new_(Clazz.load('java.lang.StringIndexOutOfBoundsException').c$$I,[index]);
...
if (0 > location || location >= this.count ) throw Clazz.new_(Clazz.load('java.lang.StringIndexOutOfBoundsException').c$$I,[location]);
...
if (index < 1 || index > this.count ) throw Clazz.new_(Clazz.load('java.lang.StringIndexOutOfBoundsException').c$$I,[index]);
return Character.codePointBefore(this.value, index);
});

Clazz.newMeth(C$, 'codePointCount$I$I', function (beginIndex, endIndex) {
if (beginIndex < 0 || endIndex > this.count  || beginIndex > endIndex ) throw Clazz.new_(Clazz.load('java.lang.StringIndexOutOfBoundsException'));
