(function(){var P$=Clazz.newPackage("java.awt.geom"),I$=[[['java.awt.geom.Point2D','.Float'],['java.awt.geom.Rectangle2D','.Float'],['java.awt.geom.Point2D','.Double'],['java.awt.geom.Rectangle2D','.Double'],'java.awt.geom.LineIterator','java.lang.InternalError']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
return this.intersects$java_awt_geom_Rectangle2D(Clazz.new_((I$[4]||$incl$(4)).c$$D$D$D$D,[x, y, w, h]));
});
...
return Clazz.new_((I$[5]||$incl$(5)).c$$java_awt_geom_Line2D$java_awt_geom_AffineTransform,[this, at]);
});
