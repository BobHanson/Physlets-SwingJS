...
this.eventFilters = Clazz.new_((I$[4]||$incl$(4)));
this.modalFiltersCount = 0;
...
), Clazz.new_((I$[5]||$incl$(5)).$init$, [this, {myid: myid}]));
var f = null;
var me = this;
var mode = 1;
{
...
var stopEvent = Clazz.new_((I$[7]||$incl$(7)), [this, null]);
...
this.pumpEventsForFilter$I$java_awt_Conditional$java_awt_EventFilter(id, cond, Clazz.new_((I$[9]||$incl$(9)).c$$java_awt_Component,[modalComponent]));
});
