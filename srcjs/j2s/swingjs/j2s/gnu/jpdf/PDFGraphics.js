(function(){var P$=Clazz.newPackage("gnu.jpdf"),I$=[['java.awt.geom.AffineTransform','java.awt.BasicStroke','java.text.DecimalFormat','java.awt.image.BufferedImage','java.awt.RenderingHints','java.awt.geom.Area','java.awt.Rectangle',['java.awt.geom.Point2D','.Double'],'gnu.jpdf.PDFImage','java.util.Hashtable','gnu.jpdf.PDFStringHelper','java.awt.Color','java.awt.Font','java.awt.font.FontRenderContext','gnu.jpdf.PDFStream',['java.awt.geom.Point2D','.Float']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.IDENTITY = Clazz.new_((I$[1]||$incl$(1)));
C$.DEF_STROKE = Clazz.new_((I$[2]||$incl$(2)));
C$.df = Clazz.new_((I$[3]||$incl$(3)).c$$S,["#.###"]);
}
...
this.dg2 = Clazz.new_((I$[4]||$incl$(4)).c$$I$I$I,[2, 2, 1]).createGraphics();
this.lineCap = 0;
this.lineJoin = 0;
this.lineWidth = 1.0;
this.miterLimit = 10.0;
this.rhints = Clazz.new_((I$[5]||$incl$(5)).c$$java_util_Map,[null]);
}, 1);
...
p$.arc_add$Z$D$D$D$D$D$D$D$D.apply(this, [first, width, height, x0, y0, (axc + width * Math.cos(ang2r)), (ayc + height * Math.sin(ang2r)), xt, yt]);
});
...
var ptSrc = Clazz.new_((I$[8]||$incl$(8)).c$$D$D,[x, y]);
var ptDst = Clazz.new_((I$[8]||$incl$(8)));
...
p$.followPath$java_awt_Shape$I.apply(this, [s, 2]);
});
...
this.closeBlock();
var image = Clazz.new_((I$[9]||$incl$(9)).c$$java_awt_Image$I$I$I$I$java_awt_image_ImageObserver,[img, x, y, w, h, obs]);
...
var properties = Clazz.new_((I$[10]||$incl$(10)));
...
this.pw.println$S((I$[11]||$incl$(11)).makePDFString$S(s) + " Tj");
});
...
return (Clazz.instanceOf(this.paint, "java.awt.Color")) ? this.paint : (I$[12]||$incl$(12)).black;
});
...
if (this.font == null ) this.setFont$java_awt_Font(Clazz.new_((I$[13]||$incl$(13)).c$$S$I$I,["SansSerif", 0, 12]));
return this.font;
});
...
var antialias = (I$[5]||$incl$(5)).VALUE_TEXT_ANTIALIAS_ON.equals$O(this.getRenderingHint$java_awt_RenderingHints_Key((I$[5]||$incl$(5)).KEY_TEXT_ANTIALIASING));
var fractions = (I$[5]||$incl$(5)).VALUE_FRACTIONALMETRICS_ON.equals$O(this.getRenderingHint$java_awt_RenderingHints_Key((I$[5]||$incl$(5)).KEY_FRACTIONALMETRICS));
return Clazz.new_((I$[14]||$incl$(14)).c$$java_awt_geom_AffineTransform$Z$Z,[Clazz.new_((I$[1]||$incl$(1))), antialias, fractions]);
});
...
return Clazz.new_((I$[1]||$incl$(1)).c$$java_awt_geom_AffineTransform,[this.oTransform]);
});
...
p$.setLineJoin$I.apply(this, [bs.getLineJoin()]);
this.setLineWidth$F(bs.getLineWidth());
p$.setMiterLimit$F.apply(this, [bs.getMiterLimit()]);
}});
...
}return Clazz.new_((I$[2]||$incl$(2)).c$$F$I$I$F$FA$F,[st.getLineWidth() * scale, st.getEndCap(), st.getLineJoin(), st.getMiterLimit(), dash, st.getDashPhase() * scale]);
});
...
var ptSrc = Clazz.new_((I$[16]||$incl$(16)).c$$F$F,[x, y]);
var ptDst = Clazz.new_((I$[16]||$incl$(16)));
this.$transform.transform$java_awt_geom_Point2D$java_awt_geom_Point2D(ptSrc, ptDst);
return "" + C$.df.format$D(ptDst.getX()) + " " + C$.df.format$D(ptDst.getY()) + " " ;
});
