(function(){var P$=Clazz.newPackage("javax.swing"),I$=[['javax.swing.DefaultBoundedRangeModel',['javax.swing.JScrollBar','.ModelListener'],'java.awt.event.AdjustmentListener','java.awt.event.AdjustmentEvent','java.awt.Dimension']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
this.listenerList.add$Class$TT(Clazz.getClass((I$[3]||$incl$(3)),['adjustmentValueChanged$java_awt_event_AdjustmentEvent']), l);
});

Clazz.newMeth(C$, 'removeAdjustmentListener$java_awt_event_AdjustmentListener', function (l) {
this.listenerList.remove$Class$TT(Clazz.getClass((I$[3]||$incl$(3)),['adjustmentValueChanged$java_awt_event_AdjustmentEvent']), l);
});

Clazz.newMeth(C$, 'getAdjustmentListeners', function () {
return this.listenerList.getListeners$Class(Clazz.getClass((I$[3]||$incl$(3)),['adjustmentValueChanged$java_awt_event_AdjustmentEvent']));
});
...
return Clazz.new_((I$[5]||$incl$(5)).c$$I$I,[pref.width, 5]);
} else {
return Clazz.new_((I$[5]||$incl$(5)).c$$I$I,[5, pref.height]);
}});

Clazz.newMeth(C$, 'getMaximumSize', function () {
var pref = this.getPreferredSize();
if (this.getOrientation() == 1) {
return Clazz.new_((I$[5]||$incl$(5)).c$$I$I,[pref.width, 32767]);
} else {
return Clazz.new_((I$[5]||$incl$(5)).c$$I$I,[32767, pref.height]);
}});
