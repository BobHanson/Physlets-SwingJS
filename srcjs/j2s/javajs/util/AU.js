(function(){var P$=Clazz.newPackage("javajs.util"),I$=[['java.lang.reflect.Array','javajs.util.T3','java.util.Arrays','javajs.util.Lst','java.util.Hashtable']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
var t = Clazz.array(java.lang.String, [newLength]);
if (array != null ) {
...
return Clazz.instanceOf(x, Clazz.array(java.lang.String, -1));
}, 1);

Clazz.newMeth(C$, 'isASS$O', function (x) {
return Clazz.instanceOf(x, Clazz.array(java.lang.String, -2));
}, 1);

Clazz.newMeth(C$, 'isAP$O', function (x) {
return Clazz.instanceOf(x, Clazz.array((I$[2]||$incl$(2)), -1));
}, 1);
...
return Clazz.instanceOf(x, Clazz.array(java.lang.Float, -1));
}, 1);
