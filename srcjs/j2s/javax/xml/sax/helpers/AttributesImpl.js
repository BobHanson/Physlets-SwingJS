...
var C$=Clazz.newClass(P$, "AttributesImpl", null, null, 'javax.xml.sax.Attributes');
var p$=C$.prototype;
...
if (this.length > 0) {
this.data = Clazz.array(java.lang.String, [this.length * 5]);
...
p$.ensureCapacity$I.apply(this, [this.length + 1]);
...
var newData = Clazz.array(java.lang.String, [max]);
if (this.length > 0) {
...
throw Clazz.new_(Clazz.load('java.lang.ArrayIndexOutOfBoundsException').c$$S,[msg]);
});
})();
//Created 2018-02-06 09:00:06
