(function(){var P$=Clazz.newPackage("javax.swing"),I$=[['javax.swing.SwingUtilities','javax.swing.JComponent','javax.swing.JRootPane','javax.swing.RepaintManager']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.superclazz.c$$java_awt_Window.apply(this, [owner == null  ? (I$[1]||$incl$(1)).getSharedOwnerFrame() : owner]);
C$.$init$.apply(this);
if (owner == null ) {
var ownerShutdownListener = (I$[1]||$incl$(1)).getSharedOwnerFrameShutdownListener();
...
C$.superclazz.c$$java_awt_Window$java_awt_GraphicsConfiguration.apply(this, [owner == null  ? (I$[1]||$incl$(1)).getSharedOwnerFrame() : owner, gc]);
C$.$init$.apply(this);
if (owner == null ) {
var ownerShutdownListener = (I$[1]||$incl$(1)).getSharedOwnerFrameShutdownListener();
this.addWindowListener$java_awt_event_WindowListener(ownerShutdownListener);
...
var rp = Clazz.new_((I$[3]||$incl$(3)).c$$S$Z,["_Window" + (++C$.windowCount), false]);
rp.setOpaque$Z(true);
return rp;
});
...
if ((I$[4]||$incl$(4)).HANDLE_TOP_LEVEL_PAINT) {
(I$[4]||$incl$(4)).currentManager$java_awt_Component(this).addDirtyRegion$java_awt_Window$I$I$I$I(this, x, y, width, height);
} else {
