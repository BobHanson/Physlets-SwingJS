(function(){var P$=Clazz.newPackage("java.awt.image"),I$=[['java.awt.image.DataBufferByte','java.awt.image.DataBufferInt','java.awt.image.DataBuffer','java.awt.Point','java.awt.image.SinglePixelPackedSampleModel','swingjs.api.Interface','java.awt.image.MultiPixelPackedSampleModel','sun.awt.image.BytePackedRaster','sun.awt.image.SunWritableRaster','java.awt.Rectangle']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
var d;
if (bands <= 0) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Number of bands (" + bands + ") must be greater than 0" ]);
}if (bitsPerBand <= 0) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Bits per band (" + bitsPerBand + ") must be greater than 0" ]);
}if (bands != 1) {
var masks = Clazz.array(Integer.TYPE, [bands]);
var mask = (1 << bitsPerBand) - 1;
var shift = (bands - 1) * bitsPerBand;
if (shift + bitsPerBand > (I$[3]||$incl$(3)).getDataTypeSize$I(dataType)) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["bitsPerBand(" + bitsPerBand + ") * bands is " + " greater than data type " + "size." ]);
}switch (dataType) {
case 0:
case 3:
break;
...
var r = (I$[6]||$incl$(6)).getInstance$S$Z("sun.awt.image." + (dataType == 0 ? "Byte" : "Integer") + "InterleavedRaster" , true);
...
}var mppsm = Clazz.new_((I$[7]||$incl$(7)).c$$I$I$I$I,[dataType, w, h, bitsPerPixel]);
if (dataType == 0 && (bitsPerPixel == 1 || bitsPerPixel == 2  || bitsPerPixel == 4 ) ) {
return Clazz.new_((I$[8]||$incl$(8)).c$$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Point,[mppsm, dataBuffer, location]);
} else {
return Clazz.new_((I$[9]||$incl$(9)).c$$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Point,[mppsm, dataBuffer, location]);
}}, 1);
...
if (Clazz.instanceOf(sm, "java.awt.image.MultiPixelPackedSampleModel") && dataType == 0  && sm.getSampleSize$I(0) < 8 ) {
return Clazz.new_((I$[8]||$incl$(8)).c$$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Point,[sm, db, location]);
}return Clazz.new_((I$[9]||$incl$(9)).c$$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Point,[sm, db, location]);
}, 1);

Clazz.newMeth(C$, 'c$$java_awt_image_SampleModel$java_awt_Point', function (sampleModel, origin) {
C$.$init$.apply(this);
this.setRaster$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Rectangle$java_awt_Point$java_awt_image_Raster(sampleModel, sampleModel.createDataBuffer(), Clazz.new_((I$[10]||$incl$(10)).c$$I$I$I$I,[origin.x, origin.y, sampleModel.getWidth(), sampleModel.getHeight()]), origin, null);
}, 1);
...
C$.$init$.apply(this);
this.setRaster$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Rectangle$java_awt_Point$java_awt_image_Raster(sampleModel, dataBuffer, Clazz.new_((I$[10]||$incl$(10)).c$$I$I$I$I,[origin.x, origin.y, sampleModel.getWidth(), sampleModel.getHeight()]), origin, null);
}, 1);
...
return Clazz.new_((I$[9]||$incl$(9)).c$$java_awt_image_SampleModel$java_awt_Point,[this.sampleModel, Clazz.new_((I$[4]||$incl$(4)).c$$I$I,[0, 0])]);
});
...
return Clazz.new_((I$[9]||$incl$(9)).c$$java_awt_image_SampleModel$java_awt_Point,[sm, Clazz.new_((I$[4]||$incl$(4)).c$$I$I,[0, 0])]);
});

Clazz.newMeth(C$, 'createCompatibleWritableRaster$java_awt_Rectangle', function (rect) {
if (rect == null ) {
throw Clazz.new_(Clazz.load('java.lang.NullPointerException').c$$S,["Rect cannot be null"]);
...
return Clazz.new_((I$[10]||$incl$(10)).c$$I$I$I$I,[this.minX, this.minY, this.width, this.height]);
});
