(function(){var P$=Clazz.newPackage("javax.swing"),I$=[['javax.swing.AbstractAction','javax.swing.Action',['javax.swing.JTextField','.NotifyAction'],'java.lang.Boolean','swingjs.JSToolkit','java.awt.event.ActionListener','java.awt.EventQueue','java.awt.event.ActionEvent',['javax.swing.JTextField','.TextFieldActionPropertyChangeListener'],'javax.swing.text.TextAction']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.defaultActions = Clazz.array((I$[2]||$incl$(2)), -1, [Clazz.new_((I$[3]||$incl$(3)))]);
}
...
if (doc != null ) {
doc.putProperty$O$O("filterNewlines", (I$[4]||$incl$(4)).TRUE);
...
return (I$[5]||$incl$(5)).getPlainDocument$javax_swing_JComponent(this);
});
...
this.listenerList.add$Class$TT(Clazz.getClass((I$[6]||$incl$(6)),['actionPerformed$java_awt_event_ActionEvent']), l);
});
...
this.listenerList.remove$Class$TT(Clazz.getClass((I$[6]||$incl$(6)),['actionPerformed$java_awt_event_ActionEvent']), l);
}});
...
return Clazz.new_((I$[9]||$incl$(9)).c$$javax_swing_JTextField$javax_swing_Action,[this, a]);
});

Clazz.newMeth(C$, 'getActions', function () {
return (I$[10]||$incl$(10)).augmentList$javax_swing_ActionA$javax_swing_ActionA(C$.superclazz.prototype.getActions.apply(this, []), C$.defaultActions);
});
