...
/**
 * Named for "Absorbtion Band," ABand.class inherits from Thing.class but is specialized to ABSORB at a desired
 * intensity and width.  The intensity of the absorption is determined by a parser evaluated as a
 * function of wavelength. It is able to "paint" itself on an instance of spectrumPanel.class by returning an
 * absorption intensity.
 *
 * Instances of ABand.class are created when addAbsorptionBand(lambda1,lambda2,func) method is
 * called from SpectrumPanel.class.
 */

public class ABand extends SpectrumThing{
 double lambda1 = 0;
 double lambda2 = 0;
 String inString = null;
 Parser iparser = null;

   public ABand(SpectrumPanel o, double lam1, double lam2, String func){
  ...
  *
  * The intensity of ABand is determined by a function of wavelength.
  *
