(function(){var P$=Clazz.newPackage("javax.xml.sax.helpers"),I$=[['javax.xml.sax.helpers.XMLReaderFactory',['javax.xml.sax.helpers.XMLReaderAdapter','.AttributesAdapter'],'javax.xml.sax.InputSource']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.$init$.apply(this);
p$.setup$javax_xml_sax_XMLReader.apply(this, [(I$[1]||$incl$(1)).createXMLReader()]);
}, 1);

Clazz.newMeth(C$, 'c$$javax_xml_sax_XMLReader', function (xmlReader) {
C$.$init$.apply(this);
p$.setup$javax_xml_sax_XMLReader.apply(this, [xmlReader]);
}, 1);
...
this.parse$javax_xml_sax_InputSource(Clazz.new_((I$[3]||$incl$(3)).c$$S,[systemId]));
});
