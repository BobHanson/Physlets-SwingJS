(function(){var P$=Clazz.newPackage("javax.xml.sax.demo"),I$=[[0,'java.io.StringReader','javax.xml.sax.helpers.ParserFactory','javax.xml.sax.InputSource','java.net.URL']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
