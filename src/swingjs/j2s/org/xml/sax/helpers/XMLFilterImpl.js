(function(){var P$=Clazz.newPackage("org.xml.sax.helpers"),I$=[['org.xml.sax.InputSource']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
this.parse$org_xml_sax_InputSource(Clazz.new_((I$[1]||$incl$(1)).c$$S,[systemId]));
});
