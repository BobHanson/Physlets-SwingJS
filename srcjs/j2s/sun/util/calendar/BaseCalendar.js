(function(){var P$=Clazz.newPackage("sun.util.calendar"),I$=[['sun.util.calendar.CalendarUtils']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
if (d <= 0 || d > p$.getMonthLength$I$I.apply(this, [bdate.getNormalizedYear(), month]) ) {
return false;
...
if (month < 1 || month > 12 ) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Illegal month value: " + month]);
}return p$.getMonthLength$I$I.apply(this, [gdate.getNormalizedYear(), month]);
});
...
}return ((I$[1]||$incl$(1)).mod$J$J(fixedDate, 7)|0) + 1;
}, 1);
...
return (I$[1]||$incl$(1)).isGregorianLeapYear$I(normalizedYear);
});
