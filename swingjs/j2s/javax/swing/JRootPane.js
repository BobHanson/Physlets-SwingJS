(function(){var P$=Clazz.newPackage("javax.swing"),I$=[[0,'javax.swing.SwingUtilities','java.awt.Dimension','sun.awt.AppContext','javax.swing.JLayeredPane','javax.swing.JPanel','java.awt.BorderLayout',['javax.swing.JRootPane','.RootLayout']]],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
...
), Clazz.new_($I$(6), [this, null],P$.JRootPane$1)));
return c;
});

Clazz.newMeth(C$, 'createGlassPane$', function () {
var c=Clazz.new_($I$(5));
...
mbd=Clazz.new_($I$(2).c$$I$I,[0, 0]);
}return Clazz.new_($I$(2).c$$I$I,[Math.max(rd.width, mbd.width) + i.left + i.right , rd.height + mbd.height + i.top + i.bottom ]);
});
...
rd=Clazz.new_($I$(2).c$$I$I,[2147483647, 2147483647 - i.top - i.bottom - mbd.height - 1 ]);
}return Clazz.new_($I$(2).c$$I$I,[Math.min(rd.width, mbd.width) + i.left + i.right , rd.height + mbd.height + i.top + i.bottom ]);
});
...
;Clazz.setTVer('3.2.4.07');//Created 2019-06-16 22:44:18 Java2ScriptVisitor version 3.2.4.07 net.sf.j2s.core.jar version 3.2.4.07
