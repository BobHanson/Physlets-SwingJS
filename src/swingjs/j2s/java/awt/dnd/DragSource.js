(function(){var P$=Clazz.newPackage("java.awt.dnd"),I$=[['java.awt.GraphicsEnvironment','java.awt.datatransfer.SystemFlavorMap','java.awt.Toolkit','sun.awt.dnd.SunDragSourceContextPeer','java.awt.dnd.DragSourceContext','java.awt.dnd.MouseDragGestureRecognizer','java.awt.dnd.DnDEventMulticaster','java.awt.dnd.DragSourceListener','java.awt.dnd.DragSourceMotionListener','java.awt.AWTEventMulticaster']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.dflt = ((I$[1]||$incl$(1)).isHeadless()) ? null : Clazz.new_(C$);
}
...
this.flavorMap = (I$[2]||$incl$(2)).getDefaultFlavorMap();
}, 1);
...
return (I$[3]||$incl$(3)).getDefaultToolkit().getDesktopProperty$S(name);
} catch (e) {
if (Clazz.exceptionOf(e, "java.lang.Exception")){
e.printStackTrace();
throw Clazz.new_(Clazz.load('java.lang.RuntimeException').c$$S,["failed to load system cursor: " + name + " : " + e.getMessage() ]);
} else {
throw e;
}
}
...
(I$[4]||$incl$(4)).setDragDropInProgress$Z(false);
throw e;
} else {
throw e;
}
...
return Clazz.new_((I$[5]||$incl$(5)).c$$java_awt_dnd_peer_DragSourceContextPeer$java_awt_dnd_DragGestureEvent$java_awt_Cursor$java_awt_Image$java_awt_Point$java_awt_datatransfer_Transferable$java_awt_dnd_DragSourceListener,[dscp, dgl, dragCursor, dragImage, imageOffset, t, dsl]);
});
...
return (I$[3]||$incl$(3)).getDefaultToolkit().createDragGestureRecognizer$Class$java_awt_dnd_DragSource$java_awt_Component$I$java_awt_dnd_DragGestureListener(recognizerAbstractClass, this, c, actions, dgl);
});
...
return (I$[3]||$incl$(3)).getDefaultToolkit().createDragGestureRecognizer$Class$java_awt_dnd_DragSource$java_awt_Component$I$java_awt_dnd_DragGestureListener(Clazz.getClass((I$[6]||$incl$(6))), this, c, actions, dgl);
});
...
return this.getListeners$Class(Clazz.getClass((I$[8]||$incl$(8)),['dragDropEnd$java_awt_dnd_DragSourceDropEvent','dragEnter$java_awt_dnd_DragSourceDragEvent','dragExit$java_awt_dnd_DragSourceEvent','dragOver$java_awt_dnd_DragSourceDragEvent','dropActionChanged$java_awt_dnd_DragSourceDragEvent']));
});
...
return this.getListeners$Class(Clazz.getClass((I$[9]||$incl$(9)),['dragMouseMoved$java_awt_dnd_DragSourceDragEvent']));
});
