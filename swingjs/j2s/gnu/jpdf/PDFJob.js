(function(){var P$=Clazz.newPackage("gnu.jpdf"),I$=[[0,'java.awt.Rectangle','gnu.jpdf.PDFDocument','gnu.jpdf.PDFPage',['gnu.jpdf.PDFJob','.PDFGraphic']]],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
...
g.clipRectangle=Clazz.new_($I$(1).c$$java_awt_Rectangle,[this.clipRectangle]);
return g;
});
