(function(){var P$=Clazz.newPackage("java.awt.font"),I$=[['java.util.HashMap','java.lang.Boolean']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
var C$=Clazz.newClass(P$, "TextAttribute", null, ['java.text.AttributedCharacterIterator','java.text.AttributedCharacterIterator.Attribute']);
C$.$instanceMap = null;
C$.FAMILY = null;
C$.WEIGHT = null;
...
C$.$instanceMap = Clazz.new_((I$[1]||$incl$(1)).c$$I,[29]);
C$.FAMILY = Clazz.new_(C$.c$$S,["family"]);
C$.WEIGHT = Clazz.new_(C$.c$$S,["weight"]);
C$.WEIGHT_EXTRA_LIGHT = Float.$valueOf(0.5);
C$.WEIGHT_LIGHT = Float.$valueOf(0.75);
C$.WEIGHT_DEMILIGHT = Float.$valueOf(0.875);
C$.WEIGHT_REGULAR = Float.$valueOf(1.0);
C$.WEIGHT_SEMIBOLD = Float.$valueOf(1.25);
C$.WEIGHT_MEDIUM = Float.$valueOf(1.5);
C$.WEIGHT_DEMIBOLD = Float.$valueOf(1.75);
C$.WEIGHT_BOLD = Float.$valueOf(2.0);
C$.WEIGHT_HEAVY = Float.$valueOf(2.25);
C$.WEIGHT_EXTRABOLD = Float.$valueOf(2.5);
C$.WEIGHT_ULTRABOLD = Float.$valueOf(2.75);
C$.WIDTH = Clazz.new_(C$.c$$S,["width"]);
C$.WIDTH_CONDENSED = Float.$valueOf(0.75);
C$.WIDTH_SEMI_CONDENSED = Float.$valueOf(0.875);
C$.WIDTH_REGULAR = Float.$valueOf(1.0);
C$.WIDTH_SEMI_EXTENDED = Float.$valueOf(1.25);
C$.WIDTH_EXTENDED = Float.$valueOf(1.5);
C$.POSTURE = Clazz.new_(C$.c$$S,["posture"]);
C$.POSTURE_REGULAR = Float.$valueOf(0.0);
C$.POSTURE_OBLIQUE = Float.$valueOf(0.2);
C$.SIZE = Clazz.new_(C$.c$$S,["size"]);
C$.TRANSFORM = Clazz.new_(C$.c$$S,["transform"]);
C$.SUPERSCRIPT = Clazz.new_(C$.c$$S,["superscript"]);
C$.SUPERSCRIPT_SUPER = Integer.$valueOf(1);
C$.SUPERSCRIPT_SUB = Integer.$valueOf(-1);
...
C$.UNDERLINE_ON = Integer.$valueOf(0);
C$.STRIKETHROUGH = Clazz.new_(C$.c$$S,["strikethrough"]);
C$.STRIKETHROUGH_ON = (I$[2]||$incl$(2)).TRUE;
C$.RUN_DIRECTION = Clazz.new_(C$.c$$S,["run_direction"]);
C$.RUN_DIRECTION_LTR = (I$[2]||$incl$(2)).FALSE;
C$.RUN_DIRECTION_RTL = (I$[2]||$incl$(2)).TRUE;
C$.BIDI_EMBEDDING = Clazz.new_(C$.c$$S,["bidi_embedding"]);
C$.JUSTIFICATION = Clazz.new_(C$.c$$S,["justification"]);
C$.JUSTIFICATION_FULL = Float.$valueOf(1.0);
C$.JUSTIFICATION_NONE = Float.$valueOf(0.0);
...
C$.UNDERLINE_LOW_ONE_PIXEL = Integer.$valueOf(1);
C$.UNDERLINE_LOW_TWO_PIXEL = Integer.$valueOf(2);
C$.UNDERLINE_LOW_DOTTED = Integer.$valueOf(3);
C$.UNDERLINE_LOW_GRAY = Integer.$valueOf(4);
C$.UNDERLINE_LOW_DASHED = Integer.$valueOf(5);
C$.SWAP_COLORS = Clazz.new_(C$.c$$S,["swap_colors"]);
C$.SWAP_COLORS_ON = (I$[2]||$incl$(2)).TRUE;
C$.NUMERIC_SHAPING = Clazz.new_(C$.c$$S,["numeric_shaping"]);
C$.KERNING = Clazz.new_(C$.c$$S,["kerning"]);
C$.KERNING_ON = Integer.$valueOf(1);
C$.LIGATURES = Clazz.new_(C$.c$$S,["ligatures"]);
C$.LIGATURES_ON = Integer.$valueOf(1);
C$.TRACKING = Clazz.new_(C$.c$$S,["tracking"]);
C$.TRACKING_TIGHT = Float.$valueOf(-0.04);
C$.TRACKING_LOOSE = Float.$valueOf(0.04);
}
