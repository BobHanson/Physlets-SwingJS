(function(){var P$=Clazz.newPackage("sun.awt.image"),I$=[['sun.awt.image.NativeLibLoader','Thread','java.awt.image.BufferedImage','java.awt.Transparency','java.awt.image.ColorModel','java.awt.image.DataBufferInt','sun.awt.image.SunWritableRaster','java.awt.image.Raster','java.awt.image.IndexColorModel','java.awt.image.DirectColorModel']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
var bi = Clazz.new_((I$[3]||$incl$(3)).c$$java_awt_image_ColorModel$java_awt_image_WritableRaster$Z$java_util_Hashtable,[cm, raster, isRasterPremultiplied, null]);
...
var size = w * h;
var dbi = Clazz.new_((I$[6]||$incl$(6)).c$$I,[size]);
var newpixels = (I$[7]||$incl$(7)).stealData$java_awt_image_DataBufferInt$I(dbi, 0);
...
if (p$.setDiffICM$I$I$I$I$IA$I$I$java_awt_image_IndexColorModel$BA$I$I$sun_awt_image_ByteComponentRaster$I.apply(this, [x, y, w, h, this.srcLUT, this.srcLUTtransIndex, this.numSrcLUT, icm, pix, off, scansize, bct, bct.getDataOffset$I(0)]) == 0) {
...
if (model.getTransparency() != (I$[4]||$incl$(4)).OPAQUE && this.cmodel.getTransparency() == (I$[4]||$incl$(4)).OPAQUE ) {
p$.convertToRGB.apply(this, []);
}if (this.isDefaultBI) {
var iraster = this.biRaster;
...
var pixels = (I$[7]||$incl$(7)).stealData$java_awt_image_DataBufferInt$I(db, 0);
for (var i = 0; i < size; i++) {
if ((pixels[i] >>> 24) != 255) {
return this.bimage;
}}
var opModel = Clazz.new_((I$[10]||$incl$(10)).c$$I$I$I$I,[24, 16711680, 65280, 255]);
var bandmasks = Clazz.array(Integer.TYPE, -1, [16711680, 65280, 255]);
var opRaster = (I$[8]||$incl$(8)).createPackedRaster$java_awt_image_DataBuffer$I$I$I$IA$java_awt_Point(db, w, h, w, bandmasks, null);
try {
