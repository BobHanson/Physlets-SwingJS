(function(){var P$=Clazz.newPackage("java.text"),I$=[['java.util.ArrayList','java.text.AttributedString','java.text.AttributedCharacterIterator']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
