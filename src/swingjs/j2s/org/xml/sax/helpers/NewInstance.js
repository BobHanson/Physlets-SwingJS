(function(){var P$=Clazz.newPackage("org.xml.sax.helpers"),I$=[['java.lang.Thread','Thread','java.lang.UnknownError']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
var m = null;
try {
m = Clazz.getClass((I$[1]||$incl$(1))).getMethod$S$ClassA("getContextClassLoader", null);
} catch (e) {
