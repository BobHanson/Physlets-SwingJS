(function(){var P$=Clazz.newPackage("gnu.jpdf"),p$1={},I$=[[0,'StringBuffer','java.util.Vector','java.io.ByteArrayOutputStream','java.util.zip.DeflaterOutputStream','gnu.jpdf.PDFStream','java.awt.image.PixelGrabber']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
...
var digitVector=Clazz.new_($I$(2));
...
var b=Clazz.new_($I$(3));
var dos=Clazz.new_($I$(4).c$$java_io_OutputStream,[b]);
...
var pg=Clazz.new_($I$(6).c$$java_awt_Image$I$I$I$I$IA$I$I,[this.img, x, y, w, h, pixels, 0, w]);
try {
pg.grabPixels$();
} catch (e) {
