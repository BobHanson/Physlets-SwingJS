(function(){var P$=Clazz.newPackage("javax.swing.text"),I$=[[['javax.swing.text.GapContent','.MarkData'],['javax.swing.text.GapContent','.MarkVector'],['javax.swing.text.GapContent','.InsertUndo'],['javax.swing.text.GapContent','.RemoveUndo'],'javax.swing.text.Segment',['javax.swing.text.GapContent','.StickyPosition'],'java.util.Vector',['javax.swing.text.GapContent','.UndoPosRef']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
return Clazz.new_((I$[3]||$incl$(3)).c$$I$I, [this, null, where, str.length$()]);
});
...
var edit = Clazz.new_((I$[4]||$incl$(4)).c$$I$S, [this, null, where, removedString]);
this.replace$I$I$O$I(where, nitems, C$.empty, 0);
return edit;
});

Clazz.newMeth(C$, 'getString$I$I', function (where, len) {
var s = Clazz.new_((I$[5]||$incl$(5)));
...
var n = this.marks.size();
var cleaned = Clazz.new_((I$[2]||$incl$(2)).c$$I,[n]);
for (var i = 0; i < n; i++) {
var mark = this.marks.elementAt$I(i);
if (mark != null ) {
...
var g0 = this.this$0.getGapStart();
var g1 = this.this$0.getGapEnd();
...
Clazz.newMeth(C$, '$init$', function () {
this.oneMark = Clazz.array((I$[1]||$incl$(1)), [1]);
}, 1);
...
Clazz.newMeth(C$, 'allocateArray$I', function (len) {
return Clazz.array((I$[1]||$incl$(1)), [len]);
});
