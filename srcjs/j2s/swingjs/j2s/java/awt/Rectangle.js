(function(){var P$=Clazz.newPackage("java.awt"),I$=[['java.awt.Point','java.awt.Dimension',['java.awt.geom.Rectangle2D','.Double'],'java.awt.geom.Rectangle2D']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
return Clazz.new_((I$[2]||$incl$(2)).c$$I$I,[this.width, this.height]);
});
...
}var dest = Clazz.new_((I$[3]||$incl$(3)));
