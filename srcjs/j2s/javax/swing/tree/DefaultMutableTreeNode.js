(function(){var P$=Clazz.newPackage("javax.swing.tree"),I$=[['java.util.Vector','java.util.Stack','javax.swing.tree.DefaultMutableTreeNode',['javax.swing.tree.DefaultMutableTreeNode','.BreadthFirstEnumeration','.Queue','.QNode'],['javax.swing.tree.DefaultMutableTreeNode','.BreadthFirstEnumeration','.Queue'],'javax.swing.tree.DefaultMutableTreeNode$1','java.lang.Error','javax.swing.tree.TreeNode',['javax.swing.tree.DefaultMutableTreeNode','.PreorderEnumeration'],['javax.swing.tree.DefaultMutableTreeNode','.PostorderEnumeration'],['javax.swing.tree.DefaultMutableTreeNode','.BreadthFirstEnumeration'],['javax.swing.tree.DefaultMutableTreeNode','.PathBetweenNodesEnumeration']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
throw Clazz.new_(Clazz.load('java.lang.IllegalStateException').c$$S,["node does not allow children"]);
} else if (newChild == null ) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["new child is null"]);
} else if (this.isNodeAncestor$javax_swing_tree_TreeNode(newChild)) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["new child is an ancestor"]);
...
if (this.$children == null ) {
throw Clazz.new_(Clazz.load('java.lang.ArrayIndexOutOfBoundsException').c$$S,["node has no children"]);
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["argument is not a child"]);
...
return Clazz.new_((I$[9]||$incl$(9)).c$$javax_swing_tree_TreeNode, [this, null, this]);
});

Clazz.newMeth(C$, 'postorderEnumeration', function () {
return Clazz.new_((I$[10]||$incl$(10)).c$$javax_swing_tree_TreeNode, [this, null, this]);
});

Clazz.newMeth(C$, 'breadthFirstEnumeration', function () {
return Clazz.new_((I$[11]||$incl$(11)).c$$javax_swing_tree_TreeNode, [this, null, this]);
});
...
return Clazz.new_((I$[12]||$incl$(12)).c$$javax_swing_tree_TreeNode$javax_swing_tree_TreeNode, [this, null, ancestor, this]);
});
...
if (index == -1) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["node is not a child"]);
...
if (count < 1) {
throw Clazz.new_((I$[7]||$incl$(7)).c$$S,["tree has zero leaves"]);
}return count;
});
