(function(){var P$=Clazz.newPackage("java.awt.geom"),I$=[[['java.awt.geom.Rectangle2D','.Float'],['java.awt.geom.Rectangle2D','.Double'],['java.awt.geom.Point2D','.Double'],'java.awt.geom.Line2D','java.awt.geom.ArcIterator']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
return Clazz.new_((I$[3]||$incl$(3)).c$$D$D,[x, y]);
});
...
var inside = ((I$[4]||$incl$(4)).relativeCCW$D$D$D$D$D$D(x1, y1, x2, y2, 2 * normx, 2 * normy) * (I$[4]||$incl$(4)).relativeCCW$D$D$D$D$D$D(x1, y1, x2, y2, 0, 0) >= 0);
...
return true;
}}var rect = Clazz.new_((I$[2]||$incl$(2)).c$$D$D$D$D,[x, y, w, h]);
...
return p$.contains$D$D$D$D$java_awt_geom_Rectangle2D.apply(this, [x, y, w, h, null]);
});

Clazz.newMeth(C$, 'contains$java_awt_geom_Rectangle2D', function (r) {
return p$.contains$D$D$D$D$java_awt_geom_Rectangle2D.apply(this, [r.getX(), r.getY(), r.getWidth(), r.getHeight(), r]);
});
...
return Clazz.new_((I$[5]||$incl$(5)).c$$java_awt_geom_Arc2D$java_awt_geom_AffineTransform,[this, at]);
});
...
return Clazz.new_((I$[1]||$incl$(1)).c$$F$F$F$F,[x, y, w, h]);
});
})()
;
...
Clazz.newMeth(C$, 'makeBounds$D$D$D$D', function (x, y, w, h) {
return Clazz.new_((I$[2]||$incl$(2)).c$$D$D$D$D,[x, y, w, h]);
});
})()
})();
