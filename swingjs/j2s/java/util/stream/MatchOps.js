...
/*lambda_C*/
Clazz.newMeth(C$, 'get$', function () { return Clazz.new_($I$(6),[this,{matchKind: matchKind, predicate: predicate}])});
})()
...
/*lambda_C*/
Clazz.newMeth(C$, 'get$', function () { return Clazz.new_($I$(7),[this,{matchKind: matchKind, predicate: predicate}])});
})()
...
/*lambda_C*/
Clazz.newMeth(C$, 'get$', function () { return Clazz.new_($I$(8),[this,{matchKind: matchKind, predicate: predicate}])});
})()
...
/*lambda_C*/
Clazz.newMeth(C$, 'get$', function () { return Clazz.new_($I$(9),[this,{matchKind: matchKind, predicate: predicate}])});
})()
...
;Clazz.setTVer('3.2.4.07');//Created 2019-06-16 21:47:11 Java2ScriptVisitor version 3.2.4.07 net.sf.j2s.core.jar version 3.2.4.07
