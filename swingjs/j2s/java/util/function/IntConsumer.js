...
var C$=Clazz.newInterface(P$, "IntConsumer");
...
(function(){var C$=Clazz.newClass(P$, "IntConsumer$lambda1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.IntConsumer', 1);
