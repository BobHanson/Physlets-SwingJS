...
C$.superclazz.c$$sun_java2d_StateTrackable_State$I$I.apply(this, [(I$[1]||$incl$(1)).UNTRACKABLE, 1, size]);
C$.$init$.apply(this);
if (dataArray == null ) {
...
C$.superclazz.c$$sun_java2d_StateTrackable_State$I$I$I$I.apply(this, [(I$[1]||$incl$(1)).UNTRACKABLE, 1, size, 1, offset]);
C$.$init$.apply(this);
if (dataArray == null ) {
throw Clazz.new_(Clazz.load('java.lang.NullPointerException').c$$S,["dataArray is null"]);
...
C$.superclazz.c$$sun_java2d_StateTrackable_State$I$I$I.apply(this, [(I$[1]||$incl$(1)).UNTRACKABLE, 1, size, dataArray.length]);
C$.$init$.apply(this);
...
C$.superclazz.c$$sun_java2d_StateTrackable_State$I$I$I$IA.apply(this, [(I$[1]||$incl$(1)).UNTRACKABLE, 1, size, dataArray.length, offsets]);
C$.$init$.apply(this);
for (var i = 0; i < dataArray.length; i++) {
if (dataArray[i] == null ) {
throw Clazz.new_(Clazz.load('java.lang.NullPointerException').c$$S,["dataArray[" + i + "] is null" ]);
