(function(){var P$=Clazz.newPackage("java.awt.event"),I$=[['java.awt.Point','java.lang.StringBuilder','java.awt.Toolkit']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
return Clazz.new_((I$[1]||$incl$(1)).c$$I$I,[this.xAbs, this.yAbs]);
});
...
var str = Clazz.new_((I$[2]||$incl$(2)).c$$I,[80]);
