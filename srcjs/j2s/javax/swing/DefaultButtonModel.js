...
this.listenerList.add$Class$TT(Clazz.getClass((I$[8]||$incl$(8)),['actionPerformed$java_awt_event_ActionEvent']), l);
});

Clazz.newMeth(C$, 'removeActionListener$java_awt_event_ActionListener', function (l) {
this.listenerList.remove$Class$TT(Clazz.getClass((I$[8]||$incl$(8)),['actionPerformed$java_awt_event_ActionEvent']), l);
});

Clazz.newMeth(C$, 'getActionListeners', function () {
return this.listenerList.getListeners$Class(Clazz.getClass((I$[8]||$incl$(8)),['actionPerformed$java_awt_event_ActionEvent']));
});
...
this.listenerList.add$Class$TT(Clazz.getClass((I$[9]||$incl$(9)),['itemStateChanged$java_awt_event_ItemEvent']), l);
});

Clazz.newMeth(C$, 'removeItemListener$java_awt_event_ItemListener', function (l) {
this.listenerList.remove$Class$TT(Clazz.getClass((I$[9]||$incl$(9)),['itemStateChanged$java_awt_event_ItemEvent']), l);
});

Clazz.newMeth(C$, 'getItemListeners', function () {
return this.listenerList.getListeners$Class(Clazz.getClass((I$[9]||$incl$(9)),['itemStateChanged$java_awt_event_ItemEvent']));
});
