(function(){var P$=Clazz.newPackage("gnu.jpdf"),I$=[['java.util.Vector','gnu.jpdf.PDFPageList','gnu.jpdf.PDFCatalog','gnu.jpdf.PDFInfo','gnu.jpdf.PDFOutline','gnu.jpdf.PDFFont','gnu.jpdf.PDFOutput']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
var C$=Clazz.newClass(P$, "PDFDocument", null, null, 'java.io.Serializable');
C$.PDF_PAGE_MODES = null;

C$.$clinit$ = function() {Clazz.load(C$, 1);
C$.PDF_PAGE_MODES = Clazz.array(java.lang.String, -1, ["/UseNone", "/UseOutlines", "/UseThumbs", "/FullScreen"]);
}
...
this.fontid++;
var ft = Clazz.new_((I$[6]||$incl$(6)).c$$S$S$S$I,["/F" + this.fontid, type, font, style]);
...
var pos = Clazz.new_((I$[7]||$incl$(7)).c$$java_io_OutputStream,[os]);
