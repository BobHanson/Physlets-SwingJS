(function(){var P$=Clazz.newPackage("javax.swing.text"),I$=[['java.awt.Rectangle','javax.swing.SizeRequirements',['javax.swing.text.Position','.Bias']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
if (this.majorAxis == 1) {
var testPos = (bias === (I$[3]||$incl$(3)).Backward ) ? Math.max(0, position - 1) : position;
