...
if (index < 0) throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["No such attribute: local=" + localName + ", namespace=" + uri ]);
return this.declared[index];
});

Clazz.newMeth(C$, 'isDeclared$S', function (qName) {
var index = this.getIndex$S(qName);
if (index < 0) throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["No such attribute: " + qName]);
return this.declared[index];
});
