(function(){var P$=Clazz.newPackage("swingjs.plaf"),I$=[[0,'java.awt.Insets','swingjs.api.js.DOMNode','javax.swing.text.WrappedPlainView','javax.swing.text.PlainView']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
...
var v;
if (area.getLineWrap$()) {
v=Clazz.new_($I$(3).c$$javax_swing_text_Element$Z,[elem, area.getWrapStyleWord$()]);
} else {
v=Clazz.new_($I$(4).c$$javax_swing_text_Element,[elem]);
}return v;
});
