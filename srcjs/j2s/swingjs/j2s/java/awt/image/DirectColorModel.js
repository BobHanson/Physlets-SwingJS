(function(){var P$=Clazz.newPackage("java.awt.image"),I$=[['java.awt.color.ColorSpace','java.awt.image.ColorModel','java.awt.image.Raster']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
C$.superclazz.c$$java_awt_color_ColorSpace$I$I$I$I$I$Z$I$I.apply(this, [(I$[1]||$incl$(1)).getInstance$I(1000), bits, rmask, gmask, bmask, amask, false, amask == 0 ? 1 : 3, (I$[2]||$incl$(2)).getDefaultTransferType$I(bits)]);
C$.$init$.apply(this);
}, 1);
...
if (this.is_sRGB) {
return p$.getsRGBComponentFromsRGB$I$I.apply(this, [pixel, 0]);
} else if (this.is_LinearRGB) {
return p$.getsRGBComponentFromLinearRGB$I$I.apply(this, [pixel, 0]);
}var rgb = p$.getDefaultRGBComponents$I.apply(this, [pixel]);
return ((rgb[0] * 255.0 + 0.5)|0);
});

Clazz.newMeth(C$, 'getGreen$I', function (pixel) {
if (this.is_sRGB) {
return p$.getsRGBComponentFromsRGB$I$I.apply(this, [pixel, 1]);
} else if (this.is_LinearRGB) {
return p$.getsRGBComponentFromLinearRGB$I$I.apply(this, [pixel, 1]);
}var rgb = p$.getDefaultRGBComponents$I.apply(this, [pixel]);
...
if (this.is_sRGB) {
return p$.getsRGBComponentFromsRGB$I$I.apply(this, [pixel, 2]);
} else if (this.is_LinearRGB) {
return p$.getsRGBComponentFromLinearRGB$I$I.apply(this, [pixel, 2]);
}var rgb = p$.getDefaultRGBComponents$I.apply(this, [pixel]);
...
}var defaultCM = (I$[2]||$incl$(2)).getRGBdefault();
...
if ((w <= 0) || (h <= 0) ) {
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Width (" + w + ") and height (" + h + ") cannot be <= 0" ]);
}var bandmasks;
if (this.supportsAlpha) {
...
return (I$[3]||$incl$(3)).createPackedRaster$I$I$I$IA$java_awt_Point(3, w, h, bandmasks, null);
} else {
return (I$[3]||$incl$(3)).createPackedRaster$I$I$I$IA$java_awt_Point(0, w, h, bandmasks, null);
}});

Clazz.newMeth(C$, 'getDataElement$IA$I', function (components, offset) {
var pixel = 0;
for (var i = 0; i < this.numComponents; i++) {
pixel = pixel|(((components[offset + i] << this.maskOffsets[i]) & this.maskArray[i]));
}
return pixel;
});
...
throw Clazz.new_(Clazz.load('java.lang.ClassCastException').c$$S,["This method has not been " + "implemented for transferType " + this.transferType ]);
}
});
