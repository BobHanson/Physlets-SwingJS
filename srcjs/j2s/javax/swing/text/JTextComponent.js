(function(){var P$=Clazz.newPackage("javax.swing.text"),I$=[['java.awt.Point','java.util.Hashtable','javax.swing.KeyStroke','javax.swing.Action','java.util.Vector',['javax.swing.text.JTextComponent','.KeymapWrapper'],'sun.awt.AppContext','javax.swing.text.JTextComponent','javax.swing.DropMode',['javax.swing.text.JTextComponent','.MutableCaretEvent'],'javax.swing.event.CaretListener',['javax.swing.text.Position','.Bias'],['javax.swing.text.JTextComponent','.DropLocation'],'Boolean',['javax.swing.text.JTextComponent','.KeymapActionMap'],['javax.swing.text.JTextComponent','.DefaultKeymap'],'java.util.HashMap',['javax.swing.text.DefaultEditorKit','.DefaultKeyTypedAction'],'swingjs.JSUtil']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
this.dropMode = (I$[9]||$incl$(9)).USE_SELECTION;
}, 1);
...
Clazz.newMeth(C$, 'c$$S', function (uid) {
...
this.listenerList.add$Class$TT(Clazz.getClass((I$[11]||$incl$(11)),['caretUpdate$javax_swing_event_CaretEvent']), listener);
});

Clazz.newMeth(C$, 'removeCaretListener$javax_swing_event_CaretListener', function (listener) {
this.listenerList.remove$Class$TT(Clazz.getClass((I$[11]||$incl$(11)),['caretUpdate$javax_swing_event_CaretEvent']), listener);
});

Clazz.newMeth(C$, 'getCaretListeners', function () {
return this.listenerList.getListeners$Class(Clazz.getClass((I$[11]||$incl$(11)),['caretUpdate$javax_swing_event_CaretEvent']));
});
...
Clazz.newMeth(C$, 'setDropLocation$javax_swing_text_JTextComponent_DropLocation$O$Z', function (location, state, forDrop) {
var retVal = null;
var textLocation = location;
if (this.dropMode === (I$[9]||$incl$(9)).USE_SELECTION ) {
...
var map = Clazz.new_((I$[16]||$incl$(16)).c$$S$javax_swing_text_Keymap,[nm, parent]);
if (nm != null ) {
...
(I$[19]||$incl$(19)).alert$O("SWINGJS BAD LOCATION EXCEPTION (replace):" + e.getMessage() + (I$[19]||$incl$(19)).getStackTrace$I(-10) );
} else {
throw e;
}
}
...
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["bad position: " + pos]);
...
(I$[7]||$incl$(7)).getAppContext().remove$O(C$.FOCUSED_COMPONENT);
}});
...
if (Clazz.exceptionOf(e, "javax.swing.text.BadLocationException")){
(I$[19]||$incl$(19)).alert$O("SWINGJS BAD LOCATION EXCEPTION (setText):" + e.getMessage() + (I$[19]||$incl$(19)).getStackTrace$I(-10) );
} else {
throw e;
}
}
...
default:
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["Invalid orientation: " + orientation]);
}
});
...
return (I$[7]||$incl$(7)).getAppContext().get$O(C$.FOCUSED_COMPONENT);
}, 1);
...
return sKeys;
}var retValue = Clazz.array((I$[3]||$incl$(3)), [sCount + keymapCount]);
...
(I$[7]||$incl$(7)).getAppContext().put$O$O((I$[8]||$incl$(8)).FOCUSED_COMPONENT, fe.getSource());
});
