(function(){var P$=Clazz.newPackage("sun.awt.datatransfer"),p$1={},I$=[[0,'java.util.HashMap','sun.awt.datatransfer.DataTransferer','java.util.Collections','java.io.InputStream','java.io.Reader',['sun.awt.datatransfer.DataTransferer','.CharsetComparator'],'java.util.HashSet','java.awt.datatransfer.DataFlavor','Boolean','java.util.ArrayList',['sun.awt.datatransfer.DataTransferer','.DataFlavorComparator'],'sun.awt.SunToolkit','java.awt.AWTError','java.security.AccessController','java.util.TreeSet','java.util.TreeMap',['sun.awt.datatransfer.DataTransferer','.IndexOrderComparator'],'java.util.Arrays','StringBuffer','java.io.ByteArrayOutputStream','java.io.ByteArrayInputStream','java.io.File','java.io.StringReader','java.io.InputStreamReader','java.lang.reflect.Modifier','java.io.SequenceInputStream','java.util.Stack','java.awt.EventQueue','sun.awt.AppContext']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
...
C$.textNatives=$I$(3).synchronizedSet$java_util_Set(Clazz.new_($I$(7)));
C$.nativeCharsets=$I$(3).synchronizedMap$java_util_Map(Clazz.new_($I$(1)));
C$.nativeEOLNs=$I$(3).synchronizedMap$java_util_Map(Clazz.new_($I$(1)));
C$.nativeTerminators=$I$(3).synchronizedMap$java_util_Map(Clazz.new_($I$(1)));
{
...
try {
tPlainTextStringFlavor=Clazz.new_($I$(8).c$$S,["text/plain;charset=Unicode;class=java.lang.String"]);
} catch (cannotHappen) {
if (Clazz.exceptionOf(cannotHappen,"ClassNotFoundException")){
} else {
throw cannotHappen;
...
try {
tJavaTextEncodingFlavor=Clazz.new_($I$(8).c$$S,["application/x-java-text-encoding;class=\"[B\""]);
} catch (cannotHappen) {
if (Clazz.exceptionOf(cannotHappen,"ClassNotFoundException")){
} else {
throw cannotHappen;
...
var tempMap=Clazz.new_($I$(1).c$$I,[17]);
tempMap.put$TK$TV("sgml", $I$(9).TRUE);
tempMap.put$TK$TV("xml", $I$(9).TRUE);
tempMap.put$TK$TV("html", $I$(9).TRUE);
tempMap.put$TK$TV("enriched", $I$(9).TRUE);
tempMap.put$TK$TV("richtext", $I$(9).TRUE);
tempMap.put$TK$TV("uri-list", $I$(9).TRUE);
tempMap.put$TK$TV("directory", $I$(9).TRUE);
tempMap.put$TK$TV("css", $I$(9).TRUE);
tempMap.put$TK$TV("calendar", $I$(9).TRUE);
tempMap.put$TK$TV("plain", $I$(9).TRUE);
tempMap.put$TK$TV("rtf", $I$(9).FALSE);
tempMap.put$TK$TV("tab-separated-values", $I$(9).FALSE);
tempMap.put$TK$TV("t140", $I$(9).FALSE);
tempMap.put$TK$TV("rfc822-headers", $I$(9).FALSE);
tempMap.put$TK$TV("parityfec", $I$(9).FALSE);
...
C$.deploymentCacheDirectoryList=Clazz.new_($I$(10));
C$.defaultCharsetComparator=Clazz.new_($I$(6).c$$Z,[false]);
C$.defaultFlavorComparator=Clazz.new_($I$(11).c$$Z,[false]);
}
...
ee.printStackTrace$();
throw Clazz.new_($I$(13).c$$S,["DataTransferer not found: " + this.$finals$.name]);
} else {
throw ee;
}
}
...
{
e.printStackTrace$();
throw Clazz.new_($I$(13).c$$S,["Cannot instantiate DataTransferer: " + this.$finals$.name]);
}
} else if (Clazz.exceptionOf(e$$,"SecurityException")){
var e = e$$;
{
e.printStackTrace$();
throw Clazz.new_($I$(13).c$$S,["Access is denied for DataTransferer: " + this.$finals$.name]);
}
} else {
throw e$$;
}
...
{
e.printStackTrace$();
throw Clazz.new_($I$(13).c$$S,["Cannot access DataTransferer: " + this.$finals$.name]);
}
} else {
throw e$$;
}
...
if (support != null ) {
return (support === $I$(9).TRUE );
}var ret_val=(flavor.getParameter$S("charset") != null );
C$.textMIMESubtypeCharsetSupport.put$TK$TV(subType, (ret_val) ? $I$(9).TRUE : $I$(9).FALSE);
return ret_val;
}, 1);
...
if ($I$(8).stringFlavor.equals$java_awt_datatransfer_DataFlavor(flavor)) {
return true;
...
var tempSet=Clazz.new_($I$(15).c$$java_util_Comparator,[C$.defaultCharsetComparator]);
...
var natives=this.getNativesForFlavors$java_awt_datatransfer_DataFlavorA(Clazz.array($I$(8), -1, [flav]));
var nat=natives.get$O(flav);
if (nat != null ) {
var list=Clazz.new_($I$(10).c$$I,[1]);
list.add$TE(nat);
return list;
} else {
...
return this.getFormatsForFlavors$java_awt_datatransfer_DataFlavorA$java_awt_datatransfer_FlavorTable(Clazz.array($I$(8), -1, [flavor]), map);
});
...
var formatMap=Clazz.new_($I$(1).c$$I,[flavors.length]);
var textPlainMap=Clazz.new_($I$(1).c$$I,[flavors.length]);
var indexMap=Clazz.new_($I$(1).c$$I,[flavors.length]);
var textPlainIndexMap=Clazz.new_($I$(1).c$$I,[flavors.length]);
var currentIndex=0;
for (var i=flavors.length - 1; i >= 0; i--) {
var flavor=flavors[i];
if (flavor == null ) continue;
if (flavor.isFlavorTextType$() || flavor.isFlavorJavaFileListType$() || $I$(8).imageFlavor.equals$java_awt_datatransfer_DataFlavor(flavor) || flavor.isRepresentationClassSerializable$() || flavor.isRepresentationClassInputStream$() || flavor.isRepresentationClassRemote$()  ) {
...
if (("text".equals$O(flavor.getPrimaryType$()) && "plain".equals$O(flavor.getSubType$()) ) || flavor.equals$java_awt_datatransfer_DataFlavor($I$(8).stringFlavor) ) {
...
var comparator=Clazz.new_($I$(17).c$$java_util_Map$Z,[indexMap, false]);
var sortedMap=Clazz.new_($I$(16).c$$java_util_Comparator,[comparator]);
...
var flavorMap=Clazz.new_($I$(1).c$$I,[formats.length]);
var mappingSet=Clazz.new_($I$(7).c$$I,[formats.length]);
var flavorSet=Clazz.new_($I$(7).c$$I,[formats.length]);
...
return $I$(18).asList$TTA(Clazz.array(java.lang.Object, -1, [key, value]));
}, 1);
...
var buffer=Clazz.new_($I$(19).c$$I,[length * 2]);
...
if (obj == null ) {
return null;
}if (flavor.equals$java_awt_datatransfer_DataFlavor($I$(8).plainTextFlavor) && !(Clazz.instanceOf(obj, "java.io.InputStream")) ) {
obj=contents.getTransferData$java_awt_datatransfer_DataFlavor($I$(8).stringFlavor);
if (obj == null ) {
return null;
...
return bytes;
}} else if ($I$(8).imageFlavor.equals$java_awt_datatransfer_DataFlavor(flavor)) {
...
}var bos=Clazz.new_($I$(20));
if (this.isFileFormat$J(format)) {
if (!$I$(8).javaFileListFlavor.equals$java_awt_datatransfer_DataFlavor(flavor)) {
throw Clazz.new_(Clazz.load('java.io.IOException').c$$S,["data translation failed"]);
}var list=obj;
var fileList=Clazz.new_($I$(10));
var nFiles=0;
...
if (str == null ) {
str=Clazz.new_($I$(21).c$$BA,[bytes]);
}if (this.isFileFormat$J(format)) {
if (!$I$(8).javaFileListFlavor.equals$java_awt_datatransfer_DataFlavor(flavor)) {
throw Clazz.new_(Clazz.load('java.io.IOException').c$$S,["data translation failed"]);
}if (bytes == null ) {
...
files[i]=Clazz.new_($I$(22).c$$S,[filenames[i]]);
}
str.close$();
return $I$(18).asList$TTA(files);
...
} else if ($I$(8).plainTextFlavor.equals$java_awt_datatransfer_DataFlavor(flavor)) {
return Clazz.new_($I$(23).c$$S,[p$1.translateBytesOrStreamToString$java_io_InputStream$BA$J$java_awt_datatransfer_Transferable.apply(this, [str, bytes, format, localeTransferable])]);
} else if (flavor.isRepresentationClassInputStream$()) {
...
if (!(C$.isFlavorCharsetTextType$java_awt_datatransfer_DataFlavor(flavor) && this.isTextFormat$J(format) )) {
throw Clazz.new_(Clazz.load('java.io.IOException').c$$S,["cannot transfer non-text data as Reader"]);
}var is=p$1.translateBytesOrStreamToInputStream$java_io_InputStream$java_awt_datatransfer_DataFlavor$J$java_awt_datatransfer_Transferable.apply(this, [str, $I$(8).plainTextFlavor, format, localeTransferable]);
var unicode=C$.getTextCharset$java_awt_datatransfer_DataFlavor($I$(8).plainTextFlavor);
var reader=Clazz.new_($I$(24).c$$java_io_InputStream$S,[is, unicode]);
return p$1.constructFlavoredObject$O$java_awt_datatransfer_DataFlavor$Class.apply(this, [reader, flavor, Clazz.getClass($I$(5))]);
} else if (flavor.isRepresentationClassCharBuffer$()) {
if (!(C$.isFlavorCharsetTextType$java_awt_datatransfer_DataFlavor(flavor) && this.isTextFormat$J(format) )) {
throw Clazz.new_(Clazz.load('java.io.IOException').c$$S,["cannot transfer non-text data as CharBuffer"]);
}return null;
...
return p$1.constructFlavoredObject$O$java_awt_datatransfer_DataFlavor$Class.apply(this, [str, flavor, Clazz.getClass($I$(4))]);
}, p$1);
...
var allowedFiles=Clazz.new_($I$(19).c$$I,[str.length$()]);
for (var i=0; i < str.split$S("(\\s)+").length; i++) {
var fileName=str.split$S("(\\s)+")[i];
var file=Clazz.new_($I$(22).c$$S,[fileName]);
...
filePath=fileObject;
}return Clazz.new_($I$(22).c$$S,[filePath]);
}, p$1);
...
try {
var cacheDirectory=(Clazz.new_($I$(22).c$$S,[cacheDirectoryPath])).getCanonicalFile$();
...
str1=Clazz.new_($I$(21).c$$BA,[arr1]);
str2=obj2;
}} else {
str1=obj1;
if (Clazz.instanceOf(obj2, Clazz.array(Byte.TYPE, -1))) {
str2=Clazz.new_($I$(21).c$$BA,[obj2]);
} else {
str2=obj2;
}}return Clazz.new_($I$(26).c$$java_io_InputStream$java_io_InputStream,[str1, str2]);
}, p$1);
...
), Clazz.new_(P$.DataTransferer$4.$init$, [this, {formatMap: formatMap, format: format, contents: contents, stack: stack}]));
...
var flavors=Clazz.array($I$(8), [flavorsSet.size$()]);
flavorsSet.toArray$TTA(flavors);
$I$(18).sort$TTA$java_util_Comparator(flavors, C$.defaultFlavorComparator);
return flavors;
}, 1);
...
var flavors=Clazz.array($I$(8), [flavorsSet.size$()]);
flavorsSet.toArray$TTA(flavors);
var comparator=Clazz.new_($I$(11).c$$java_util_Map$Z,[flavorToNativeMap, false]);
$I$(18).sort$TTA$java_util_Comparator(flavors, comparator);
return flavors;
}, 1);

Clazz.newMeth(C$, 'inputStreamToByteArray$java_io_InputStream', function (str) {
var baos=Clazz.new_($I$(20));
var len=0;
...
{
var charsetsMap=Clazz.new_($I$(1).c$$I$F,[8, 1.0]);
charsetsMap.put$TK$TV(P$.DataTransferer.canonicalName$S("UTF-16LE"), Integer.valueOf$I(4));
charsetsMap.put$TK$TV(P$.DataTransferer.canonicalName$S("UTF-16BE"), Integer.valueOf$I(5));
charsetsMap.put$TK$TV(P$.DataTransferer.canonicalName$S("UTF-8"), Integer.valueOf$I(6));
charsetsMap.put$TK$TV(P$.DataTransferer.canonicalName$S("UTF-16"), Integer.valueOf$I(7));
...
C$.UNKNOWN_OBJECT_LOSES_L=Long.valueOf$J(-9223372036854775808);
C$.UNKNOWN_OBJECT_WINS_L=Long.valueOf$J(9223372036854775807);
{
{
var exactTypesMap=Clazz.new_($I$(1).c$$I$F,[4, 1.0]);
exactTypesMap.put$TK$TV("application/x-java-file-list", Integer.valueOf$I(0));
C$.exactTypes=$I$(3).unmodifiableMap$java_util_Map(exactTypesMap);
}{
var primaryTypesMap=Clazz.new_($I$(1).c$$I$F,[1, 1.0]);
primaryTypesMap.put$TK$TV("application", Integer.valueOf$I(0));
C$.primaryTypes=$I$(3).unmodifiableMap$java_util_Map(primaryTypesMap);
}{
var nonTextRepresentationsMap=Clazz.new_($I$(1).c$$I$F,[3, 1.0]);
nonTextRepresentationsMap.put$TK$TV(Clazz.getClass($I$(4)), Integer.valueOf$I(0));
C$.nonTextRepresentations=$I$(3).unmodifiableMap$java_util_Map(nonTextRepresentationsMap);
}{
var textTypesMap=Clazz.new_($I$(1).c$$I$F,[16, 1.0]);
textTypesMap.put$TK$TV("text/plain", Integer.valueOf$I(0));
textTypesMap.put$TK$TV("application/x-java-serialized-object", Integer.valueOf$I(1));
textTypesMap.put$TK$TV("text/calendar", Integer.valueOf$I(2));
textTypesMap.put$TK$TV("text/css", Integer.valueOf$I(3));
textTypesMap.put$TK$TV("text/directory", Integer.valueOf$I(4));
textTypesMap.put$TK$TV("text/parityfec", Integer.valueOf$I(5));
textTypesMap.put$TK$TV("text/rfc822-headers", Integer.valueOf$I(6));
textTypesMap.put$TK$TV("text/t140", Integer.valueOf$I(7));
textTypesMap.put$TK$TV("text/tab-separated-values", Integer.valueOf$I(8));
textTypesMap.put$TK$TV("text/uri-list", Integer.valueOf$I(9));
textTypesMap.put$TK$TV("text/richtext", Integer.valueOf$I(10));
textTypesMap.put$TK$TV("text/enriched", Integer.valueOf$I(11));
textTypesMap.put$TK$TV("text/rtf", Integer.valueOf$I(12));
textTypesMap.put$TK$TV("text/html", Integer.valueOf$I(13));
textTypesMap.put$TK$TV("text/xml", Integer.valueOf$I(14));
textTypesMap.put$TK$TV("text/sgml", Integer.valueOf$I(15));
C$.textTypes=$I$(3).unmodifiableMap$java_util_Map(textTypesMap);
}{
var decodedTextRepresentationsMap=Clazz.new_($I$(1).c$$I$F,[4, 1.0]);
decodedTextRepresentationsMap.put$TK$TV($I$(2).charArrayClass, Integer.valueOf$I(0));
decodedTextRepresentationsMap.put$TK$TV(Clazz.getClass(String), Integer.valueOf$I(2));
decodedTextRepresentationsMap.put$TK$TV(Clazz.getClass($I$(5)), Integer.valueOf$I(3));
C$.decodedTextRepresentations=$I$(3).unmodifiableMap$java_util_Map(decodedTextRepresentationsMap);
}{
var encodedTextRepresentationsMap=Clazz.new_($I$(1).c$$I$F,[3, 1.0]);
encodedTextRepresentationsMap.put$TK$TV($I$(2).byteArrayClass, Integer.valueOf$I(0));
encodedTextRepresentationsMap.put$TK$TV(Clazz.getClass($I$(4)), Integer.valueOf$I(2));
...
C$.superclazz.c$$Z.apply(this, [order]);
C$.$init$.apply(this);
this.charsetComparator=Clazz.new_($I$(6).c$$Z,[order]);
...
C$.$init$.apply(this);
this.charsetComparator=Clazz.new_($I$(6).c$$Z,[order]);
var hashMap=Clazz.new_($I$(1).c$$I,[map.size$()]);
...
;Clazz.setTVer('3.2.4.07');//Created 2019-06-16 21:47:43 Java2ScriptVisitor version 3.2.4.07 net.sf.j2s.core.jar version 3.2.4.07
