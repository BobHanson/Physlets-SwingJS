(function(){var P$=Clazz.newPackage("javajs.util"),p$1={},I$=[[0,['javajs.util.CBZip2InputStream','.Data']]],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
...
if (this.data == null ) {
this.data=Clazz.new_($I$(1).c$$I,[this.blockSize100k]);
