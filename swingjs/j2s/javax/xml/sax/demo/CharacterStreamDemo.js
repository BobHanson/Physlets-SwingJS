(function(){var P$=Clazz.newPackage("javax.xml.sax.demo"),I$=[[0,'javax.xml.sax.helpers.ParserFactory','javax.xml.sax.demo.DemoHandler','java.io.StringReader','javax.xml.sax.InputSource']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
...
parser.parse$javax_xml_sax_InputSource(Clazz.new_($I$(4).c$$java_io_Reader,[reader]));
}, 1);
