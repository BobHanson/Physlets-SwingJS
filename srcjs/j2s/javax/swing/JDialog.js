(function(){var P$=Clazz.newPackage("javax.swing"),I$=[[['javax.swing.JDialog','.AsynchronousObject'],'javax.swing.SwingUtilities',['java.awt.Dialog','.ModalityType'],'javax.swing.JComponent','javax.swing.UIManager','javax.swing.JRootPane','javax.swing.RepaintManager','java.lang.Boolean']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
var C$=Clazz.newClass(P$, "JDialog", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'java.awt.Dialog', ['javax.swing.WindowConstants', 'javax.swing.RootPaneContainer']);
...
;
C$.ASYNCHRONOUS_OBJECT = Clazz.new_((I$[1]||$incl$(1)));
}
...
C$.superclazz.c$$java_awt_Frame$S$Z.apply(this, [owner == null  ? (I$[2]||$incl$(2)).getSharedOwnerFrame() : owner, title, modal]);
C$.$init$.apply(this);
if (owner == null ) {
var ownerShutdownListener = (I$[2]||$incl$(2)).getSharedOwnerFrameShutdownListener();
...
C$.superclazz.c$$java_awt_Frame$S$Z$java_awt_GraphicsConfiguration.apply(this, [owner == null  ? (I$[2]||$incl$(2)).getSharedOwnerFrame() : owner, title, modal, gc]);
C$.$init$.apply(this);
if (owner == null ) {
var ownerShutdownListener = (I$[2]||$incl$(2)).getSharedOwnerFrameShutdownListener();
this.addWindowListener$java_awt_event_WindowListener(ownerShutdownListener);
...
C$.c$$java_awt_Window$java_awt_Dialog_ModalityType.apply(this, [owner, (I$[3]||$incl$(3)).MODELESS]);
}, 1);
...
C$.c$$java_awt_Window$S$java_awt_Dialog_ModalityType.apply(this, [owner, title, (I$[3]||$incl$(3)).MODELESS]);
}, 1);
...
this.setLocale$java_util_Locale((I$[4]||$incl$(4)).getDefaultLocale());
...
var rp = Clazz.new_((I$[6]||$incl$(6)).c$$S$Z,["_Dialog" + (++C$.dialogCount), false]);
rp.setOpaque$Z(true);
return rp;
});
...
(I$[4]||$incl$(4)).getGraphicsInvoked$java_awt_Component(this);
return C$.superclazz.prototype.getGraphics.apply(this, []);
});

Clazz.newMeth(C$, 'repaint$J$I$I$I$I', function (time, x, y, width, height) {
if ((I$[7]||$incl$(7)).HANDLE_TOP_LEVEL_PAINT) {
(I$[7]||$incl$(7)).currentManager$java_awt_Component(this).addDirtyRegion$java_awt_Window$I$I$I$I(this, x, y, width, height);
} else {
...
(I$[2]||$incl$(2)).appContextPut$O$O(C$.defaultLookAndFeelDecoratedKey, (I$[8]||$incl$(8)).TRUE);
} else {
(I$[2]||$incl$(2)).appContextPut$O$O(C$.defaultLookAndFeelDecoratedKey, (I$[8]||$incl$(8)).FALSE);
}}, 1);
