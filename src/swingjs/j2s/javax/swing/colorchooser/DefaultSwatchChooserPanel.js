...
var gb = Clazz.new_((I$[1]||$incl$(1)));
var gbc = Clazz.new_((I$[2]||$incl$(2)));
var superHolder = Clazz.new_((I$[3]||$incl$(3)).c$$java_awt_LayoutManager,[gb]);
this.swatchPanel = Clazz.new_((I$[4]||$incl$(4)));
this.swatchPanel.putClientProperty$O$O("AccessibleName", this.getDisplayName());
this.swatchPanel.setInheritsPopupMenu$Z(true);
this.recentSwatchPanel = Clazz.new_((I$[5]||$incl$(5)));
this.recentSwatchPanel.putClientProperty$O$O("AccessibleName", C$.recentStr);
this.mainSwatchListener = Clazz.new_((I$[6]||$incl$(6)), [this, null]);
this.swatchPanel.addMouseListener$java_awt_event_MouseListener(this.mainSwatchListener);
this.recentSwatchListener = Clazz.new_((I$[7]||$incl$(7)), [this, null]);
this.recentSwatchPanel.addMouseListener$java_awt_event_MouseListener(this.recentSwatchListener);
var mainHolder = Clazz.new_((I$[3]||$incl$(3)).c$$java_awt_LayoutManager,[Clazz.new_((I$[8]||$incl$(8)))]);
var border = Clazz.new_((I$[9]||$incl$(9)).c$$javax_swing_border_Border$javax_swing_border_Border,[Clazz.new_((I$[10]||$incl$(10)).c$$java_awt_Color,[(I$[11]||$incl$(11)).black]), Clazz.new_((I$[10]||$incl$(10)).c$$java_awt_Color,[(I$[11]||$incl$(11)).white])]);
...
gbc.insets = Clazz.new_((I$[12]||$incl$(12)).c$$I$I$I$I,[0, 0, 0, 10]);
superHolder.add$java_awt_Component$O(mainHolder, gbc);
gbc.insets = oldInsets;
this.recentSwatchPanel.addMouseListener$java_awt_event_MouseListener(this.recentSwatchListener);
this.recentSwatchPanel.setInheritsPopupMenu$Z(true);
var recentHolder = Clazz.new_((I$[3]||$incl$(3)).c$$java_awt_LayoutManager,[Clazz.new_((I$[8]||$incl$(8)))]);
...
var l = Clazz.new_((I$[13]||$incl$(13)).c$$S,[C$.recentStr]);
...
gbc.weighty = 0;
gbc.gridheight = 0;
gbc.insets = Clazz.new_((I$[12]||$incl$(12)).c$$I$I$I$I,[0, 0, 0, 2]);
...
}, 'java.awt.event.MouseAdapter', 'java.io.Serializable');
...
this.this$0.getColorSelectionModel().setSelectedColor$java_awt_Color(color);
});
