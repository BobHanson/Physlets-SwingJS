(function(){var P$=Clazz.newPackage("javax.swing"),I$=[[['javax.swing.Spring','.StaticSpring'],['javax.swing.Spring','.NegativeSpring'],['javax.swing.Spring','.SumSpring'],['javax.swing.Spring','.MaxSpring'],['javax.swing.Spring','.ScaleSpring'],['javax.swing.Spring','.WidthSpring'],['javax.swing.Spring','.HeightSpring']]],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
this.setValue$I(this.getPreferredValue() + ((strain * p$.range$Z.apply(this, [strain < 0 ]))|0));
});
...
return Clazz.new_((I$[1]||$incl$(1)).c$$I$I$I,[min, pref, max]);
}, 1);

Clazz.newMeth(C$, 'minus$javax_swing_Spring', function (s) {
return Clazz.new_((I$[2]||$incl$(2)).c$$javax_swing_Spring,[s]);
}, 1);

Clazz.newMeth(C$, 'sum$javax_swing_Spring$javax_swing_Spring', function (s1, s2) {
return Clazz.new_((I$[3]||$incl$(3)).c$$javax_swing_Spring$javax_swing_Spring,[s1, s2]);
}, 1);

Clazz.newMeth(C$, 'max$javax_swing_Spring$javax_swing_Spring', function (s1, s2) {
return Clazz.new_((I$[4]||$incl$(4)).c$$javax_swing_Spring$javax_swing_Spring,[s1, s2]);
}, 1);
...
C$.checkArg$O(s);
return Clazz.new_((I$[5]||$incl$(5)).c$$javax_swing_Spring$F,[s, factor]);
}, 1);

Clazz.newMeth(C$, 'width$java_awt_Component', function (c) {
C$.checkArg$O(c);
return Clazz.new_((I$[6]||$incl$(6)).c$$java_awt_Component,[c]);
}, 1);

Clazz.newMeth(C$, 'height$java_awt_Component', function (c) {
C$.checkArg$O(c);
return Clazz.new_((I$[7]||$incl$(7)).c$$java_awt_Component,[c]);
}, 1);

Clazz.newMeth(C$, 'checkArg$O', function (s) {
if (s == null ) {
throw Clazz.new_(Clazz.load('java.lang.NullPointerException').c$$S,["Argument must not be null"]);
}}, 1);
;
...
Clazz.newInstance(this, arguments[0],false,C$);
}, ['javax.swing.Spring','javax.swing.Spring.AbstractSpring']);
...
Clazz.newInstance(this, arguments[0],false,C$);
}, ['javax.swing.Spring','javax.swing.Spring.StaticSpring']);
...
Clazz.newInstance(this, arguments[0],false,C$);
}, ['javax.swing.Spring','javax.swing.Spring.CompoundSpring']);
