(function(){var P$=Clazz.newPackage("javax.swing.undo"),I$=[['java.util.Vector','javax.swing.UIManager']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
return (I$[2]||$incl$(2)).getString$O("AbstractUndoableEdit.undoText");
}} else {
...
return (I$[2]||$incl$(2)).getString$O("AbstractUndoableEdit.redoText");
}} else {
