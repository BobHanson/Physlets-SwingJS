(function(){var P$=Clazz.newPackage("java.awt.geom"),I$=[[['java.awt.geom.Rectangle2D','.Float'],['java.awt.geom.Rectangle2D','.Double'],'java.awt.geom.RoundRectIterator']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
var ah = Math.min(this.getHeight(), Math.abs(this.getArcHeight())) / 2.0;
var x0class = p$.classify$D$D$D$D.apply(this, [x, rrx0, rrx1, aw]);
var x1class = p$.classify$D$D$D$D.apply(this, [x + w, rrx0, rrx1, aw]);
var y0class = p$.classify$D$D$D$D.apply(this, [y, rry0, rry1, ah]);
var y1class = p$.classify$D$D$D$D.apply(this, [y + h, rry0, rry1, ah]);
...
return Clazz.new_((I$[3]||$incl$(3)).c$$java_awt_geom_RoundRectangle2D$java_awt_geom_AffineTransform,[this, at]);
});
