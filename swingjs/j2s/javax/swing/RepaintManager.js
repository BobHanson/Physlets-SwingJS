...
$I$(14).getSystemEventQueueImplPP$sun_awt_AppContext(context).postEvent$java_awt_AWTEvent(Clazz.new_($I$(15).c$$O$I$Runnable$O$Z,[$I$(8).getDefaultToolkit$(), 1200, this.processingRunnable, null, false]));
}}, p$1);
;
...
;Clazz.setTVer('3.2.4.07');//Created 2019-06-16 22:44:10 Java2ScriptVisitor version 3.2.4.07 net.sf.j2s.core.jar version 3.2.4.07
