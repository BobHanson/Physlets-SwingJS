...
this.invalidate$();
var children=$I$(2).秘getChildArray$java_awt_Container(this.desktop);
...
this.setSize$I$I(r.width, r.height);
this.invalidate$();
var children=$I$(2).秘getChildArray$java_awt_Container(this);
if (children != null ) {
...
;Clazz.setTVer('3.2.4.07');//Created 2019-06-16 22:44:09 Java2ScriptVisitor version 3.2.4.07 net.sf.j2s.core.jar version 3.2.4.07
