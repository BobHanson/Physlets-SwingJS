(function(){var P$=Clazz.newPackage("java.awt"),I$=[['java.awt.MediaEntry','java.awt.ImageMediaEntry']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
return p$.checkAll$Z$Z.apply(this, [false, true]);
});

Clazz.newMeth(C$, 'checkAll$Z', function (load) {
return p$.checkAll$Z$Z.apply(this, [load, true]);
});
