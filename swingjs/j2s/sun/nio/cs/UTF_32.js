...
var C$=Clazz.newClass(P$, "UTF_32", null, 'sun.nio.cs.Unicode');
...
C$.superclazz.c$$S$SA.apply(this, ["UTF-32", $I$(1).aliases_UTF_32]);
C$.$init$.apply(this);
}, 1);
...
return Clazz.new_($I$(2).c$$java_nio_charset_Charset$I,[this, 0]);
});
