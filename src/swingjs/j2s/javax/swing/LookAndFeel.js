(function(){var P$=Clazz.newPackage("javax.swing"),I$=[['javax.swing.UIManager','swingjs.JSUtil','javax.swing.plaf.InputMapUIResource','javax.swing.plaf.ComponentInputMapUIResource','javax.swing.KeyStroke','sun.swing.DefaultLayoutStyle']],$incl$=function(i){return I$[i]=Clazz.load(I$[0][i-1])};
...
if (bg == null  || Clazz.instanceOf(bg, "javax.swing.plaf.UIResource") ) c.setBackground$java_awt_Color((I$[1]||$incl$(1)).getColor$O(defaultBgName));
var fg = c.getForeground();
if (fg == null  || Clazz.instanceOf(fg, "javax.swing.plaf.UIResource") ) c.setForeground$java_awt_Color((I$[1]||$incl$(1)).getColor$O(defaultFgName));
}, 1);
...
var retMap = Clazz.new_((I$[3]||$incl$(3)));
...
var retMap = Clazz.new_((I$[4]||$incl$(4)).c$$javax_swing_JComponent,[c]);
C$.loadKeyBindings$javax_swing_InputMap$OA(retMap, keys);
return retMap;
}, 1);
...
var ks = (Clazz.instanceOf(keyStrokeO, "javax.swing.KeyStroke")) ? keyStrokeO : (I$[5]||$incl$(5)).getKeyStroke$S(keyStrokeO);
