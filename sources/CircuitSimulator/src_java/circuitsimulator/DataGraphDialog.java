...
public class DataGraphDialog extends Dialog
{
	...
	public DataGraphDialog(Frame parent, CircuitBuilder cirbuilder, String s)
	{
		...
		setTitle(title+" "+cb.cirProp.getProperty(ce.name())+" "+ce.getlabel());
	...
	java.awt.Button stripChart = new java.awt.Button();
	java.awt.TextField periodInput = new java.awt.TextField();
