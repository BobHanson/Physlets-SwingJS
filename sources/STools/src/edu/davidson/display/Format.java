 ...
 */
 ...
 // isWhitespace has been must be changed to isSpace for 1.02 compatibility.
...
{ /** 
  ...
  */
   ...
   */
   ...
   {
      if(fmt=='i' || fmt=='d') return this.form((int)x);    // added by W. Christian to hand conversions to intergers with a double input.
      if(Double.isNaN(x) ||Double.isInfinite(x)) return "NaN"; 
      String r;
