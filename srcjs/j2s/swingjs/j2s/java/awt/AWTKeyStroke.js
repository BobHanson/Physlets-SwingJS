...
if (C$.vks == null ) {
C$.vks = Clazz.new_((I$[5]||$incl$(5)));
var vk = C$.vks;
{
var c = Clazz.load("java.awt.event.KeyEvent");
for (var k in c) if (k.indexOf("VK_") == 0 && typeof c[k] == "number") vk.put(k, Integer.$valueOf(c[k]));
}
}return C$.vks;
}, 1);
...
if (Clazz.exceptionOf(e$$, "java.lang.NoSuchFieldException")){
var nsfe = e$$;
{
throw Clazz.new_(Clazz.load('java.lang.IllegalArgumentException').c$$S,["String formatted incorrectly"]);
}
...
vkCollect.put$S$Integer(key, value);
